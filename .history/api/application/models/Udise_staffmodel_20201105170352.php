      ...
      // $school_id = $this->session->userdata('emis_user_id');
        ...
        public function get_schoolwise_class_section_medium($class,$section,$school_id)
        {
          ...
          //   return $result;
             ...
             $SQL="select schoolnew_section_group.*,schoolnew_mediumofinstruction.MEDINSTR_DESC as medium_name from schoolnew_section_group left join schoolnew_mediumofinstruction ON schoolnew_mediumofinstruction.MEDINSTR_ID = schoolnew_section_group.school_medium_id  where class_id=$class and section ='".$section."' and school_key_id=$school_id";
          $query = $this->db->query($SQL);
         return $query->result_array(); 
        }
