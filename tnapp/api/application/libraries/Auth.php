...
class Auth 
{
    ...
    public function get_login_details($user_type,$user_id)
    {
    	...
    	switch ($user_type) {
    		case 1: //SChool
    			$select = 'school_id,udise_code,school_name,district_id,block_id,edu_dist_id,
                           edu_dist_name,district_name,school_type,school_type_id,management,cate_type,section_nos,low_class,high_class,total,totstaff';
