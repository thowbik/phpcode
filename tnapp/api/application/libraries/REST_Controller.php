...
abstract class REST_Controller extends CI_Controller {
    ...
    public function __construct($config = 'rest')
    {
        ...
        //  get current routing name for token verification if login means not reqruired
        ...
        //this is for token validations 
           $token=AUTHORIZATION::checkAuthorizationUser($route);
        //end for token verification 
    }
