...
group by class_studying_id,class_section,education_medium_id;";
	...
	**********************************************************************************************************************/
	...
	public function nsstagginglist($where){
		$sql="select students_club_participation.id, students_club_participation.school_id,student_id,students_club_participation.class_studying_id,students_club_participation.class_section,participate_type_id,participate_subtype_id,participate_level,acyear,participate_type,participate_sub_type ,name
