...
/** 6 TC */
    ...
    $route['TCDtls'] = 'Registration/generate_student_tc_dtls';
...
$route['StudDetails']='State/StudDetails';
/* student list */
...
$route['getMobNo'] = "Home/getMobileNo"; 
$route['UpdateMobNo'] = "Home/updateMobileNo"; 
$route['QuestSet'] = "Home/questionSet";
$route['QuestResponse'] = "Home/questionResponse";
$route['SchoolsUnderBRTE'] = "Home/SchoolsUnderBRTE";
$route['SurveyList'] = "Home/surveyList"; 

$route['getSocialCategry'] = 'Home/social_category';
$route['getDiffAbled'] = 'Home/diff_abled';


// volunteer API by Karthi
$route['teacherVolunteer'] = 'Udise_staff/teacher_volunteer';
$route['volunteersList'] = 'Udise_staff/teacher_volunteers_list';
$route['studentVolunteer'] = 'Student/student_volunteer';
$route['getSchoolList'] = 'Udise_staff/volunteers_school_list';
$route['studentVolunteerlist'] = 'Student/student_volunteers_list';
$route['schoolVolunteerList'] = 'Schools_home/school_volunteers_list';
$route['TeachStudCount'] = 'Schools_home/teach_stud_count';
$route['TeachData'] = 'Schools_home/teach_data';
$route['StudData'] = 'Schools_home/stud_data';
$route['PrimerGuideBookUpdate'] = 'Udise_staff/primer_book_update';
$route['DelStudTeach'] = 'Udise_staff/delete_stu_teacher';

//Common APi for district get List
$route['getMasterDistrict']="MasterCtrl/getAllMastersDist";
$route['getAcademicDet']="MasterCtrl/getAcademicDet";

//By Nirmal
$route['getStdFieldApproval']="Student/getStdFieldApproval";

//Teacher Volunter Get Api and Save Api By Nirmal
$route['VolntrTeachrInSchl']="Student/VolntrTeachrInSchl";
$route['AssignTeacher']="Student/AssignTeacher";
$route['AssigndStudTeachList']="Student/AssigndStudTeachList";

//KE-Visiting Report
$route['InsrtUpdtInspctnReport']="Student/InsrtUpdtInspctnReport";

//Student Req-Araise 
$route['StudentDetail']="Student/StudentDetail";

//VOLUNTEER ATTENTACE 
$route['SavevolunteerAttentnance']="Student/volunteerAttentnance";
$route['GetvolunteerAttentnance']="Student/GetvolunteerAttentnance";
$route['GetAttentnancedtails']="Student/GetAttentnancedtails";

//Staff Details By Nirmal (By Teacher_id Based Details)
$route['Teacherlist'] ='Udise_staff/Teacherlist';


//reg Details by Karthi
$route['ReqRaised'] ='Student/req_raised';
$route['ReqPending'] ='Student/req_pending';
$route['ReqUpdate'] = 'Student/req_update';

//smartCard by Karthi
$route['SmartcardDetails'] = 'Student/smart_card_details';

//API for Observation Module starts here
$route['checkapi'] = 'Auth/checkapi';
$route['getAllTemplates'] = 'Template/getTemplates'; 
$route['getMaster'] = 'Masters/getMaster'; 
$route['getSchoolListByBlockId'] = 'Masters/getSchoolListByBlockId';
$route['getSchoolListByDistrictId'] = 'Masters/getSchoolListByDistrictId'; 
$route['getStudentsListBySchoolId'] = 'Masters/getStudentsListBySchoolId'; 
$route['getTeachersListBySchoolId'] = 'Masters/getTeachersListBySchoolId'; 
$route['getAppVersionInfo'] = 'Masters/getAppVersionInfo'; 
$route['saveObservation'] = 'Template/saveObservation'; 
$route['getLeaningOutcomeQuestions'] = 'Template/getLeaningOutcomeQuestions'; 
$route['getObservationList'] = 'Template/getObservationList'; 

$route['getObservationInfo'] = 'Student_OB/getObservationInfo';
$route['getTeachingMethodology'] = 'Student_OB/getTeachingMethodology';
$route['getChapterSection'] = 'Student_OB/getChapterSection';
$route['getAssesmentReasons'] = 'Student_OB/getAssesmentReasons';
$route['getMismatchReasons'] = 'Student_OB/getMismatchReasons';
$route['getTermList'] = 'Student_OB/getTermList';

$route['getSchoolMapping'] = 'Student_OB/getSchoolMapping';
$route['getSubjects'] = 'Student_OB/getSubjects';
$route['getQuestions'] = 'Student_OB/getQuestions';
$route['getSchoolDetails/(:num)'] = 'Student_OB/getSchoolDetails/';
$route['getBlocknames/(:num)'] = 'Student_OB/getBlocknames/';
$route['getTeacherDetails/(:num)'] = 'Student_OB/getTeacherDetails/';
$route['getSchoolClassInfo/(:num)'] = 'Student_OB/getSchoolClassInfo/';


$route['getStudentDetails'] = 'Student_OB/getStudentDetails/';
$route['saveObservationJson'] = 'Student_OB/saveObservationJson/';

$route['getAllData'] = 'Student_OB/getAllData/';
$route['getSchoolData/(:num)'] = 'Student_OB/getSchoolData/';

$route['getSchoolByDist'] = 'Student_OB/getSchoolByDist';
//$route['getTeachingQuestions/(:num)'] = 'Student_OB/getTeachingQuestions/';
$route['getBlocksBySchool/(:num)'] = 'Student_OB/getBlocksBySchool/';

//API for Observation Module ends here



//APi for Approval Module By Nirmal


$route['getDataDC'] = 'Student/getDataDC';
$route['dcApprvRejct'] = 'Student/dcApprvRejct_update';
$route['dirCheck']='Student/CheckData';

//END

//API FOR INSCPECTION TEACHER TAUGHT
$route['TechTaughtDropdown']='Udise_staff/TechTaughtDropdown';

//API DONE BY NIRMAL FOR SCHOOL MAINTANTCE

$route['MaintnceGet']='Udise_staff/MaintnceGet';
$route['MaintnceInsrtUpdtDlt']='Udise_staff/MaintnceInsrtUpdt';
$route['MaintnceStatusInsrtUpdtDlt']='Udise_staff/MaintnceStatusInsrtUpdtDlt';
$route['MaintnceStatusGet']='Udise_staff/MaintnceStatusGet';
$route['MaintnceTypeGet']='Udise_staff/MaintnceType';


//API DONE BY NIRMAL FOR BILL/EB API
$route['BilingDataGet']='Udise_staff/BilingDataGet';
$route['BillingInsrtUpdtDel']='Udise_staff/BillingInsrtUpdt';

//API DONE BY NIRMAL FOR BANK BRANCH DETAILS
$route['GetBranchDetls']='Udise_staff/GetBranchDetls';

//API DONE BY NIRMAL FOR STIPEND API
$route['GetStipendDet']='Udise_staff/GetStipendDet';
$route['GetStipendHistry']='Udise_staff/GetStipendHistry';
$route['StipendInsrtUpdtDlt']='Udise_staff/StipendInsrtUpdtDlt';
$route['StudBankDetails']='Udise_staff/StudBankDetails';
//END

$route['PLAAttendnceRep']='State/PLAAttendnceRep';

//API Acc Details BY Karthi
$route['AccntDetailsInstUpdDlt']='Student/AccntDetailsInstUpdDlt';
$route['StudentBankDetails']='Student/StudentBankDetails';
// $route['StudentBankDetailsID']='Student/StudentBankDetailsID';

//API DONE BY NIRMAL For SMC RESOLUTION
$route['ImgUpload']='Udise_staff/ImgUpload';
$route['GetImgUpload']='Udise_staff/GetImgUpload';
