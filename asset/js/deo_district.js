...
function validateoldpassword1()// function to validate oldpassword
  {
     ...
     $.ajax({
            type: "POST",
            url:baseurl+'Deo_District/emis_district_oldpasswordck',
            dataType: 'json',
        cache: false,
        async: false,
...
$(document).ready(function(){  // function call for validate company name 
    $("#emis_deo_reset_pass").click(function(){ 
    ...
    if(newpassword != cnfpassword)
    {
      ...
      return false;
          ...
          $.ajax({
              type: "POST",
              url:baseurl+'Deo_District/emis_deo_passwordreset',
             ...
             swal({
              ...
              function(isConfirm) {
              if (isConfirm) {
               window.location.href = baseurl+'Deo_District/emis_deo_resetpassword';
               return true;
              } else {
