...
function validateoldpassword1()// function to validate oldpassword
  {
     ...
     $.ajax({
            type: "POST",
            url:baseurl+'Beo_block/emis_block_oldpasswordck',
            dataType: 'json',
        cache: false,
        async: false,
...
$(document).ready(function(){  // function call for validate company name 
    $("#emis_beo_reset_pass").click(function(){ 
    ...
    if(newpassword != cnfpassword)
    {
      ...
      return false;
          ...
          $.ajax({
              type: "POST",
              url:baseurl+'Beo_block/emis_block_passwordreset',
             ...
             swal({
              ...
              function(isConfirm) {
              if (isConfirm) {
               window.location.href = baseurl+'Beo_block/emis_block_resetpassword';
               return true;
              } else {
