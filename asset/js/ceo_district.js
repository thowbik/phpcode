...
function validateoldpassword1()// function to validate oldpassword
  {
     ...
     $.ajax({
            type: "POST",
            url:baseurl+'Ceo_District/emis_district_oldpasswordck',
            dataType: 'json',
        cache: false,
        async: false,
...
$(document).ready(function(){  // function call for validate company name 
    $("#emis_ceo_reset_pass").click(function(){ 
    ...
    if(newpassword != cnfpassword)
    {
      ...
      return false;
          ...
          $.ajax({
              type: "POST",
              url:baseurl+'Ceo_District/emis_ceo_passwordreset',
             ...
             swal({
              ...
              function(isConfirm) {
              if (isConfirm) {
               window.location.href = baseurl+'Ceo_District/emis_Ceo_District_home';
               return true;
              } else {
