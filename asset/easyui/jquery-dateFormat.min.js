...
!function (a) {
    ...
    a.format = function () {
        ...
        function j(a) {
            var b, c, d, e, f, g = a, h = "";
            return -1 !== g.indexOf(".") && (e = g.split("."), g = e[0], h = e[1]), f = g.split(":"), 3 === f.length ? (b = f[0], c = f[1], d = f[2].replace(/\s.+/, "").replace(/[a-z]/gi, ""), g = g.replace(/\s.+/, "").replace(/[a-z]/gi, ""), {time: g, hour: b, minute: c, second: d, millis: h}) : {time: "", hour: "", minute: "", second: "", millis: ""}
        }
        function k(a, b) {
        ...
        return{parseDate: function (a) {
                ...
                if ("function" == typeof a.getFullYear)
                    b.year = String(a.getFullYear()), b.month = String(a.getMonth() + 1), b.dayOfMonth = String(a.getDate()), b.time = j(a.toTimeString());
                else if (-1 != a.search(f))
                    values = a.split(/[T\+-]/), b.year = values[0], b.month = values[1], b.dayOfMonth = values[2], b.time = j(values[3].split(".")[0]);
                else
                    switch (values = a.split(" "), values.length) {
                        case 6:
                        ...
                        if (p)
                            ...
                            switch (m += r, o = "", m) {
                                ...
                                case"H":
                                    ...
                                    break;
                                case"hh":
                                    hour = 0 === l.hour ? 12 : l.hour < 13 ? l.hour : l.hour - 12, n += k(hour, 2), m = "";
                                    break;
                                case"h":
                                    if ("h" === s)
                                        break;
                                    hour = 0 === l.hour ? 12 : l.hour < 13 ? l.hour : l.hour - 12, n += parseInt(hour, 10), m = "";
                                    break;
                                case"mm":
                                    n += k(l.minute, 2), m = "";
                                    break;
