    ...
    function initCss() {
        if (!$('#easyui-portal-style').length) {
            $('head').append(
                    ...
                    '.portal table {width: 100% !important;height: 100% !important;overflow:hidden;}' +
                    '.portal-noborder{border:0;}' +
                    '.portal .portal-panel{margin-bottom:2px;}' +
                    '.portal-column-td{vertical-align:top;}' +
                    '.portal-column{padding:2px 0 2px 2px;overflow:hidden;}' +
                    '.portal-column-left{padding-left:2px;}' +
                    '.portal-column-right{padding-right:2px;}' +
                    '.portal-proxy{opacity:0.6;filter:alpha(opacity=60);}' +
                    '.portal-spacer{border:3px dashed #eee;margin-bottom:2px;}' +
                    '</style>'
                    );
        }
    }
