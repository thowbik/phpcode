...
(function ($) {
    function _ac(_ad) {
        ...
        /* ifdef CUSTOM_CHANGE */
        $("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
        $("<td><input id='searchButton' name='searchButton' class='easyui-searchbox' data-options='searcher:doSearch,prompt:\"Search Text\"'/></td>").appendTo(tr);
                ...
                if (e.keyCode == 9) {
                    ...
                    if (e.keyCode == 13) {
                        ...
                        if (_2c4.length) {
                            ...
                            var message = _2c4.val();
                            if (message !== null && message !== "" && message !== undefined) {
                                //_2c5(dlg, _2c4.val());
                                _2c4.closest('.messager-window').find('.messager-button').children('a.l-btn:first-child').click();
                            } else {
                                //DO NOTHING
                            }
                        }
...
(function ($) {
    ...
    function load(_5d0, data) {
        ...
        function _5d5(v, val) {
            /* ifdef CUSTOM_CHANGE */
            if (Number(val) === 0 || val === "No" || val === "no" || val === "Disabled" || val === "disabled" || val === "Locked" || val === "locked") {
                val = "off";
            } else if (Number(val) === 1 || val === "Yes" || val === "yes" || val === "Enabled" || val === "enabled" || val === "Unlocked" || val === "unlocked") {
                val = "on";
            } else {
                val = "off";
            }
            if (v == String(val) || $.inArray(v, $.isArray(val) ? val : [val]) >= 0 || v == 1) {
                return true;
            } else {
                return false;
            }
...
(function ($) {
            ...
            for (var i = 0; i < _6cf.length; i++) {
                ...
                for (var j = 0; j < cols.length; j++) {
                    ...
                    if (col.checkbox) {
                        ...
                        /* ifdef CUSTOM_CHANGE */
                        $("<div class=\"datagrid-header-check\"></div>").html("<input class=\"datagrid-header-check\" type=\"checkbox\"/>").appendTo(td);
                        /* else CUSTOM_CHANGE */
    ...
    function _6e8(e) {
        ...
        /* ifdef CUSTOM_CHANGE */
        var ck = $(e.target).closest("input.datagrid-header-check[type=checkbox]");
        /* else CUSTOM_CHANGE */
    ...
    function _763(_764) {
        ...
        var dc = _765.dc;
        /* ifdef CUSTOM_CHANGE */
        dc.header1.add(dc.header2).find("input.datagrid-header-check[type=checkbox]")._propAttr("checked", false);
        /* else CUSTOM_CHANGE */
    ...
    function _6fc(_794, _795, _796) {
        ...
        if (tr.length == opts.finder.getRows(_794).length) {
            var dc = _797.dc;
            /* ifdef CUSTOM_CHANGE */
            dc.header1.add(dc.header2).find("input.datagrid-header-check[type=checkbox]")._propAttr("checked", true);
            /* else CUSTOM_CHANGE */
    ...
    function _6fd(_798, _799, _79a) {
        ...
        /* ifdef CUSTOM_CHANGE */
        _79c.find("input.datagrid-header-check[type=checkbox]")._propAttr("checked", false);
        /* else CUSTOM_CHANGE */
    ...
    function _6ea(_79d, _79e) {
        ...
        var dc = _79f.dc;
        /* ifdef CUSTOM_CHANGE */
        var hck = dc.header1.add(dc.header2).find("div.datagrid-header-check input[type=checkbox]");
        /* else CUSTOM_CHANGE */
