...
include_once APPPATH.'/third_party/swiftmailer/lib/swift_required.php';
class Mailer { 
    ...
    public function __construct() { 
        ...
        $this->userName = 'clusterassets@gmail.com';
        $this->password = 'Ct24*7 Hacker';
        $this->emailHost = 'smtp.gmail.com';
        $this->mailFrom = ['clusterassets@gmail.com' => 'Vivek Rao Bhosale'];
