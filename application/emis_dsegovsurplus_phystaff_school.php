...
<link href="<?php echo base_url().'asset/global/plugins/simple-line-icons/simple-line-icons.min.css';?>" rel="stylesheet" type="text/css" />
                                     ...
                                     <div class="portlet-body">
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>DSESchool Surplus Report <?php echo "  Eligible Surplus :(".$sur.')'?></div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
 ...
 <th>Date Of <br>Appointment</th>
                                                            ...
                                                            <?php $i=1;
                                                         if(!empty($dsegovsurplus_phystaff)){
                                                           // print_r(dsegovsurplus_sgstaff);
															foreach($dsegovsurplus_phystaff as $sd){
...
<input type="hidden" id="school_id<?=$i?>" value="<?=$sd->school_id;?>">
														...
														<td><?=
														date('d-m-Y', strtotime($sd->staff_join))?></td>
														...
														<td><?=
														date('d-m-Y', strtotime($sd->staff_dob))?></td>
  ...
  <option value="0" <?=$sd->surplus == 1 ?'selected="selected"':'';?>>NonSurplus</option>
...
function saveleaveperiods()
{
	...
	var dsegovsurplus_sgstaff = <?=json_encode($dsegovsurplus_sgstaff);?>;
		...
		for(var i =1;i<=dsegovsurplus_sgstaff.length;i++)
		{
			...
			if(modeule_id1 != 0)
			{
		         school_verification.push({'modeule_id1':modeule_id1,'school_id':school_id,'teach_id':teach_id});
		...
		if(surplus_count >= sur_count){
			...
			$.ajax(
          {
			...
			url:baseurl+'Ceo_District/save_surplus',
			type:"POST",
			dataType:"JSON",
