                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                        ...
                                        <form action="<?=base_url().'Home/emis_uniform_indent'?>" method="post">
                            ...
                            <div id="faq-cat-1-sub-2" class="panel-collapse panel-collapse collapse in" aria-expanded="true" style>
							 ...
							 <th style="text-align: center;">Size V</th>
							  ...
							  <?php if(!empty($uf->district_name)){?>
							            ...
							            <?php if(!empty($uf->sets)){?>
										<td style="text-align: left;"> <a href="<?php echo base_url().'Home/emis_uniform_indent/?district_id='.$uf->sets.$uf->scheme_id.$uf->district_id?>"><?php } else {?>
										<td style="text-align: left;"> <a href="<?php echo base_url().'Home/emis_uniform_indent/?district_id='.'0'.$uf->scheme_id.$uf->district_id?>"><?php }?>
							  ...
							  <?php } else if(!empty($uf->block_name)) {?>
							           <?php if(!empty($uf->sets)){?>
							           <td style="text-align:left;"><a href="<?php echo base_url().'Home/emis_uniform_indent/?block_id='.$uf->sets.$uf->scheme_id.$uf->block_id?>"><?php } else {?>
									   <td style="text-align:left;"><a href="<?php echo base_url().'Home/emis_uniform_indent/?block_id='.'0'.$uf->scheme_id.$uf->block_id?>"><?php }?>
