                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Vocational Sector Under NSQF<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="center">Job Role</th>
                                                                    <th class="center">Job Sector</th>
                                                                    <th style="text-align: center;">Boys Total</th>
                                                                      <th style="text-align: center;">Girls Total</th>
                                                                         <th>PreKG-Boys</th>
                                                                    <th>PreKG-Girls</th>
                                                                    <th>LKG-Boys</th>
                                                                    <th>LKG-Girls</th>
															...
															if(!empty($school_community)){ $total1 = []; $tot_b=[]; $tot_g=[]; $Prkg_b=[]; $Prkg_g=[]; $lkg_b=[]; $lkg_g=[]; $ukg_b=[]; $ukg_g=[]; $c1_b=[]; $c1_g=[]; $c2_b=[]; $c2_g=[]; $c3_b=[]; $c3_g=[]; $c4_b=[]; $c4_g=[]; $c5_b=[]; $c5_g=[]; $c6_b=[]; $c6_g=[]; $c7_b=[]; $c7_g=[]; $c8_b=[]; $c8_g=[]; $c9_b=[]; $c9_g=[]; $c10_b=[]; $c10_g=[]; $c11_b=[]; $c11_g=[]; $c12_b=[]; $c12_g=[]; $total_t=[]; $total_b=[]; $total_g=[]; $total=[]; foreach($school_community as $index=> $sd){   ?>

                             <tr>
                                  <td class="center"><?=$index+1;?></td>
																  <td style="text-align: left;"><?= $sd->job_role ?></td>		
																  <td style="text-align: left;"><?= $sd->job_sector ?></td>
                                  <td style="text-align: center;"><?= $sd->cnt_b ?></td>
                                  <td style="text-align: center;"><?= $sd->cnt_g ?></td>
                                  ...
                                  <!-- <td  class="center"><?= $sd->total?></td>  -->
                                 								
                            </tr>
                                     <?php
                                      array_push($tot_b,$sd->cnt_b);
                                      array_push($tot_g,$sd->cnt_g);
                                        ...
                                        array_push($total,$sd->total);
                                                         ...
                                                         <tfoot>
                                                           ...
                                                           <th style="text-align: center;" ></th>
                                                            ...
                                                            $tot_b = array_sum($tot_b);
                                                            array_push($total1,$tot_b);
                                                            echo number_format($tot_b);?></th>
                                                             <th style="text-align: center;" ><?php 
                                                            $tot_g = array_sum($tot_g);
                                                            array_push($total1,$tot_g);
                                                            echo number_format($tot_g);?></th>
                                                             <th style="text-align: center;" ><?php 
