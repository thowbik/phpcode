                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                               ...
                               <th style="text-align: center;">District</th>
                                ...
                                <?php $teach_type=$this->input->get('desig');  if($teach_type==36  || $teach_type==41 || $teach_type==11 || $teach_type==26  || $teach_type==27 || $teach_type==28 || $teach_type==29){
                                ?>
                              ...
                              <td style="text-align: center;"><?php if($staff_tnfr->new_sub==0){
                                 echo $staff_tnfr->sub;
                              }
                              else
                              {

                              echo $staff_tnfr->new_sub; 
                            } 
                            ?></td>
