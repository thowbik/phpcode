                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Districtwise - Profile Completion Status<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
														...
														foreach($district_profile_completion_status as $index=> $comp_status){   ?>
                                                                ...
                                                                <tr>
                                                                    <td ><?=$index+1;?></td>
                                                                    <td style="text-align: left;"><a href="<?=base_url().'State/profile_status_schoolkwise?block='.$comp_status->block_id.'&school_type='.$school_type_c?>"><?=$comp_status->block_name?></a>
