                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                       <h1>Laptop Distribution Monitoring Report
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Laptop Distribution Monitoring-(2018-2019) </div>
                              ...
                              <?php if(!empty($student_migration_details)){ $Gov_tot= [];$FA_tot= [];$UA_tot= [];$PA_tot= []; $CG_tot= []; $sum1=[]; $assigned_sum1=[]; $not_marked1=[]; $i=1;foreach($student_migration_details as $key => $value){ $j=0; $sum=0; $assigned_sum=0;  $not_marked=0;
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="<?php echo base_url().'State/dge_2018_19_report_schl/?block_id='.$key?>"><?php echo($key); ?></a></td>
