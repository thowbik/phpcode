                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <form action="<?php echo base_url().'State/get_dash_blockwise_dee?block='.$block_name?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
