                        ...
                        <div class="page-content-wrapper">
                         ...
                         <h5 style="color:red;"><strong>Distributed :</strong>Number of students for whom laptop has been distributed</h5>
                            ...
                            <div class="page-content">
                              ...
                              <tbody>
                              <?php $total1=[]; ?>
                              <?php if(!empty($student_migration_details)){ $Gov_tot= [];$FA_tot= [];$UA_tot= [];$PA_tot= []; $CG_tot= []; $sum1=[]; $assigned_sum1=[]; $not_marked1=[]; $i=1;foreach($student_migration_details as $key => $value){ $j=0; $sum=0; $assigned_sum=0; $not_marked=0; //print_r($value); die();
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="<?php echo base_url().'State/dge_2018_19_report_blk/?district_id='.$key?>"><?php echo($key); ?></a></td>
