                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Teacher Time Table Assigned classes<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                               ...
                                                               <tbody>
                                                            <?php if(!empty($classwise_teacherassign)){ $total1 = 0; foreach($classwise_teacherassign as $index=> $sd){   ?>

                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td><!--<a href="<?php echo base_url().'state/emis_teacherassign_classwise?teacherid='.$sd->teacher_code?>">--><?php echo $sd->teacher_name; ?></td>
