                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'State/BRTE_List_block?dist_id='.$dist?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
...
$total1 = [];
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
														...
														?>
                                                            <i class="fa fa-globe"></i>BRTE-List | District : <?php echo $school_timetable_details[0]->district_name ?> | Block-wise<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="sum center">Assigned Schools</th>
																	                                  <th class="sum center">Not Assigned Schools</th>
                                                            ...
                                                            <?php if(!empty($school_timetable_details)){ $total1 = 0; foreach($school_timetable_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td><a href="<?php echo base_url().'state/BRTE_List_teacher?blk='.$sd->block_id?>"><?php echo $sd->block_name ?></a></td>
                                                                  
                                                                   <td class="center"><?=number_format($sd->Total_school)?></td>
                                                                   <td class="center"><?=number_format($sd->brte_cnt)?></td>
																   <td class="center"><?=number_format($unmarked=$sd->Total_school-$sd->brte_cnt)?></td>
                                                                   <td class="center">
                                                                                <?php 

                                                                                    $marked_school = round(($sd->brte_cnt/$sd->Total_school)*100);
   ...
   <div class="row">
                                                            ...
                                                            <div class="color-box-green" style="background-color:#5cb85c;" data-hex="#CD5C5C" data-rgb="205, 92, 92" data-hsl="0, 53%, 58%"></div> Marked Sections
                                                        </div>
                                                        
                                                        <div class="col-md-2">
                                                            <div class="color-box-green" style="background-color:#ed6b75;" data-hex="#CD5C5C" data-rgb="205, 92, 92" data-hsl="0, 53%, 58%"></div>  Not Marked Sections
                                                        </div>
