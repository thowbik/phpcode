                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="text-align: center;">Total <br/>School <br/>Count</th>
                                                           ...
                                                           $total1 = []; $tot=[]; $std_count=[]; $toil_notuse_bys=[]; $toil_bys_inuse=[]; $toil_inuse_grls=[]; $toil_notuse_grls=[]; $total_b=[]; $total_g=[]; $i=1;  foreach($school_land_verification as $det){ 
                                                              
                                                             ?>

                                                                <tr>
                                                                    <td><?php echo $i;?></td>
                                                                    <td ><a href="<?php echo base_url().'State/school_sanitation_verification_district_1/?block_id='.$det->block_id?>"><?=$det->block_name;?></a></td>
                                                                   <!---->
                                                                    <td style="text-align: center;"><?= number_format($det->std_count);?></td>
                                                                     <td style="text-align: center;"><?php echo number_format(($det->total_b)/($det->toil_bys_inuse),3);?></td>
                                                                     ...
                                                                     <td style="text-align: center;"><?php echo number_format(($det->total_g)/($det->toil_inuse_grls),3);?></td>
                                                                     <td style="text-align: center;"><?php $bys_toil_tot = $det->toil_bys_inuse+$det->toil_notuse_bys;

                                                                     echo ($bys_toil_tot!=0?number_format(($det->total_b)/($bys_toil_tot),3):'NA');?></td>
                                                                       <td style="text-align: center;"><?= number_format($det->toil_bys_inuse);?></td>

                                                                     <!-- <td style="text-align: center;"><?= number_format($det->toil_notuse_bys);?></td>
                                                                    <!--  <td style="text-align: center;"><?php $girls_toil_tot = $det->toil_inuse_grls+$det->toil_notuse_grls;
