...
<link href="<?php echo base_url().'asset/global/plugins/simple-line-icons/simple-line-icons.min.css';?>" rel="stylesheet" type="text/css" />
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Dashboard
                                           ...
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'State/emis_state_school_dee'?>">
                                          ...
                                          <li role="presentation" class="next">
                                                <a href="<?php echo base_url().'State/emis_state_school_dms'?>">
                                              <span class="text" >Directorate Of Matriculation School</a></span>
                                          </a>
                                          </li>
                                            <li role="presentation" class="next">
                                                <a href="<?php echo base_url().'State/emis_state_school_others'?>">
 ...
 $s_cnt= []; $i=1; $total1=[];
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo base_url().'State/get_state_school_wise_dee/?dist='.$det->district_name."&mang=".$det->management?>"><?=$det->district_name;?></a></td>
