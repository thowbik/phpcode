                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Special Cash Incentive Report - (2019-20)</div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="sum center">Total Student</th>
                                                                    <th class="sum center">Eligible Student</th>
																	<th class="sum center">Not Eligible Student</th>
															...
															$total_marked=0;
															$unmarked=0;
															if(!empty($state_cash_details)){ 
															foreach($state_cash_details as $index=> $sd){   

                                                                
                                                                $no_data = ($sd->twelth - ($sd->mark+$sd->not_elig)); 
                                                                ?>

                                                                <tr >
                                                                   <td class="center"><?=$index+1;?></td>
                                                                   <td> <a href="<?php echo base_url().'state/schoolwise_special_cash?districtid='.$sd->district_id?>"><?=$sd->district_name;?></a></td>
                                                                   <td class="center"> <?=$sd->school_count;?></td>
                                                                   <td class="center"><?=$sd->twelth?></td>
                                                                   <td class="center"><?=$sd->mark?></td>
																   <td class="center"><?=$sd->not_elig;


                                                                   ?></td>
                                                                   <td class="center"><?=$no_data;?></td>
                                                           ...
                                                           <tfoot>
                                                                ...
                                                                <th class="center"></th>
                                                                <th class="center"></th>
                                                                <th class="center"><?php echo $total_stu?></th>
                                                                <th class="center"><?php echo $total_marked?></th>
                                                                <th class="center"></th>
                                                                
                                                            </tfoot>
                                                            <?php } ?>
                                                        </table>
                                                         <p><b>*  includes all categories of fully aided partially aided schools in the district</b></p>
