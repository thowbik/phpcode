                                ...
                                <div class="container">
                                    ...
                                    <!--  <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <form action="<?php echo base_url()?>State/schoolwise_class_question_report_dist" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                               ...
                                               ?>
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>CCE Entry Monitoring Report(District-Wise) : TERM-1</div>
                               ...
                               //   $assigned_sum +=$dge['dge']==2?$dge['std_cnt']:0;
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="<?php echo base_url().'State/schoolwise_class_question_report_blk/?district_id='.$key->District?>"><?php echo ($key->District); ?></td>
                                      <td style="text-align: center;"><?php echo $sum=$key->Total_Students; ?></td>
                                      <td style="text-align: center;"><?php echo $assigned_sum=$key->Term1_Marked;?></td>
