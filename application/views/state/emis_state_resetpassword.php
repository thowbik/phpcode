                                             ...
                                             <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <label class="control-label col-md-4">Old password *</label>
                                                        <div class="col-md-4">
                                                            <input type="password" class="form-control" id="emis_state_user_oldpass" name="emis_state_user_oldpass"  placeholder="Old Password *" >
                                                             <font style="color:#dd4b39;"><div id="emis_state_user_oldpass_alert"></div></font>
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                             <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <label class="control-label col-md-4">New password *</label>
                                                        <div class="col-md-4">
                                                            <input type="password" class="form-control" id="emis_state_user_newpass" name="emis_state_user_newpass"  placeholder="New Password *" onkeyup='password_strength(this.value)' >
                                                             <font style="color:#dd4b39;"><div id="emis_state_user_newpass_alert"></div></font>
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                        <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <label class="control-label col-md-4">Confirm New password *</label>
                                                        <div class="col-md-4">
                                                            <input type="password" class="form-control" id="emis_state_user_cnfpass" name="emis_state_user_cnfpass"  placeholder="Confirm New password *">
                                                             <font style="color:#dd4b39;"><div id="emis_state_user_cnfpass_alert"></div></font>
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-6">
                                                            <button type="button" class="btn green" id="emis_state_reset_pass">Submit</button>
