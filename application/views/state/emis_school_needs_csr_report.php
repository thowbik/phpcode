   ...
   <?php } ?>
                        ...
                        <div class="page-content-wrapper">
                          ...
                          <div class="portlet-body">
                                     ...
                                     <div class="row">
                                        ...
                                        <form action="<?=base_url().'State/school_needs_csr'?>" method="post">
                          ...
                          <div class="col-md-3">
                                                            ...
                                                            <select class="form-control" id="itemnames" name="itemname" >
                                                            <option value="" >Choose</option>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content faq-cat-content">
                ...
                <?php 
                            if(!empty($school_needs_csr))
                            {
                            
                            foreach($school_needs_csr as $uf)
                            {
                            ...
                            <div class="panel-heading active-faq">
                                <a data-toggle="collapse" data-parent="#accordion-cat-1" href="#" aria-expanded="true" class>
                                    <h4 class="panel-title">
                                        <i class="fa fa-globe"></i> School Needs CSR
                ...
                <input type="hidden" id="scat" name="scat" value="<?php echo $sub_cat ;?>">
                <input type="hidden" id="itm" name="itm" value="<?php echo $item ;?>">
                ...
                <td style="text-align:left;"><a href="<?php echo base_url().'State/school_needs_csr/-/'.$cat.'/'.$sub_cat.'/'.$item.'/'.$uf->district_id ?>">
                              <?php echo $uf->district_name;?></a></td>
                <td style="text-align: center;"><?php echo $uf->school_id; ?></td>
                <td style="text-align: center;"><?php echo $uf->qty; ?></td>
                <?php } else if(!empty($uf->block_name)) {?>
                <td style="text-align:left;"><a href="<?php echo base_url().'State/school_needs_csr/'.$uf->block_id.'/'. $this->uri->segment(4,0).'/'. $this->uri->segment(5,0).'/'. $this->uri->segment(6,0) ?>"><?php echo $uf->block_name;?></a></td>
                <td style="text-align: center;"><?php echo $uf->school_id; ?></td>
                <td style="text-align: center;"><?php echo $uf->qty; ?></td>
                <?php } else {?>
                    <td style="text-align: center;"><?php echo $uf->udise_code ?></td>
                <td style="text-align: left;"><?php echo $uf->school_name;?></td>
                <td style="text-align: center;"><?php echo $uf->material_name; ?></td>
                <td style="text-align: center;"><?php echo $uf->cat_name; ?></td>
                <td style="text-align: center;"><?php echo $uf->sub_cat_name; ?></td> 
                <td style="text-align: center;"><?php echo $uf->qty ?></td> 
