                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Teacher Surplus List</div>
                                                    ...
                                                    <div class="portlet-body">
															...
															<tbody>
                                                            <?php $total1=[];?>
															<?php if(!empty($teacherdistrictdetails)){  $Govteacher_tot= [];$BTteacher_tot= [];$SGteacher_tot= [];$HM_tot=[];$PGteacher_tot= [];$i=1;foreach($teacherdistrictdetails as $det){ 
                                                               
															 ?>
															<tr>
                                                            <td style="text-align: center;"><?php echo $i;?></td>
                                                            <td><a href="<?php echo base_url().'State/emis_teacher_classwise_surplus_district/?dist_id='.$det->district_id?>">
                                                           ...
                                                           <td style="text-align: center;"> <?php echo number_format($det->BT); ?></td>
                                                          ...
                                                          <td style="text-align: center;"> <?php echo number_format($det->Govteacher); ?></td>
                                                            ...
                                                            array_push($BTteacher_tot,$det->BT);
                                                            array_push($SGteacher_tot,$det->SG);
                                                            array_push($PGteacher_tot,$det->PG);
