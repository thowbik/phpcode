                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Right To Education - Seat Allocation Status
                              ...
                              <!--      <div class="portlet light portlet-fit ">
                                        ...
                                        <!-- BEGIN CARDS -->
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>RTE-Seat Allocation Status| District-wise</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                    <th >S.No</th>
                                                                    <th>District </th>           
                                                                    <th style="text-align: center;">Total Schools</th>
                                                                   
                                                                    <th style="text-align: center;">Completed Schools</th>
                                                                    <th style="text-align: center;">RTE Seats</th>
                                                                   
                                                                </tr>
                                                                </thead>
                                                               
                                                                 
                                                            <?php $i=1; $total1 = []; if(!empty($allstuds)){
                                                                $total_school_tot=[];$Completed_school_tot=[];$RTE_tot=[];
 
                                                              foreach($allstuds as $det){ 
                                                              
                                                             ?>

                                                                <tr>
                                                                    <td><?php echo $i;?></td>
                                                                    <td><a href="<?php echo base_url().'State/get_RTE_school_allocation/?dist='.$det->district_name?>"><?=$det->district_name;?></a></td>
                                                                   <!---->
                                                                    <td style="text-align: center;"><?=number_format($det->tot);?></td>
                                                                  
                                                                    <td style="text-align: center;"><?=number_format($det->school_count);?></td>
                                                                      <td style="text-align: center;"><?=number_format($det->rte_seats);?></td>
                                                                    
                                                                </tr>
                                                                <?php $i++;?>
                                                             <?php 
                                                            array_push($total_school_tot,$det->tot);
                                                            array_push($Completed_school_tot,$det->school_count);
                                                            array_push($RTE_tot,$det->rte_seats);
                                                         ...
                                                         <?php } ?>
                                                            ...
                                                            $total_school_tot = array_sum($total_school_tot);
                                                            array_push($total1,$total_school_tot);
                                                            echo number_format($total_school_tot);?></th>
                                                            <th style="text-align: center;"><?php 
                                                                $Completed_school_tot = array_sum($Completed_school_tot);
                                                                array_push($total1,$Completed_school_tot);
                                                            echo number_format($Completed_school_tot);?></th>
                                                            <th style="text-align: center;"><?php 
                                                            $RTE_tot = array_sum($RTE_tot);
                                                                array_push($total1,$RTE_tot);
                                                                echo number_format($RTE_tot);?></th>
