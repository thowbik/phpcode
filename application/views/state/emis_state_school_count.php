...
<html lang="en">
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>School Total Count   <small>Click this school to select</small>
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i> School Total Count | <span>Block : <?php if($blockname!="") { echo $blockname; } ?></span> </div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <?php if(!empty($details)){ foreach($details as $det){ ?>
                                                                ...
                                                                <tr><td><a onclick="saveschoolid('<?php echo $det->school_id; ?> ','<?php echo $det->udise_code; ?>')">
                                                                    <?php echo $det->udise_code; ?></a></td>
                                                                    <td> <a onclick="saveschoolid('<?php echo $det->school_id; ?> ','<?php echo $det->udise_code; ?>')">
  ...
  <script type="text/javascript">
               function saveschoolid(value,value1){
                 var baseurl = "<?php echo base_url(); ?>";

                swal({
                          title: "Are you sure?",
                          text: "You want to select this school?",
                          type: "warning",
                        ...
                        function(isConfirm) {
                          if (isConfirm) {
                             window.location.href = baseurl+'state/emis_state_schoolmainid/'+value+'/'+value1;
                          } else {
        ...
        <script src="<?php echo base_url().'asset/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js';?>" type="text/javascript"></script>
              ...
              <script src="<?php echo base_url().'asset/global/plugins/bootstrap-sweetalert/sweetalert.min.js';?>" type="text/javascript"></script>

        <script src="<?php echo base_url().'asset/pages/scripts/ui-sweetalert.min.js';?>" type="text/javascript"></script>
