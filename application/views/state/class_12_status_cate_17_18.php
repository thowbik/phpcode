                                    ...
                                    <div class="page-title">
                                        <h1>Past Class 12 Student Status (Category-Wise)
                                          ...
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist" style="width:max-content">
                                            ...
                                            <a href="<?php echo base_url().'State/class_12_status_cate_17_18'?>">
                                              <span class="text">Class 12 Status -(2017-2018)  </span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'State/class_12_status_cate'?>">
                         ...
                         <h5 style="color:red;"><strong>NOTE:</strong>12th Passed Students Only</h5>
                            ...
                            <div class="page-content">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Class 12 Status - (Category-wise) - (2017-2018)   </div>
                             ...
                             <th style="text-align: center;">Joined <br/>polytechnic college</th>
                              <th style="text-align: center;">Not studying <br/> /Not working</th>
                              <th style="text-align: center;">Other/Working</th>
                            ...
                            <td><a href="<?php echo base_url().'State/class_12_status_cate_17_18_blk/?district_name='.$student_mig->district_name?>">
                             ...
                             <td style="text-align: center;"> <?php echo number_format($student_mig->eng); ?></td>
                              ...
                              <td style="text-align: center;"> <?php echo number_format($student_mig->other+$student_mig->working); ?></td>
                              ...
                              <?php
                                                            ...
                                                            array_push($stud_work,$student_mig->stud_work);
															                              array_push($other,($student_mig->other+$student_mig->working));
                                                         ...
                                                         <tfoot>
                                                           ...
                                                           echo number_format($eng);?></th>
                                                            ...
                                                            $other = array_sum($other);
                                                             ...
                                                             <th style="text-align: center;"><?php echo number_format( $arts_sci_law+$eng+$medi_clg+$poly_clg+$stud_work+$other);?></th>
