                                                ...
                                                <div class="bs-callout-lightsteelblue dashboard-stat2">
                                                    <div class="display">
                                                        <div class="number">
                                                         ...
                                                         <span class="bottom" data-counter="counterup" data-value="34">Total Staff
                                                         </span></h4>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        $total_absent = 0;
                                                                ...
                                                                <tr class="center">
                                                                    ...
                                                                    <td ><a href="<?=base_url().'State/get_attendance_teacher_classwise?school='.$det->school_id.'&date='.$date?>"><?=$det->udise_code?></a>
                                                                    </td>
                                                               <?php }else { ?>
                                                               <td ><?=$det->udise_code?>
                                                                    </td>
