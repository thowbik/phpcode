                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'State/schoolwise_class_timetable_report?block_name='.$school_timetable_details[0]->block_name?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="center">School Name</th>
                                                            ...
                                                            <?php if(!empty($school_timetable_details)){ $total1 = 0; foreach($school_timetable_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td> <a href="<?php echo base_url().'State/school_class_section_timetable?schoolid='.$sd->school_id?>&schoolname=<?php echo $sd->school_name ?>"><?=$sd->school_name;?></a></td>
