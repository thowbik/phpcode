                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>DEE-Staff Fixation ReportBlock-Wise</div>
                              ...
                              <td><a href="<?php echo base_url().'State/emis_staff_fixa_report_school/?block_id='.$student_fig->block_id?>">
