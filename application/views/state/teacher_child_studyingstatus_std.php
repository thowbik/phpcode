                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                             ...
                             <td>
                              <?php echo $student_mig->name; ?></td>
                              <td style="text-align: center;"> <?php echo $student_mig->unique_id_no; ?></td>
                              <td style="text-align: center;"> <?php echo $student_mig->udise_code; ?></td>
