                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                       <h1><!--Past Class 12 Student Status-->Laptop Distribution Monitoring
                                            <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'State/past_12_2017_18_report'; ?>">
                                              <span class="text">Class 12 Status-(2017-2018)</span>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'State/past_12_2018_19_report'; ?>">
                            ...
                            <div class="page-content">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Laptop Distribution Monitoring-(2017-2018) </div>
                              ...
                              <tbody>
                              <?php $total1=[]; ?>
                              <?php if(!empty($student_migration_details)){ $Gov_tot= [];$FA_tot= [];$UA_tot= [];$PA_tot= []; $CG_tot= []; $sum1=[]; $assigned_sum1=[]; $not_marked1=[]; $i=1;foreach($student_migration_details as $key => $value){ $j=0; $sum=0; $assigned_sum=0;  $not_marked=0;
                                    foreach ($value as $dge) {
                                    $sum +=$dge['dge']==1?$dge['std_cnt']:0;
                                  $assigned_sum +=$dge['dge']==2?$dge['std_cnt']:0;
                                  $not_marked +=$dge['dge']==3?$dge['std_cnt']:0;
                                    }
                                ?>
                                  <tr>
                                      <td style="text-align: center;"><?php echo($i++); ?></td>
                                      <td><a href="<?php echo base_url().'State/past_12_2017_18_report_schl/?block_id='.$key?>"><?php echo($key); ?></a></td>
                                      <td style="text-align: center;"><?php echo $sum;?></td>
                                      <td style="text-align: center;"><?php echo $assigned_sum;?></td>
                                       <td style="text-align: center;"><?php echo $not_marked?></td>
                                    </tr>  
                             <?php  
                                      array_push($sum1,$sum);
