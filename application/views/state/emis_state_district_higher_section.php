                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>District Name</th>
																	<th>Total School *</th>
																	<th>Groups in Hr.Sec</th>
																	<th>DGE Groups Assigned</th>
															...
															{ $total1 = 0; foreach($dist_school_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo base_url().'state/school_class_higher_section?districtid='.$sd->district_id?>"><?=$sd->district_name;?></a></td>
																	 <td><?=$sd->total_school;?></td>
                                                                   <td><?=$sd->highersection;?></td>
                                                                     <td><?=$sd->highergroup;?></td>
                                                                </tr>
                                                                <?php  }  ?>
