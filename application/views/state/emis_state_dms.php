                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Directorate Of School Education-Student Details
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url()?>State/emis_state_DMS" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
...
$total1 = [];
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <tbody>
                                                               ...
                                                               <?php if(!empty($classcount)){$total1=[];
 $prekg_tot= [];$lkg_tot= [];$ukg_tot= [];$c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1;
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo base_url().'State/get_dms_district/?dist='.$det->district_id?>"><?=$det->district_name;?></a></td>
