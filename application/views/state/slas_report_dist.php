                               ...
                               $j=0; $sum=0; $assigned_sum=0; $not_marked=0;//print_r($value); die();
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="<?php echo base_url().'State/slas_report_blk/?dist_id='.$key->district_id?>"><?php echo($key->district_name); ?></a></td>
                                       <td style="text-align: center;"><?php echo number_format($key->total) ?> </td>
