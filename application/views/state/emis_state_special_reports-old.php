												...
												<div class="portlet box" >
													...
													<div class="portlet-body" >
														<div class="form-group">
															...
															<label class="control-label bold">Mangement</label>
															
                                                    
															<div class="">
															<input type="radio" id="emis_state_report_schcate1" name="emis_state_report_schcate" value="Government">Government</input><br/>
															<input type="radio" id="emis_state_report_schcate2" name="emis_state_report_schcate" value="Fully Aided">Aided</input><br/>
															<input type="radio" id="emis_state_report_schcate3" name="emis_state_report_schcate" value="Un-aided">Unaided</input><br/>
															<input type="radio" id="emis_state_report_schcate4" name="emis_state_report_schcate" value="Central Govt">Central</input>
															</div>
														</div>
															
															<div class="form-group">
															<label class="control-label bold" id="category">School Type</label>
															<div class="" >
															<input type="radio" id="emis_state_report_schmgtype1" name="emis_state_report_schmgtype" value="Primary School" >Primary</input><br/>
															
															<input type="radio" id="emis_state_report_schmgtype2" name="emis_state_report_schmgtype" value="Middle School" >Middle</input><br/>
															
															<input type="radio" id="emis_state_report_schmgtype3" name="emis_state_report_schmgtype" value="High School" >High</input><br/>
															
															<input type="radio" id="emis_state_report_schmgtype4" name="emis_state_report_schmgtype" value="Higher Secondary School" >Higher Secondary</input>
															</div>
															<div id="msg"></div>
															<!--<font style="color:#dd4b39;"><div id="msg"></div></font>-->
															</div>
															<div class="form-group" >
															<label class="control-label bold">Student Total count</label>
                                                    
																<div class="">
																<input type="number" class="form-control" id="emis_state_special_search" name="emis_state_special_search"  placeholder="Type the number" min="1" maxlength="4"  onKeyDown="if(this.value.length==4 && event.keyCode!=8) return false;"/>
																<!--<font style="color:#dd4b39;"><div id="emis_state_report_schmanage_alert"></div></font>-->
															</div>
															
															</div>
															<div class="form-group">
																<button type="button" class="btn green btn-lg" onclick="return searchfilter();" >Submit</button><!---->
															</div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <?php if(!empty($special_schools)){ $total1 = 0; $count = 0; foreach($special_schools as $det){ 
                                                                ...
                                                                <td><a onclick="saveschoolid('<?php echo $det->school_id; ?> ')">        <?php echo $det->udise_code; ?></a></td>
