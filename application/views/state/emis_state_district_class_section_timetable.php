                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Timetable Report<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
															...
															{ $total1 = 0; foreach($dist_school_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo base_url().'state/schoolwise_class_section_timetable_created?districtid='.$sd->district_id?>"><?=$sd->district_name;?></a></td>
