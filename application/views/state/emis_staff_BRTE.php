                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>BRTE Details<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
																    ...
																    <th style="text-align: center">BRTE Count</th>
                                                                </tr>
                                                                </thead>
                                                               <tbody>
														   ...
														   $cnt =0;
															...
															{ $total1 = 0; foreach($staff_district_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
																	 <a href="<?php echo base_url().'state/emis_staff_BRTE_list?districtid='.$sd->district_id?>">
																	<?=$sd->district_name;?></a> </td>
																	  <td style="text-align: center"><?=$sd->cnt;?>
																	   <?php $cnt=$cnt+$sd->cnt;?>
																  </td>
