  ...
  <?php $this->load->view('state/header.php'); ?>
       ...
       $over_total = $over_total + $total;
             ...
             <h4 style="font-size: 30px;">  <?php echo number_format($over_total); ?></h4>
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>DSE-Staff Trasfer Request (District-Wise)</div>
                              ...
                              <td><a href="<?php echo base_url().'State/emis_staff_transfer_dse_req_teacher/?district_id='.$staff_tnfr->district_id?>">
