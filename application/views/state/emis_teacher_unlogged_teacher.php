                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title col-md-12">
                                                        <div class="caption col-md-6">
                                                            <i class="fa fa-globe"></i><?php echo $sname;?> &nbsp;&nbsp;&nbsp;Teachers Not-Logged in TNTP</div>
                              ...
                              <?php if(!empty($unlogged_teachers)){  $i=1; 
                                foreach($unlogged_teachers as $ut){ 
								
								if($ut->status=='neverloggedin')
								{     
                              ?>
                              <tr>
							  
                              <td style="text-align: center;"><?php echo $i++;?></td>
							  <td style="text-align: center;"><?php echo $ut->teacher_name?></td>
							  <td style="text-align: center;"><?php echo $ut->teacher_type?></td>
