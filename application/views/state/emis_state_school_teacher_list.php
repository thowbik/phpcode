                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Teacher Name</th>
                                                                    <th>Total Peroids</th>
                                                                    <th >Assign Periods</th>
                                                                </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php if(!empty($schoolwise_teacher_list)){ $total1 = 0; foreach($schoolwise_teacher_list as $index=> $sd){   ?>

                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td><a href="<?php echo base_url().'state/emis_teacherassign_classwise?teacherid='.$sd->teacher_code?>"><?php echo $sd->teacher_name; ?></a></td>
                                                                    <td>28</td>
                                                                    <td><?php echo $sd->assignperiods;?></td>
