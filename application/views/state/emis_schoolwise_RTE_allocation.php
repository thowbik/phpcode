                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Right To Education - Seat Alloction Status
                              ...
                              <!--      <div class="portlet light portlet-fit ">
                                        ...
                                        <!-- BEGIN CARDS -->
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>RTE-Seat Allocation Status| School-wise</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                       ...
                                                       <?php $c1_tot=0;$c2_tot=0;$c3_tot=0;$c4_tot=0;$c5_tot=0;$c6_tot=0;$c7_tot=0;$c8_tot=0;$c9_tot=0;$c10_tot=0;$c11_tot=0;$c12_tot=0; ?>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            $total_school_tot=[];$Completed_school_tot=[];$RTE_tot=[];$section_nos=[];
                                                             ...
                                                             array_push($section_nos,$det->section_nos);
                                                         ...
                                                         <?php } ?>
                                                            ...
                                                            $section_nos = array_sum($section_nos);
                                                                array_push($total1,$section_nos);
                                                                echo number_format($section_nos);?></th>
