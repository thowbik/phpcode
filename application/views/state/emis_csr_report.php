                              ...
                              // "<?php echo base_url().'district/emis_staff_school_count_details?schoolid='.$sd->school_id
                               ...
                               if(!empty($csr)){ $total1 = 0; foreach($csr as $index=> $sd){ ?>
                                          ...
                                          <td width="90"><span><?php echo date('d-m-Y',strtotime($sd->time)); ?></span></td>
                                                                   <td><?php echo 'Block - '.$sd->block_name;?><?php echo '<br>';?><?php echo '<br>';?><?php echo $sd->district_name;?></td>

                                                                  
                                                                  
                                                                    <td><?php echo $sd->school_name;?></td>
                                                                     <td><?php echo $sd->udise_code;?></td>
                                                                      <td><?php echo $sd->cate_type.','?><?php echo '<br>';?><?php echo $sd->contribute;?></td>
                                                                      
                                                                        <td><?php echo $sd->material_name;?></td>
                                                                 <td><?php echo $sd->qty;?></td>
                                                                          <td><?php echo $sd->amount;?></td>
