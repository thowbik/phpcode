                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Staff Strike Reports  </div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover " id="sample_3">
                                                            <thead>
                                                               ...
                                                               <tbody>
                                                            <?php if(!empty($teacher_strick))
                                                            {  foreach($teacher_strick as $index=>  $det){   
                                                                    
                                                                ?>  

                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td> <a href="<?php echo base_url().'State/get_edu_district_strick_report?dist='.$det->district_name?>">
                                                                    <?php echo $det->district_name; ?></a></td>
                                                                    <td class="center"><?=number_format($det->total_teacher);?></td>
                                                                   <td class="center"><?=number_format($det->teacher_participate);?></td>
                                                                   <td class="center"><?=number_format($det->teacher_not_participate);?></td>
                                                                   <td class="center"><?php $not_entered = ($det->total_teacher-($det->teacher_participate+$det->teacher_not_participate)); echo number_format($not_entered);?></td>
