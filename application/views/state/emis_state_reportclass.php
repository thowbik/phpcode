  ...
  <?php $this->load->view('state/header.php'); ?>
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Smart Card Report - Student Class wise
                                                        ...
                                                        <div class="portlet light ">
                                                            <div class="portlet-title">
                                                                <div class="caption">
                                                                    ...
                                                                    <span class="caption-subject bold uppercase font-green-haze">Smart card Completion Report</span>
        ...
        <script type="text/javascript">
               function savedistrictid(value){
                ...
                if(resp==true){  
                window.location.href = baseurl+'State/emis_student_report_district'; 
                return true;  
                 }else{
                    return false;
                 }
