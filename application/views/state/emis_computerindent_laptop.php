                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title col-md-12">
                                                        <div class="caption col-md-4">
                                                            <i class="fa fa-globe"></i>Laptop Distribution District:<?php echo $lab_dis[0]->district_name; ?></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>UDISE Code</th>           
                                                                    <th>Block Name</th>
                                                                    <th>Education District<br/>Name</th>
                                                                    <th>School Name</th>
                                                                    <th>11th Enrollment</th>
                                                                    <th>11th Distribution</th>
                                                            ...
                                                            <!-- <?php print_r($lab_dis); ?> -->
                                                               <?php if(!empty($lab_dis)) { 
                                                                ...
                                                                $enrollment_11= []; $i=1; 
                                                                $enrollment_12=[];$Class11_dist=[]; $Class12_dist=[]; $Class12_19_20=[];
                                                                foreach($lab_dis as $det){ 
                                                                     
                                                                ?>
                                                                <tr>
                                                                    <td style="text-align: center;"><?php echo $i++;?></td>
                                                                    <td  style="text-align: center;"><?=$det->udise_code;?></a></td>
                                                                    <td><?=$det->block_name;?></a></td>
                                                                    <td><?=$det->edu_dist_name;?></a></td>
                                                                    <td><a href="<?php echo base_url().'State/get_schoolwise_laptop_distlist/?school='.$det->school_id?>"><?=$det->school_name;?></a></td>
                                                                    <td style="text-align: center;"><?=$det->Class11_Enr;?></a></td>
                                                                    <td style="text-align: center;"><?=$det->Class11_dist;?></a></td>
                                                                    <td style="text-align: center;"><?=$det->Class12_Enr;?></a></td>
                                                                    <td style="text-align: center;"><?=$det->Class12_dist;?></a></td>
