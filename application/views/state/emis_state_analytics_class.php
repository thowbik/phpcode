  ...
  <?php $this->load->view('state/header.php'); ?>
                                        ...
                                        <div class="portlet light ">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject bold uppercase font-green-haze"> Class wise enrollment report</span>
                                    ...
                                    <div class="portlet-body">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Student Class wise - All District - Show reults by - All</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
        ...
        <script type="text/javascript">
               function savedistrictid(value){
                ...
                if(resp==true){  
                window.location.href = baseurl+'State/emis_student_classwise_district'; 
                return true;  
                 }else{
                    return false;
                 }
