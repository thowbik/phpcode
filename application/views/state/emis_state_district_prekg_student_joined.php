                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title col-md-12">
                                                        <div class="caption col-md-4">
                                                            <i class="fa fa-globe"></i> Students Class wise - All District</div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <tbody>
                                                               <?php if(!empty($stud_admission_count)){ 
                                                                    $i=1;
                                                                    $prekg_tot= [];
                                                                    $lkg_tot =[];
                                                                    $ukg_tot =[];
                                                                    ...
                                                                    $c12_tot =[];
                                                                    $over_total =[];
                                                                foreach($stud_admission_count as $det){ 
                                                                    
                                                                ?>
                                                                <tr>
                                                                    <td style="text-align: center;"><?php echo $i;?></td>
                                                                    <td>
																	 <a href="<?php echo base_url().'state/emis_dist_school_prekg_student_joined?id='.$det->district_id?>">
																	<?=$det->district_name;?></a></td>
                                                                    ...
                                                                    <td style="text-align: center; font-weight: bold;"><?php echo number_format($det->prekg+$det->lkg+$det->ukg+$det->c1+$det->c2+$det->c3+$det->c4+$det->c5+$det->c6+$det->c7+$det->c8+$det->c9+$det->c10+$det->c11+$det->c12); ?></td>
                                                                </tr>
                                                                <?php $i++;?>
                                                   ...
                                                   <?php } ?>
                                                         ...
                                                         <th style="text-align: center;"> <?php 
                                                          ...
                                                          echo number_format($prekg_tot+ $lkg_tot+$ukg_tot+$c1_tot+$c2_tot+$c3_tot+$c4_tot+$c5_tot+$c6_tot+$c7_tot+$c8_tot+$c9_tot+$c10_tot+$c11_tot+$c12_tot); ?></th> 
