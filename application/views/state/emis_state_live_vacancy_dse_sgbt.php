                        ...
                        <div class="page-content-wrapper">
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>
                                            ...
                                            <a href="<?php echo base_url().'State/live_vacancy_dse_pgreport'?>">
                                              <span class="text">Live Vacancy Teachers DSE-PG</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'State/live_vacancy_dse_sgbtreport'?>">
                                              <span class="text">Live Vacancy Teachers DSE-SG & BT</span><br/>
                                            </a>
                                          </li>
                                          <!-- <li role="presentation">
                                            <a href="<?php echo base_url().'State/emis_state_school_dse'?>">
                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title col-md-12">
                                                        <div class="caption col-md-4">
                                                            <i class="fa fa-globe"></i>DSE Live Vacancy Others</div>
                            ...
                            <th style="text-align: center;">SG</th>
                              ...
                              <?php if(!empty($live_vacancy_dsereportsgbt)){  $i=1;  $vac_sg=[]; $sciense=[]; $maths=[];
                               ...
                               <td><a href="<?php echo base_url().'state/live_vacancy_district_dse_sgbtreport?districtid='.$vacancydse->district_id?>"><?=$vacancydse->district_name;?></a></td>
