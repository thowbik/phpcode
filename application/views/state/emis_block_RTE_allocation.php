                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Right To Education - Student Report
                                                    ...
                                                    <div class="portlet-body">
                                                       ...
                                                       <?php $c1_tot=0;$c2_tot=0;$c3_tot=0;$c4_tot=0;$c5_tot=0;$c6_tot=0;$c7_tot=0;$c8_tot=0;$c9_tot=0;$c10_tot=0;$c11_tot=0;$c12_tot=0; ?>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <?php $i=1; $total1 = []; if(!empty($allstuds)){  foreach($allstuds as $det){ 
                                                              
                                                             ?>

                                                                <tr>
                                                                    <td><?php echo $i;?></td>
                                                                    <td><a href="<?php echo base_url().'State/get_RTE_school_allocation/?block='.$det->block_name?>"><?=$det->block_name;?></a></td>
                                                                   <!---->
