...
else if($this->session->userdata('emis_user_type_id') == 9){
  $this->load->view('Ceo_District/header.php');
}else if($this->session->userdata('emis_user_type_id') == 3){
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                       <h1><!--Past Class 12 Student Status-->CO-SCHOLASTIC ACHIEVEMENT OF CHILDREN 
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>1st-8th  CO-SCHOLASTIC ACHIEVEMENT OF CHILDRENS- Monitoring Report</div>
                              ...
                              <?php if(!empty($student_migration_details)){ $Gov_tot= [];$FA_tot= [];$UA_tot= [];$PA_tot= []; $sum1= []; $assigned_sum1=[]; $not_marked1=[]; $i=1;foreach($student_migration_details as $key){ $j=0; $sum=0; $assigned_sum=0; $not_marked=0;//print_r($value); die();
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="<?php echo base_url().'State/student_co_scholastic_1_8_schl/?block_id='.$key->blk?>"><?php echo($key->blk); ?></td>
