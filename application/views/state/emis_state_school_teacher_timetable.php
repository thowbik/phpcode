                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Teacher Time Table <span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>School Name</th>
                                                                    <th>HM</th>
                                                                    <th class="sum center">PG-Teacher</th>
                                                                    <th class="sum ">BT-Teacher</th>
                                                                    <th class="sum center">SG-Teacher</th>
                                                                    <th class="sum center">Others</th>
																	 <th class="sum center">Total</th>
																	 
                                                                </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php if(!empty($schoolwise_teacher_details)){ $total1 = 0; foreach($schoolwise_teacher_details as $index=> $sd){   ?>

                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td><a href="<?php echo base_url().'state/emis_teacherlist_schoolwise_timetable?schoolid='.$sd->school_id?>"><?php echo $sd->school_name; ?></a></td>
                                                                    <td><?php echo $sd->HM; ?></td>
                                                                    <td class="center"><?=$sd->PGteacher;?></td>
                                                                   <td class="center"><?=$sd->BTteacher?></td>
                                                                   <td class="center"><?=$sd->SGteacher?></td>
																   <td class="center"><?=$sd->Others?></td>
                                                                   <td class="center"><?=$sd->Govteacher?></td>
                                                                </tr>
                                                                <?php  }  ?>
