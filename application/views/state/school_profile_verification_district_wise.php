                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                           <!--  <?php echo '<pre>';print_r($school_profile_verification );echo '<pre>';?> -->
                                            <form action="<?php echo base_url()?>State/school_profile_verification_district_wise" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-8" >
                                                              ...
                                                              <div class="form-group" style="padding: 10px;padding-left: 8%">
                                                                <label class="control-label bold">
                                                                   <?php echo $this->input->get('magt_type');?>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            $tot=[];  foreach($school_profile_verification as $det){ 
                                                             ...
                                                             ?>
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $i;?></td>
                                                                    <td ><a href="<?php echo base_url().'State/school_profile_verification_district/?dist_id='.$det->district_id?>"><?=$det->district_name;?></a></td>
                                                                   <!---->
