...
<link href="<?php echo base_url().'asset/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css';?>" rel="stylesheet" type="text/css" />
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>DSE-Promotion Report</div>
                                                        
                                                    </div>
													<form action="<?=base_url().'State/promotion_dsereport' ?>" method="post">
													               			  <div class="col-md-3"> 
  ...
  <select  class="form-control"  id="desig" name="desig" required="" onchange="getIndex(this.value)">
                        ...
                        <button type="submit" ID="addClick"  class="btn btn-primary">Submit</button>
                          ...
                          <th style="text-align: center;">S.No</th>
                              ...
                              <tbody id="student_detail">
														   ...
														   if(!empty($dsepromotion)){ $total1 = 0; foreach($dsepromotion as $sd){   
           ...
           $('#sample_2').DataTable().clear().destroy();
			   ...
			   // {
				   // var a =s;
				    // $.ajax({
// data:{'a':a},
// url:baseurl+'State/promotion_dsereport',
// type:"POST",
// dataType:"JSON",
...
// {
        ...
        // // var dob = (date.getDate() < 10 ? '0'+date.getDate():date.getDate())+'-'+(dob_month < 10 ? '0'+dob_month:dob_month)+'-'+date.getFullYear();
						...
						// students_tbl +='<td>'+val.district_name+'</td>';
