                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url()?>State/emis_non_teaching_staffs" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
...
$total1 = [];
                            ...
                            <td><a href="<?php echo base_url().'State/emis_nonteaching_blockwise_district/?dist_id='.$teaching->dist_id?>">
