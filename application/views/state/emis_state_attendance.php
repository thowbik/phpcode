                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                        ...
                                        <div class="row">
                                                    <div class="col-md-4">
        <!-- <a href="#"><button  class="btn green btn-lg" >Weekly</button></a> -->
        <!-- <a href="<?php echo base_url().'state/get_monthly_attendance_details'?>"><button  class="btn green btn-lg" >Monthly</button></a> -->

                                                    </div>
                                           <form action="<?=base_url().'State/get_attendance_details'?>" method="post">
...
<div class="col-md-3">
                                                            ...
                                                            <thead>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if(!empty($school_type)){
                                                                        ...
                                                                        ?>
                                                                        <td><?=$index+1;?></td>
                                                                        <td style="text-align:left"><?=$type->school_type;?></td>
                                                                        <td><?=number_format($type->total_school);?></td>
                                                                        <td><?=number_format($type->Fully_Marked);?></td>
                                                                        <td><?=number_format($type->Partially_Marked);?></td>
                                                                        <td><?php 
                                                                            $not_marked = $type->total_school-
                                                                            ($type->Fully_Marked + $type->Partially_Marked);
                                                                            echo number_format($not_marked);?>
                                                                        </td>
                                                                        <td>
                                                                        <?php 
 ...
 $total_school= [];$over_total_fully_marked = [];$over_total_part_marked = [];
                                                               if(!empty($school_details_districtwise)){ 

                                                               
                                                                foreach($school_details_districtwise as $index=> $det){ 
                                                                ...
                                                                <tr>
                                                                    <td><?=$index+1;?></td>
                                                                    <td style="text-align: left;"><a href="<?=base_url().'State/get_attendance_blockwise_details?dist='.$det->district_name.'&date='.$date?>"><?=$det->district_name?></a>

                                                                    </td>
                                                                    <td><?=number_format($det->total_school);?>
                                                                    </td>
                                                                    <td><a href="<?=base_url().'State/get_attendance_search?dist='.$det->district_name.'&col_name=1&date='.$date?>"><?=number_format($det->Fully_Marked_school);?></a></td>
                                                                    <td><a href="<?=base_url().'State/get_attendance_search?dist='.$det->district_name.'&col_name=2&date='.$date?>"><?=number_format($det->Partially_Marked_school);?></a></td>
                                                                    <td><a href="<?=base_url().'State/get_attendance_search?dist='.$det->district_name.'&col_name=3&date='.$date?>"><?=number_format($det->total_school - ($det->Fully_Marked_school+$det->Partially_Marked_school));?></a>
                                                                        </td>
                                                                    <td >
                                                                        <?php 
                                ...
                                <!-----Table 1st Start------>
                                    <table class="table table-striped table-bordered table-hover district" id="sample_3">
                                        ...
                                        <thead>
                                                                ...
                                                                <tbody>
                                                                    <?php if(!empty($teacher_school_type)){
                                                                        $total_schools =0;
                                                                        $total_marked_schools =0;
                                                                        $total_not_marked_school=0;
                                                                        
                                                                        foreach ($teacher_school_type as $key => $det) {
                                 ...
                                 <!-----Table 1st Start------>
                                    <table class="table table-striped table-bordered table-hover district" id="sample_4" >
                                       ...
                                       <thead>
                                                                ...
                                                                <tbody>
                                                                    <?php if(!empty($teacher_districtwise)){
                                                                        $total_schools =0;
                                                                        $total_marked_schools =0;
                                                                        
                                                                        foreach ($teacher_districtwise as $key => $det) {
                                                                            $total_schools  +=$det->total_school;
                                                                            $total_marked_schools +=$det->marked_school;
                                                                        ...
                                                                        <tr>
                                                                            <td class="center"><?=$key+1;?></td>
                                                                            <td><a href="<?=base_url().'state/get_attendance_blockwise_details?dist='.$det->district_name.'&date='.$date?>"><?=$det->district_name;?></a></td>
                                                                            
                                                                            <td class="center"><?=number_format($det->total_school);?></td>
                                                                            <td class="center">
                                                                                <a href="<?=base_url().'State/get_attendance_teacher_search?dist='.$det->district_name.'&col_name=1&date='.$date?>"><?=number_format($det->marked_school);?></a>
                                                                            </td>
                                                                            
                                                                            <td class="center">
                                                                                <a href="<?=base_url().'State/get_attendance_teacher_search?dist='.$det->district_name.'&col_name=2&date='.$date?>"><?php $not_marked = ($det->total_school-$det->marked_school); echo number_format($not_marked);?></a>
                                                                            </td>
                                                                            <td class="center">
                                                                                <?php 
      ...
      <?=(100-$marked_school).'%'?>
                                                                ...
                                                                <tfoot>
                                                                    <tr>
                                                                        ...
                                                                        <th class="center">
                                                                            <?php
                                                                             $not_marked_teacher = $total_schools - $total_marked_schools;
                                                                             echo $not_marked_teacher;
                                                                            ?>
                                                                        </th>
