                              ...
                              <!--      <div class="portlet light portlet-fit ">
                                        ...
                                        <!-- BEGIN CARDS -->
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>RTE-Student Report-2019 | Block-wise</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                            ...
                                                            <?php $total1 = []; if(!empty($allstuds)){ $pre_kg_tot= [];$ukg_tot= [];$lkg_tot= []; $c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1;$total1 = []; foreach($allstuds as $det){ 
                                                             ...
                                                             ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo base_url().'State/get_RTE_school_2019/?block_name='.$det->block_name?>"><?=$det->block_name;?></a></td>
                                                         ...
                                                         <?php } ?>
                                                           ...
                                                           echo number_format($c1_tot);?></th>
                                                            ...
                                                            echo number_format($c8_tot);?></th>
                                                                                    <th style="text-align: center;"> <?php echo $tot_all=  $pre_kg_tot+$lkg_tot+$ukg_tot+$c1_tot+$c2_tot+$c3_tot+$c4_tot+$c5_tot+$c6_tot+$c7_tot+$c8_tot;?> </th>
