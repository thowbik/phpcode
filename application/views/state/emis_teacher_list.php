                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'State/emis_teacher_details'?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Teaching Staff Details By Grade-District wise </div>
                                                    ...
                                                    <div class="portlet-body">
															...
															<tbody>
                                                            <?php $total1=[];?>
															<?php if(!empty($teacherdistrictdetails)){  $Govteacher_tot= [];$BTteacher_tot= [];$SGteacher_tot= [];$HM_tot=[];$PGteacher_tot= [];$others_tot=[];$i=1;foreach($teacherdistrictdetails as $det){ 
                                                               
															/*$total = $det->Govteacher + $det->BTteacher + $det->SGteacher + $det->PGteacher;*/ ?>
															<tr>
                                                            <td style="text-align: center;"><?php echo $i;?></td>
                                           <td><a href="<?php echo base_url().'State/emis_teacher_classwise_district/?dist_id='.$det->dist_id?>">
