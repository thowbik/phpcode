                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url()?>State/emis_enrollment_2018" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
...
$total1 = [];
          ...
          <?php if(!empty($classcount)){ $over_total = 0;
            foreach($classcount as $det){ 
                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title col-md-12">
                                                        <div class="caption col-md-4">
                                                            ...
                                                            <div class="col-md-5" style="margin-top: -1%;"><h3>Admissions In 2018-19</h3></div>
 ...
 $prekg_tot= [];$lkg_tot= [];$ukg_tot= [];$c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1;
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo base_url().'State/get_classwise_district_2018/?dist='.$det->district_name?>"><?=$det->district_name;?></a></td>
                                                                    <td style="text-align: center;"><?=number_format($det->Prkg);?></td>
                                                           ...
                                                           echo number_format($c1_tot);?></th>
                                                            ...
                                                            <th style="text-align: center;"><?php 
                                                             ...
                                                             $c12_tot = array_sum($c12_tot);
                                                                ...
                                                                ?></th>
                                                             <th style="text-align: center;"> <?php echo number_format($over_total); ?>
