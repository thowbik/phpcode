                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'State/school_land_verification_district_wise'?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            $tot=[];  foreach($school_land_verification as $det){ 
                                                             ...
                                                             ?>
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $i;?></td>
                                                                    <td ><a href="<?php echo base_url().'State/school_land_verification_district/?dist_id='.$det->district_id?>"><?=$det->district_name;?></a></td>
                                                                   <!---->
