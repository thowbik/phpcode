...
"> 
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                       <th >S.No</th>
                                                                        <th>District Name</th>
                                                                       <th class="sum" style="text-align: center;">Total School</th>
                                                            ...
                                                            $total_school_tot=[];$Completed_school_tot=[];$RTE_tot=[];$section_nos=[];
                                                             ...
                                                             ?>
                                                                ...
                                                                <tr>
                                                                     ...
                                                                     <td ><a href="<?=base_url().$link.'/get_staff_fix_schoolwise_dse?dist='.$det->district_id;?>"><?=$det->district_name;?></td>
                                                                     <td style="text-align: center;"><?=$det->tot_school;?></td>
      ...
      $over_total1 = $over_total1 + $total1;
                                                             ...
                                                             <th style="text-align: center;"><?php echo $sub=$over_total-$over_total1;?></th>
