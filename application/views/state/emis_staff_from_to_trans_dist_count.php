            ...
            <div class="page-wrapper-row full-height">
                <div class="page-wrapper-middle">
                    ...
                    <div class="page-container">
						...
						<form action="<?=base_url().'State/emis_staff_from_to_trans_dist_count'?>" method="post">
             ...
             <h4 style="font-size: 30px;"> </h4>
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Transfer Details (District-Wise) From 15-07-2019 To <?php echo date("d-m-Y");?></div>
                              ...
                              <td><a href="<?php echo base_url().'State/emis_staff_from_to_trans_block_count/?district_id='.$staff_tnfr->FROM_scl_dist.'&fdate='.$fdate.'&tdate='.$tdate?>">
                              <?php echo $staff_tnfr->FROM_scl_dist; ?></a></td>
