                        ...
                        <div class="page-content-wrapper">
                         ...
                         <h5 style="color:red;"><strong>Distributed :</strong>Number of students for whom laptop has been distributed</h5>
                            ...
                            <div class="page-content">
                              ...
                              <tbody>
                              <?php $total1=[]; ?>
                              <?php if(!empty($student_migration_details)){ $Gov_tot= [];$FA_tot= [];$UA_tot= [];$PA_tot= []; $CG_tot= []; $sum1=[]; $assigned_sum1=[]; $not_marked1=[]; $i=1;foreach($student_migration_details as $key ){ $j=0; $sum=0;  $tot=0;?>
                                  <tr>
