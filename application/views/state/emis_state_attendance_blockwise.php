...
<div class="col-md-offset-2 col-md-1" style="margin-top: 15px;"><!-- 
        <a href="<?=base_url().'State/get_attendance_details'?>"><button type="sumbit" class="btn green btn-lg" ><i class="fa fa-angle-left 
"></i></button></a> -->
...
<button onclick="goBack()" class="btn green"><i class="fa fa-arrow-left" aria-hidden="true"></i></button>
                                                            ...
                                                            <thead>
                                                                ...
                                                                <tbody class="center">
                                                                    ...
                                                                    if(!empty($school_type)){
                                                                        ...
                                                                        <td><a href="<?=base_url().'state/get_attendance_search?cate='.$type->school_type.'&col_name=1&date='.$date.'&dist='.$dist?>"><?=number_format($type->Fully_Marked);?></a></td>
                                                                        <td><a href="<?=base_url().'state/get_attendance_search?cate='.$type->school_type.'&col_name=2&date='.$date.'&dist='.$dist?>"><?=number_format($type->Partially_Marked);?></a></td>
                                                                        <td><a href="<?=base_url().'state/get_attendance_search?cate='.$type->school_type.'&col_name=3&date='.$date.'&dist='.$dist?>"><?php 
 ...
 $total_school= [];$over_total_fully_marked = [];$over_total_part_marked = [];
                                                               if(!empty($school_details_blockwise)){ 
                                                                ...
                                                                <tr>
                                                                    <td><?=$index+1;?></td>
                                                                    <td style="text-align: left;"><a href="<?=base_url().'State/get_attendance_schoolwise_details?block='.$det->block_name.'&date='.$date?>"><?=$det->block_name?></a>

                                                                    </td>
                                                                    <td><?=number_format($det->total_school);?>
                                                                    </td>
                                                                    <td><a href="<?=base_url().'State/get_attendance_search?block='.$det->block_name.'&col_name=1&date='.$date?>"><?=number_format($det->Fully_Marked_school);?></a></td>
                                                                    <td><a href="<?=base_url().'State/get_attendance_search?block='.$det->block_name.'&col_name=2&date='.$date?>"><?=number_format($det->Partially_Marked_school);?></a></td>
                                                                    <td><a href="<?=base_url().'State/get_attendance_search?block='.$det->block_name.'&col_name=3&date='.$date?>"><?=number_format($det->total_school - ($det->Fully_Marked_school+$det->Partially_Marked_school));?></a>
                                                                        </td>
                                                                    <td>
                                                                        <?php 
                                                        ...
                                                        ?>
                                                            ...
                                                            <tfoot>
                                                               <tr>
                                                                    ...
                                                                    <td class="center"><b><?=number_format($over_total_fully_marked);?></b></td>
                                                                    <td class="center"><b><?=number_format($over_total_part_marked);?></b></td>
                                                                    <td class="center"><b><?=number_format($over_total_not_marked);?></b></td>
                                                                    <td>
                        ...
                        <div class="panel panel-default panel-faq">
                            ...
                            <div id="faq-cat-2-sub-1" class="panel-collapse collapse in" aria-expanded="true" style="">
                                <div class="panel-body">
                                    <br/>
                                <!-----Table 1st Start------>
                                    <table class="table table-striped table-bordered table-hover district" id="">
                                       ...
                                       <thead>
                                                                ...
                                                                <tbody>
                                                                    <?php if(!empty($teacher_blockwise)){
                                                                        ...
                                                                        <tr>
                                                                            <td class="center"><?=$key+1;?></td>
                                                                            <td><a href="<?=base_url().'state/get_attendance_teacher_schoolwise?block='.$det->block_name.'&date='.$date?>"><?=$det->block_name;?></a></td>
                                                                            <td class="center"><?=number_format($det->total_school);?></td>
                                                                            <td class="center">
                                                                                <a href="<?=base_url().'State/get_attendance_teacher_search?block='.$det->block_name.'&col_name=1&date='.$date?>"><?=number_format($det->marked_school);?></a>
                                                                            </td>
                                                                            
                                                                            <td class="center">
                                                                                <a href="<?=base_url().'State/get_attendance_teacher_search?block='.$det->block_name.'&col_name=2&date='.$date?>"><?php $not_marked = ($det->total_school-$det->marked_school); echo number_format($not_marked);?></a>
                                                                            </td>
                                                                            <td class="center">
                                                                                <?php 
