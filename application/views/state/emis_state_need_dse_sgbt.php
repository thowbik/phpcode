                        ...
                        <div class="page-content-wrapper">
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>
                                            ...
                                            <a href="<?php echo base_url().'State/need_dse_pgreport'?>">
                                              <span class="text">Need Teachers DSE-PG</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'State/need_dse_sgbtreport'?>">
                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title col-md-12">
                                                        <div class="caption col-md-4">
                                                            <i class="fa fa-globe"></i>DSE Need Others</div>
                            ...
                            <th style="text-align: center;">SG</th>
                              ...
                              <?php if(!empty($need_dsereportsgbt)){  $i=1;  $need_sg=[]; $sciense=[]; $maths=[];
                               ...
                               <td><a href="<?php echo base_url().'state/need_district_dse_sgbtreport?districtid='.$needdse->district_id?>"><?=$needdse->district_name;?></a></td>
