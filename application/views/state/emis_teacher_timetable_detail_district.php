  ...
  <strong><button class="tablinks" title="your Class <?php echo $classsection;  ?>" value="<?php echo $classsection; ?>"><?php echo $classsection;  ?> </button></strong>
   <?php         
                                 ...
                                 ?>
                                                ...
                                                <center>
                                                  <form id="filter" method="post" action="<?php echo base_url().'State/emis_teacher_timetable_detail_district';?>">
    ...
    width: auto !important;
                          ...
                          <div class="col-md-12">
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <tbody>
                                                             <?php                                                           
                                                              $i=1; $tech_cnt= []; $Periods= []; $total1=[];
                                                               foreach($teacher_details as $ds)
                                  {
                                    ?>
                                                               <tr>
                                                                     <td><?php echo $i++; ?></td>
                                                                     <td style="text-align: left;"><a href="<?php echo base_url().'State/emis_teacher_timetable_details?dist_id='.$ds->dist_id?>"><?php echo $ds->district_name; ?></a></td>
                                 
                                                                     <td><?php echo $ds->tech_cnt; ?></td>
                                 
                                                                     <td ><?php echo $ds->Periods; ?></td>
                                 ...
                                 <tfoot>
                                                            ...
                                                            $tech_cnt = array_sum($tech_cnt);
                                                            array_push($total1,$tech_cnt);
                                                            echo number_format($tech_cnt);?></th>
                                                            <th style="text-align: center;"><?php 
                                                                $Periods = array_sum($Periods);
                                                                array_push($total1,$Periods);
                                                            echo number_format($Periods);?></th>
                                                          </tr>
                                                        </tfoot>
                                                        </table>
                                                        </div>
