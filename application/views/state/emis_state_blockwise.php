                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                               ...
                                                               <tbody>
                                                            <?php if(!empty($details)){ $total1 = 0; foreach($details as $det){ $total = $det->PREKG + $det->LKG + $det->UKG + $det->class_1 + $det->class_2 + $det->class_3 + $det->class_4 + $det->class_5 + $det->class_6 + $det->class_7 + $det->class_8 + $det->class_9 + $det->class_10 + $det->class_11 + $det->class_12;  ?>

                                                                <tr>

                                                                    <td> <a href="<?php echo base_url().'State/get_state_schoolwise?blk='.$blkname=$det->block_name?>">
        ...
        <script src="<?php echo base_url().'asset/js/state.js';?>" type="text/javascript"></script>
           ...
           <script type="text/javascript">
               function saveblockid(value){
                ...
                if(resp==true){  
                window.location.href = baseurl+'State/emis_student_classwise_block'; 
                return true;  
                 }else{
                    return false;
                 }
