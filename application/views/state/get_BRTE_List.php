...
<center>
  ...
  <?php $this->load->view('state/header.php'); ?>
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
														...
														?>
                                                            <i class="fa fa-globe"></i>BRTE-List | District-wise<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="sum center">Total BRTE</th>
                                                                    <th class="sum center">Assigned BRTE</th>
																	                                  <th class="sum center">Not Assigned BRTE</th>
                                                            ...
                                                            <?php if(!empty($school_timetable_details)){ $total1 = 0; foreach($school_timetable_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td><a href="<?php echo base_url().'state/BRTE_List_teacher?dist_id='.$sd->district_id?>"><?php echo $sd->district_name ?></a></td>
                                                                  
                                                                   <td class="center"><?=number_format($sd->total_brte)?></td>
                                                                   <td class="center"><?=number_format($sd->assigned_brte)?></td>
																   <td class="center"><?=number_format($unmarked=$sd->total_brte-$sd->assigned_brte)?></td>
                                                                   <td class="center">
                                                                                <?php 

                                                                                    $marked_school = round(($sd->assigned_brte/$sd->total_brte)*100);
   ...
   <div class="row">
                                                            ...
                                                            <div class="color-box-green" style="background-color:#5cb85c;" data-hex="#CD5C5C" data-rgb="205, 92, 92" data-hsl="0, 53%, 58%"></div>BRTE Assigned
                                                        </div>
                                                        
                                                        <div class="col-md-2">
                                                            <div class="color-box-green" style="background-color:#ed6b75;" data-hex="#CD5C5C" data-rgb="205, 92, 92" data-hsl="0, 53%, 58%"></div> BRTE Not Marked
                                                        </div>
