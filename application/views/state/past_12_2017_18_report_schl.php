                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                              ...
                              <tbody>
                              <?php $total1=[]; ?>
                              <?php if(!empty($student_migration_details)){ $Gov_tot= [];$FA_tot= [];$UA_tot= [];$PA_tot= []; $CG_tot= []; $tot=[]; $sum1=[]; $assigned_sum1=[]; $not_marked1=[]; $i=1;foreach($student_migration_details as $key ){ $j=0; $sum=0; $tot=0;  ?>
                                  <tr>
                                      ...
                                      <td style="text-align: center;"><?php echo $tot=$key->not_marked;?></td>
                                 </tr>  
                                    <?php  
