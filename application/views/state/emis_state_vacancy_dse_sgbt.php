                        ...
                        <div class="page-content-wrapper">
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>
                                            ...
                                            <a href="<?php echo base_url().'State/vacancy_dse_pgreport'?>">
                                              <span class="text">Vacancy Teachers DSE-PG</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'State/vacancy_dse_sgbtreport'?>">
                                              <span class="text">Vacancy Teachers DSE-SG & BT</span><br/>
                                            </a>
                                          </li>
                                          <!-- <li role="presentation">
                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title col-md-12">
                                                        <div class="caption col-md-4">
                                                            <i class="fa fa-globe"></i>DSE Vacancy Others</div>
                            ...
                            <th style="text-align: center;">SG</th>
                              ...
                              <?php if(!empty($vacancy_dsereportsgbt)){  $i=1;  $vac_sg=[]; $sciense=[]; $maths=[];
                               ...
                               <td><a href="<?php echo base_url().'state/vacancy_district_dse_sgbtreport?districtid='.$vacancydse->district_id?>"><?=$vacancydse->district_name;?></a></td>
