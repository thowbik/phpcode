  ...
  <?php $this->load->view('state/header.php'); ?>
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Student Class wise  - Report for all district
                                              ...
                                              <?php  } ?>
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Student Class wise - All District - Class <?php echo $this->Datamodel->getclass_studying_id($class_id); ?></div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <?php if(!empty($alldist)){ foreach($alldist as $det){ ?>

                                                                <tr>
                                                                <td>
                                                                <a onclick="savedistrictid('<?php echo $det->id; ?>')">
                                                                <?php echo $det->district_name; ?></a></td>
                                                                <td><?php $tot = null ;
                                                                if($manage!=""){ 
                                                                $tot = $this->Statemodel->getallstudistcoutnbyclass1("c".$class_id,$det->id,$manage); 
                                                                 }else{ 
                                                                $tot = $this->Statemodel->getallstudistcoutnbyclass("c".$class_id,$det->id);  }
        ...
        <script type="text/javascript">
               function savedistrictid(value){
                ...
                $.ajax({
                type: "POST",
                url:baseurl+'State/savedashdistrictidsession',
                data:"&dist_id="+value,
                success: function(resp){ 
                if(resp==true){  
                window.location.href = baseurl+'State/emis_dash_block_stucount'; 
                return true;  
                 }else{
                    return false;
                 }
