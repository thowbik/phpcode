                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                               ...
                                                               <tbody>
                                                            <?php if(!empty($teacher_details)){ $total1 = 0; foreach($teacher_details as $index=> $sd){   ?>

                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td><a href="<?php echo base_url().'state/emis_teacher_schoolwise_timetable_details?districtid='.$sd->dist_id?>"><?php echo $sd->district_name; ?></a></td>
