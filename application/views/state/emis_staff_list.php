                        ...
                        <div class="page-content-wrapper">
                          ...
                          <div class="portlet-body">
                                     ...
                                     <div class="row">
                                        ...
                                        <form action="<?=base_url().'State/staff_list'?>" method="post">
												...
												<!--	<div class="col-md-3 ">
															...
															<br>
                                                           <input class="form-control" type="text" value ="" id="teach" name="teach">
                                                    </div> -->
													<div class="col-md-3 ">
													...
													<div  class="col-md-4"><p><font color="red">SEARCH BY ANY ONE</font></p></div>
