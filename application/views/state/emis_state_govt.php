                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url()?>State/emis_dash_govt" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
...
$total1 = [];
 ...
 $prekg_tot= [];$lkg_tot= [];$ukg_tot= [];$c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1;
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo base_url().'State/get_classwise_district/?dist='.$det->district_name?>"><?=$det->district_name;?></a></td>
