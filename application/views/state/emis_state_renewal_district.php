                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Private School Verification District-wise  </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover " id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>District</th>
                                                                    <th class="sum center">Total Private Schools</th>
                                                                    <th class="sum center">Verified Schools</th>
                                                            ...
                                                            {  foreach($school_renewal_status as $index=>  $det){   
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> <a href="<?php echo base_url().'State/get_renewal_state_block?dist='.$det->district_name?>">
                                                                    <?php echo $det->district_name; ?></a></td>
                                                                    <td class="center"><?=number_format($det->mange);?></td>
