...
function comp(nameid) {
  ...
  $('.cards').addClass('hidden');
	  ...
	  $("#stat1").html('<a href="<?php echo base_url().'State/emis_teacher_surplus_sg_dee'; ?>"> <h4>SG Teachers</h4> <span><?php echo $teachertype_total[0]-> SG;?></span></a>');
	  $("#stat2").html('<a href="<?php echo base_url().'State/emis_teacher_surplus_bt_dee'; ?>"> <h4>BT Teachers</h4> <span><?php echo $teachertype_total[0]->BT;?></span></a>');
	  $("#stat3").html('<a href="<?php echo base_url().'State/emis_teacher_surplus_pg_dee'; ?>"> <h4>PG Teachers</h4> <span><?php echo $teachertype_total[0]->PG;?></span></a>');
	  $("#stat4").html('<a href="<?php echo base_url().'State/emis_teacher_surplus_phm_dee'; ?>"> <h4>Primary HM</h4> <span><?php echo $teachertype_total[0]->Primary_HM;?></span></a>');
	   $("#stat5").html('<a href="<?php echo base_url().'State/emis_teacher_surplus_mhm_dee'; ?>"> <h4>Middle School HM</h4> <span><?php echo $teachertype_total[0]->Middle_HM;?></span></a>');
