                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Higher Secondary Groups<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="sum ">School Name</th>
																	 <th class="sum ">With Aadhar Count</th>
																	 <th class="sum ">WithOut Aadhar Count</th>
                                                            ...
                                                            <?php
                                                             $aadharnotincount=0;															
															if(!empty($dist_block_aadhar_details)){ $total1 = 0; foreach($dist_block_aadhar_details as $index=> $sd){   ?>

                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td><?php echo $sd->district_name; ?></td>
                                                                    <td><?php echo $sd->block_name; ?></td>
                                                                    <td class="center"><?=$sd->edu_dist_name;?></td>
																	 <td class="center"><?=$sd->udise_code;?></td>
																	 <td class="center"><?=$sd->
																	 school_type;?></td>
                                                                   <td> <a href="<?php echo base_url().'state/school_higher_class_section?schoolid='.$sd->school_id?>&schoolname=<?php echo $sd->school_name ?>"><?=$sd->school_name;?></a></td>
																   <td class="center"><?=$sd->aadharin?></td>
                                                                   <td class="center"><?=$aadharnotin=$sd->totalstudent-$sd->aadharin;?>
														<?php $aadharnotincount=$aadharnotincount+$aadharnotin;?></td>
