                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>NoonMeal Students Details(Grade1 to 10)<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   $studtot =0;
															...
															if(!empty($noonmeal_count_details))
															{ $total1 = 0; foreach($noonmeal_count_details as $index=> $sd){   ?>
                                                              
                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td>
																	 <a href="<?php echo base_url().'state/meal_school_distic_based_count_details?districtid='.$sd->district_id?>">
																	<?=$sd->district_name;?></a> </td>
																	  <td><?=$sd->total;?>
																	   <?php $studtot=$studtot+$sd->total;?>
																  </td>
                                                                   <td><?=$sd->meals;?>
