                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'State/schoolwise_class_timetable_report_blk?dist_id='.$school_timetable_details[0]->district_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            ...
                                                            <?php if(!empty($school_timetable_details)){ $total1 = 0; foreach($school_timetable_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td><a href="<?php echo base_url().'State/schoolwise_class_timetable_report?block_name='.$sd->block_name?>"><?php echo $sd->block_name ?></a></td>
