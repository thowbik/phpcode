...
<link href="<?php echo base_url().'asset/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css';?>" rel="stylesheet" type="text/css" />
  ...
  <?php $this->load->view('state/header.php'); ?>
         ...
         $total = $staff_tnfr->BT_tam + $staff_tnfr->BT_eng + $staff_tnfr->BT_mat + $staff_tnfr->BT_sci + $staff_tnfr->BT_soc + $staff_tnfr->SG + $staff_tnfr->PG + $staff_tnfr->HM_mid + $staff_tnfr->HM_pri +$staff_tnfr->Oth;
             ...
             <h4 style="font-size: 30px;">  <?php echo number_format($over_total); ?></h4>
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>DEE-Staff Trasfer Request (District-Wise)</div>
                              ...
                              <tbody>
                              <?php $total1=[];?>
                              <?php if(!empty($staff_transfer_req)){ $total1=[]; $BT_tam= [];$BT_eng= [];$BT_mat= [];$BT_sci= []; $BT_soc= []; $SG= [];  $PG= []; $oth=[]; $i=1; $HM_mid=[]; $HM_pri=[];foreach($staff_transfer_req as $staff_tnfr){ 
                                                              
                                ?>
                              <tr>
                              <td style="text-align: center;"><?php echo $i;?></td>
                              <td><a href="<?php echo base_url().'State/emis_staff_transfer_req_block/?district_id='.$staff_tnfr->district_id?>">
                              <?php echo $staff_tnfr->district_name; ?></a></td>
