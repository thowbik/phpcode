                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th>Total School *</th>
																	 ...
																	 <th>Total Aided Section</th>
																	 <th>Total UnAided Section</th>
																	 <th>Not Marked Sections</th>
																	  <th>Not Marked Medium</th>
                                                                </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php 
															if(!empty($dist_school_details))
															{ $total1 = 0; foreach($dist_school_details as $index=> $sd){   ?>
                                                              
                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td><a href="<?php echo base_url().'state/schoolwise_class_section?districtid='.$sd->district_id?>"><?=$sd->district_name;?></a></td>
																	 <td><?=$sd->total_school;?></td>
                                                                  
                                                                   <td><?=$sd->aided;?></td>
																   <td><?=$sd->self_financed;?></td>
																   <td><?=$sd->unmarked;?></td>
                                                                  <td><?=$sd->unmediummarked;?></td>
