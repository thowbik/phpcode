                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Aadhar Enrollment Details<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>District Name</th>
																	 ...
																	 <th class="center">Students With<br/> Valid Aadhar </th>
                                                                     <th  class="center">Students With <br/>Invalid Aadhar / WithOut Aadhar </th>
															...
															$aadharincount =0;
															$aadharnotincount =0;
															if(!empty($dist_aadhar_details))
															{ $total1 = 0; foreach($dist_aadhar_details as $index=> $sd){   ?>
                                                              
                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td>
																	 <a href="<?php echo base_url().'state/aadhar_school_distic_based_count_details?districtid='.$sd->district_id?>">
																	<?=$sd->district_name;?></a> </td>
																	
                                                                   <td  class="center"><?=$sd->aadharin;?>
																   <?php $aadharincount=$aadharincount+$sd->aadharin;?></td>
                                                        <td class="center"><?=$aadharnotin=$sd->totalstudent-$sd->aadharin;?>
														<?php $aadharnotincount=$aadharnotincount+$aadharnotin;?>
														</td>
                                                                </tr>
                                                                <?php  }  ?>
                                                            ...
                                                            <tfoot>
                                                                ...
                                                                <th class="center">Total</th>
																 <th class="center"></th>
                                                                <th  class="center"><?php echo $aadharincount?></th>
                                                                <th  class="center"><?php echo $aadharnotincount?></th>
                                                       ...
                                                       <!-- <p><b>*  includes all categories of fully aided, partially aided ,Higher Secondary schools in the district</b></p> -->
                                                        </div>
                                                    </div>
                                                </div>
