...
<div class="page-wrapper-middle">
                                        ...
                                        <div class="portlet light portlet-fit ">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-dark sbold uppercase">Teacher Monthly Utilization | District -  <?php echo $teacher_details[0]->district_name;?> </span>
                                                </div>
                                            </div> 
  ...
  <strong><button class="tablinks" title="your Class <?php echo $classsection;  ?>" value="<?php echo $classsection; ?>"><?php echo $classsection;  ?> </button></strong>
   <?php				 
                                                ...
                                                <center>
                                                  <?php $dist_id=$this->input->get('dist_id');?>
                                                  <form id="filter" method="post" action="<?php echo base_url().'State/emis_teacher_timetable_details?dist_id='.$dist_id;?>">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                             ...
                                                             <?php                                                           
                                                              $i=1;     $teacher_count= []; $total1=[];
                                                               ...
                                                               <tr>
                                                                    ...
                                                                    <td><?php echo $i++; ?></td>
																                                	 <td style="text-align: left;"><?php echo $ds->block_name; ?></td>
																                                  	<td  style="text-align: left;"><?php echo $ds->school_name; ?></td>
                                                                    <td  style="text-align: left;"><?php echo $ds->teacher_name; ?></td>
																                                  	<td  style="text-align: left;"><?php echo $ds->subjects; ?></td>
                                                                    <td ><?php echo $ds->teacher_count; ?></td>
																	
                                                               </tr>
                                                                 <?php 

                                                            //array_push($tech_cnt,$ds->tech_cnt);
                                                            array_push($teacher_count,$ds->teacher_count);
                                                             }
                                                         ...
                                                         ?>
                                                            ...
                                                            <th style="text-align: center;"><?php 
                                                                $teacher_count = array_sum($teacher_count);
                                                                array_push($total1,$teacher_count);
                                                            echo number_format($teacher_count);?></th>
                                                          </tr>
                                                        </tfoot>
                                                        </table>
                                                        </div>
