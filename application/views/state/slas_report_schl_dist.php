                                        ...
                                        <div class="row margin-bottom-20">
                                             <div class="portlet-body">
                                                <div class="row" style="margin-left: 6px;">
                                                    ...
                                                    <!--  <form  action="<?=base_url().'State/slas_report_dist'?>" method="POST" >
                                                        <div class="row">
                                                        <div class="col-md-4">
                               ...
                               $j=0; $sum=0; $assigned_sum=0; $not_marked=0;//print_r($value); die();
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="<?php echo base_url().'State/slas_report_schl_blk/?dist_id='.$key->district_id.'&catty_id='.$key->catty_id.'&manage_id='.$key->manage_id?>"> <?php echo($key->district_name); ?></a></td>
