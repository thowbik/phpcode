                                    ...
                                    <div class="page-title">
                                        <h1>RTE-Student Report
                                          ...
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                            ...
                                            <a href="<?php echo base_url().'State/emis_student_RTE_list'?>">
                                              <span class="text">RTE Student Report</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'State/emis_student_RTE_list_2019'?>">
                              ...
                              <!--      <div class="portlet light portlet-fit ">
                                        ...
                                        <!-- BEGIN CARDS -->
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>RTE-Student Report-2019 | District-wise</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                       ...
                                                       <?php $c1_tot=0;$c2_tot=0;$c3_tot=0;$c4_tot=0;$c5_tot=0;$c6_tot=0;$c7_tot=0;$c8_tot=0;$c9_tot=0;$c10_tot=0;$c11_tot=0;$c12_tot=0; ?>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <?php $total1 = []; if(!empty($allstuds)){  $pre_kg_tot= [];$ukg_tot= [];$lkg_tot= [];$c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1;$total1 = []; foreach($allstuds as $det){ 
                                                                $tot1=$det->pre_kg+$det->lkg+$det->ukg+$det->C1+$det->C2+$det->C3+$det->C4+$det->C5+$det->C6+$det->C7+$det->C8;
                                                             ?>

                                                                <tr>
                                                                    <td style="text-align: center;"><?php echo $i;?></td>
                                                                    <td><a href="<?php echo base_url().'State/get_RTE_school_2019/?dist='.$det->district_name?>"><?=$det->district_name;?></a></td>
                                                                   <!---->
                                                         ...
                                                         <?php } ?>
                                                           ...
                                                           echo number_format($c1_tot);?></th>
                                                            ...
                                                            echo number_format($c8_tot);?></th>
                                                             ...
                                                             <th style="text-align: center;"> <?php echo number_format($tot_all= $pre_kg_tot+$lkg_tot+$ukg_tot+$c1_tot+$c2_tot+$c3_tot+$c4_tot+$c5_tot+$c6_tot+$c7_tot+$c8_tot);?> </th>
