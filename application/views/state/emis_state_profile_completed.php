                ...
                <div class="page-wrapper-middle">
                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <form id="filter" method="post" action="<?php echo base_url().'State/emis_school_profile_completed';?>">
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Profile Completion Status<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
															 ...
															 <th></th>
															  <th></th>
                                                               ...
                                                               <tbody>
															    <?php $total1=[];?>
                                                            <?php 
															if(!empty($state_profile_completion_status))
															{
															  $totalschool=[];	
															  $f1notsave= [];
															  $f1save= [];
														...
														foreach($state_profile_completion_status as $index=> $comp_status){   ?>
                                                              
                                                                <tr>
                                                                    <td ><?=$index+1;?></td>
                                                                    <td style="text-align: left;"><a href="<?=base_url().'State/profile_status_blockwise?dist='.$comp_status->district_id.'&school_type='.$school_type_c?>"><?=$comp_status->district_name?></a>
