                              ...
                              <!--      <div class="portlet light portlet-fit ">
                                        ...
                                        <!-- BEGIN CARDS -->
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>Un-Recognized School Report| District-wise</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                     <th >S.No</th>
                                                                    <th>District</th>           
                                                                    <th style="text-align: center;">Un-Recognized Schools</th>
                                                            ...
                                                            $tot=[];{  foreach($student_unrecognized_details as $det){ 
                                                             ...
                                                             ?>
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $i;?></td>
                                                                    <td><a href="<?php echo base_url().'State/emis_school_unrecognized_block/?dist='.$det->district_name?>"><?=$det->district_name;?></a></td>
                                                                   <!---->
