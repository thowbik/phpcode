                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title col-md-12">
                                                        <div class="caption col-md-4">
                                                            <i class="fa fa-globe"></i>DSE Vacancy -PG</div>
                            ...
                            <th style="text-align: center;">Tamil</th>
                              ...
                              <td><a href="<?php echo base_url().'state/vacancy_district_dse_pgreport?districtid='.$vacancydse->district_id?>"><?=$vacancydse->district_name;?></a></td>
                              <?php
