                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Student Class wise  - All block - <?php echo $this->Datamodel->get_district_name($dist_ids)[0]->district_name;?> 
                                              ...
                                              <?php  } ?>
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Student Overall count - Block wise - <?php echo $this->Datamodel->get_district_name($dist_ids)[0]->district_name;?> - Class <?php echo $this->Datamodel->getclass_studying_id($class_id); ?></div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <?php if(!empty($allblock)){ foreach($allblock as $all){ ?>

                                                                <tr>
                                                                <td><a onclick="saveblockid('<?php echo $all->id; ?> ')">
                                                                    <?php echo $all->block_name; ?></a></td>
                                                                    <td><?php $tot = null ;
                                                                if($manage!=""){  
                                                                 $tot = $this->Statemodel->getallstublockcoutnbyclass1("c".$class_id,$all->id,$manage);
                                                                  }else{
                                                                    $tot = $this->Statemodel->getallstublockcoutnbyclass("c".$class_id,$all->id);
                                                                }

                                                                     if($tot!=null){ echo $tot; }else{ echo "0
                                                                        "; }?></td>
