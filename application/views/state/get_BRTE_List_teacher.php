                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
														...
														?>
                                                            <i class="fa fa-globe"></i>BRTE-List | District:<?php echo $school_timetable_details[0]->district_name; ?> <span> </span></div>
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Block Name</th>
                                                                     ...
                                                                     <th class=" center">School / Block</th>
                                                            ...
                                                            <?php if(!empty($school_timetable_details)){ $total1 = 0; foreach($school_timetable_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   <td class="center"><?=$index+1;?></td>
                                                                    ...
                                                                    <td><a href="<?php echo base_url().'state/BRTE_assigned_school?dist='.$sd->brte_id?>"><?php echo $sd->teacher_name ?></a></td>
                                                                     <td><?php echo $sd->appointed_subject?></td>
                                                                    
                                                                     <td><?=($sd->school_name)?></td>
                                                                    <td class="center"><?=number_format($sd->teacher_count)?></td>
...
function sum_dataTable(dataId){
    var table = $(dataId).DataTable({
      dom: 'Blfrtip',
      order: [[0, "asc"]],
            lengthMenu: [[5, 10, 15, 20, 10], [5, 10, 15, 20, 'All']],
            pageLength: 10,
