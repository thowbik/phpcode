                                             ...
                                             <div class="portlet-body">
                                                <div class="row" style="margin-left: 6px;">
                                                      ...
                                                      <form method="POST" >
                                                       ...
                                                       List Teachers Working In the Same School For More Than<input type="text" name="teach_year" id="teach_year" placeholder="" value="<?php echo $teach_year; ?>" autocomplete="off" >Years
                                             ...
                                             <br>
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>DSE - Teachers Working In the Same School For More Than-<?php $tmp= $this->input->post('teach_year')==''?'5':$this->input->post('teach_year');echo $tmp;  ?> Years</div>
                                                    ...
                                                    <div class="portlet-body">
                                                            ...
                                                            <th style="text-align: center;">S.No</th>
														                              	<th>District</th>                        
                                                            <th style="text-align: center;">High School<br/>Teacher Total</th>
                                                            <th style="text-align: center;">Higher Secondary School <br/>Teacher Total</th>
															...
															<tbody>
                                                            <?php $total1=[];?>
															<?php if(!empty($teacher_tot)){  $SG= [];$BT= [];$i=1;
                             foreach ($teacher_tot as $key => $value) {
                               $tmp= $this->input->post('teach_year')==''?'5':$this->input->post('teach_year');
                              ?>
															<tr>
                                      <td style="text-align: center;"><?php echo $i;?></td>
                                      <td><a href="<?php echo base_url().'State/emis_teacher_gt_5years_school/?dist_id='.$key."&tmp=".$tmp;?>"><?php echo $key; ?></td></a>
                                     <td style="text-align: center;"> <?php  echo $value[0]['Teachers']; ?></td>
                                     <td style="text-align: center;"> <?php echo  $value[1]['Teachers']; ?></td>
                                ...
                                <?php
                                                            ...
                                                            array_push($SG,$value[0]['Teachers']);
                                                            array_push($BT,$value[1]['Teachers']);
