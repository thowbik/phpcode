                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Students  Teachers Ratio<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																    ...
																    <th>Students<br>(1to5) </th>
																	<th>Teachers<br>(SG)</th> 
																	<th>STR</th>
                                                                    <th>Students<br>(6to8)</th>
																    <th>Teachers<br>(BT)</th>
																	<th>STR</th>
																	<th>Students<br>(9to12)</th>
																    <th>Teachers<br>(PG)</th>
																	<th>STR</th>
																	                                                                                             </tr>
                                                                </thead>
                                                               <tbody>
														   ...
														   $bttot=0;
														   $pgtot=0;
														   if(!empty($staff_stud_dist_details)){ $total1 = 0; foreach($staff_stud_dist_details as $index=> $sd){   ?>
 
                                                               <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td><a href="<?php echo base_url().'state/emis_staff_stud_dist_school_details?district_id='.$sd->district_id?>"><?php echo $sd->district_name; ?></a></td>
																	
                                                                
																	<td class="center" ><?=
																    $sd->stud; ?>
																	 <?php $studtot=$studtot+$sd->stud;?>
																    </td >
																	  <td class="center" ><?=
																     $sd->SGT;?>
																	   <?php $sgttot=$sgttot+$sd->SGT;?>
																    </td>
																	 <td > 
																	 <?= ($sd->studsgt ==0)?'NA':number_format((float)$sd->studsgt, 2, '.', ''); ?></td>
																	  <td class="center" ><?=
																  $sd->student;
																	   ?>
                                                                <?php $studenttot=$studenttot+$sd->student;?>
																    </td >
																	
																	  <td class="center" ><?=
																  $sd->BT;
																	   ?>
																	   <?php $bttot=$bttot+$sd->BT;?>
																    </td >
																	<td>
																	 <?= ($sd->studBT ==0)?'NA':number_format((float)$sd->studBT, 2, '.', ''); ?></td>
																	  <td class="center" ><?=
																  $sd->students;
																	   ?>
																	     <?php $studentstot=$studentstot+$sd->students;?> 
																    </td >
																	     
																	  <td class="center" ><?=
																  $sd->PG;
																	   ?>
																	   <?php $pgtot=$pgtot+$sd->PG;?>
																    </td >
                                                                 
																	 <td>
																	 <?= ($sd->studPG ==0)?'NA':number_format((float)$sd->studPG, 2, '.', ''); ?></td>
                                                        ...
                                                        <tfoot>
                                                                ...
                                                                <th class="center"></th>
																 ...
																 <th ><?php echo $studtot?></th>
                                                                 <th ><?php echo $sgttot?></th>
																 <th class="center"></th>
																 <th ><?php echo $studenttot?></th>
                                                                 <th ><?php echo $bttot?></th>
																 <th class="center"></th>
																 <th ><?php echo $studentstot?></th>
                                                                 <th ><?php echo $pgtot?></th>
																 <th class="center"></th>
                                                            </tfoot> 
                                                            <?php } ?>
                                                        </table>
...
function openmodel(school)
{
    ...
    {
        type: "POST",
        url:baseurl+'State/get_school_class_section_details',
