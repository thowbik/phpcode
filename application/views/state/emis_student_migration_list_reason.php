                ...
                <div class="page-wrapper-middle">
                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Students in Common Pool-District wise (Transfer Reason)</div>
                            ...
                            <td><a href="<?php echo base_url().'State/get_block_migration_reason/?dist_id='.$student_mig->district_name?>">
