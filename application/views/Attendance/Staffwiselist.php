                               ...
                               <!-- BEGIN PAGE TITLE -->
                                <div class="page-title">
									<div class="portlet-body">
										<div class="row">
											<form action="<?php echo base_url().'Attendance/staffwise/'; ?>" method="post">
												<div class="col-md-5">
													<div>
												...
												<div class="col-md-2">
													...
													<button class="btn btn-primary" name="stafflist">Search</button>
												</div>
											</form>
										</div>
									</div>
															...
															<table class="table table-striped table-bordered table-hover" id="sample_2">
																...
																<tbody>
																	<?php $i=1; foreach($stafflist as $staff) {?>
																		...
																		<tr>
																			<td><?php echo $i; ?></td>
																			<td><a href="<?php echo base_url().'Attendance/staffdatewise/'.$staff['u_id'].'/'.$_SESSION['fromdate'].'/'.$_SESSION['todate']; ?>"><?php echo $staff['teacher_name']; ?></a></td>
