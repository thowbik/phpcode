                                    ...
                                    <?php $this->load->view('emis_school_profile_header.php'); ?>
                                        ...
                                        <!-- BEGIN CARDS -->
                                         ...
                                         <span style="font-size: 22px;">Student List Section wise </span>
                                          ...
                                          <span style="font-size: 22px;" class="pull-right">Level 2 - For Class <b>
                                          <?php if($class!=""){ echo $class; } if($classid == 13){ echo 'LKG'; } else if($classid == 14){ echo 'UKG'; } else if($classid == 15){ echo 'PreKG'; }  ?></b></span>
                                                 <hr>
                                                        ...
                                                        <?php $class_id=$this->uri->segment(3,0); 
                                                         ...
                                                         if ($class_id == 13 || $class_id ==14 || $class_id ==15)
                                                        {  ?>
                                                             <div class="col-md-4">
                                                            <a href="<?php echo base_url().'Home/emis_school_studentsectionwisedata/'.$class_id.'/A';?>" style="text-decoration: none;">
                                                            <h1>Section <?php echo 'All';?></h1></a>
                                                             <?php  $this->db->select('name'); 
                                                           $this->db->from('students_child_detail');
                                                           $this->db->where('class_section', 'A');
                                                        ...
                                                        if($allsections!=""){ $a=explode(',',$allsections); 
                                                        // echo $allsections;
                                                        ...
                                                        foreach($a as $v){?> 
                                                            ...
                                                            <div class="col-md-4">
                                                            <a href="<?php echo base_url().'Home/emis_school_studentsectionwisedata/'.$class_id.'/'.$v;?>" style="text-decoration: none;">
