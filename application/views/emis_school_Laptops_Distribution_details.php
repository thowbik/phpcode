                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
														<?php 
														foreach($Laptops_distribute_details as $sd)
														{
															
														}
														?>
                                                            <i class="fa fa-globe"></i>School Laptops Distribution Register For 11 Students<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
															...
															if(!empty($Laptops_distribute_details)){ $total1 = 0; foreach($Laptops_distribute_details as $index=> $sd){   ?>
