                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
														<?php 
														foreach($atlas_distribute_details as $sd)
														{
															
														}
														?>
                                                            <i class="fa fa-globe"></i>School Atlas Distribution Register<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
															...
															if(!empty($atlas_distribute_details)){ $total1 = 0; foreach($atlas_distribute_details as $index=> $sd){   ?>
