                                    ...
                                    <div class="page-title">
                                        <h1>
                                          ...
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                            ...
                                            <a href="<?php echo base_url().'Home/ptmgr_noon_meal_program'?>">
                                              <span class="text">Student Opted For Noon-Meal</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Home/ptmgr_noon_meal_program_not_opt'?>">
                                              <span class="text">Student Not Opted For Noon-Meal</span><br/>
                                            </a>
                                          </li>
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Student Not Opted For Noon-Meal<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
															...
															if(!empty($ptmgr_noon_meal_program)){ $total1 = 0; $i=1; foreach($ptmgr_noon_meal_program as $sd){   ?>
