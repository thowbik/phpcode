                        ...
                        <div class="panel panel-default panel-faq">
                            ...
                            <div id="faq-cat-1-sub-2" class="panel-collapse panel-collapse collapse in" aria-expanded="true" style>
							 ...
							 <th style="text-align: center;">Cat-I:Size 13</th>
							  ...
							  <?php if(!empty($uf->district_name)){?>
                              <td style="text-align: left;"> <a href="<?php echo base_url().'Home/emis_footwear_indent/?district_id='.$uf->scheme_id.$uf->district_id?>">
                              <?php echo $uf->district_name; ?></a></td>
							  <?php } else if(!empty($uf->block_name)) {?>
							  <td style="text-align:left;"><a href="<?php echo base_url().'Home/emis_footwear_indent/?block_id='.$uf->scheme_id.$uf->block_id?>">
