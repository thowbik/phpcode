                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="row">
                                       ...
                                       <form action="<?=base_url().'Home/emis_Sweater_indent'?>" method="post">
                                                
                                                    <div class=" col-md-3">
                                                					 <label class="control-label bold">Size</label>
																						  <select style="width: 90%;" class="form-control"   tabindex="1" id="size" name="size"   required="" >
                                                               	
                                                                <option value="0">Select Size</option>
                                                                <option value="67">Cat-A Small Size 26-30</option>
																<option value="68">Cat-B Small Size 32-38</option>
                ...
                <div class="tab-pane active in fade" id="faq-cat-1">
                    <div class="panel-group" id="accordion-cat-1">
                        <div class="panel panel-default panel-faq" >
							  ...
							  <?php 
														if(!empty($sweater_indent))
														{
														foreach($sweater_indent as $uf)
														{
                            ...
                            <div class="panel-heading active-faq">
                                <a data-toggle="collapse" data-parent="#accordion-cat-1" href="#" aria-expanded="true" class>
                                    <h4 class="panel-title">
                                        <i class="fa fa-globe"></i> Sweater Indent Summary 
                                 ...
                                 <div class="panel-body" style="overflow:auto">
                                  ...
                                  <thead>
								    <tr>
									   ...
									   <th style="text-align: center;"  colspan = '5' >Cat-A Small Size 26-30</th>
									    <th style="text-align: center;"  colspan = '3' >Cat-B Small Size 32-38</th>
							 ...
							 <?php if(!empty($uf->district_name)){?>
                              ...
                              <td style="text-align: center;"><?php echo $i;?></td>
							    ...
							    <?php if(!empty($uf->district_name)){?>
							            ...
							            <?php if(!empty($uf->scheme_category)){?>
										<td style="text-align: left;"> <a href="<?php echo base_url().'Home/emis_dseSweater_indent/?district_id='.$uf->scheme_id.$uf->district_id?>"><?php } else {?>
										<td style="text-align: left;"> <a href="<?php echo base_url().'Home/emis_dseSweater_indent/?district_id='.$uf->scheme_id.$uf->district_id?>"><?php }?>
							  ...
							  <?php } else if(!empty($uf->block_name)) {?>
							           <?php if(!empty($uf->scheme_category)){?>
							           <td style="text-align:left;"><a href="<?php echo base_url().'Home/emis_dseSweater_indent/?block_id='.$uf->scheme_id.$uf->block_id?>"><?php } else {?>
									   <td style="text-align:left;"><a href="<?php echo base_url().'Home/emis_dseSweater_indent/?block_id='.$uf->scheme_id.$uf->block_id?>"><?php }?>
							  ...
							  <td style="text-align: center;"><?php echo number_format($uf->c4); ?></td>
							  <td style="text-align: center;"><?php echo number_format($uf->c5); ?></td>
							  <td style="text-align: center;"><?php echo number_format($uf->c6); ?></td> 
							  <td style="text-align: center;"><?php echo number_format($uf->c7); ?></td>
							  <td style="text-align: center;"><?php echo number_format($uf->c8); ?></td>
