                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'District/schoolwise_class_timetable_report?dist_id='.$school_timetable_details[0]->district_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            ...
                                                            <?php if(!empty($school_timetable_details)){ $total1 = 0; foreach($school_timetable_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td> <a href="<?php echo base_url().'District/school_class_section_timetable?schoolid='.$sd->school_key_id?>&schoolname=<?php echo $sd->school_name ?>"><?=$sd->school_name;?></a></td>
