                        ...
                        <div class="page-content-wrapper">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Students in Common Pool-Block wise|District: <?php echo $this->input->post('emis_state_fix');?></div>
                            ...
                            <?php array_push($check,$t['school_type'] ); } ?>
                              ...
                              <?php if(!empty($student_migration_details)){ $Gov_tot= [];$FA_tot= [];$UA_tot= [];$PA_tot= []; $CG_tot= []; $i=1;foreach($student_migration_details as $key => $value){ $j=0; $sum=0;  ?>
                                  <tr>
                                      <td><?php echo($i++); ?></td>
                                      <td><a href="<?php echo base_url().'District/get_school_migration/?block_id='.$key?>"><?php echo($key); ?></a></td>
                                      <?php 
