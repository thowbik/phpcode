...
<div class="page-content">
        ...
        <?php echo number_format($total_count_details->student_total);?></h3>
                ...
                <!-- 1 Card End -->
                <a href="<?php echo base_url().'District/emis_teacher_classwise_district'; ?>">
                   <div class=" col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <!-- 2 Card End -->
                <a href="<?php echo base_url().'District/emis_state_school'; ?>">
                    <div class=" col-lg-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <?php echo number_format($total_count_details->school_total) ?></h3>
                 ...
                 <a href="<?php echo base_url().'district/emis_dist_school_prekg_student_joined'; ?>">
                    <div class=" col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="bs-callout-mediumaquamarine dashboard-stat2">
                            <div class="display">
                                <div class="number">
                ...
                <div class="panel-body">
                   <div class="row">
                                                    ...
                                                    <div class="col-md-3 space-2px">
                                                            ...
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'District/dash_renewal';?>"><?php echo ($renewal_details[0]['TOTAL']); ?></a></b></small>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'District/dash_renewal_beo/';?>"><?php echo ($renewal_details[0]['BEO']); ?></a></b></small>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'District/dash_renewal_deo/';?>"><?php echo ($renewal_details[0]['DE0']); ?></a></b></small>
                                                        </div>
                                                        <div class="col-md-9 space-2px">
                                                            <small>Pending CEO Approval</small>
                                                    </div>
                                                    <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'District/dash_renewal_ceo/';?>"><?php echo ($renewal_details[0]['CE0']); ?></a></b></small>
                                                     </div>
                                                     <div class="col-md-9 space-2px">
                                                     ...
                                                     <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'District/get_renewal_rejected/';?>"></small><?php echo ($renewal_details[0]['REJECTED']); ?></a></b></small>
                                                    </div>
