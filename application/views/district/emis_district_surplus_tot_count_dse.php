...
function comp(nameid) {
  ...
  $('.cards').addClass('hidden');
	  ...
	  $("#stat1").html('<a href="<?php echo base_url().'District/emis_teacher_surplus_sg'; ?>"> <h4>SG Teachers</h4> <span><?php echo $teachertype_total[0]-> SG;?></span></a>');
	  $("#stat2").html('<a href="<?php echo base_url().'District/emis_teacher_surplus_bt'; ?>"> <h4>BT Teachers</h4> <span><?php echo $teachertype_total[0]->BT;?></span></a>');
	  $("#stat3").html('<a href="<?php echo base_url().'District/emis_teacher_surplus_pg'; ?>"> <h4>PG Teachers</h4> <span><?php echo $teachertype_total[0]->PG;?></span></a>');
	  $("#stat4").html('<a href="<?php echo base_url().'District/emis_teacher_surplus_highhm'; ?>"> <h4>High School HM</h4> <span><?php echo $teachertype_total[0]-> high_hm;?></span></a>');
	   $("#stat5").html('<a href="<?php echo base_url().'District/emis_teacher_surplus_hrshm'; ?>"> <h4>Hrsc School HM</h4> <span><?php echo $teachertype_total[0]-> hrs_hm;?></span></a>');
