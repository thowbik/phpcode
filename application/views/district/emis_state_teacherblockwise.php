                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'District/emis_teacher_classwise_district/?dist_id='.$dist_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                           ...
                                                           <td><a href="<?php echo base_url().'District/emis_teacher_classwise_block/?block_id='.$det->block_id?>"><?php echo $det->block_name; ?></td></a>
