...
<link href="<?php echo base_url().'asset/global/plugins/simple-line-icons/simple-line-icons.min.css';?>" rel="stylesheet" type="text/css" />
  ...
  <?php if($this->session->userdata('emis_user_type_id') == 3) { $this->load->view('district/header.php'); } else if($this->session->userdata('emis_user_type_id') == 5) { $this->load->view('state/header.php');  } ?>
