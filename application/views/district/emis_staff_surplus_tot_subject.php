...
function comp(nameid) {
  ...
  $('.cards').addClass('hidden');
	  ...
	  $("#stat1").html('<a href="<?php echo base_url().'District/emis_sgstaff_surpwithpost'; ?>"> <h4>SecondaryGrade Teacher</h4> <span><?php echo $surplus_sub[0]-> sg;?></span></a>');
	  $("#stat2").html('<a href="<?php echo base_url().'District/emis_sciencestaff_surpwithpost'; ?>"> <h4>Science</h4> <span><?php echo $surplus_sub[0]-> sci;?></span></a>');
	  $("#stat3").html('<a href="<?php echo base_url().'District/emis_mathstaff_surpwithpost'; ?>"> <h4>Maths</h4> <span><?php echo $surplus_sub[0]-> mat;?></span></a>');
	  $("#stat4").html('<a href="<?php echo base_url().'District/emis_englishstaff_surpwithpost'; ?>"> <h4>English</h4> <span><?php echo $surplus_sub[0]-> eng;?></span></a>');
	  $("#stat5").html('<a href="<?php echo base_url().'District/emis_tamilstaff_surpwithpost'; ?>"> <h4>Tamil</h4> <span><?php echo $surplus_sub[0]-> tam;?></span></a>');
	  $("#stat6").html('<a href="<?php echo base_url().'District/emis_socialsciencestaff_surpwithpost'; ?>"> <h4>SocialScience</h4> <span><?php echo $surplus_sub[0]-> soc;?></span></a>');
	 

	  
	  $("#stat7").html('<a href="<?php echo base_url().'District/emis_primaryhmstaff_surpwithpost'; ?>"> <h4>Primary HM</h4> <span><?php echo $surplus_sub[0]->phm ;?></span></a>');
	  $("#stat8").html('<a href="<?php echo base_url().'District/emis_middlehmstaff_surpwithpost'; ?>"> <h4>Middle HM</h4> <span><?php echo $surplus_sub[0]->mhm ;?></span></a>');
	  $("#stat9").html('<a href="<?php echo base_url().'District/emis_highhmstaff_surpwithpost'; ?>"> <h4>High HM</h4> <span><?php echo $surplus_sub[0]->hhm ;?></span></a>');
	  $("#stat10").html('<a href="<?php echo base_url().'District/emis_telgustaff_surpwithpost'; ?>"> <h4>Telugu</h4> <span><?php echo $surplus_sub[0]->telu ;?></span></a>');
	  $("#stat11").html('<a href="<?php echo base_url().'District/emis_kannadastaff_surpwithpost'; ?>"> <h4>Kannada</h4> <span><?php echo $surplus_sub[0]->kann ;?></span></a>');
	  $("#stat12").html('<a href="<?php echo base_url().'District/emis_urdustaff_surpwithpost'; ?>"> <h4>Urdu</h4> <span><?php echo $surplus_sub[0]->urdu ;?></span></a>');
	  $("#stat13").html('<a href="<?php echo base_url().'District/emis_malayalamstaff_surpwithpost'; ?>"> <h4>Malayalam</h4> <span><?php echo $surplus_sub[0]->mala ;?></span></a>');
