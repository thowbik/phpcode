                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                           <form action="<?php echo base_url().'district/get_attendance_blockwise_details'?>" method="post">
                                                <div class="row">
...
<div class="col-md-3">
                                                            ...
                                                            <thead>
                                                                ...
                                                                <tbody class="center">
                                                                    ...
                                                                    if(!empty($school_type)){
                                                                        ...
                                                                        <td><a href="<?=base_url().'district/get_attendance_search?cate='.$type->school_type.'&col_name=1&date='.$date?>"><?=number_format($type->Fully_Marked);?></a></td>
                                                                        <td><a href="<?=base_url().'district/get_attendance_search?cate='.$type->school_type.'&col_name=2&date='.$date?>"><?=number_format($type->Partially_Marked);?></a></td>
                                                                        <td><a href="<?=base_url().'district/get_attendance_search?cate='.$type->school_type.'&col_name=3&date='.$date?>"><?php 
 ...
 $total_school= [];$over_total_fully_marked = [];$over_total_part_marked = [];
                                                               if(!empty($school_details_blockwise)){ 
                                                                ...
                                                                <tr>
                                                                    <td><?=$index+1;?></td>
                                                                    <td style="text-align: left;"><a href="<?=base_url().'district/get_attendance_schoolwise_details?block='.$det->block_name.'&date='.$date?>"><?=$det->block_name?></a>

                                                                    </td>
                                                                    <td><?=number_format($det->total_school);?>
                                                                    </td>
                                                                    <td><a href="<?=base_url().'district/get_attendance_search?block='.$det->block_name.'&col_name=1&date='.$date?>"><?=number_format($det->Fully_Marked_school);?></a></td>
                                                                    <td><a href="<?=base_url().'district/get_attendance_search?block='.$det->block_name.'&col_name=2&date='.$date?>"><?=number_format($det->Partially_Marked_school);?></a></td>
                                                                    <td><a href="<?=base_url().'district/get_attendance_search?block='.$det->block_name.'&col_name=3&date='.$date?>"><?=number_format($det->total_school - ($det->Fully_Marked_school+$det->Partially_Marked_school));?></a>
                                                                        </td>
                                                                    <td>
                                                                        <?php 
                                                        ...
                                                        ?>
                                                            ...
                                                            <tfoot>
                                                               <tr>
                                                                    ...
                                                                    <td class="center"><a href="<?=base_url().'district/get_attendance_search?&col_name=1&date='.$date?>"><b><?=number_format($over_total_fully_marked);?></b></a></td>
                                                                    <td class="center"><a href="<?=base_url().'district/get_attendance_search?&col_name=2&date='.$date?>"><b><?=number_format($over_total_part_marked);?></b></a></td>
                                                                    <td class="center"><a href="<?=base_url().'district/get_attendance_search?&col_name=3&date='.$date?>"><b><?=number_format($over_total_not_marked);?></b></a></td>
                                       ...
                                       <thead>
                                                                ...
                                                                <tbody>
                                                                    <?php if(!empty($teacher_blockwise)){
                                                                        ...
                                                                        <tr>
                                                                            <td class="center"><?=$key+1;?></td>
                                                                            <td><a method="post"href="<?=base_url().'district/get_attendance_teacher_schoolwise?block='.$det->block_name.'&date='.$date?>"><?=$det->block_name;?></a></td>
                                                                            <td class="center"><?=number_format($det->total_school);?></td>
                                                                            <td class="center">
                                                                                <a href="<?=base_url().'district/get_attendance_teacher_search?block='.$det->block_name.'&col_name=1&date='.$date?>"><?=number_format($det->marked_school);?></a>
                                                                            </td>
                                                                            
                                                                            <td class="center">
                                                                                <a href="<?=base_url().'district/get_attendance_teacher_search?block='.$det->block_name.'&col_name=2&date='.$date?>"><?php $not_marked = ($det->total_school-$det->marked_school); echo number_format($not_marked);?></a>
                                                                            </td>
                                                                            <td class="center">
                                                                                <?php 
      ...
      <?=(100-$marked_school).'%'?>
                                                                ...
                                                                <tfoot>
                                                                    <tr>
                                                                        <th colspan="2" class="center">Total</th>
                                                                        <th class="center"></th>
                                                                        <th class="center"><a href="<?php echo base_url().'district/get_attendance_teacher_search?col_name=1&date='.$date?>"><?=number_format($total_marked_schools);?></a></th>
                                                                        <th class="center">
                                                                            <a href="<?php echo base_url().'district/get_attendance_teacher_search?col_name=2&date='.$date?>"><?php $total_not_marked = $total_schools - $total_marked_schools;
