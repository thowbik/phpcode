...
<link href="<?php echo base_url().'asset/global/plugins/simple-line-icons/simple-line-icons.min.css';?>" rel="stylesheet" type="text/css" />
    ...
    ?>
  <?php if($usertype== 3) { $this->load->view('district/header.php'); } else if($usertype== 5) { $this->load->view('state/header.php');  } ?>
   ...
   <script type="text/javascript">
       ...
       function get_tech_cat(myschl_id){
            ...
            $.post('<?php echo base_url(); ?>District/tech_cat_only/'+myschl_id, function(data) {
              if(data!='')
              {
                // alert(data);
                 $('#type_tech').html(data);
       ...
       function get_tchr(schl_id){
        ...
        if(schl_id == "")
        {
            ...
            $.post('<?php echo base_url(); ?>District/get_tchr/'+schl_id, function(data) {
              if(data!='')
              {
                // alert(data);
                 $('#gettchr').html(data);
            ...
            if(resp==true){
              swal({
                ...
                if (isConfirm) {
                  ...
                  window.open(baseurl+'District/emis_teacher_transfer_form/'+tech_id, '_blank');
                } else {
