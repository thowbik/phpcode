                              ...
                              <?php if(!empty($child_studying_status)){  $staff1= []; $yes1=[]; $no1=[]; $na1=[]; $remain1=[];$per1=[]; $i=1;foreach($child_studying_status as $key => $value){ $j=0; $staff=0; $yes=0; $no=0; $na=0; $remain=0; $per=0;//print_r($value); die();
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <!--<td><a href="<?php echo base_url().'District/dge_2017_18_report_blk/?district_id='.$key?>"><?php echo($key); ?></a></td>-->
                    <td ><a href="<?php echo base_url().'District/teacher_child_studyingstatus_block/?block_id='.$key?>"><?php echo $key;?></td>
