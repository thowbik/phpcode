                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'District/emis_district_student_report_2018?dist='.$dist_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                            ...
                                                            <?php if(!empty($details)){$prekg_tot= [];$lkg_tot= [];$ukg_tot= [];$c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1; foreach($details as $det){   ?>
                                                                ...
                                                                <tr>
                                                                  <td style="text-align: center;"><?php echo $i;?></td>
                                                                    <td> <a href="<?php echo base_url().'District/get_dash_blockwise_school_2018?dist='.$dist_id.'&block='.$det->block_name?>">
