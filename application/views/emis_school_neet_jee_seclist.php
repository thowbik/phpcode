                                    ...
                                    <?php $this->load->view('emis_school_profile_header.php'); ?>
                                        ...
                                        <!-- BEGIN CARDS -->
                                         ...
                                         <span style="font-size: 22px;">Student List Section wise </span>
                                          ...
                                          <?php if($class!=""){ echo $class; } if($classid == 13){ echo 'LKG'; } else if($classid == 14){ echo 'UKG'; }  ?></b></span>
                                                 <hr>
                                                        ...
                                                        foreach($a as $v){?> 
                                                            ...
                                                            <div class="col-md-4">
                                                            <a href="<?php echo base_url().'Home/emis_neet_jee_studentlist/'.$class_id.'/'.$v;?>" style="text-decoration: none;">
