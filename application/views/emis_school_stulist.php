                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <?php $this->load->view('emis_school_profile_header.php'); ?>
                                       ...
                                       <!---<?php $classes=array();
                                        ...
                                        <!-- BEGIN CARDS -->
                                        <span style="font-size: 18px;">Level 1 - Overall School Strength - <b><?php echo $overallstrength; ?></b></span>
                                        
                                       <!--  <span style="font-size: 18px;" class="pull-right">Enrollment Abstract Filled by Schools : <b><?php   if( isset($enrolltotal)) { echo $enrolltotal; } else { echo 0; } ?> </b></span> -->
...
<!-- 
                                            ...
                                            <a href="<?php echo base_url().'Home/emis_school_studentsectionwise/'.$j; ?>" style="text-decoration: none;"> 
                                                ...
                                                <?php  if(!empty($classlist)){ foreach ($classlist as $key){ ?>
                                                    ...
                                                    <div class="m-grid-col m-grid-col-middle m-grid-col-center">
                                            <a href="<?php echo base_url().'Home/emis_school_studentsectionwise/'.$key; ?>" style="text-decoration: none;"> 
                                              <?php 
                                                $classname =  $this->Homemodel->getstandaradnamesepe($key); ?>
                                                        <h2><?php echo $classname; ?></h2>
                                                <?php 
                                                $strength =  count($this->Homemodel->getallbrachesbyschoolinchildetail($school_id,$key)); ?>
                                                <p style="color: red;">strength : <?php echo $strength; ?></p>
                                                    </a>
                                                    </div> 
                                                    <?php } } ?>
                                                ...
                                                <?php if($lowclass == 1) {   ?>      
                                                     ...
                                                     <div class="m-grid-col m-grid-col-middle m-grid-col-center">
                                                      <a href="<?php echo base_url().'Home/emis_school_studentsectionwise/15'; ?>" style="text-decoration: none;"> 
                                                        <h2>PreKG</h2>
                                                       <?php 
                                                $strength =  count($this->Homemodel->getallbrachesbyschoolinchildetail($school_id,15)); ?> 
                                                      <p style="color: red;">strength : <?php echo $strength; ?></p>
                                                    </a>
                                                    </div> 
                                                      ...
                                                      <div class="m-grid-col m-grid-col-middle m-grid-col-center">
                                                      <a href="<?php echo base_url().'Home/emis_school_studentsectionwise/13'; ?>" style="text-decoration: none;"> 
                                                        <h2>LKG</h2>
                                                       <?php 
                                                $strength =  count($this->Homemodel->getallbrachesbyschoolinchildetail($school_id,13)); ?> 
                                                      <p style="color: red;">strength : <?php echo $strength; ?></p>
                                                    </a>
                                                    </div> 

                                                    <div class="m-grid-col m-grid-col-middle m-grid-col-center">
                                                      <a href="<?php echo base_url().'Home/emis_school_studentsectionwise/14'; ?>" style="text-decoration: none;"> 
                                                        <h2>UKG</h2>
                                                       <?php 
                                                $strength =  count($this->Homemodel->getallbrachesbyschoolinchildetail($school_id,14)); ?> 
                                                      <p style="color: red;">strength : <?php echo $strength; ?></p>
                                                    </a>
                                                    </div> 
