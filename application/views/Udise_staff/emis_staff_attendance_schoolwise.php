                                    ...
                                    <!-- BEGIN PAGE TITLE -->
                                       ...
                                       <div class="portlet light portlet-fit ">
                                            ...
                                            <div class="portlet-body">
                                                <div class="row">
                                                  <form action="<?=base_url().'Udise_staff/emis_staff_attendance_monthly_schoolwise' ?>" method="post">
                                                    <!-- <div class="col-md-3">
                                             ...
                                             <div class="portlet-body">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Staff Attendance - <span><?=date('M Y',strtotime($date));?></span> </div>
...
<th class="center">
                                                               ...
                                                               <tbody>
                                                            <?php if(!empty($teacher_absent_list)){ 

                                                                asort($teacher_absent_list);
                                                                $index =1;
                                                                $total_students = 0;
                                                                $present_students = 0;
                                                                 foreach($teacher_absent_list as  $det){   
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><span style="color:<?=$det['gender']==1?'blue':'deeppink'?>"><?=$det['teacher_name'];?></span></td>
                                                                    ...
                                                                    for($i=1;$i<=$current_date;$i++)
                                                                        ...
                                                                        ?>
                                                                   <td class=""><i class="<?=$class_variable;?>" style="font-size:20px;" aria-hidden="true"></i><span><?=$det[$i]['present']==0?'&nbsp;/&nbsp;&nbsp;'.$det[$i]['reason']:''?></span><span style="display:none;text-align:center;"><?=$name;?></span></td>
