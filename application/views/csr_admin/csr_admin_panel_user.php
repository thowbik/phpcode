                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                              ...
                              <tr>                          <th style="text-align:center">Created On</th>
                                                            ...
                                                            <th style="text-align:center">Type of Fund </th>
                                                            <th style="text-align:center">Status</th>
                              ...
                              <td style="text-align:center"><?php echo $csr_value['merchant_txn_id'];?></td>
							  <?php if ($csr_value['cont_towards'] ==1 ){?>
							  
							  <td style="text-align:center"><?php echo 'Genderal'; ?></td>
							  <?php } else {?>
							   <td style="text-align:center"><?php echo 'Against Requirement'; ?></td>
							     <?php }?>
                               ...
                               <button onclick="update_child_click();" type="button" data-toggle="modal" data-todo ='{"id":"<?php echo $csr_value["id"]?>","timestamp":"<?php echo $csr_value["timestamp"]?>"}' data-target="#myModal2" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-eye-open"></span></button>
...
{ 
   $('#myModal2').on('show.bs.modal', function (event) {
           ...
           var todoId = button.data('todo');
           console.log(todoId);
           console.log(todoId.timestamp);
        // var date = new Date(todoId.timestam);
...
//console.log(date);
       ...
       document.getElementById('cont_id').value = todoId.id;
         ...
         var Id = todoId.id;
         var timestamp = todoId.timestamp;
