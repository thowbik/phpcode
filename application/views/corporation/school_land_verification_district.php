                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <!--  <form action="<?php echo base_url().'corporation/school_land_verification_district?dist_id='.$district_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Boundary Wall<br/> Type</th>
                                                                    <th>Perimenter <br/>of boundary <br/>in meters</th>
                                                                    <th>Length <br/>of boundary wall<br/> in m</th>
                                                                    <!--<th>Verified</th>-->
