                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Staffs Surplus Post WithOut Person Fixation - DEE<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														    ...
														    $soctot =0;
														   $toteligible =0;									
														   if(!empty($staff_surpwithoutpost)){ $total1 = 0; foreach($staff_surpwithoutpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <td><?php echo $sd->surp_wo_sg;?><?php $sgtot=$sgtot+$sd->surp_wo_sg;?></td>
																	<td><?php echo $sd->surp_wo_sci;?><?php $scitot=$scitot+$sd->surp_wo_sci;?> </td>
																	<td><?php echo $sd->surp_wo_mat;?> <?php $mattot=$mattot+$sd->surp_wo_mat;?></td>
																	<td><?php echo $sd->surp_wo_eng;?> <?php $engtot=$engtot+$sd->surp_wo_eng;?></td>
																	<td><?php echo $sd->surp_wo_tam;?><?php $tamtot=$tamtot+$sd->surp_wo_tam;?> </td>
																	<td><?php echo $sd->surp_wo_soc;?> <?php $soctot=$soctot+$sd->surp_wo_soc;?></td>
																	  <td><?php echo $sd->surp_wo_tot;?>
																	 <?php $toteligible=$toteligible+$sd->surp_wo_tot;?>  </td>
...
$('#test').modal('show');
  ...
  $("#emis_state_report_schcate").change(function(){ 
    ...
    var emis_state_report_schcate = $("#emis_state_report_schcate").val();
      ...
      $.ajax({
        type: "POST",
        url:baseurl+'corporation/get_school_management_data',
...
function remove_catefilter(){
  ...
  $.ajax({
        type: "POST",
        url:baseurl+'Deo_corporation/deletereport_schoolcatemanage',
        data:"&test=1",
        success: function(resp){
        // alert(resp);  
