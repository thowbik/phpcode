                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Dashboard
                                             <small>Corporation Dashboard</small> - <label style="color:red;"><?=$block_name;?></label>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                    <!-- BEGIN PAGE TOOLBAR -->
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                        ...
                                        <!--  <form action="<?php echo base_url().'corporation/get_dash_blockwise_school?dist='.$dist.'&block='.$block_name?>"" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
