                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
														<?php 
														foreach($aadhar_school_details as $sd)
														{
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class="sum ">School Type</th>
                                                                    <th class="sum ">School Name</th>
																	 <th class="sum ">Students With Aadhar</th>
																	 <th class="sum ">Students WithOut Aadhar </th>
                                                            ...
                                                            <?php
                                                             $aadharincount =0;
															$aadharnotincount =0;															
															if(!empty($aadhar_school_details)){ $total1 = 0; foreach($aadhar_school_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <td ><?=$sd->aadharin?>
																    <?php $aadharincount=$aadharincount+$sd->aadharin;?></td>
                                                                     <td >
																   <a href="<?php echo base_url().'corporation/aadhar_school_notin_count_details?schoolid='.$sd->school_id?>"><?=$aadharnotin=$sd->totalstudent-$sd->aadharin;?>
																   <?php $aadharnotincount=$aadharnotincount+$aadharnotin;?></a>
														</td>
...
function openmodel(school)
{
    ...
    {
        type: "POST",
        url:baseurl+'Deo_corporation/get_school_class_section_details',
