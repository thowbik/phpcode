  ...
  <?php $this->load->view('corporation/header.php'); ?>
        ...
        <script src="<?php echo base_url().'asset/js/district.js';?>" type="text/javascript"></script>
         <script type="text/javascript">
                ...
                $.ajax({
                type: "POST",
                url:baseurl+'corporation/saveblockcommunity',
                data:"&block_id="+value,
                success: function(resp){ 
                if(resp==true){  
                window.location.href = baseurl+'corporation/emis_district_community_schools'; 
                return true;  
                 }else{
                    return false;
                 }
       ...
       <script type="text/javascript">
               function savecommuntiyonly(value){
                ...
                $.ajax({
                type: "POST",
                url:baseurl+'corporation/savecommunityonly',
                data:"&comm="+value,
                success: function(resp){ 
                if(resp==true){  
                window.location.href = baseurl+'corporation/emis_district_community_schools'; 
