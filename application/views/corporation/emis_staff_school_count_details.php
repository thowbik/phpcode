                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Staff Name</th>
                                                                    <th>Gender</th>
                                                                    <th class="sum center">Join_Date</th>
																	
                                                                    <th class="sum ">Professional</th>
																	<th>Categoryname</th>
																	 <th class="sum ">MobileNumber</th>
																	  <th class="sum ">Email_ID</th>
																	 <th class="sum "> Type_Teacher</th>
																	  <th class="sum ">Category</th>
																	 
																	                                                                                             </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php
                                                         		if(!empty($staff_school_details)){ $total1 = 0; foreach($staff_school_details as $index=> $sd){   ?>

                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td><?= $sd->teacher_name; ?></td>
                                                                    <td><?=($sd->gender==1)?'Male':'Female';?></td>
																...
																<td><?=($sd->category ==1)? 'Teaching Staff':'Non TeachingStaff' ;?>
																    </td>
