  ...
  <?php $this->load->view('corporation/header.php'); ?>
                            ...
                            <div class="page-content">
                                ...
                                <div class="container">
                                    ...
                                    <div class="portlet-body">
                                     ...
                                     <div class="col-md-12">
                                <form  method="post" action="<?php echo base_url().'corporation/emis_district_findschoolbyid';?>" id="emis_school_search_form" name="emis_school_search_form">
                                     <div class="row">
                                        <div class="col-md-6">
                                        <div class="form-body">
                                   ...
                                   <div class="portlet-body">
                                     ...
                                     <table id="user" class="table table-bordered table-striped">
                                        ...
                                        <center>
                            <a  href="<?php echo base_url().'corporation/emis_district_schoolmainid/'.$schoolid;?>" class="btn green acedit" 
   ...
   <script src="<?php echo base_url().'asset/js/district.js';?>" type="text/javascript"></script>
              ...
              <!--<script type="text/javascript">
                ...
                $.ajax({
                type: "POST",
                url:baseurl+'corporation/emis_district_saveschool_id',
                data:"&emis_school_id="+Udisecode,
                success: function(resp){ 
                if(resp==true){  
                alert("true");
                window.location.href = baseurl+'corporation/emis_district_findschoolbyid'; 
