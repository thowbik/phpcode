                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Staffs Available Fixation -DEE<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														    ...
														    $soctot =0;
														   $toteligible =0;									
														   if(!empty($staff_availpost)){ $total1 = 0; foreach($staff_availpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <td><?php echo $sd->avail_sg;?><?php $sgtot=$sgtot+$sd->avail_sg;?></td>
																	<td><?php echo $sd->avail_sci;?><?php $scitot=$scitot+$sd->avail_sci;?> </td>
																	<td><?php echo $sd->avail_mat;?> <?php $mattot=$mattot+$sd->avail_mat;?></td>
																	<td><?php echo $sd->avail_eng;?> <?php $engtot=$engtot+$sd->avail_eng;?></td>
																	<td><?php echo $sd->avail_tam;?><?php $tamtot=$tamtot+$sd->avail_tam;?> </td>
																	<td><?php echo $sd->avail_soc;?> <?php $soctot=$soctot+$sd->avail_soc;?></td>
																	  <td><?php echo $sd->avail_tot;?>
																	 <?php $toteligible=$toteligible+$sd->avail_tot;?>  </td>
