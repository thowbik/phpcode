                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>NoonMeal Student Details(Grade1 to 8)<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th>Total Students</th>
																	 <th class="sum "> Eligible Students</th>
																	                                                                                             </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php
															...
															//$aadharnotincount =0;
                                                           $studmeal=0;
														   $studtot =0;										if(!empty($meal_school_details)){ $total1 = 0; foreach($meal_school_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <?=$sd->school_name;?></td>
																   <td><?=$sd-> total ;?>
																    <?php $studtot=$studtot+$sd->total;?></td>
																   <td > <a href="<?php echo base_url().'corporation/meal_school_eligible_stud_count?schoolid='.$sd->school_id?>">
																    
																	<?=($sd->meals == '')?'0': $sd->meals;?>
																    <?php $studmeal=$studmeal+$sd->meals;?>
																	</a>
																   </td>
