                                                                ...
                                                                <tr>
																 ...
																 <td><?php echo $sd->subjects?></td>
																  <td><?php echo $sd->staff_join?></td>
																	...
																	<!--<td><input type="text" class="form-control" id="number<?php echo $i;?>" value="<?php echo $sd->seniority_district?>"></td> 
   ...
   function save(i,teachercode)  
		 {
		   ...
		   teacher_code=teachercode;
			...
			url:baseurl+'Ceo_District/emis_teacher_surplus_add_dse',
			type:"POST",
			dataType:"JSON",
