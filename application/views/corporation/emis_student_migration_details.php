          ...
          <td style="text-align: center; font-weight: bold ;color:green;"> <?php echo number_format($tot_inflow);?></td>
                              ...
                              <?php
                                                         ...
                                                         <tfoot>
                                                            ...
                                                            <th>Total</th>
                                                            <th></th>
                                                            <th style="text-align: center;" ><a href="<?php echo base_url().'corporation/get_migration_detail_student/?school_type_from='.'Government'.'&school_type_to='.'Fully Aided'?>"> <?php 
                                                            $gtofa = array_sum($gtofa);
                                                            array_push($total1,$gtofa);
                                                            echo number_format($gtofa);?></a></th>
                                                            <th style="text-align: center;"><a href="<?php echo base_url().'corporation/get_migration_detail_student/?school_type_from='.'Government'.'&school_type_to='.'Un-aided'?>"> <?php 
                                                                $gtoua = array_sum($gtoua);
                                                                array_push($total1,$gtoua);
                                                            echo number_format($gtoua);?></a></th>
                                                            <th style="text-align: center;"><a href="<?php echo base_url().'corporation/get_migration_detail_student/?school_type_from='.'Government'.'&school_type_to='.'Partially Aided'?>"><?php 
                                                           ...
                                                           echo number_format($gtopa);?></a></th>
                                                             ...
                                                             <th style="text-align: center;"><a href="<?php echo base_url().'corporation/get_migration_detail_student/?school_type_from='.'Un-aided'.'&school_type_to='.'Government'?>"><?php 
                                                             $uatog = array_sum($uatog);
                                                                array_push($total1,$uatog);
                                                           echo number_format($uatog);?></a></th>
                                                             <th style="text-align: center;"><a href="<?php echo base_url().'corporation/get_migration_detail_student/?school_type_from='.'Fully Aided'.'&school_type_to='.'Government'?>"><?php 
                                                             $fatog = array_sum($fatog);
                                                                array_push($total1,$fatog);
                                                           echo number_format($fatog);?></a></th>
                                                           
                                                             <th style="text-align: center;"><a href="<?php echo base_url().'corporation/get_migration_detail_student/?school_type_from='.'Partially Aided'.'&school_type_to='.'Government'?>"><?php 
