                                ...
                                <div class="container">
                                    ...
                                    <div class="portlet-body">
                                     ...
                                     <div class="col-md-12">
                                        <!--  <div class="col-md-4 thumbnail" style="margin-left: 10px; width: 20%"><center>
                                                    <form method="post" action="<?php echo base_url().'corporation/emis_district_findschoolbyid';?>">
                                         ...
                                         <div class="col-md-4 thumbnail" style="margin-left: 10px; width: 30%; height: 170px;"><center>
                                                    <form method="post" action="<?php echo base_url().'corporation/emis_district_findschoolbyudise';?>">
                                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 thumbnail" style="margin-left: 10px; height: 170px;"><center>
                                                   <form method="post" action="<?php echo base_url().'corporation/emis_district_findschoolbyblock';?>">
                                                    <div class="form-group">
                                   ...
                                   <div class="portlet-body">
                                     ...
                                     <table id="user" class="table table-bordered table-striped">
                                        ...
                                        <center>
                            <a  href="<?php echo base_url().'corporation/emis_district_schoolmainid/'.$schoolid.'/'.$udise_code;?>" class="btn green acedit" 
