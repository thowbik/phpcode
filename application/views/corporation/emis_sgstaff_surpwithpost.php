                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   if(!empty($sgstaff_surpwithpost)){ $total1 = 0; foreach($sgstaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Ceo_District/emis_deegovsurplus_sgstaff_school?schoolid='.$sd->school_id; ?>">
...
function openmodel(school)
{
    ...
    {
        type: "POST",
        url:baseurl+'Ceo_District/get_school_class_section_details',
