                ...
                <div class="page-wrapper-middle">
                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Students in Common Pool-Block wise|District: <?php echo $student_migration_details[0]->district_name;?></div>
                            ...
                            <td><a href="<?php echo base_url().'corporation/get_school_migration/?block_name='.$student_mig->block_name?>">
