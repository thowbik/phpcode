                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Staffs Needed Fixation - DEE<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														    ...
														    $soctot =0;
														   $toteligible =0;									
														   if(!empty($staff_needpost)){ $total1 = 0; foreach($staff_needpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <td><?php echo $sd->need_sg;?><?php $sgtot=$sgtot+$sd->need_sg;?></td>
																	<td><?php echo $sd->need_sci;?><?php $scitot=$scitot+$sd->need_sci;?> </td>
																	<td><?php echo $sd->need_mat;?> <?php $mattot=$mattot+$sd->need_mat;?></td>
																	<td><?php echo $sd->need_eng;?> <?php $engtot=$engtot+$sd->need_eng;?></td>
																	<td><?php echo $sd->need_tam;?><?php $tamtot=$tamtot+$sd->need_tam;?> </td>
																	<td><?php echo $sd->need_soc;?> <?php $soctot=$soctot+$sd->need_soc;?></td>
																	  <td><?php echo $sd->need_tot;?>
																	 <?php $toteligible=$toteligible+$sd->need_tot;?>  </td>
