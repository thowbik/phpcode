                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
														<?php 
														foreach($notinaadhar_schoolbase_details as $sd)
														{
															
														}
														?>
                                                            <i class="fa fa-globe"></i> Students WithOut Aadhar Details<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
															...
															if(!empty($notinaadhar_schoolbase_details)){ $total1 = 0; foreach($notinaadhar_schoolbase_details as $index=> $sd){   ?>

                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                  <td><?php echo $sd->unique_id_no; ?></td>
                                                                    <td><?php echo $sd->name; ?></td>
                                                                   <td class="center"><?=($sd->gender==1)?'Male':'Female';?></td>
																	
																	<td class="center"><?=$sd->
																	 dob;?></td> 
                                                                   
																   <td ><?php 
																   if($sd->class_studying_id == 13 )
																   {
																	   echo 'LKG';
																   } elseif($sd->class_studying_id == 14 ){
																	   echo 'UKG';
																   }
																   elseif($sd->class_studying_id == 15 ){
																	   echo 'PRE-KG';
																   }else{
