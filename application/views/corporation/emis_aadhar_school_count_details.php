                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
														<?php 
														foreach($aadhar_schoolbase_details as $sd)
														{
															
														}
														?>
                                                            <i class="fa fa-globe"></i>Aadhar Count Details<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
															...
															if(!empty($aadhar_schoolbase_details)){ $total1 = 0; foreach($aadhar_schoolbase_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td ><a href="<?php echo base_url().'corporation/aadhar_school_notin_count_details?schoolid='.$sd->school_id?>"><?=$aadharnotin=$sd->totalstudent-$sd->aadharin;?></a>
														</td>
