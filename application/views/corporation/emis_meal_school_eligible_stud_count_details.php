                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>NoonMeal  Eligible Students Details(Grade1 to 8)<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
															...
															//$aadharnotincount =0;
                                                           $studmeal=0;
														   $studtot =0;										if(!empty($meal_school_eligible_stud_count)){ $total1 = 0; foreach($meal_school_eligible_stud_count as $index=> $sd){   ?>
