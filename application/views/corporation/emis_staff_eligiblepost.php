                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Staffs EligibleFixation-DEE<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
															...
															// "<?php echo base_url().'corporation/emis_staff_school_count_details?schoolid='.$sd->school_id
                                                            $sgtot=0;
														    $scitot =0;
															 $mattot=0;
														    $engtot =0;
														    ...
														    $soctot =0;
														   $toteligible =0;									
														   if(!empty($staff_eligiblepost)){ $total1 = 0; foreach($staff_eligiblepost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <!--  <td><?=$sd-> staff ;?>
																    <?php $stafftot=$stafftot+$sd->staff;?></td>
																   <td >
																    
																	<?=($sd->nonstaff == '')?'0': $sd->nonstaff;?>
																    <?php $nonstafftot=$nonstafftot+$sd->nonstaff;?>
																	
																   </td>
																   <td><?=$sd->totstaff ;?>
																    <?php $totstaffs=$totstaffs+$sd->totstaff;?></td>  -->
                                                                
                                                                 <td><?php echo $sd->elig_sg;?><?php $sgtot=$sgtot+$sd->elig_sg;?></td>
																	<td><?php echo $sd->elig_sci;?><?php $scitot=$scitot+$sd->elig_sci;?> </td>
																	<td><?php echo $sd->elig_mat;?> <?php $mattot=$mattot+$sd->elig_mat;?></td>
																	<td><?php echo $sd->elig_eng;?> <?php $engtot=$engtot+$sd->elig_eng;?></td>
																	<td><?php echo $sd->elig_tam;?><?php $tamtot=$tamtot+$sd->elig_tam;?> </td>
																	<td><?php echo $sd->elig_soc;?> <?php $soctot=$soctot+$sd->elig_soc;?></td>
																	  <td><?php echo $sd->elig_tot;?>
																	 <?php $toteligible=$toteligible+$sd->elig_tot;?>  </td>
...
function openmodel(school)
{
    ...
    {
        type: "POST",
        url:baseurl+'corporation/get_school_class_section_details',
...
$('#test').modal('show');
  ...
  $("#emis_state_report_schcate").change(function(){ 
    ...
    var emis_state_report_schcate = $("#emis_state_report_schcate").val();
      ...
      $.ajax({
        type: "POST",
        url:baseurl+'Deo_corporation/get_school_management_data',
...
function remove_catefilter(){
  ...
  $.ajax({
        type: "POST",
        url:baseurl+'corporation/deletereport_schoolcatemanage',
        data:"&test=1",
        success: function(resp){
        // alert(resp);  
