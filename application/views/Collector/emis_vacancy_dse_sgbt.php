                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>
                                            ...
                                            <a href="<?php echo base_url().'Collector/vacancy_dse_pgreport'?>">
                                              <span class="text">Vacancy Teachers DSE-PG</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Collector/vacancy_dse_sgbtreport'?>">
                                              <span class="text">Vacancy Teachers DSE-SG</span><br/>
                                            </a>
                                          </li>
                                          <!-- <li role="presentation">
                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title col-md-12">
                                                        <div class="caption col-md-4">
                                                            <i class="fa fa-globe"></i>Total Schools-(Management-Wise)</div>
                            ...
                            <th style="text-align: center;">SG</th>
                              ...
                              <?php if(!empty($vacancy_dsereportsgbt)){  $i=1; $vac_sg=[]; $sciense=[]; $maths=[];
                                $english=[]; $tamil=[]; $social=[];  $hhm=[]; $telugu=[]; $agri=[]; $computer=[]; $pet=[]; $sew=[]; $music=[]; $drawing=[]; $pd2=[]; $kannadam=[]; $malayalam=[]; $urudu=[];
                                foreach($vacancy_dsereportsgbt as $vacancydse){ 
								?>
								<tr>
