                                                  ...
                                                  <div class="portlet box green">
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   if(!empty($dse_promotion_sch_staff_list)){ $total1 = 0; foreach($dse_promotion_sch_staff_list as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <a href="<?php echo base_url().'Collector/dse_promotion_staff_details?schoolid='.$sd->school_id ?>">
