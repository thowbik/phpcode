...
<?php $this->load->view('Collector/header.php'); ?>
                                    ...
                                    <div class="page-content-inner">
                                        ...
                                        <div class="row margin-bottom-20">
                                             <div class="portlet-body">
											  <form action="<?=base_url().'Collector/panelwise_transfer' ?>" method="post">
                                                    			  <div class="col-md-3"> 
  ...
  <select  class="form-control"  id="blk" name="blk" required="" >
                  ...
                  <div class="col-md-3" id="Edn"> 
                       <label class="control-label"><b>School Type</b></label>
                       <div class="form-group">    
                      <!-- <input type="text" class="form-control" id="sch" name="sch" placeholder="" required > -->
						
						 	   <select  class="form-control"  id="sch" name="sch" required="">
							
							 
<option value="1" >Panchayat School</option>
<option value="2" >Municipal School</option>
				   ...
				   <div class="col-md-3" id="panel"> 
                       <label class="control-label"><b>Panel Type</b></label>
                       <div class="form-group">    
                         <select  class="form-control"  id="pan" name="pan" required="">
						 
						  
                            <option  value="">Select Option *</option> 
                           <?php foreach($panel as $res) {   ?>
						   
                                                          <option   
														  value="<?php echo $res->id;?>">
														  <?php echo $res->panel_type; ?></option>
                                                          <?php  } ?>
                         </select> 
					   ...
					   <input type="hidden" class="form-control" id="manage_pan" name="manage_pan" placeholder="" required>
                       ...
                       <div class="form-group"> 
                        ...
                        <button type="submit" ID="addClick"  class="btn btn-primary">Submit</button>
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>DEE Panelwise Transfer List : <?php echo $blockname ?> <span> </span></div>
                            ...
                            <!--  <th style="text-align: center;">Gender</th> -->
                              ...
                              <th style="text-align: center;">DOJ<br/>Present-Post</th> 
                              <th style="text-align: center;">DOJ<br/>Present-School</th>
							  
                              <!--<th style="text-align: center;">Date Of<br/>Regularization</th>
                              <th style="text-align: center;">Designation</th>
                              <th style="text-align: center;">Subject</th>
                              <th style="text-align: center;">Priority Claimed</th>-->
                              </tr>
                              </thead>
                                                               <tbody>
                                                            <?php
														   ...
														   if(!empty($sch_panel_blk)){ $total1 = 0; foreach($sch_panel_blk as $sd){   ?>
                                                               ...
                                                               <td><?php echo $sd->teacher_id?></td>
																<td><?php echo $sd->sub?></td>
																	<td><?php echo $sd->type_teacher?></td>
																<!-- <td><?php echo $sd->gender==1?'Male':'Female'?></td> -->
																  <td><?php echo  date('d-m-Y', strtotime($sd->dob))?></td>
																  <!--<td><?php echo  date('d-m-Y', strtotime($sd->staff_join))?></td> -->
																	<td><?php echo  date('d-m-Y', strtotime($sd->doj_pr))?></td>
																	<td><?php echo  date('d-m-Y', strtotime($sd->doj_pr_schol))?></td> 
