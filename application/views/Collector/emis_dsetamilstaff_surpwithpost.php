                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Tamil Surplus PersonFixation<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" ">Surplus Tamil Teachers</th>
														    ...
														    $martot =0;
															 $pendtot=0;									
														   if(!empty($dsetamilstaff_surpwithpost)){ $total1 = 0; foreach($dsetamilstaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Collector/emis_dsegovsurplus_tamstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->swp_1 ?>">
                                                                 ...
                                                                 <td class="center"><?php echo $sd->swp_1;?><?php $sgtot=$sgtot+$sd->swp_1;?></td>
																<!--<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->swp_1 - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td> -->
