                                                  ...
                                                  <div class="portlet box green">
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   if(!empty($dsesciencestaff_surpwithpost)){  foreach($dsesciencestaff_surpwithpost as $index=> $sd){   ?>
																...
																<a href="<?php echo base_url().'Collector/emis_dsegovsurplus_sciencestaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_sci ?>">
																   ...
																   <?=$sd->school_name;?>
																	...
																	<td class="center"><?php $ss =$sd->surp_w_sci - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td>-->
