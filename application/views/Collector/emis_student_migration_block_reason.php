                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                              ...
                              <?php
                                  ...
                                  foreach($title as $t){
                              ?>                      
                              <th style="text-align: center;"><?php echo($t['transfer_reason']); ?></th>
                            <?php array_push($check,$t['transfer_reason'] ); } ?>
                              ...
                              <?php if(!empty($student_migration_details)){ $Gov_tot= [];$FA_tot= [];$UA_tot= [];$PA_tot= []; $CG_tot= []; $i=1;foreach($student_migration_details as $key => $value){ $j=0; $sum=0;  ?>
                                  <tr>
                                      <td><?php echo($i++); ?></td>
                                      <td><a href="<?php echo base_url().'Collector/get_school_migration_reason/?block_id='.$key?>"><?php echo($key); ?></a></td>
                                      <?php 
                                          foreach($check as $c){ $cc=0;
                                                foreach($value as $v){
                                                    if($v['transfer_reason']==$c){
                                                        $total1[$j++]+=$v['cnt'];
                                                        echo ('<td>'.number_format($v['cnt']).'</td>');
                                                        $cc=1;
                                                        $sum+=$v['cnt'];
                                                        break;  
                                                    }
