                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Malayalam Surplus PersonFixation<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   $toteligible =0;									
														   if(!empty($malastaff_surpwithpost)){ $total1 = 0; foreach($malastaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td class="details-control">
																    <a href="<?php echo base_url().'Collector/emis_deegovsurplus_malastaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_mala ?>">
                                                                 ...
                                                                 <td class="center"><?php echo $sd->surp_w_mala;?><?php $sgtot=$sgtot+$sd->surp_w_mala;?></td>
																  <!--<td><?php echo $sd->surplus;?> </td>
																	<td><?php $ss =$sd->surp_w_mala - $sd->surplus;?><?php echo $ss;?> </td> -->
