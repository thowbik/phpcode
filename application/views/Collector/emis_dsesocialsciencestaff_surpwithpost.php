                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
																...
																<th class=" ">Surplus SocialScience</th>
																	<!-- <th class=" ">Marked</th>
																	  <th class=" ">Pending</th>-->
														   ...
														   if(!empty($dsesocialsciencestaff_surpwithpost)){ $total1 = 0; foreach($dsesocialsciencestaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td class="details-control">
																 	<a href="<?php echo base_url().'Collector/emis_dsegovsurplus_ssciencestaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_soc ?>">
																   ...
																   <?=$sd->school_name;?>
																	...
																	<!--<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->surp_w_soc - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td>-->
                                                         ...
                                                         <tfoot>
															  ...
															  <!--  <th class="center"><?php echo $martot?></th>
                                                                <th class="center"><?php echo $pendtot?>
