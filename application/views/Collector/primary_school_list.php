                            ...
                            <div class="page-content">
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Primary School High Class  Greater than  5 | <span>District :<?php echo $details[0]->district_name;?></span> </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                   ...
                                                                   <th style="text-align: center;">HM Name</th> 
                                     ...
                                     <td style="text-align: center;"><?php echo ($det->udise_code); ?></td>
                                      <td ><?php echo ($det->name); ?></td>
                                     <td style="text-align: center;"><?php echo ($det->phone); ?></td>
