                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> School Renewal Reports  - Block - <?=$block_id;?> </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover " id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>UDISE Code</th>
                                                                    <th class="sum">School Name</th>
                                                                    <th class="sum">Management</th>
                                                                    <th class="sum center">Category</th>
                                                                    <th class="sum">Affiliation </th>
                                                                    <th class="sum center">Year Of Recognition</th>
                                                                    <th class="sum center">Last Renewal Year</th>
                                                                    <th class="sum center">Reference No.</th>
