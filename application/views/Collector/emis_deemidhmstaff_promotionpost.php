                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>HM(Middle) School Wise<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" "> HM(Middle) <br>Teacher</th>
														   ...
														   if(!empty($emis_deemidhmstaff_promotion)){ $total1 = 0; foreach($emis_deemidhmstaff_promotion as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <a href="<?php echo base_url().'Collector/emis_deehsmidschoolstaff_promotionpost?schoolid='.$sd->school_key_id ?>">
