			 ...
			 <div class="portlet-body">
				   ...
				   <div class="portlet box green">
							<div class="portlet-title">
								<div class="caption">
									 <i class="fa fa-globe"></i> HM (PRIMARY)  Eligible for Promotion</div>
								<div class="tools"> </div>
							</div>
							<div class="portlet-body">
...
<th>Date Of <br>Appointment</th>
									...
									<?php $i=1;
								 if(!empty($deehsprischoolstaffpromot)){
								
									foreach($deehsprischoolstaffpromot as $sd){
...
var dsegovsurplus_sgstaff = <?=json_encode($deehsprischoolstaffpromot);?>;
