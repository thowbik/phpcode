                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Teacher School Wise<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   if(!empty($dee_promotion_sch_staff_list)){ $total1 = 0; foreach($dee_promotion_sch_staff_list as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <a href="<?php echo base_url().'Collector/dee_promotion_staff_details?schoolid='.$sd->school_id ?>">
                                                                 ...
                                                                 <td class ="center"><?php echo $sd->staff;?><?php $sgtot=$sgtot+$sd->staff;?></td>
