...
function comp(nameid) {
  ...
  $('.cards').addClass('hidden');
	  ...
	  $("#stat1").html('<a href="<?php echo base_url().'Collector/emis_dsesgstaff_promotionpost'; ?>"> <h4>SecondaryGrade Teacher</h4> <span><?php echo $eligiblepromotiontot[0]-> sgteacher;?></span></a>');
	  $("#stat2").html('<a href="<?php echo base_url().'Collector/emis_dsebtstaff_promotionpost'; ?>"> <h4>BT Teacher</h4> <span><?php echo $eligiblepromotiontot[0]-> btteacher;?></span></a>');
	  $("#stat3").html('<a href="<?php echo base_url().'Collector/emis_dsepgstaff_promotionpost'; ?>"> <h4>PG Teacher</h4> <span><?php echo $eligiblepromotiontot[0]-> pgteacher;?></span></a>');
	  $("#stat4").html('<a href="<?php echo base_url().'Collector/emis_dsehshmstaff_promotionpost'; ?>"> <h4>HM(HS)</h4> <span><?php echo $eligiblepromotiontot[0]-> hshm;?></span></a>');
	  $("#stat5").html('<a href="<?php echo base_url().'Collector/emis_dsehsshmstaff_promotionpost'; ?>"> <h4>HM(HSS)</h4> <span><?php echo $eligiblepromotiontot[0]-> hsshm;?></span></a>');
