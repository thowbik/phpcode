                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> English Surplus PersonFixation<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" ">Surplus English Teachers</th>
														    ...
														    $martot =0;
															 $pendtot=0;									
														   if(!empty($dseenglishstaff_surpwithpost)){ $total1 = 0; foreach($dseenglishstaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Collector/emis_dsegovsurplus_engstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->swp_2 ?>">
                                                                 ...
                                                                 <td class="center"><?php echo $sd->swp_2;?><?php $sgtot=$sgtot+$sd->swp_2;?></td>
															<!--	<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->swp_2 - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td> -->
