                                                  ...
                                                  <div class="portlet box green">
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														    ...
														    $martot =0;
															 $pendtot=0;									
														   if(!empty($dsesgstaff_surpwithpost)){ $total1 = 0; foreach($dsesgstaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Collector/emis_dsegovsurplus_sgstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_sg ?>">
                                                                 ...
                                                                 <td class="center"><?php echo $sd->surp_w_sg;?><?php $sgtot=$sgtot+$sd->surp_w_sg;?></td>
															<!--	<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->surp_w_sg - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td> -->
