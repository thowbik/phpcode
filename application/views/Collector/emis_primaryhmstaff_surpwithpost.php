                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Primary HM Surplus PersonFixation<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" ">Surplus Primary HM</th>
																<!--	<th class=" ">Marked</th>
																	 <th class=" ">Pending</th> -->
														   ...
														   $toteligible =0;									
														   if(!empty($primarystaff_surpwithpost)){ $total1 = 0; foreach($primarystaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																  ...
																  <a href="<?php echo base_url().'Collector/emis_deegovsurplus_primaryhmstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_phm?>">
                                                                 ...
                                                                 <td><?php echo $sd->surp_w_phm;?><?php $sgtot=$sgtot+$sd->surp_w_phm;?></td>
																<!--  <td><?php echo $sd->surplus;?> </td>
																	<td><?php $ss =$sd->surp_w_phm - $sd->surplus;?><?php echo $ss;?> </td> -->
