                                    ...
                                    <div class="page-content-inner">
									 ...
									 <td class="center"><?= date('d-m-Y',strtotime($sd->staff_join))?></td>
																 ...
																 <button type="submit" onclick="savevalid(<?= $i ?>);"class="btn btn-primary">Save</button>
																   ...
																   <td><a href="<?=base_url().'Collector/dsegenerate_pdf/'.$sd->teacher_code?>"><i class="fa fa-file-pdf-o"></i></a></td>
...
// url:baseurl+'Collector/sur_plus',
// type:"POST",
// dataType:"JSON",
...
$.each($(".checkbox:checked"), function() {
	...
	$.ajax({
		...
		dataType:"JSON",
		data:data,
		url:"<?=base_url().'Collector/get_dynamic_school_details'?>",
	 ...
	 dist.push(checkedValue);
		...
		var distkg =$("#distkg1").val();
                    ...
                    $.ajax(
                    {
                        method:"POST",
                        dataType:"JSON",
                        url:'<?=base_url()."Collector/staffs_transfers"?>',
                        data:data,
                        success:function(res)
                        {
