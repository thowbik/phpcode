                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                      ...
                                      <div class="portlet light">
                                            <!-- form action="<?php echo base_url().'Collector/emis_district_schools_student_list'?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
...
function get_tamil_engilsh_stu_count(school_id)
{
    ...
    $.ajax({
        ...
        method:"POST",
        url:"<?=base_url().'Collector/get_student_schoolwise_count'?>",
        data:data,
        dataType:'json',
...
// console.log(status);
    if(status=='true')
    {
      ...
      $.ajax({
        method:"POST",
        url:"<?=base_url().'Collector/save_staff_schoollist_count'?>",
        data:data,
        dataType:'JSON',
        success:function(res)
        {
...
function get_tamil_engilsh_high_stu_count(school_id)
{
    ...
    $.ajax({
        ...
        method:"POST",
        url:"<?=base_url().'Collector/get_mediumwise_school_students_count'?>",
        data:data,
        dataType:'json',
        success:function(res)
        {
...
console.log(school_high_id);
    swal({
      ...
      $.ajax({
        method:"POST",
        url:"<?=base_url().'Collector/save_staff_higher_details'?>",
        data:data,
        dataType:'JSON',
        success:function(res)
        {
