                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>BT Teacher School Wise<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   if(!empty($emis_deebtstaff_promotion)){ $total1 = 0; foreach($emis_deebtstaff_promotion as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <a href="<?php echo base_url().'Collector/emis_deebtschoolstaff_promotionpost?schoolid='.$sd->school_key_id ?>">
