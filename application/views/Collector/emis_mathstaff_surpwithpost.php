                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> MatheMatic Teacher Surplus PersonFixation<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class=" ">School Name</th>
																	 ...
																	 <th class=" ">Surplus Mathematics Teacher</th>
																  <!--<th class=" ">Marked</th>
																	 <th class=" ">Pending</th>-->
																	                                                                                             </tr>
                                                                </thead>
														   ...
														   if(!empty($mathstaff_surpwithpost)){ $total1 = 0; foreach($mathstaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Collector/emis_deegovsurplus_mathstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_mat ?>">
																...
																<td class ="center"><?php echo $sd->surp_w_mat;?> <?php $mattot=$mattot+$sd->surp_w_mat;?></td>
																<!--<td><?php echo $sd->surplus;?> <?php $martot=$martot+$sd->surplus;?></td>
											                     <td><?php $ss =$sd->surp_w_mat - $sd->surplus;?><?php echo $ss;?>
