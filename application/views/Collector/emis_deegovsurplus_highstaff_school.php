...
<link href="<?php echo base_url().'asset/global/plugins/simple-line-icons/simple-line-icons.min.css';?>" rel="stylesheet" type="text/css" />
                                     ...
                                     <div class="portlet-body">
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>DEESchool Surplus Report <?php echo "  Eligible Surplus :(".$sur.')'?></div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
 ...
 <th>Date Of <br>Appointment</th>
                                                            ...
                                                            <?php $i=1;
                                                         if(!empty($deegovsurplus_highhmstaff)){
                                                         
															foreach($deegovsurplus_highhmstaff as $sd){
...
function saveleaveperiods()
{
	...
	var dsegovsurplus_sgstaff = <?=json_encode($deegovsurplus_highhmstaff);?>;
		...
		for(var i =1;i<=dsegovsurplus_sgstaff.length;i++)
		{
			...
			if(modeule_id1 != 0)
			{
		         school_verification.push({'modeule_id1':modeule_id1,'school_id':school_id,'teach_id':teach_id,'subject':subject});
	...
	/*if(surplus_count >= sur_count){*/
			...
			$.ajax(
          {
			...
			url:baseurl+'Collector/save_surplusdse',
			type:"POST",
			dataType:"JSON",
