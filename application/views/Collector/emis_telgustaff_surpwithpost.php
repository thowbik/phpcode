                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Telugu Surplus PersonFixation<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" ">Surplus Telugu Teacher</th>
																	<!--	<th class=" ">Marked</th>
																	 <th class=" ">Pending</th>
																	-->
																	                                                                                             </tr>
														   ...
														   if(!empty($telgustaff_surpwithpost)){ $total1 = 0; foreach($telgustaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <a href="<?php echo base_url().'Collector/emis_deegovsurplus_telugustaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_telu ?>">
                                                                 ...
                                                                 <td><?php echo $sd->surp_w_telu;?><?php $sgtot=$sgtot+$sd->surp_w_telu;?></td>
																 
																<!-- <td><?php echo $sd->surplus;?> </td>
																	<td><?php $ss =$sd->surp_w_telu - $sd->surplus;?><?php echo $ss;?> </td>
																-->
