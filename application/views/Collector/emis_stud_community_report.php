                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url()?>Collector/stud_community_report" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
...
$total1 = [];
                         ...
                         <?php
															...
															if(!empty($school_community)){ $total1 = []; $prekg_t=[]; $lkg_t=[];  $ukg_t=[];  $c1=[];  $c2=[]; $c3=[];  $c4=[]; $c5=[];  $c6=[];  $c7=[];  $c8=[]; $c8_g=[]; $c9=[];  $c10=[];  $c11=[];  $c12=[];  $total=[]; foreach($school_community as $index=> $sd){   ?>

                              <tr>
                                  <td class="center"><?=$index+1;?></td>
																  <td><a href="<?php echo base_url().'Collector/stud_community_report_dist/?community_name='.$sd->community_name?>"><?= $sd->community_name ?></a></td>		
