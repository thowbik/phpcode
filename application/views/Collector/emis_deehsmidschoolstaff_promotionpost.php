			 ...
			 <div class="portlet-body">
				   ...
				   <div class="portlet box green">
							<div class="portlet-title">
								<div class="caption">
									 <i class="fa fa-globe"></i> HM (MIDDLE)  Eligible for Promotion</div>
								<div class="tools"> </div>
							</div>
							<div class="portlet-body">
...
<th>Date Of <br>Appointment</th>
									...
									<?php $i=1;
								 if(!empty($deehsmidschoolstaffpromot)){
								
									foreach($deehsmidschoolstaffpromot as $sd){
...
var dsegovsurplus_sgstaff = <?=json_encode($deehsmidschoolstaffpromot);?>;
