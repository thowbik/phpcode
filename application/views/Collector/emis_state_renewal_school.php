...
<link href="<?php echo base_url().'asset/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css';?>" rel="stylesheet" type="text/css" />
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Private School Verification School-wise
  ...
  <div class="col-md-4">
    ...
    <div class="input-group input-daterange">
      ...
      <input type="text" id="min-date" class="form-control date-range-filter" data-date-format="yyyy" placeholder="From:">

      <div class="input-group-addon">to</div>

      <input type="text" id="max-date" class="form-control date-range-filter" data-date-format="yyyy" placeholder="To:">

    </div>
  </div>
  <div class="err_msg"></div>
</div>
                                           <!-- <form action="<?php echo base_url()?>Collector/get_district_strick_report" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Private School Verification School-wise - <?=$block_id;?> </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover " id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class=" center">Year Of Recognition</th>
                                                                    <th class=" center">Last Renewal Year</th>
                                                                    <th class=" center">Reference No.</th>
                                                                    
                                                                </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php if(!empty($school_renewal_status))
                                                            {  foreach($school_renewal_status as $index=>  $det){   
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="center"> 
                                                                    <?php echo $det->udise_code; ?></td>
                                                                    <td class=""><?=$det->school_name;?></td>
                                                                   <td class=""><?=$det->category;?></td>
                                                                   <td class=""><?=$det->management;?></td>
                                                                   
                                                                   <td class=""><?=$det->department;?></td>
                                                                   <td class="center"><?=$det->yr_recgn_first;?></td>
                                                                   <td class="center"><?=$det->last_year;?></td>
                                                                   <td class="center"><?=$det->certifi_no;?></td>
                                                                   <!-- <td class="center"><?=$det->department;?></td> -->
...
//   // $("#max-date").datepicker('setStartDate',min);
...
$("#max-date").change(function()
{
  ...
  table.rows().invalidate().draw();
    $(".err_msg").html('');
        ...
        {
            $(".err_msg").html("<p style='color:red'>Please Select From Date</p>");
        }
})
