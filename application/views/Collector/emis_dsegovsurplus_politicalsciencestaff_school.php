...
<link href="<?php echo base_url().'asset/global/plugins/simple-line-icons/simple-line-icons.min.css';?>" rel="stylesheet" type="text/css" />
                                     ...
                                     <div class="portlet-body">
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>DSESchool Surplus <?php echo "  Eligible Surplus :(".$sur.')'?> Political Science</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
 ...
 <th>Date Of <br>Appointment</th>
                                                            ...
                                                            <?php $i=1;
                                                         if(!empty($dsegovsurplus_politicalsciencestaff)){
                                                           // print_r(dsegovsurplus_sgstaff);
															foreach($dsegovsurplus_politicalsciencestaff as $sd){
...
function saveleaveperiods()
{
	...
	var dsegovsurplus_sgstaff = <?=json_encode($dsegovsurplus_politicalsciencestaff);?>;
