                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                          ...
                                                          $martot =0;
														   ...
														   if(!empty($dsebtengtaff_surpwithpost)){  foreach($dsebtengtaff_surpwithpost as $index=> $sd){   ?>
																...
																<a href="<?php echo base_url().'Collector/emis_dsegovsurplus_btengstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_eng ?>">
																   ...
																   <?=$sd->school_name;?>
																	...
																	<td><?php echo $sd->surp_w_eng;?><?php $scitot=$scitot+$sd->surp_w_eng;?> </td>
																<!--	<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->surp_w_eng - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td>-->
