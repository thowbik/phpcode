...
function comp(nameid) {
  ...
  $('.cards').addClass('hidden');
	  ...
	  $("#stat1").html('<a href="<?php echo base_url().'Collector/emis_deesgstaff_promotionpost'; ?>"> <h4>SecondaryGrade Teacher</h4> <span><?php echo $eligibledeepromotiontot[0]-> sgteacher;?></span></a>');
	  $("#stat2").html('<a href="<?php echo base_url().'Collector/emis_deebtstaff_promotionpost'; ?>"> <h4>BT Teacher</h4> <span><?php echo $eligibledeepromotiontot[0]-> btteacher;?></span></a>');
	 // $("#stat3").html('<a href="<?php echo base_url().'Collector/emis_deepgstaff_promotionpost'; ?>"> <h4>PG Teacher</h4> <span><?php echo $eligibledeepromotiontot[0]-> pgteacher;?></span></a>');
	  $("#stat4").html('<a href="<?php echo base_url().'Collector/emis_deeprihmstaff_promotionpost'; ?>"> <h4>HM(Primary)</h4> <span><?php echo $eligibledeepromotiontot[0]-> prihm;?></span></a>');
	  $("#stat5").html('<a href="<?php echo base_url().'Collector/emis_deemidhmstaff_promotionpost'; ?>"> <h4>HM(Middle)</h4> <span><?php echo $eligibledeepromotiontot[0]-> midhm;?></span></a>');
