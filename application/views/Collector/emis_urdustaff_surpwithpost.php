                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Urdu Surplus PersonFixation<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   $toteligible =0;									
														   if(!empty($urdustaff_surpwithpost)){ $total1 = 0; foreach($urdustaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																  ...
																  <a href="<?php echo base_url().'Collector/emis_deegovsurplus_kannadastaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_urdu?>">
                                                                 ...
                                                                 <td class="center"><?php echo $sd->surp_w_urdu;?><?php $sgtot=$sgtot+$sd->surp_w_urdu;?></td>
																<!-- <td><?php echo $sd->surplus;?> </td>
																	<td><?php $ss =$sd->surp_w_urdu - $sd->surplus;?><?php echo $ss;?> </td> -->
