                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Dashboard
                                             <small>State Dashboard</small> - <label style="color:red;"><?=$block_name;?></label>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                    <!-- BEGIN PAGE TOOLBAR -->
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <form action="<?php echo base_url().'Collector/get_dash_blockwise_school?block='.$block_name?>"" method="POST">
                                               <div class="row">
                                                    <div class="col-md-12">
        ...
        <?php echo number_format($over_total); ?></h4>
                                          ...
                                          <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i> Student School wise | <span>District :<?php echo $details[0]->district_name;?></span> | <span>Block : <?php if($block_name!="") { echo $block_name; } ?></span>  </div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
