                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title col-md-12">
                                                        <div class="caption col-md-4">
                                                            <i class="fa fa-globe"></i>Live Vacancy Report</div>
                            ...
                            <th style="text-align: center;">Tamil</th>
                              ...
                              <?php if(!empty($live_vacancy_dsereport)){  $i=1; 
                                foreach($live_vacancy_dsereport as $vacancydse){ 
                              ...
                              <?php
                                foreach ($sub as $s) { $comp='vac_'.$s;
                              ?>
                              <td style="text-align: center;"><?php echo number_format($vacancydse->$comp); ?></a></td>
                      
                              <?php
                                $total1[$comp]+=$vacancydse->$comp;
