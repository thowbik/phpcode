                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Physics Teacher Surplus PersonFixation<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" "> Surplus Physics Teachers</th>
														    ...
														    $martot =0;
															 $pendtot=0;									
														   if(!empty($dsephystaff_surpwithpost)){ $total1 = 0; foreach($dsephystaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Collector/emis_dsegovsurplus_phystaff_school?schoolid='.$sd->school_id,'&sur='.$sd->swp_3 ?>">
                                                                 ...
                                                                 <td class="center"><?php echo $sd->swp_3;?><?php $sgtot=$sgtot+$sd->swp_3;?></td>
																<!--<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->swp_3 - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td>-->
