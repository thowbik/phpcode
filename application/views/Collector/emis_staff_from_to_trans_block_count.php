            ...
            <div class="page-wrapper-row full-height">
                <div class="page-wrapper-middle">
                    ...
                    <div class="page-container">
						...
						<form action="<?=base_url().'Collector/emis_staff_from_to_trans_block_count'?>" method="post">
...
<h2></h2>
        <button type="sumbit" class="btn green btn-md" >Submit</button>
             ...
             <h4 style="font-size: 30px;"> </h4>
                              ...
                              <td><a href="<?php echo base_url().'Collector/emis_district_teacher_transhistory/?Block='.$staff_tnfr->from_block.'&fdate='.$fdate.'&tdate='.$tdate?>">
