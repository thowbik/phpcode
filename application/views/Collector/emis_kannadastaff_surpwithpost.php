                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Kannada Surplus PersonFixation<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   $toteligible =0;									
														   if(!empty($kannadamstaff_surpwithpost)){ $total1 = 0; foreach($kannadamstaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <a href="<?php echo base_url().'Collector/emis_deegovsurplus_kannadastaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_kann  ?>">
                                                                 ...
                                                                 <td><?php echo $sd->surp_w_kann;?><?php $sgtot=$sgtot+$sd->surp_w_kann;?></td>
																 	<!-- <td><?php echo $sd->surplus;?> </td>
																	<td><?php $ss =$sd->surp_w_kann - $sd->surplus;?><?php echo $ss;?> </td> -->
