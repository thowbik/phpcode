                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>
                                            ...
                                            <a href="<?php echo base_url().'Collector/live_vacancy_dse_pgreport'?>">
                                              <span class="text">Live Vacancy Teachers DSE-PG</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Collector/live_vacancy_dse_sgbtreport'?>">
                                              <span class="text">Live Vacancy Teachers DSE-SG</span><br/>
                                            </a>
                                          </li>
                                          <!-- <li role="presentation">
                                            <a href="<?php echo base_url().'Collector/emis_state_school_dse'?>">
                                              <span class="text">Directorate Of School Education</span>
                                            </a>
                                          </li>
                                          <li role="presentation" class="next">
                                                <a href="<?php echo base_url().'Collector/emis_state_school_dms'?>">
                                              <span class="text" >Directorate Of Matriculation School</a></span>
                                          </a>
                                          </li>
                                            <li role="presentation" class="next">
                                                <a href="<?php echo base_url().'Collector/emis_state_school_others'?>">
                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title col-md-12">
                                                        <div class="caption col-md-4">
                                                            <i class="fa fa-globe"></i>Live Vacancy others</div>
                            ...
                            <th style="text-align: center;">SG</th>
                              ...
                              <?php if(!empty($live_vacancy_dsereportsgbt)){  $i=1; $vac_sg=[]; $sciense=[]; $maths=[];
                                $english=[]; $tamil=[]; $social=[];  $hhm=[]; $telugu=[]; $agri=[]; $computer=[]; $pet=[]; $sew=[]; $music=[]; $drawing=[]; $pd2=[]; $kannadam=[]; $malayalam=[]; $urudu=[];
                                foreach($live_vacancy_dsereportsgbt as $vacancydse){ 
								?>
								<tr>
                               <td style="text-align: center;"><?php echo $i++;?></td>
                              <td> <?php echo $vacancydse->school_name; ?></td>
