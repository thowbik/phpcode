    ...
    // Edit Change Hss School
      ...
      function get_pri_schools(block_id,sch_ctype_id,hss_sch_id)
      {
          ...
          if(block_id !='' && sch_ctype_id !='')
          {
            ...
            {
              method:"POST",
              url:'<?=base_url()."Collector/get_primary_school_list"?>',
                    ...
                    if(map_list_detail.hss_school_id!=hss_sch_id)
                    {
                        ...
                        }, function(isConfirm)
                        {
                         ...
                         $.ajax(
                         {
                            ...
                            dataType:'JSON',
                            url:'<?=base_url()."Collector/check_brte_staff_school"?>',
                            success:function(res)
                            {
                                if(res.count >0){
                                swal(
           ...
           // return false;
            ...
            }, function(isConfirm)
            {
             ...
             $.ajax(
             {
                ...
                data:data,
                dataType:'JSON',
                url:'<?=base_url()."Collector/emis_brte_save"?>',
                success:function(res)
                {
                    // console.log(res);
        ...
        $.ajax(
             {
                ...
                dataType:'JSON',
                url:'<?=base_url()."Collector/get_brte_school_group"?>',
                success:function(res)
                {
                        console.log(res);
            ...
            }, function(isConfirm)
            {
              if(isConfirm)
              {
                 $.ajax(
                    ...
                    dataType:'JSON',
                    url:'<?=base_url()."Collector/brte_nodal_school_remove"?>',
                    success:function(res)
                    {
                        swal(
                            {
          ...
          }else
          {
            ...
            }, function(isConfirm)
            {
             ...
             $.ajax(
             {
                ...
                data:data,
                dataType:'JSON',
                url:'<?=base_url()."Collector/save_brte_school_group"?>',
                success:function(res)
                {
                    // console.log(res);
