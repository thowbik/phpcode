  ...
  <?php $this->load->view('Collector/header.php'); ?>
												...
												<div class="portlet box" >
													...
													<div class="portlet-body" >
														<div class="form-group">
															...
															<form action="<?php echo base_url(); ?>Collector/schoolcatemanagefil" method="POST">
        ...
        <script type="text/javascript">
			...
			function searchfilter(emis_state_report_schcate,emis_state_report_schmgtype,emis_state_special_search,emis_state_special_search1) {
				...
				var id1 = $("#emis_Collector_special_search").val();
				var id2= $("#emis_Collector_special_search1").val();
            ...
            $(document).on('change','#student_count',function()
             {
             	// alert($(this).val());
             	$("#emis_Collector_special_search").val($(this).val());
             })
             $(document).on('change','#emis_Collector_special_search',function()
             {
             ...
             {
             	// alert($(this).val());
             	$("#emis_Collector_special_search1").val($(this).val());
             })
             $(document).on('change','#emis_Collector_special_search1',function()
             {
             	$("#student_count").val($(this).val());
             })
