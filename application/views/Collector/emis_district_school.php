                                    ...
                                    <div class="page-title">
                                        <h1>Dashboard - <label style="color:red;"><?php echo $details[0]->district_name;?></label>
                                          ...
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                            ...
                                            <a href="<?php echo base_url().'Collector/emis_Collector_school'?>">
                                              <span class="text"><b>DSE</b></span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Collector/get_dee_district'?>">
                                              <span class="text"><b>DEE</b></span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Collector/get_dse_district'?>">
                                              <span class="text"><b>DMS</b></span>
                                            </a>
                                          </li>
                                          <li role="presentation" class="next">
                                              <a href="<?php echo base_url().'Collector/get_dms_district'?>">
                                              <span class="text" ><b>Others</b></a></span>
                                          </a>
                                          </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Collector/emis_Collector_home'?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
...
$total1 = [];
         ...
         $total = $det->PREKG + $det->LKG + $det->UKG + $det->class_1 + $det->class_2 + $det->class_3 + $det->class_4 + $det->class_5 + $det->class_6 + $det->class_7 + $det->class_8 + $det->class_9 + $det->class_10 + $det->class_11 + $det->class_12; ?>
        ...
        <?php echo number_format($over_total); ?></h4>
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Student Block wise | <span>District :<?php echo $details[0]->district_name;?></span> </div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                               ...
                                                               <tbody>
                                                            <?php if(!empty($details)){$prekg_tot= [];$lkg_tot= [];$ukg_tot= [];$c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1; foreach($details as $det){   ?>

                                                                <tr>
                                                                  <td style="text-align: center;"><?php echo $i;?></td>
                                                                    <td> <a href="<?php echo base_url().'Collector/get_dash_blockwise_school?block='.$det->block_name?>">
