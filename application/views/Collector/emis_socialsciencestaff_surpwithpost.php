                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
																...
																<th class=" "> Surplus <br>SocialScience<br>Teacher</th>
																		<!--<th class=" ">Marked</th>
																	 <th class=" ">Pending</th>-->
																	                                                                                             </tr>
                                                                </thead>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td class="details-control">
																    ...
																    <input type="hidden" id="school_id<?=$index?>" value="<?=$sd->school_id;?>"></a>
																		...
																		<td class="center"><?php echo $sd->surp_w_soc;?> <?php $soctot=$soctot+$sd->surp_w_soc;?></td>
																	<!--<td><?php echo $sd->surplus;?> <?php $martot=$martot+$sd->surplus;?></td>
											<td><?php $ss =$sd->surp_w_soc - $sd->surplus;?><?php echo $ss;?>
