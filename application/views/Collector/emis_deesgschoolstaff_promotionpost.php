...
<th>Date Of <br>Appointment</th>
									...
									<?php $i=1;
								 if(!empty($deesgschoolstaffpromot)){
								
									foreach($deesgschoolstaffpromot as $sd){
...
var dsegovsurplus_sgstaff = <?=json_encode($deesgschoolstaffpromot);?>;
...
url:baseurl+'Collector/save_promotiondee',
type:"POST",
dataType:"JSON",
