                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>  Teacher Surplus PersonFixation<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														    ...
														    $martot =0;
															 $pendtot=0;									
														   if(!empty($dseeconomicsstaff)){ $total1 = 0; foreach($dseeconomicsstaff as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Collector/emis_dsegovsurplus_economicsstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->swp_19 ?>">
                                                                 ...
                                                                 <td class="center"><?php echo $sd->swp_19;?><?php $sgtot=$sgtot+$sd->swp_19;?></td>
															<!--	<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->swp_19 - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td>-->
