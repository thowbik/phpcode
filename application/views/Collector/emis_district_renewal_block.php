                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Private School Verification
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Private School Verification Block-wise - <?=($dist_id ==''?'':$dist_id);?>  </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover " id="sample_3">
                                                            ...
                                                            {  foreach($school_renewal_status as $index=>  $det){   
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> <a href="<?php echo base_url().'Collector/get_renewal_state_school?block='.$det->block_name?>">
