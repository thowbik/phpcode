                                    ...
                                    <div class="page-title">
                                        <h1>Student  Community Details
                                          ...
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                            ...
                                            <a href="<?php echo base_url().'Collector/emis_state_home'?>">
                                              <span class="text">All Students</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Collector/emis_state_DEE'?>">
                                              <span class="text">Directorate Of Elementary Education</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Collector/emis_state_DSE'?>">
                                              <span class="text">Directorate Of School Education</span>
                                            </a>
                                          </li>
                                          <li role="presentation" class="next">
                                                                              <a href="<?php echo base_url().'Collector/emis_state_DMS'?>">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Collector/stud_community_report_blk?community_name='.$community_name.'&dist_id='.$dist_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Students Community Details | District -<?php echo ($this->input->get('dist_id')); ?>| community - (<?php echo ($this->input->get('community_name')); ?>)<span> </span></div>
                         ...
                         <?php
                              ...
                              <tr>
                                  <td class="center"><?=$index+1;?></td>
																  <td><a href="<?php echo base_url().'Collector/stud_community_report_schl/?community_name='.$sd->community_name.'&blk='.$sd->block_name?>"><?= $sd->block_name ?></a></td>		
																 <td  class="center"><?= number_format($sd->prekg_t) ?></td>
                                  <td  class="center"><?= number_format($sd->lkg_t) ?></td>
                                  <td  class="center"><?= number_format($sd->ukg_t) ?></td>
                                  <td  class="center"><?= number_format($sd->c1) ?></td> 
                                  <td  class="center"><?= number_format($sd->c2) ?></td>
                                  <td  class="center"><?= number_format($sd->c3) ?></td> 
                                  <td  class="center"><?= number_format($sd->c4) ?></td>
                                  <td  class="center"><?= number_format($sd->c5) ?></td>
                                  <td  class="center"><?= number_format($sd->c6) ?></td> 
                                  <td  class="center"><?= number_format($sd->c7) ?></td>
                                  <td  class="center"><?= number_format($sd->c8) ?></td> 
                                  <td  class="center"><?= number_format($sd->c9) ?></td> 
                                  <td  class="center"><?= number_format($sd->c10) ?></td> 
                                  <td  class="center"><?= number_format($sd->c11) ?></td>
                                  <td  class="center"><?= number_format($sd->c12) ?></td>
                                  <td  class="center"><?= number_format($sd->total)?></td>											
                              </tr>
                                    <?php  
...
$('#test').modal('show');
  ...
  $("#emis_state_report_schcate").change(function(){ 
    ...
    var emis_state_report_schcate = $("#emis_state_report_schcate").val();
      ...
      $.ajax({
        type: "POST",
        url:baseurl+'Collector/get_school_management_data',
...
column.selector.opts.page='current';
            ...
            function saveclassid(value){
                ...
                $.ajax({
                type: "POST",
                url:baseurl+'Collector/savedash_classidsession',
                data:"&class_id="+value,
                success: function(resp){ 
                if(resp==true){  
                window.location.href = baseurl+'Collector/emis_dash_district_count'; 
                return true;  
                 }else{
                    return false;
                 }
...
if(manage == 0 ){
  ...
  $.ajax({
        type: "POST",
        url:baseurl+'Collector/savereport_schoolcatemanage',
