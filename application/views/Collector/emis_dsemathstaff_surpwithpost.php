                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														    ...
														    // $scitot =0;
														     ...
														     $martot =0;
															 $pendtot=0;									
														   if(!empty($dsemathstaff_surpwithpost)){ $total1 = 0; foreach($dsemathstaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td class="details-control">
																  	 <a href="<?php echo base_url().'Collector/emis_dsegovsurplus_mathsstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_mat?>">
															...
															<!--	<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->surp_w_mat - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td>-->
