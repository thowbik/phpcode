                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Botany Teacher Surplus PersonFixation<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" "> Surplus Botany Teachers</th>
																	
																	<!--<th class=" ">Marked</th>
																	  <th class=" ">Pending</th>   -->                                                                                         </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php
                                                             //$aadharincount =0;
														    ...
														    $martot =0;
															 $pendtot=0;									
														   if(!empty($dsebotanstaff_surpwithpost)){ $total1 = 0; foreach($dsebotanstaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Collector/emis_dsegovsurplus_botanystaff_school?schoolid='.$sd->school_id,'&sur='.$sd->swp_6 ?>">
                                                                 ...
                                                                 <td class="center"><?php echo $sd->swp_6;?><?php $sgtot=$sgtot+$sd->swp_6;?></td>
														<!--	<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->swp_6 - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td>-->
