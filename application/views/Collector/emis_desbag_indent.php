                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="row">
                                       ...
                                       <form action="<?=base_url().'Collector/emis_desbag_indent'?>" method="post">
                        ...
                        <div class="panel panel-default panel-faq">
                            ...
                            <div id="faq-cat-1-sub-2" class="panel-collapse panel-collapse collapse in" aria-expanded="true" style>
							  ...
							  <?php  if(!empty($uf->block_name)) {?>
							           ...
							           <td style="text-align:left;"><a href="<?php echo base_url().'Collector/emis_desbag_indent/?block_id='.$uf->scheme_category.$uf->scheme_id.$uf->block_id?>"><?php } else {?>
									   <td style="text-align:left;"><a href="<?php echo base_url().'Collector/emis_desbag_indent/?block_id='.'0'.$uf->scheme_id.$uf->block_id?>"><?php }?>
