                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" ">Surplus Tamil<br>Teacher</th>
																	<!--<th class=" ">Marked</th>
																	 <th class=" ">Pending</th> -->
														   ...
														   if(!empty($tamilstaff_surpwithpost)){ $total1 = 0; foreach($tamilstaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																  ...
																  <a href="<?php echo base_url().'Collector/emis_deegovsurplus_tamilstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_tam ?>">
																...
																<td class="center"><?php echo $sd->surp_w_tam;?><?php $tamtot=$tamtot+$sd->surp_w_tam;?> </td>
																	
																	 
																	<!-- <td><?php echo $sd->surplus;?> <?php $martot=$martot+$sd->surplus;?></td>
											<td><?php $ss =$sd->surp_w_tam - $sd->surplus;?><?php echo $ss;?>
