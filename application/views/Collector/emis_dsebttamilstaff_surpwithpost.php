                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														    ...
														    $scitot =0;
															 $martot =0;
															 $pendtot=0;									
														   if(!empty($dsebttamtaff_surpwithpost)){  foreach($dsebttamtaff_surpwithpost as $index=> $sd){   ?>
																...
																<a href="<?php echo base_url().'Collector/emis_dsegovsurplus_bttamilstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_tam ?>">
																   ...
																   <?=$sd->school_name;?>
																	...
																	<td><?php echo $sd->surp_w_tam;?><?php $scitot=$scitot+$sd->surp_w_tam;?> </td>
																		<!--<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->surp_w_tam - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td>-->
