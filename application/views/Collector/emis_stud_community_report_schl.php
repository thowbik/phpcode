                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Collector/stud_community_report_schl?community_name='.$community_name.'&blk='.$blk?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Students Community Details | Block -<?php echo ($this->input->get('blk')); ?> | community - (<?php echo ($this->input->get('community_name')); ?>)<span> </span></div>
