                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Middle HM Surplus PersonFixation<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   $toteligible =0;									
														   if(!empty($middlestaff_surpwithpost)){ $total1 = 0; foreach($middlestaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																  ...
																  <a href="<?php echo base_url().'Collector/emis_deegovsurplus_middlestaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_mhm ?>">
                                                                 ...
                                                                 <td><?php echo $sd->surp_w_mhm;?><?php $sgtot=$sgtot+$sd->surp_w_mhm;?></td>
																 <!-- <td><?php echo $sd->surplus;?> </td>
																	<td><?php $ss =$sd->surp_w_mhm - $sd->surplus;?><?php echo $ss;?> </td>-->
