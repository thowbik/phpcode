                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     <div class="portlet light">
                                            <form action="<?php echo base_url()?>Collector/get_edu_district_strick_report" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            ...
                                                            <?php if(!empty($teacher_strick)){ $total1 = 0; foreach($teacher_strick as $index=> $det){   ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> <a href="<?php echo base_url().'Collector/get_block_strick_report?edu_dist='.$det->edu_dist_name?>">
