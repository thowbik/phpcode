                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>HM(Primary) School Wise<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" "> HM(Primary) <br>Teacher</th>
														   ...
														   if(!empty($emis_deeprihmstaff_promotion)){ $total1 = 0; foreach($emis_deeprihmstaff_promotion as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <a href="<?php echo base_url().'Collector/emis_deehsprischoolstaff_promotionpost?schoolid='.$sd->school_key_id ?>">
                                                                 ...
                                                                 <td class ="center"><?php echo $sd->teacher;?><?php $sgtot=$sgtot+$sd->teacher;?></td>
