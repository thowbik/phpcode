                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Microbiology Teacher Surplus PersonFixation<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" "> Surplus Microbiology <br>Teachers</th>
														    ...
														    $martot =0;
															 $pendtot=0;									
														   if(!empty($dsemicrobiostaff_surpwithpost)){ $total1 = 0; foreach($dsemicrobiostaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Collector/emis_dsegovsurplus_microbiologystaff_school?schoolid='.$sd->school_id,'&sur='.$sd->swp_11 ?>">
                                                                 ...
                                                                 <td class="center"><?php echo $sd->swp_11;?><?php $sgtot=$sgtot+$sd->swp_11;?></td>
															<!--<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->swp_11 - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td>-->
                                                           </tr>
                                                                <?php  }  ?>
