...
<link href="<?php echo base_url().'asset/global/plugins/simple-line-icons/simple-line-icons.min.css';?>" rel="stylesheet" type="text/css" />
                                     ...
                                     <div class="portlet-body">
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>DSESchool Surplus  <?php echo "  Eligible Surplus :(".$sur.')'?> Biochemistry</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
 ...
 <th>Date Of <br>Appointment</th>
                                                            ...
                                                            <?php $i=1;
                                                         if(!empty($dsegovsurplus_biochestaff)){
                                                           // print_r(dsegovsurplus_biochestaff);
															foreach($dsegovsurplus_biochestaff as $sd){
...
function saveleaveperiods()
{
	...
	var dsegovsurplus_sgstaff = <?=json_encode($dsegovsurplus_biochestaff);?>;
