                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                                       ...
                                       <h1>Past Class 12 Student Status
                                          ...
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Collector/dge_2017_18_report_blk'; ?>">
                                              <span class="text">Class 12 Status-(2017-2018)</span>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Collector/dge_2018_19_report_blk'; ?>">
                            ...
                            <div class="page-content">
                              ...
                              <tbody>
                              <?php $total1=[]; ?>
                              <?php if(!empty($student_migration_details)){ $Gov_tot= [];$FA_tot= [];$UA_tot= [];$PA_tot= []; $CG_tot= []; $i=1;foreach($student_migration_details as $key ){ $j=0; $sum=0;  ?>
                                  <tr>
                                      <td style="text-align: center;"><?php echo($i++); ?></td>
                                      <td><?php echo($key->school_name); ?></td>
                                       <td><?php echo($key->udise_code); ?></td>
                                        <td><?php echo($key->school_type); ?></td>
                                      <td><?php echo $key->std_cnt;?></td>
                                      <td><?php echo $key->assigned;?></td>
                                 </tr>  
