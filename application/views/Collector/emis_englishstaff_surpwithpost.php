                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class=" ">School Name</th>
																	   ...
																	   <th class=" ">Surplus English<br>Teacher</th>
																	   <!-- <th class=" ">Marked</th>
																	 <th class=" ">Pending</th>-->
														   ...
														   if(!empty($englishstaff_surpwithpost)){ $total1 = 0; foreach($englishstaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <a href="<?php echo base_url().'Collector/emis_deegovsurplus_englishstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_eng ?>">
																   ...
																   <?=$sd->school_name;?>
																    <input type="hidden" id="school_id<?=$index?>" value="<?=$sd->school_id;?>"></a>
																		...
																		<td class ="center"><?php echo $sd->surp_w_eng;?> <?php $engtot=$engtot+$sd->surp_w_eng;?></td>
																	<!--<td><?php echo $sd->surplus;?> <?php $martot=$martot+$sd->surplus;?></td>
											<td><?php $ss =$sd->surp_w_eng - $sd->surplus;?><?php echo $ss;?>
                                              <?php $pendtot=$pendtot+$ss;?></td> -->
                                                         ...
                                                         <tfoot>
															...
															<!--	<th class="center"><?php echo $martot?></th>
                                                                <th class="center"><?php echo $pendtot?></th> -->
                                                            </tfoot>
                                                            <?php } ?>
                                                        </table>
