                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Biology Surplus PersonFixation<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" ">Surplus Biology Teachers</th>
														    ...
														    $martot =0;
															 $pendtot=0;									
														   if(!empty($dsebiostaff_surpwithpost)){ $total1 = 0; foreach($dsebiostaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Collector/emis_dsegovsurplus_biostaff_school?schoolid='.$sd->school_id,'&sur='.$sd->swp_5 ?>">
                                                                 ...
                                                                 <td class="center"><?php echo $sd->swp_5;?><?php $sgtot=$sgtot+$sd->swp_5;?></td>
																<!--<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->swp_5 - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td> -->
