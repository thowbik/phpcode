...
function comp(nameid) {
  ...
  $('.cards').addClass('hidden');
	  ...
	  $("#stat1").html('<a href="<?php echo base_url().'Collector/emis_teacher_surplus_sg'; ?>"> <h4>SG Teachers</h4> <span><?php echo $teachertype_total[0]-> SG;?></span></a>');
	  
	  // $("#stat2").html('<a href="<?php echo base_url().'Collector/emis_teacher_surplus_bt'; ?>"> <h4>BT Teachers</h4> <span><?php echo $teachertype_total[0]->BT;?></span></a>');
	  // var name = "asdasd";
	  $("#stat2").html('<a href="javascript:void(0)" onclick="com()" > <h4>BT Teachers</h4> <span><?php echo $teachertype_total[0]->BT;?></span></a>');
	  
	  $("#stat3").html('<a href="<?php echo base_url().'Collector/emis_teacher_surplus_pg'; ?>"> <h4>PG Teachers</h4> <span><?php echo $teachertype_total[0]->PG;?></span></a>');
	  $("#stat4").html('<a href="<?php echo base_url().'Collector/emis_teacher_surplus_highhm'; ?>"> <h4>High School HM</h4> <span><?php echo $teachertype_total[0]-> high_hm;?></span></a>');
	   $("#stat5").html('<a href="<?php echo base_url().'Collector/emis_teacher_surplus_hrshm'; ?>"> <h4>Hrsc School HM</h4> <span><?php echo $teachertype_total[0]-> hrs_hm;?></span></a>');
...
function com() {
  ...
  $('.card2').addClass('hidden');
	  ...
	  $("#st1").html('<a href="<?php echo base_url().'Collector/tamil_teacher_surplus_report'; ?>"> <h4>Tamil Teachers</h4> <span><?php echo $bt_sub_teacher_total[0]-> tamil;?></span></a>');
	  
	   $("#st2").html('<a href="<?php echo base_url().'Collector/english_teacher_surplus_report'; ?>"> <h4>Engligh Teachers</h4> <span><?php echo $bt_sub_teacher_total[0]->english;?></span></a>');
	  //$("#stat2").html('<a href="javascript:void(0)" onclick="comp()"> <h4>BT Teachers</h4> <span><?php echo $teachertype_total[0]->BT;?></span></a>');
	  
	  $("#st3").html('<a href="<?php echo base_url().'Collector/maths_teacher_surplus_report'; ?>"> <h4>Maths Teachers</h4> <span><?php echo $bt_sub_teacher_total[0]->maths;?></span></a>');
	  $("#st4").html('<a href="<?php echo base_url().'Collector/sc_teacher_surplus_report'; ?>"> <h4>Science Teachers</h4> <span><?php echo $bt_sub_teacher_total[0]-> sc;?></span></a>');
	   $("#st5").html('<a href="<?php echo base_url().'Collector/ssc_teacher_surplus_report'; ?>"> <h4>SocialScience<br> Teachers</h4> <span><?php echo $bt_sub_teacher_total[0]-> ss;?></span></a>');
