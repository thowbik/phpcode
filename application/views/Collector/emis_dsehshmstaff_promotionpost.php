                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>HM(HS) School Wise<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   if(!empty($dsehshmstaff_promotionpost)){ $total1 = 0; foreach($dsehshmstaff_promotionpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <a href="<?php echo base_url().'Collector/emis_dsehsschoolstaff_promotionpost?schoolid='.$sd->school_key_id ?>">
