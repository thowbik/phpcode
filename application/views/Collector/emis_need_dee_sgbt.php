                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title col-md-12">
                                                        <div class="caption col-md-4">
                                                            <i class="fa fa-globe"></i>DEE Need</div>
                            ...
                            <th style="text-align: center;">SG</th>
                              ...
                              <?php if(!empty($need_deereportsgbt)){  $i=1; $need_sg=[]; $sciense=[]; $maths=[];
                                $english=[]; $tamil=[]; $social=[]; $phm=[]; $mhm=[]; $telugu=[]; $kannadam=[]; $malayalam=[]; $urudu=[];
                                foreach($need_deereportsgbt as $needdse){ 
								?>
								<tr>
							  ...
							  <td> <?php echo $needdse->phm; ?></td>
							 <td> <?php echo $needdse->mhm; ?></td>
