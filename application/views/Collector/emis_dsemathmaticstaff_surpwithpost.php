                                                  ...
                                                  <div class="portlet box green">
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														    ...
														    $martot =0;
															 $pendtot=0;									
														   if(!empty($dsemathstaff)){ $total1 = 0; foreach($dsemathstaff as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Collector/emis_dsegovsurplus_mathematicsstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->swp_16 ?>">
                                                                 ...
                                                                 <td class="center"><?php echo $sd->swp_16;?><?php $sgtot=$sgtot+$sd->swp_16;?></td>
															<!--	<td class="center"><?php echo $sd->surplus;?>  <?php $martot=$martot+$sd->surplus;?></td>
																	<td class="center"><?php $ss =$sd->swp_16 - $sd->surplus;?><?php echo $ss;?><?php $pendtot=$pendtot+$ss;?> </td>-->
