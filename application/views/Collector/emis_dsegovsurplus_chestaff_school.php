...
<link href="<?php echo base_url().'asset/global/plugins/simple-line-icons/simple-line-icons.min.css';?>" rel="stylesheet" type="text/css" />
                                     ...
                                     <div class="portlet-body">
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>DSESchool Surplus <?php echo "  Eligible Surplus :(".$sur.')'?>  Chemistry</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
 ...
 <th>Date Of <br>Appointment</th>
                                                            ...
                                                            <?php $i=1;
                                                         if(!empty($dsegovsurplus_chestaff)){
                                                           // print_r(dsegovsurplus_sgstaff);
															foreach($dsegovsurplus_chestaff as $sd){
...
function saveleaveperiods()
{
	...
	var dsegovsurplus_staff = <?=json_encode($dsegovsurplus_chestaff);?>;
	
		school_verification = new Array();
			var sur_count = 0;
		for(var i =1;i<=dsegovsurplus_staff.length;i++)
		{
