                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                        ...
                                        <div class="row margin-bottom-20">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<!-- <th class=" ">SG Teachers</th>-->
																	 <th class=" ">Surplus Science Teacher</th>
																	<!--  <th class=" ">Marked</th>
																	 <th class=" ">Pending</th> -->
														   ...
														   if(!empty($sciencestaff_surpwithpost)){ $total1 = 0; foreach($sciencestaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Collector/emis_deegovsurplus_sciencestaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_sci ?>">
											...
											<td><?php $ss =$sd->surp_w_sci - $sd->surplus;?><?php echo $ss;?>
