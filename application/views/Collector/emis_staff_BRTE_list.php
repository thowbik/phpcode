                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>BRTE  Details | District - <?php echo $staff_district_details[0]->district_name; ?><span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                          ...
                                                          <!--  <th style="text-align: center">Block Name</th>-->
                                                            ...
                                                            <th style="text-align: center">Appointed Subject</th>
														   ...
														   $cnt =0;
															...
															{ $total1 = 0; foreach($staff_district_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <!--   <td><?=$sd->block_name;?></a> </td>-->
                                                                    <td class="center"><?=$sd->teacher_code;?></a> </td>
                                                                    <td><?=$sd->teacher_name;?></a> </td>
                                                                    <td><?=$sd->appointed_subject;?></a> </td>
                                                                    <td class="center"><?=$sd->mbl_nmbr;?></a> </td>
