                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> High HM Surplus PersonFixation<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   $toteligible =0;									
														   if(!empty($highstaff_surpwithpost)){ $total1 = 0; foreach($highstaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Collector/emis_deegovsurplus_highstaff_school?schoolid='.$sd->school_id,'&sur='.$sd->surp_w_hhm ?>">
                                                                 ...
                                                                 <td><?php echo $sd->surp_w_hhm;?><?php $sgtot=$sgtot+$sd->surp_w_hhm;?></td>
																<!-- <td><?php $ss =$sd->surp_w_hhm - $sd->surplus;?><?php echo $ss;?> </td> -->
