                                                  ...
                                                  <div class="portlet box green">
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														   ...
														   if(!empty($dsepgstaff_promotionpost)){ $total1 = 0; foreach($dsepgstaff_promotionpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <a href="<?php echo base_url().'Collector/emis_dsepgschoolstaff_promotionpost?schoolid='.$sd->school_key_id ?>">
