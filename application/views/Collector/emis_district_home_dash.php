...
<div class="page-content">
        ...
        <?php echo number_format($total_count_details->student_total);?></h3>
                ...
                <!-- 1 Card End -->
                <a href="<?php echo base_url().'Collector/emis_teacher_classwise_district'; ?>">
                   <div class=" col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <!-- 2 Card End -->
                 <a href="<?php echo base_url().'Collector/emis_state_school'; ?>">
                    <div class=" col-lg-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <?php echo number_format($total_count_details->school_total) ?></h3>
                   ...
                   <a href="<?php echo base_url().'Collector/emis_dist_school_prekg_student_joined'; ?>">
                    <div class=" col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="bs-callout-mediumaquamarine dashboard-stat2">
                            <div class="display">
                                <div class="number">
...
<div class=" row page-content-inner">
                ...
                <div class="panel-body">
                   <div class="row">
                                                    ...
                                                    <div class="col-md-3 space-2px">
                                                            ...
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Collector/dash_renewal';?>"><?php echo number_format($renewal_details[0]['TOTAL']); ?></a></b></small>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Collector/dash_renewal_beo/';?>"> <?php echo number_format($renewal_details[0]['BEO']); ?></a></b></small>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Collector/dash_renewal_deo/';?>"> <?php echo number_format($renewal_details[0]['DE0']); ?></a></b></small>
                                                        </div>
                                                        <div class="col-md-9 space-2px">
                                                            <small>Pending CEO Approval</small>
                                                    </div>
                                                    <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Collector/dash_renewal_ceo/';?>"> <?php echo number_format($renewal_details[0]['CE0']); ?></a></b></small>
                                                        </div>
                                                     ...
                                                     <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Collector/dash_renewal_rejected';?>"></small><?php echo number_format($renewal_details[0]['REJECTED']); ?></a></b></small>
                                                    </div>
    ...
    <!-- 8 Page-->
     <div class="col-lg-3">
            ...
            <div class="panel panel-success">
                <div class="panel-heading mediumaquamarine">
                    <h3 class="panel-title"><i class="fa fa-envelope"></i> Messages &nbsp<span style="margin-top:-5px;background-color:yellow;"class="badge"><?=(!empty($old_flash_message)?sizeof($old_flash_message):'0');?></span> &nbsp;<a href="<?php echo base_url().'Collector/get_flash_news'?>"><i class="fa fa-plus"></i> </a></h3>
                    <span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i> </span>
                </div>
                <div class="panel-body">
                   <div class="row">
