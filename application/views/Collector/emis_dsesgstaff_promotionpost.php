                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>SecondaryGrade Teacher School Wise<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" "> SecondaryGrade <br>Teacher</th>
														   ...
														   if(!empty($dsesgstaff_promotionpost)){ $total1 = 0; foreach($dsesgstaff_promotionpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <a href="<?php echo base_url().'Collector/emis_dsesgschoolstaff_promotionpost?schoolid='.$sd->school_key_id ?>">
																 
																  
																   <?=$sd->school_name;?>
																    <input type="hidden" id="school_id<?=$index?>" value="<?=$sd->school_key_id;?>"></a>
																   </td>
													 
                                                                 <td class ="center"><?php echo $sd->sgteacher;?><?php $sgtot=$sgtot+$sd->sgteacher;?></td>
