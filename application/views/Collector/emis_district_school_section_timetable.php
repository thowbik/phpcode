                                                              ...
                                                              <?php if(!empty($school_class_section_timetable)){ $total1 = 0; $i=1; foreach($school_class_section_timetable as $index=> $sd){ ?>
                                                                ...
                                                                <tr>
                                                                   <td  style="text-align: center;"><?php echo $i++;?></td>
                                                                    <td style="text-align: center;"><!-- <a href="<?php echo base_url().'Collector/school_period_count_timetable?classsection='.$sd->class?>&schoolid=<?php echo $schoolid?>">--><?=$sd->class;?></td>
