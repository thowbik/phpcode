                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                              ...
                              <?php
                                  ...
                                  foreach($title as $t){
                              ?>                      
                              <th style="text-align: center;"><?php if ($t['transfer_reason']!='dropped_out' || $t['transfer_reason']!='duplicate_entry'){ echo($t['transfer_reason']); ?></th>
                            <?php array_push($check,$t['transfer_reason'] ); } } ?>
                              <th>Total</th>
                              ...
                              <?php if(!empty($student_migration_details)){ $Gov_tot= [];$FA_tot= [];$UA_tot= [];$PA_tot= []; $CG_tot= []; $i=1;foreach($student_migration_details as $key => $value){ $j=0; $sum=0;  ?>
                                  <tr>
                                      <td><?php echo($i++); ?></td>
                                      <td><a href="<?php echo base_url().'Ceo_District/get_school_migration_reason/?block_id='.$key?>"><?php echo($key); ?></a></td>
                                      <?php 
                                          foreach($check as $c){ $cc=0;
                                                foreach($value as $v){
                                                    if($v['transfer_reason']==$c){
                                                        $total1[$j++]+=$v['cnt'];
