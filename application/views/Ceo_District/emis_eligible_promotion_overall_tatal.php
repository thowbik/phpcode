            ...
            <div class="col-xs-6 col-sm-4 col-md-2">
              ...
              <a  href="javascript:void(0)" onclick="comp('surpwith')">
               <span class="bottom" style="font-size: 20px;">Total </br>Teachers </span>
                        ...
                        <?php echo number_format($eligiblepromotiontot[0]->pgteacher + $eligiblepromotiontot[0]->sgteacher + $eligiblepromotiontot[0]->btteacher +$eligiblepromotiontot[0]-> hshm+$eligiblepromotiontot[0]-> hsshm); ?></h3>
              </a>
            </div>
            </div>
...
function comp(nameid) {
  ...
  $('.cards').addClass('hidden');
	  ...
	  $("#stat1").html('<a href="<?php echo base_url().'Ceo_District/emis_dsesgstaff_promotionpost'; ?>"> <h4>SecondaryGrade Teacher</h4> <span><?php echo $eligiblepromotiontot[0]-> sgteacher;?></span></a>');
	  $("#stat2").html('<a href="<?php echo base_url().'Ceo_District/emis_dsebtstaff_promotionpost'; ?>"> <h4>BT Teacher</h4> <span><?php echo $eligiblepromotiontot[0]-> btteacher;?></span></a>');
	  $("#stat3").html('<a href="<?php echo base_url().'Ceo_District/emis_dsepgstaff_promotionpost'; ?>"> <h4>PG Teacher</h4> <span><?php echo $eligiblepromotiontot[0]-> pgteacher;?></span></a>');
	  $("#stat4").html('<a href="<?php echo base_url().'Ceo_District/emis_dsehshmstaff_promotionpost'; ?>"> <h4>HM(HS)</h4> <span><?php echo $eligiblepromotiontot[0]-> hshm;?></span></a>');
	  $("#stat5").html('<a href="<?php echo base_url().'Ceo_District/emis_dsehsshmstaff_promotionpost'; ?>"> <h4>HM(HSS)</h4> <span><?php echo $eligiblepromotiontot[0]-> hsshm;?></span></a>');
