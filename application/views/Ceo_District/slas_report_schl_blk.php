                                       ...
                                       <!-- <div class="row margin-bottom-20">
                                             <div class="portlet-body">
                                                <div class="row" style="margin-left: 6px;">
                                                      ...
                                                      <form  action="<?php echo base_url().'Ceo_District/slas_report_blk/?dist_id='.$dist_id?>" method="POST" >
                                                        <div class="row">
                                                        <div class="col-md-4">
                               ...
                               $j=0; $sum=0; $assigned_sum=0; $not_marked=0;//print_r($value); die();
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="<?php echo base_url().'Ceo_District/slas_report_schl_wise/?blk_id='.$key->block_id.'&catty_id='.$key->catty_id.'&manage_id='.$key->manage_id?>"> <?php echo($key->block_name); ?></a></td>
