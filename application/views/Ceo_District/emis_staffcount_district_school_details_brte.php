                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>DEE Staffs Transfer Request<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class=" ">Name of the School</th>
														   ...
														   if(!empty($emis_staffcount_district_school)){ $total1 = 0; foreach($emis_staffcount_district_school as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																  ...
																  <a href="<?php echo base_url().'Ceo_District/emis_govstaff_school_details_brte?schoolid='.$sd->school_id?>">
																															                                        <?=$sd->school_name;?></a>
