                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url()?>Ceo_District/schoolwise_class_question_report_dist" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                              ...
                              <?php if(!empty($student_migration_details)){ $Gov_tot= [];$FA_tot= [];$UA_tot= [];$PA_tot= []; $sum1= []; $assigned_sum1=[]; $not_marked1=[]; $i=1;foreach($student_migration_details as $key => $value){ $j=0; $sum=0; $assigned_sum=0; $not_marked=0;//print_r($value); die();
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="<?php echo base_url().'Ceo_District/schoolwise_class_question_report_blk/?district_id='.$key?>"><?php echo($key); ?></td>
                                      ...
                                      <td class="center">
                                                                                <?php 
                                                                                    ...
                                                                                    $marked_school = round(($assigned_sum/$not_marked)*100);
