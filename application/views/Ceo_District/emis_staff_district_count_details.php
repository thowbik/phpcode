                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>District Name</th>
																	 ...
																	 <th class="sum "> Non Teaching Staffs</th>
																	<th>Total Staff</th>
														   ...
														   $totstaffs =0;
															...
															if(!empty($staff_district_details))
															{ $total1 = 0; foreach($staff_district_details as $index=> $sd){   ?>
                                                              
                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td>
																	 <a href="<?php echo base_url().'Ceo_District/emis_staff_district_school_count_details?districtid='.$sd->district_id?>">
																	<?=$sd->district_name;?></a> </td>
																	  <td><?=$sd->staff;?>
																	   <?php $stafftot=$stafftot+$sd->staff;?>
																  </td>
                                                                   <td><?=$sd->nonstaff;?>
																    ...
																    <td><?=$sd->totstaff;?>
																    <?php $totstaffs=$totstaffs+$sd->totstaff;?>
																  </td>
