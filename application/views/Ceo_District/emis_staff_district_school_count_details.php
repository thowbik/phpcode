                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Staffs Details<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th>Teaching Staffs</th>
																	 <th class=" "> Non Teaching Staffs</th>
																	  <th class=" ">Total Staffs</th>
														   ...
														   $nonstafftot =0;
														   $totstaffs =0;									
														   if(!empty($staff_district_school_details)){ $total1 = 0; foreach($staff_district_school_details as $index=> $sd){   ?>
                                                         ...
                                                         <tfoot>
                                                                ...
                                                                <th class="center"></th>
																 ...
																 <th ><?php echo $stafftot?></th>
                                                               <th ><?php echo $nonstafftot?></th>
															    <th ><?php echo $totstaffs?></th>
                                                            </tfoot>
                                                            <?php } ?>
                                                        </table>
   ...
   // var Otable = sum_dataTable("#sample_4");
    ...
    var  thead= '',tbody='';
       ...
       $.ajax({
           ...
           url: '<?=base_url()."Ceo_District/emis_district_staff_data"?>',
           ...
           success: function (response) {
            console.log(response);
               ...
               // var data = JSON.parse(response.responseText);
                   ...
                   thead += '<td><b>Join Date</b></td>';
                   thead += '<td><b>Professional</b></td>';
                   thead += '<td><b>UG Degree</b></td>';
				   thead += '<td><b>PG Degree</b></td>';
                   thead += '<td><b>MobileNumber</b></td>';
                   thead += '<td><b>Type Teacher</b></td>';
                   thead += '<td><b>Appointed Subject </b></td>';
                ...
                tbody +='<tbody><tr>';
                tbody +='<td>'+i+'</td><td>'+d.teacher_name+'</td><td>'+(d.gender==1?'Male':'Female')+'</td><td>'+d.staff_join+'</td><td>'+d.professional+'</td><td>'+(d.ug_degree !=null ?d.ug_degree :'-')+'</td><td>'+(d.pg_degree!=null ?d.pg_degree :'-')+'</td><td>'+d.mbl_nmbr+'</td><td>'+d.type_teacher+'</td><td>'+d.subjects+'</td><td>'+(d.category==1?'Teaching Staff':'Non Teaching Staff')+'</td>';
                tbody +='</tr></tbody>';
