                                    ...
                                    <div class="page-title">
                                        <h1>RTE-Student Report
                                          ...
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                            ...
                                            <a href="<?php echo base_url().'Ceo_District/get_RTE_school'?>">
                                              <span class="text">RTE Student Report</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Ceo_District/get_RTE_school_2019'?>">
                              ...
                              <!--      <div class="portlet light portlet-fit ">
                                        ...
                                        <!-- BEGIN CARDS -->
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>RTE-Student Report-2019</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Name </th> 
                                                                     <th>class</th>
                                                                     <th>RTE Type</th>
                                                                     <th>RTE Allocation</th>
                                                                      <th>Update</th>
                                                                </tr>
                                                                </thead>
                                                               
                                                                 
                                             <?php $total1 = []; if(!empty($allstuds)){ $pre_kg_tot= [];$ukg_tot= [];$lkg_tot= []; $c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1; $a=1;$total1 = []; foreach($allstuds as $det){ 
                                             ...
                                             ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?=$det->unique_id_no;?>
                                                                       <input type="hidden" value="<?=$det->unique_id_no;?>" id="unique_id_no<?=$i+1;?>">
                                                                    </td>
                                                                    <td><?=$det->name;?>
                                                                    ...
                                                                    <td style="text-align: center;"><?php 
                                                                      ...
                                                                      if($det->class_studying_id==15)
                                                                        {
                                                                            echo "PreKG";
                                                                        }
                                                                        else if($det->class_studying_id==13)
                                                                        {
                                                                            echo "LKG";
                                                                        }
                                                                        else if($det->class_studying_id==14)
                                                                        {
                                                                            echo "UKG";
                                                                        }
                                                                        else{
                                                                            echo $det->class_studying_id;
                                                                        }
                                                                        ?></td>
                                                                        <td><?=$det->rte_type;?></td>
                                                                    <td class=""><?php if ($det->child_admitted_under_reservation='YES'){
                                                                          echo "Yes";
                                                                        }else if($det->child_admitted_under_reservation='No'){
                                                                          echo "No";
                                                                        }else{}?></td>
    ...
    function cls_validation()
{
    ...
    var tempIndx = -1;
    var rowIdx = -1;
    var RTE_lists = <?=json_encode($allstuds);?>;
    var rte_list = '';
     ...
     $("#sample_2").on('click','.editdata',function()
    {
        ...
        rowIdx = $(this).closest('tr').index();
          ...
          {
            var class_st = '';
            if(rte_list.child_admitted_under_reservation='yes')
            {
                class_st='YES';
            }else if(rte_list.child_admitted_under_reservation="No")
            {
                class_st='No';
            }else
            {
          ...
          $("#sample_2").find('tbody tr:eq('+tempIndx+')').find('td:eq(6)').html(save_data);
          $("#sample_2").find('tbody tr:eq('+tempIndx+')').find('td:eq(5)').text(class_st);

          }
   
          var save_data = '<span onclick="update_data(rowIdx);"><i class="fa fa-save" style="color:green;"></span>';
          $("#sample_2").find('tbody tr:eq('+rowIdx+')').find('td:eq(6)').html(save_data);

          var child_admitted_under_reservation = "<input type='radio' name='child_admitted_under_reservation' value='Yes'>YES<br/><input type='radio' name='child_admitted_under_reservation' value='No'>NO";
          $("#sample_2").find('tbody tr:eq('+rowIdx+')').find('td:eq(5)').html(child_admitted_under_reservation);

          var child_admitted_under_reservation = $('input:radio[name="child_admitted_under_reservation"]').filter('[value="'+rte_list.child_admitted_under_reservation+'"]').attr('checked', true);
...
<script type="text/javascript">
    ...
    {
         var child_admitted_under_reservation = $("input[name='child_admitted_under_reservation']:checked").val();
      ...
      if(child_admitted_under_reservation !=''){
              swal({
        ...
        function(){
          ...
          var datas = {'id':id,'child_admitted_under_reservation':child_admitted_under_reservation,'unique_id_no':unique_id_no};
          $.ajax(
          {
            method:'POST',
            dataType:'JSON',
            url:'<?=base_url().$link.'/save_RTE_student_list'?>',
            data:datas,
            success:function(res)
            {
              ...
              if(res)
              {
                swal({  
                  ...
                  swal('success','successfully Saved RTE student allocation','success');
