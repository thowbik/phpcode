                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                                <div></div> 
                                <div class="container">
								<form id="filter" method="post" action="<?php echo base_url().'Ceo_District/profile_status_blockwise';?>">
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Blocktwise - Profile Completion Status<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
															 ...
															 <th></th>
															  <th></th>
                                                               ...
                                                               <tbody>
															    <?php $total1=[];?>
                                                            <?php 
															if(!empty($district_profile_completion_status))
															{
															  $totalschool=[];	
															  $f1notsave= [];
															  $f1save= [];
														...
														foreach($district_profile_completion_status as $index=> $comp_status){   ?>
                                                              
                                                                <tr>
                                                                    <td ><?=$index+1;?></td>
                                                                   <td style="text-align: left;"><a href="<?=base_url().'Ceo_District/profile_status_schoolkwise?block='.$comp_status->block_id.'&school_type='.$school_type_c?>"><?=$comp_status->block_name?></a>

                                                                    </td>
																	 <td class="center"><?=number_format($comp_status->total_school);?></td>
                                                                ...
                                                                <?php 
                              array_push($totalschool,$comp_status->total_school);
							 ...
							 array_push($f8finalsubmit,$comp_status->f8finalsubmit);									 
                                                          ...
                                                          <tr>
                                                            ...
                                                            $totalschool = array_sum($totalschool);
                                                            array_push($total1,$totalschool);
                                                            echo number_format($totalschool);?></th>
