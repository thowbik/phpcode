...
<?php $this->load->view('Ceo_District/header.php'); ?>
		  ...
		  <div class="panel panel-success">
                ...
                <!-- <div class="row">
                 ...
                 <div class="col-md-6" style="border-right: 2px solid #abe7ed;height: 30px;">  <div class="col-md-12">
                    <div class="col-md-6">
                        <span style="margin-right: 15px;"><input type="checkbox" name=" profile_count[]" class="check" value="1">Same School</span>
                 </div>
                <!-- <div class="col-md-6">
                    <span style="margin-right: 15px;"><input type="checkbox" name=" profile_count[]" class="check" value="2">Municipal School</span>
                 </div>-->
                 ...
                 <!-- <span style="margin-right: 0px; display: block; "><input type="checkbox" name=" profile_count[]" class="checkbox"  value="4">District To District</span> -->
                  ...
                  <div class="row">
                  <div class="col-md-4"> 
                       <label class="control-label">Name of the BRTE</label>
 ...
 <input type="hidden" class="form-control" id="revenue_block_id" name="revenue_block_id" placeholder="" required >   						   
                  ...
                  <div class="col-md-4"> 
                       <label class="control-label">Date of appoinment</label>
                       <div class="form-group">                     
                  ...
                  <div class="col-md-4"> 
                       <label class="control-label">Date of joining in the present place</label>
                       <div class="form-group">                     
                           <input type="text" class="form-control" id="school_office" name="school_office" placeholder="" required readonly>                      
                       </div>                        
                  </div> 
                  <div class="col-md-4"> 
                       <label class="control-label">Nature of joining in the present place</label>
                       <div class="form-group">
                  ...
                  <div class="col-md-4"> 
                       <label class="control-label">Name and address of the present place</label>
                       <div class="form-group">                     
                ...
                <div class="col-md-4" id ="dissch"> 
                       <label class="control-label">Details of the district which transfer is requested</label>
                       <div class="form-group"> 
