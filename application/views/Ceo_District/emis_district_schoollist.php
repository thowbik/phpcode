                                                            ...
                                                            <thead>
                                                                <tr>
																   <td>S.No</td>
                                                                    ...
                                                                    <th>School Name</th>
                                                                    <th>Minority</th>
                                                                    <th style="width:10%;">School Mail</th>
																	<th>School Type</th>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-6" >
                                                   <label class="control-label">Name of Cluster Resource Centre (CRC) *</label>
                                                    <div class="form-group">
                                                          <div class="">
                                                            <select  class="form-control" data-placeholder="Choose a Category" tabindex="1" id="cluster" name="cluster"  required>
                                                               <option value="">Choose</option>
										   ...
										   <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                   <label class="control-label">Name of City (where applicable) *</label>
                                                    <div class="form-group">
                                                        <div class="">
                                                              <select  class="form-control" data-placeholder="Choose a Category" tabindex="1" id="city" name="city"  required="">
												...
												<div class="row">
												 <div class="col-md-6">
                                                   <label class="control-label">Year Of Last Renewal *</label>
                                                    <div class="form-group">
														<select  class="form-control" data-placeholder="Choose a Category" tabindex="1" id="emis_reg_sch_renewal" name="emis_reg_sch_renewal">
                                                               <option value="">Choose</option>
															   <?php 
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                   <label class="control-label">Primary</label>
                                                    <div class="form-group">
                                                        <div class="">
                                                            <select  class="form-control" data-placeholder="Choose a Category" tabindex="1" id="primary" name="primary" onchange="upprimyear(this.value)" >
                                                ...
                                                <div class="col-md-6">
                                                   <label class="control-label">Higher Secondary</label>
                                                    <div class="form-group">
                                                        <div class="">
                                                            <select  class="form-control" data-placeholder="Choose a Category" tabindex="1" id="highersecondary" name="highersecondary">
                                                               <option value="">Choose</option>
															   <?php 
                                                                for($i = 1950 ; $i <= date('Y'); $i++){ ?>
                                                        ...
                                                        <div class="">
                                                           <textarea type="text" class="form-control" id="ceo_comments" name="ceo_comments" 
                                                            placeholder="comments" required></textarea>
                                                             ...
                                                             <font style="color:#dd4b39;"><div id="ceo_comments_alert"></div></font>
                                                             
                                                        </div>
                                                    </div>
                                                </div>
												<div class="col-md-6">
                                                   <label class="control-label">State Comments</label>
                                                    <div class="form-group">
                                                        <div class="">
        ...
        <script type="text/javascript">
		  ...
		  function recognizationyear(year)
		  {
			  //alert(year);
			   ...
			   var recognization_drop = '<select class="form-control" data-placeholder="Choose a Category" id="recognization" name="recognization" >';
		   ...
		   function upprimyear(year)
		   {
			    $(".upperprimary").empty();
			   var currentYear = (new Date()).getFullYear();
			   var upprimyear_drop = '<select class="form-control" data-placeholder="Choose a Category" id="upperprimary" name="upperprimary" onchange="secondary(this.value);" >';
		   ...
		   function secondary(year)
		   {
			    $(".secondary").empty();
			   var currentYear = (new Date()).getFullYear();
			   var secondary_drop = '<select class="form-control" data-placeholder="Choose a Category" id="secondary" name="secondary" >';
                    ...
                    success:function(res)
                    {
					 ...
					 //$("#muncipality").val(school_detail.lb_vill_town_muni).attr('selected','selected');
					  ...
					  /************************************/
					   ...
					   var upprimyear_drop = '<select class="form-control" data-placeholder="Choose a Category" id="upperprimary" name="upperprimary"  >';
