                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
														<?php 
														foreach($school_cash_details as $sd)
														{
															
														}
														?>
                                                            <i class="fa fa-globe"></i>Special Cash Incentive Report  - (2019-20)-<?php echo $sd->district_name; ?><span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                               ...
                                                               <tbody>
                                                            <?php if(!empty($school_cash_details)){ 
															foreach($school_cash_details as $index=> $sd){   ?>

                                                                <tr>
                                                                   <td class="center"><?=$index+1;?></td>
                                                                   <td class="center"><?=$sd->udise_code;?></td>
                                                                   <td> <?=$sd->school_name;?></td>
                                                                   <td class="center"><?=$sd->student_count?></td>
                                                                   <td class="center"><?=$sd->student_marked?></td>
																   <td class="center"><?=$noteligible=$sd->student_count-$sd->student_marked?></td>
