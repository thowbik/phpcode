                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <?php $blk_id=$this->input->get('block_id'); ?>
                                            <form action="<?php  echo base_url().'Ceo_District/schoolwise_class_question_report_schl?block_id='.$blk_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                               ...
                                               ?>
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>CCE Entry Monitoring Report(School-Wise)  : TERM-1 </div>
