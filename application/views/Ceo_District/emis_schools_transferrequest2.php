                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <?php if(!empty($details)){ foreach($details as $det){ ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $det->class_section; ?></td>
                                                                    <td><?php echo $det->request_id; ?></td>
                                                                    <td><?php echo $det->request_date; ?></td>
                                                                    <td>
                                        <button onclick="distrrictusertransfer('<?php echo $det->unique_id_no; ?>','<?php echo $schooludise; ?>');"  class="btn green">Transfer</button></td>
                                        <td>
                                        <button onclick="districtuserreject('<?php echo $det->unique_id_no; ?>','<?php echo $schooludise; ?>');"  class="btn red">Reject</button></td>
