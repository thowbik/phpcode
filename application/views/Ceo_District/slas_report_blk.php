        ...
        <br>
                               ...
                               $j=0; $sum=0; $assigned_sum=0; $not_marked=0;//print_r($value); die();
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="<?php echo base_url().'Ceo_District/slas_report_schl/?blk_id='.$key->block_id?>"><?php echo($key->block_name); ?></a></td>
                            ...
                            <tfoot>
                              <tr>
                                  <th>Total</th>
                                  <th></th>
                                  <th  style="text-align: center;"><?php echo $total['val']['tot']; ?></th>
                                  <?php
