                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
														<?php 
														foreach($school_details as $sd)
														{
															
														}
														?>
                                                            <i class="fa fa-globe"></i>Partially Aided School - Section Verification - -<?php echo $sd->district_name; ?><span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Block</th>
                                                                    <th class="sum center">Udise Code</th>
                                                                    <th class="sum ">School Name</th>
																	
                                                                    <th class="sum center">Total Aided Sections</th>
                                                                    <th class="sum center">Total UnAided Sections</th>
																	 <th class="sum center">Total Aided Not Marked</th>
																	 <th class="sum center">Total Medioum Not Marked</th>
                                                                </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php if(!empty($school_details)){ $total1 = 0; foreach($school_details as $index=> $sd){   ?>

                                                                <tr>
                                                                   <td class="center"><?=$index+1;?></td>
                                                                   <td><?php echo $sd->block_name ?></td>
                                                                   <td class="center"><?=$sd->udise_code;?></td>
                                                                   <td> <a href="<?php echo base_url().'Ceo_District/school_class_section?schoolid='.$sd->school_id?>&schoolname=<?php echo $sd->school_name ?>"><?=$sd->school_name;?></a></td>
                                                                   <td class="center"><?=$sd->aided?></td>
                                                                   <td class="center"><?=$sd->self_finance?></td>
																   <td class="center"><?=$sd->unmarked?></td>
																   <td class="center"><?=$sd->unmediummarked?></td>
                                                                </tr>
                                                                <?php  }  ?>
