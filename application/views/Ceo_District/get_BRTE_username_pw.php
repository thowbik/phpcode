...
<?php if($this->session->userdata('emis_user_type_id') == 9 ) 	
{?>
<?php $this->load->view('Ceo_District/header.php'); }else if($this->session->userdata('emis_user_type_id') == 2) { ?>
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>BRTE Login Details<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <?php
                                                            														                                       $i=1;
															if(!empty($brte)){ $total1 = 0; foreach($brte as $all){   ?>
                                                                ...
                                                                <tr>
                                                                  <td><?php echo $i; ?></td>
                                                                   <!--  <td><a onclick="savestudentid1('<?php echo $all->unique_id_no; ?>')"><?php echo $all->unique_id_no; ?></a></td> -->
                                                                    ...
                                                                    <td><?php echo $all->teacher_name; ?>
                                                                          <input type="hidden"value="<?=$all->id;?>">
                                                                    </td>
                                                                    
                                                                    <td><?php echo $all->emis_username; ?></td>
                                                                     <td><?php echo $all->ref; ?></td>
