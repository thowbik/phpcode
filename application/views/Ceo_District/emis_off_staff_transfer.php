...
<?php $this->load->view('Ceo_District/header.php'); ?>
                                    ...
                                    <div class="page-content-inner">
									 ...
									 <td class="center"><?= date('d-m-Y',strtotime($sd->staff_join))?></td>
																 ...
																 <button type="submit" onclick="savevalid(<?= $i ?>);"class="btn btn-primary">Save</button>
																   ...
																   <td><a href="<?=base_url().'Ceo_District/offgenerate_pdf/'.$sd->teacher_code?>"><i class="fa fa-file-pdf-o"></i></a></td>
    ...
    <div class="modal-dialog modal-lg" style="width: 1046px !important;">
      <div class="modal-content">
		  ...
		  <div class="panel panel-success">
               ...
               <!--  <div class="row">
                  <div class="col-md-offset-3 col-md-3" style="border-right: 2px solid #abe7ed;height: 90px;"> 
                  <span style="margin-right: 15px;"><input type="checkbox" name=" profile_count[]" class="check" value="1">Government School</span><br>
                  <span style="margin-right: 15px;"><input type="checkbox" name=" profile_count[]" class="check" value="2">Municipal School</span>                 
                  </div>
                  <div class="col-md-offset-1 col-md-3"> 
                  <span style="margin-right: 0px;"><input type="checkbox" name=" profile_count[]" class="checkbox"  value="1">Within Block</span><br>
                  <span style="margin-right: 0px;"><input type="checkbox" name=" profile_count[]" class="checkbox"  value="2">Within Education District</span><br>
                  <span style="margin-right: 0px;"><input type="checkbox" name=" profile_count[]" class="checkbox"  value="3">Within District</span><br>
                  <span style="margin-right: 0px; display: block; "><input type="checkbox" name=" profile_count[]" class="checkbox"  value="4">State Level</span>
                  </div>
                  </div> -->
                ...
                <!-- <div class="col-md-6" style="border-right: 2px solid #abe7ed;height: 30px;">  <div class="col-md-12">
                    <div class="col-md-6">
                        <span style="margin-right: 15px;"><input type="checkbox" name=" profile_count[]" class="check" value="1">Government School</span>
                 </div>
                 <div class="col-md-6">
                    <span style="margin-right: 15px;"><input type="checkbox" name=" profile_count[]" class="check" value="2">Municipal School</span>
                 </div>
                 ...
                 <div class="col-md-4">
                   <span style="margin-right: 0px;"><input type="checkbox" name=" profile_count[]" class="checkbox"  value="4" style="display: inline-block;">Within Education District</span>
                 </div>
                 <div class="col-md-4">
                   <span style="margin-right: 0px;"><input type="checkbox" name=" profile_count[]" class="checkbox"  value="5" style="display: inline-block;">Eduction District to Education District </span>
                 </div>
				        <div class="col-md-4">
                ...
                <!--  </div> -->
                  ...
                  <div class="col-md-4"> 
                       ...
                       <div class="form-group">                     
                           <input type="text" class="form-control" id="designation" name="designation" placeholder="" required readonly>
						    ...
						    <input type="hidden" class="form-control" id="designation_id" name="designation_id" placeholder="" required>
                  ...
                  <div class="col-md-4"> 
                       ...
                       <div class="form-group">                     
						   ...
						   <input type="hidden" class="form-control" id="education_district_id" name="education_district_id" placeholder="" required>  
 ...
 <input type="hidden" class="form-control" id="revenue_block_id" name="revenue_block_id" placeholder="" required >   						   
                ...
                <!--  <div class="col-md-4"> 
                       <label class="control-label">Details of the school in which transfer is requested</label>
                       <div class="form-group"> 
...
<select style="width: 90%;" class="form-control" data-placeholder="Choose a Category" tabindex="1" id="joining_present_school_name" name="joining_present_school_name"  style="width: 60%" required=""  onchange="getIndex(this.value)" >
				   ...
				   <div class="col-md-4"> 
                       ...
                       <div class="form-group">
                       <select class="form-control"  id="school_medium" name="school_medium" required="" >
                           <option value="">Select Option *</option> 
                  ...
                  <div class="col-md-4" id="Dis" > 
                       ...
                       <input type="text" class="form-control" id="district" name="district" placeholder="" required>
					    ...
					    <input type="hidden" class="form-control" id="district_id" name="district_id" >
						 <input type="hidden" class="form-control" id="school_key_id" name="school_key_id" >
                       ...
                       <select class="form-control"  id="priority_if_claimed" name="priority_if_claimed" required="">
                           <option value="" >Select Option *</option> 
                            <?php foreach($teacher_trans_priority as $res) {   ?>
                                                          <option value="<?php echo $res->id;?>" ><?php echo $res->  description; ?></option>
                                                          <?php  } ?>  
                        </select>  
...
column.selector.opts.page='current';
     ...
     function opentab(id)
    {
	    ...
	    $("#phoneno").val(staffinfo.mbl_nmbr);
		 ...
		 $("#school_key_id").val(staffinfo.school_key_id)
		 ...
		 $("#address_present_school").val(staffinfo.school_name);	
        //,staffinfo.e_prsnt_distrct,staffinfo.e_prsnt_pincode	staffinfo.e_prsnt_doorno,	 
		$("#joining_present_school").val(staffinfo.joining_reason).attr('selected','selected');
		$("#school_medium").val(staffinfo.medium).attr('selected','selected');
		...
		$("#distkg1").val(staffinfo.district_id).attr('selected','selected');
		 $("#joining_present_school_name").val(staffin.school_name).attr('selected','selected');
  ...
  var dist = [];
	...
	var checkedValue = $(this).val();
	 ...
	 dist.push(checkedValue);
        ...
        // var soffice = chnage_date_format($("#school_office").val());
		var soffice  = staffinfo.staff_psjoin;
		//return false;
		// if(soffice >= '2016-06-01')
		// {
			// alert('Not Eligible for Transfer(Date Of Joining Present School After 1-JUNE-2016');
			// //swal("OK", "Not Eligible for Transfer(Date Of Joining Present School After 1-JUNE-2016", "error");
			// return false;
		// }
		...
		var distkg =$("#distkg1").val();
                    ...
                    data = {'trans_stu':trans_stu,'teachername' :teachername ,'Staffdob' :Staffdob ,'subject' :staffinfo.id ,'designation' :designation ,'gender' :gender ,'phoneno' :phoneno ,'edist' : edist,'redist' : redist,'fdjoin' :fdjoin ,'fdregulsr' :fdregulsr ,'soffice' : soffice,'praddress' :praddress ,'jpschool' : jpschool,'pic' :pic,'datereq':datereq,'school_type' :staffinfo.school_type_id,'school_id':staffinfo.school_key_id,'teacher_code':staffinfo.teacher_code,'distkg':distkg,'distemp':distemp,'school_name':school_name ,'chagedistid':chagedistid,'chagedistname':chagedistname,'block':staffinfo.block_id,'transschool_id':staffin.school_id,'dod':dod,'dot':dot,'transedndistrict_id':transedndistrict_id,'transdistrict_id':transdistrict_id,'sschool':dist,'transfer_location':dist_school,'appointed_subject':appointed_subject,'transfer':transfer,'school_medium':school_medium,'school_key_id':school_key_id};
                    ...
                    $.ajax(
                    {
                        method:"POST",
                        dataType:"JSON",
                        url:'<?=base_url()."Ceo_District/staffs_transfers"?>',
                        data:data,
                        success:function(res)
                        {
