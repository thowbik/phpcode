                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
														...
														?>
                                                            <i class="fa fa-globe"></i>Higher Secondary Groups<?php echo $sd->district_name; ?><span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
																	...
																	<th class="sum center">Groups in Hr.Sec</th>
																	<th class="sum center">DGE Groups Assigned</th>
                                                            ...
                                                            <?php if(!empty($school_details)){ $total1 = 0; foreach($school_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td> <a href="<?php echo base_url().'Ceo_District/school_higher_class_section?schoolid='.$sd->school_id?>&schoolname=<?php echo $sd->school_name ?>"><?=$sd->school_name;?></a></td>
																   <td class="center"><?=$sd->twelth?></td>
                                                                   <td class="center"><?=$groups=$sd->nogrouptwelth+$sd->nogroupelevelth?></td>
