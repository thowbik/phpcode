                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>DSE Staffs Transfer Request<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Office Area</th>
                                                                  <!--  <th class=" center">Office Code</th>-->
														   ...
														   if(!empty($offstaff_details)){ $total1 = 0; foreach($offstaff_details as $index=> $sd){   ?>

                                                                <tr>
                                                                    <td class="center"><?=$index+1;?></td>
                                                                    <td><?php echo $sd->office_area; ?></td>
                                                                  <!--  <td class="center"><?=$sd->office_code;?></td>-->
																	<td class="details-control">
																    <a href="<?php echo base_url().'Ceo_District/offstaff_transfer?schoolid='.$sd->school_key_id?>"><?=$sd->office_name;?>
																	<input type="hidden" id="school_id<?=$index?>" value="<?=$sd->school_key_id;?>">
																   </td>
																   <td><?=$sd-> staff ;?>
