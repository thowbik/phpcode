                                    ...
                                    <div class="page-title">
                                        <h1>Dashboard - <label style="color:red;"><?php echo $details[0]->district_name;?></label>
                                          ...
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                            ...
                                            <a href="<?php echo base_url().'Ceo_District/emis_Ceo_District_school'?>">
                                              <span class="text"><b>DSE</b></span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Ceo_District/get_dee_district'?>">
                                              <span class="text"><b>DEE</b></span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Ceo_District/get_dse_district'?>">
                                              <span class="text"><b>DMS</b></span>
                                            </a>
                                          </li>
                                          <li role="presentation" class="next">
                                              <a href="<?php echo base_url().'Ceo_District/get_dms_district'?>">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Ceo_District/emis_Ceo_District_home'?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                            ...
                                                            <?php if(!empty($details)){$prekg_tot= [];$lkg_tot= [];$ukg_tot= [];$c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1; foreach($details as $det){   ?>
                                                                ...
                                                                <tr>
                                                                  <td style="text-align: center;"><?php echo $i;?></td>
                                                                    <td> <a href="<?php echo base_url().'Ceo_District/get_dash_blockwise_school?block='.$det->block_name?>">
