            ...
            <div class="page-wrapper-row full-height">
                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Staffs SurplusPost with Person SocialScience Teacher<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th style ="background-color:#1495f130"  class=" ">DOJ Present Post</th>
                                                           ...
                                                           $i=1;								
														   if(!empty($ssc_teachers)){ $total1 = 0; foreach($ssc_teachers as  $sd){   ?>
								...
								<!--<input type="text" id="tid <?php echo $i;?>" value="<?php echo $sd->teacher_id;?>">
								<input type="text" id="sid <?php echo $i;?>" value="<?php echo $sd->school_key_id;?>">
								<input type="hidden" id="district_id<?=$i?>" value="<?=$sd->district_id;?>">
								<input type="hidden" id="sub_id<?=$i?>" value="<?=$sd->sub_id;?>">
								<input type="hidden" id="block<?=$i?>" value="<?=$sd->block;?>">  -->
																	
																	
																	<?php echo $sd->district_name; ?></td>
																 ...
																 <td><?php echo $sd->subjects?></td>
																  ...
																  <td><?php echo  date('d-m-Y', strtotime($sd->staff_join))?></td>
																	<td style ="background-color:#1495f130" ><?php echo  date('d-m-Y', strtotime($sd->staff_pjoin))?></td>
																	<td ><?php echo  date('d-m-Y', strtotime($sd->staff_psjoin))?></td> 
																	<td style="display:none" ><?php echo $sd->seniority_district?></td>
                                                                <td><input type="text" class="form-control" id="rank<?php echo $i;?>" value="<?php echo $sd->seniority_district?>"></td> 
																	<td>
																	<input type ="hidden" value ="<?= $sd->teacher_id;?>" id= "teach<?=$i?>" class ="teach">
								<input type ="hidden" value ="<?= $sd->school_key_id;?>" id= "school<?=$i?>" class ="school">
			 ...
			 <!--  <div class="col-md-12" >
									  <div class="form-group" style="padding: 10px;margin-top: 15px">
										...
										<button type="submit" class="btn green btn-lg" onclick ="save(<?php echo $i;?>)">Submit</button>
									  </div>
									  </div>  -->
		</div>
                                                        </div>
