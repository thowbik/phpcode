...
<th>Date Of <br>Appointment</th>
									...
									<?php $i=1;
								 if(!empty($deeschoolstaffpromot)){
								
									foreach($deeschoolstaffpromot as $sd){
...
var dsegovsurplus_sgstaff = <?=json_encode($deeschoolstaffpromot);?>;
...
// var major3 =$("#major3"+i).val();
    ...
    if(m_id ==''){
			...
			,'dpp':dpp,'adate':adate,'dps':dps,'dob':dob,'des':des,'tetype':tetype,'prof':prof,'regdate':regdate,'dojb':dojb,'panel1':panel1,'panel2':panel2,'panel3':panel3,'rank1':rank1,'rank2':rank2,'rank3':rank3,'teacher_name':teacher_name,'gender':gender});
			}
        }else
			{
				school_promotion.push({'modeule_id1':modeule_id1,'school_id':school_id,'teach_id':teach_id,'subject':subject,'dist_id':dist_id,'edu_dist_id':edu_dist_id,'block':block
