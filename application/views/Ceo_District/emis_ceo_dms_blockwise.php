                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Directorate Of Matriculation School-Student Detail
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Ceo_District/get_dms_district?dist='.$dist_id?>" method="POST">
                                            <div class="row">
                                                    <div class="col-md-12">
...
&nbsp;
                          ...
                          <?php if($cate!=""){?>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <h5><b>Selected Categoty :</b>  <?=$cate!=''?implode(",",$cate):'';?></h5>
        ...
        <?php echo number_format($over_total); ?></h4>
                                                  ...
                                                  <div class="portlet box green">
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <?php $total1=[]; $prekg_tot=0;$lkg_tot=0;$ukg_tot=0;$c1_tot=0;$c2_tot=0;$c3_tot=0;$c4_tot=0;$c5_tot=0;$c6_tot=0;$c7_tot=0;$c8_tot=0;$c9_tot=0;$c10_tot=0;$c11_tot=0;$c12_tot=0; ?>
                                                            ...
                                                            <?php if(!empty($details)){$prekg_tot= [];$lkg_tot= [];$ukg_tot= [];$c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1; foreach($details as $det){   ?>
                                                                ...
                                                                <tr>
                                                                  <td style="text-align: center;"><?php echo $i;?></td>
                                                                    <td> <a href="<?php echo base_url().'Ceo_District/get_dash_blockwise_dms?dist='.$dist_id.'&block='.$det->block_name?>">
                                                                 ...
                                                                 <td style="text-align: center;"><?php echo number_format($det->class_11); ?></td>
                                                                   <td style="text-align: center;"><?php echo number_format($det->class_12); ?></td>
                                                                    <td style="text-align: center; font-weight: bold;"><?php echo number_format($det->total); ?></td>
