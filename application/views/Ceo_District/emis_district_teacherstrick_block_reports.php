                                ...
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Staff Strike Reports - 
                                             Educational-District - <span><?=!empty($edu_dist)?$edu_dist:'--';?> </span>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                    <!-- BEGIN PAGE TOOLBAR -->
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     <div class="portlet light">
                                            <form action="<?php echo base_url()?>Ceo_District/get_block_strick_report" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="col-md-2" style="width:6%;padding-top:5%;">
                                                            <input type="hidden" value="<?=$edu_dist;?>" name="edu_dist"> 
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Staff Strike Reports  | Educational District - <span><?=!empty($edu_dist)?$edu_dist:'--';?> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Block</th>
                                                                    <th class="sum center">Total Staff</th>
                                                            ...
                                                            <?php if(!empty($teacher_strick)){ $total1 = 0; foreach($teacher_strick as $index=> $det){   ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> <a href="<?php echo base_url().'Ceo_District/get_school_strick_report?block='.$det->block_name?>">
