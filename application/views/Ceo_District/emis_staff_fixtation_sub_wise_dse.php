  ...
  <?php $this->load->view('Ceo_District/header.php'); ?>
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>DSE Staff Fixation - Subject-Wise(BT)</div>
    ...
    <tr>
      ...
      <td style="text-align: center;"><?php echo $staff_fixtation_sub_wise[0]->avail_tam?></td>
       <td style="text-align: center;"><?php echo $staff_fixtation_sub_wise[0]->vac_tamil?></td>
    ...
    <tr>
      ...
      <td style="text-align: center;"><?php echo $staff_fixtation_sub_wise[0]->vac_eng?></td>
    ...
    <tr>
      ...
      <td style="text-align: center;"><?php echo $staff_fixtation_sub_wise[0]->avail_mat?></td>
          <td style="text-align: center;"><?php echo $staff_fixtation_sub_wise[0]->vac_mat?></td>
    ...
    <tr>
      ...
      <td  style="text-align: center;"><?php echo $staff_fixtation_sub_wise[0]->avail_sci?></td>
            <td  style="text-align: center;"><?php echo $staff_fixtation_sub_wise[0]->vac_sci?></td>
    ...
    <tr>
      ...
      <td style="text-align: center;"><?php echo $staff_fixtation_sub_wise[0]->avail_soc?></td>
        <td style="text-align: center;"><?php echo $staff_fixtation_sub_wise[0]->vac_soc?></td>
     ...
     <tr>
      ...
      <td style="text-align: center;"><?php echo $staff_fixtation_sub_wise[0]->avail_sg?></td>
         <td style="text-align: center;"><?php echo $staff_fixtation_sub_wise[0]->vac_sg?></td>
