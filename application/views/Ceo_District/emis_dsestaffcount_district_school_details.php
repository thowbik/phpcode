                                                  ...
                                                  <div class="portlet box green">
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
														   ...
														   if(!empty($emis_desstaffcount_district_school)){ $total1 = 0; foreach($emis_desstaffcount_district_school as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																  ...
																  <a href="<?php echo base_url().'Ceo_District/dseemis_govstaff_school_details?schoolid='.$sd->school_id?>">
																															                                        <?=$sd->school_name;?></a>
