                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>DSE-Promotion Report :<?php echo $pan?></div>
                                                        
                                                    </div>
													<form action="<?=base_url().'Ceo_District/promotion_dsereport' ?>" method="post">
													               			  <div class="col-md-3"> 
           ...
           $('#sample_2').DataTable().clear().destroy();
			   ...
			   // {
				   // var a =s;
				    // $.ajax({
// data:{'a':a},
// url:baseurl+'Ceo_District/promotion_dsereport',
// type:"POST",
// dataType:"JSON",
