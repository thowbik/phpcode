        ...
        <link href="<?php echo base_url().'asset/css/support/custom-vivek.css';?>" rel="stylesheet" type="text/css" />
         ...
         <body class="page-container-bg-solid page-md">
            <div class="page-wrapper">
               ...
               <?php $this->load->view('Ceo_District/header.php'); }else{ ?>
                                    ...
                                    <div class="row">
                                       ...
                                       <!-- error displaying part end -->
														  ...
														  <div class="row">
															...
															<div class="col-md-6" id="emis_reg_rectrank_enable">
                                                               <div class="form-group">
                                                                  ...
                                                                  <div class="col-md-9">
                                                                    <input type="text" class="form-control" id="emis_reg_staff_rank" name="emis_reg_staff_rank" placeholder="Rank" maxlength="6" onkeypress="return event.charCode >= 48 && event.charCode <= 57" onfocus="textvalidate(this.id,'emis_reg_staff_rank_alert');" onchange="textvalidate(this.id,'emis_reg_staff_rank_alert');" autocomplete="off" >
                                                ...
                                                <div class="form-actions">
                                                    ...
                                                    <button type="button" onclick="location.href='<?php echo base_url().'Ceo_District/emis_school_staff2';?>'" class="btn default">Cancel</button>
                                                </div>
                                                </form>
                                                <!-- END FORM-->
                                             </div>
