                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                        ...
                                        <form action="<?=base_url().'Ceo_District/emis_desuniform_indent'?>" method="post">
...
<?php if($uf->hill_frst !=1 || $uf->hill_frst !=0 ){ echo '  (Other School)';}else { echo ' (Hill Station School)';}?>
                            ...
                            <div id="faq-cat-1-sub-2" class="panel-collapse panel-collapse collapse in" aria-expanded="true" style>
							 ...
							 <th style="text-align: center;">Size V</th>
							  ...
							  <?php  if(!empty($uf->block_name)) {?>
							           <?php if($sets !=0 ){?>
							           <td style="text-align:left;"><a href="<?php echo base_url().'Ceo_District/emis_desuniform_indent/?block_id='.$val.$sets.$uf->scheme_id.$uf->block_id?>"><?php } else {?>
									   <td style="text-align:left;"><a href="<?php echo base_url().'Ceo_District/emis_desuniform_indent/?block_id='.'00'.$uf->scheme_id.$uf->block_id?>"><?php }?>
