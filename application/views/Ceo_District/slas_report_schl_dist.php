                                         ...
                                         <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Ceo_District/slas_report_schl_dist'; ?>">
                                                    ...
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>SLAS Marks Range -
                                                             <strong>DISTRICT_WISE</strong> <!--<strong>Category : </strong> <!-- <?php echo $student_migration_details[0]->cate_type; ?>-->
                                                              </div>
                               ...
                               $j=0; $sum=0; $assigned_sum=0; $not_marked=0;//print_r($value); die();
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="<?php echo base_url().'Ceo_District/slas_report_schl_blk/?dist_id='.$key->district_id.'&catty_id='.$key->catty_id.'&manage_id='.$key->manage_id?>"> <?php echo($key->district_name); ?></a></td>
                                      ...
                                      <?php 
                                      $total['values']['p0']+=$key->per_20;
                                      $total['values']['p1']+=$key->per_21_40;
                                      $total['values']['p2']+=$key->per_41_60;
                                      $total['values']['p3']+=$key->per_61_80;
                                      $total['values']['p4']+=$key->per_81_100;
                                       $total['val']['tot']+=$key->tot_schl;
                                      $total['percent']['per0']+=$key->per20;
                                      $total['percent']['per1']+=$key->per40;
                                      $total['percent']['per2']+=$key->per60;
                                      $total['percent']['per3']+=$key->per80;
                                      $total['percent']['per4']+=$key->per100;
