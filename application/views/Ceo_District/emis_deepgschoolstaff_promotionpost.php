			 ...
			 <div class="portlet-body">
				   ...
				   <div class="portlet box green">
							<div class="portlet-title">
								<div class="caption">
									 <i class="fa fa-globe"></i> PG Teacher  Eligible for Promotion</div>
								<div class="tools"> </div>
							</div>
							<div class="portlet-body">
...
<th>Date Of <br>Appointment</th>
									...
									<?php $i=1;
								 if(!empty($deepgschoolstaffpromot)){
								
									foreach($deepgschoolstaffpromot as $sd){
...
var dsegovsurplus_sgstaff = <?=json_encode($deepgschoolstaffpromot);?>;
...
var modeule_id1 = $("#profile"+i).val();
    ...
    if(m_id ==''){
			...
			,'dpp':dpp,'adate':adate,'dps':dps,'dob':dob,'des':des,'tetype':tetype,'prof':prof,'regdate':regdate,'dojb':dojb});
			}
        }else
			{
				school_promotion.push({'modeule_id1':modeule_id1,'school_id':school_id,'teach_id':teach_id,'subject':subject,'dist_id':dist_id,'edu_dist_id':edu_dist_id,'block':block
