                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>
                                            ...
                                            <a href="<?php echo base_url().'Ceo_District/live_vacancy_dse_pgreport'?>">
                                              <span class="text">Live Vacancy Teachers DSE-PG</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Ceo_District/live_vacancy_dse_sgbtreport'?>">
                            ...
                            <th style="text-align: center;">SG</th>
                              ...
                              <td> <?php echo $vacancydse->udise_code; ?></td>
