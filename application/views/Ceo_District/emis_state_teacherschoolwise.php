                                         ...
                                         <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                           <li role="presentation">
                                             <a href="<?php echo base_url().'Ceo_District/emis_teacher_blockwise_district'; ?>">
                                              <span class="text">Teaching Staff</span>
                                            </a>
                                          </li>
                                            <li role="presentation">
                                            <a href="<?php echo base_url().'Ceo_District/emis_nonteaching_blockwise_district'; ?>">
                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Ceo_District/emis_teacher_classwise_block/?block_id='.$block_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
...
$total1 = [];
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Teaching Staff Details By Grade-School wise |Block:<?php echo $details[0]->block_name?></div>
 ...
 <?php $Govteacher=0;$BTteacher=0;$SGteacher=0;$PGteacher=0; ?>
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                    ...
                                                    <tbody>
                                                        <?php if(!empty($details)){ $total1 = []; $Govteacher_tot= [];$BTteacher_tot= [];$SGteacher_tot= [];$PGteacher_tot= [];$HM_tot=[];$others_tot=[]; $i=1; foreach($details as $det){ 
                                                         ?>
                                                        <tr>
                                                            ...
                                                            <td><a onclick=""><?php echo $det->school_name; ?></a></td>
