                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Ceo_District/stud_community_report_dist?community_name='.$community_name?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                         ...
                         <?php
                              ...
                              <tr>
                                  <td class="center"><?=$index+1;?></td>
																  <td><a href="<?php echo base_url().'Ceo_District/stud_community_report_blk/?community_name='.$sd->community_name.'&dist_id='.$sd->district_name?>"><?= $sd->district_name ?></a></td>		
