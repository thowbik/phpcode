                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Staff Strike Reports - District - 
                                            <?=!empty($dist_name)?$dist_name:'--';?>                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                    <!-- BEGIN PAGE TOOLBAR -->
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     <div class="portlet light">
                                            <form action="<?php echo base_url()?>Ceo_District/get_edu_district_strick_report" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="col-md-2" style="width:6%;padding-top:5%;">
                                                            <input type="hidden" value="<?=$dist_name;?>" name="dist_name"> 
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Staff Strike Reports  | District - <span><?=!empty($dist_name)?$dist_name:'--';?> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="sum center">Total Staffs</th>
                                                                    <th class="sum center">Participated</th>
                                                                    <th class="sum center">Not Participated</th>
                                                                    <th class="sum center">No Data</th>
                                                                </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php if(!empty($teacher_strick)){ $total1 = 0; foreach($teacher_strick as $index=> $det){   ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> <a href="<?php echo base_url().'Ceo_District/get_block_strick_report?edu_dist='.$det->edu_dist_name?>">
                                                                    <?php echo $det->edu_dist_name; ?></a></td>
                                                                    <td class="center"><?=$det->total_teacher;?></td>
                                                                   <td class="center"><?=$det->teacher_participate;?></td>
                                                                   <td class="center"><?=$det->teacher_not_participate;?></td>
                                                                   <td class="center"><?php $not_entered = ($det->total_teacher-($det->teacher_participate+$det->teacher_not_participate)); echo $not_entered;?></td>
