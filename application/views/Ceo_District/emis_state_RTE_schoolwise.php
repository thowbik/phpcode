                              ...
                              <!--      <div class="portlet light portlet-fit ">
                                        ...
                                        <!-- BEGIN CARDS -->
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>RTE-Student Report | School-wise</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                            ...
                                                            <?php $total1 = []; if(!empty($allstuds)){ $pre_kg_tot= [];$ukg_tot= [];$lkg_tot= []; $c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1;$total1 = []; foreach($allstuds as $det){ 
                                                             ...
                                                             ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo base_url().'Ceo_District/get_RTE_school_student/?school_id='.$det->school_id?>"><?=$det->school_name;?></a></td>
