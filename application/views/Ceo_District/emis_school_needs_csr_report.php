                        ...
                        <div class="page-content-wrapper">
                          ...
                          <div class="portlet-body">
                                     ...
                                     <div class="row">
                                        ...
                                        <form action="<?=base_url().'Ceo_District/school_needs_csr'?>" method="post">
                ...
                <div class="tab-pane active in fade" id="faq-cat-1">
                    <div class="panel-group" id="accordion-cat-1">
                        ...
                        <?php } ?>
							  ...
							  <?php if(!empty($uf->block_name)) {?>
							  <td style="text-align:left;"><a href="<?php echo base_url().'Ceo_District/school_needs_csr/'.$uf->block_id.'/'.$cat.'/'.$sub_cat.'/'.$item ?>">
