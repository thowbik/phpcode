<!DOCTYPE html>
    ...
    <link href="<?php echo base_url().'asset/global/plugins/bootstrap-timepicker/css/bootstrap-timepicker.min.css';?>" rel="stylesheet" type="text/css" />
     ...
     <div class="portlet-body form" id="dialogform">
                     ...
                     <!-- BEGIN PAGE CONTENT INNER -->
     <form method="post"  action="<?php echo base_url().'Ceo_District/beo_form';?>" name="beoform_submit"  id="beoform_submit" >
...
{
    var url='<?php echo base_url().'Ceo_District/get_allblocks';?>';
    $.ajax({
    type: "POST",
    url: url,
...
{
    var url='<?php echo base_url().'Ceo_District/get_all_edu_dist'?>';
    $.ajax({
    type: "POST",
    url: url,
    data: '&'+node.name+'='+node.value,
