                            ...
                            <div class="page-content">
                                ...
                                <div class="container">
                                  ...
                                  <tr>
                                     ...
                                     <td><a href="<?php echo base_url().'Ceo_District/boys_schl_with_girls_enrol';?>"><?php  echo ('Boys School With Girls Enrollment'); ?></a></td>
                                     ...
                                     <td><a href="<?php echo base_url().'Ceo_District/girls_schl_with_boys_enrol';?>"><?php echo ('Girls School With Boys Enrollment'); ?><a href=""></td>
                                     ...
                                     <td><a href="<?php echo base_url().'Ceo_District/primary_school_list';?>"><?php echo ('Primary School High Class > 5'); ?></a></td>
                                     ...
                                     <td><a href="<?php echo base_url().'Ceo_District/middle_school_list';?>"><?php echo ('Middle School  High Class > 8'); ?></a></td>
                                     ...
                                     <td><a href="<?php echo base_url().'Ceo_District/schools_with_zero_staff_profile';?>"><?php echo ('Schools With Zero Staff Profile'); ?></a></td>
                                     ...
                                     <td><a href="<?php echo base_url().'Ceo_District/schools_with_zero_enrollment';?>"><?php echo ('Schools With Zero Enrollment'); ?></a></td>
                                     ...
                                     <td><a href="<?php echo base_url().'Ceo_District/emis_school_unrecognized_block';?>"><?php echo ('Unrecognized Schools'); ?></a></td>
                                     <td style="text-align: center;"><?php //echo ($zeroenroll[0]['cnt']); ?></td>
