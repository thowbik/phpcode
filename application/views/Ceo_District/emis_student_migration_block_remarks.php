                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        ...
                                        <!--    <li role="presentation">
                                            <a href="<?php echo base_url().'Ceo_District/get_block_migration_remarks'?>">
                            ...
                            <div class="page-content">
                              ...
                              <th style="text-align: center;">Remark Not Updated</th>
                              <!--<th>Total</th>-->
                            ...
                            <td><a href="<?php echo base_url().'Ceo_District/get_school_migration_remarks/?block_name='.$student_mig->block_name?>">
                              <?php echo $student_mig->block_name; ?></a></td>
                               <td style="text-align: center;"><?php echo number_format($student_mig->tot_std); ?></td>
                              <td style="text-align: center;"><?php echo number_format($student_mig->not_marked_remarks); ?>
