                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="width:14%;">Section Type</th>
																	<th style="width:14%;">Medium </th>
																	<th style="width:14%;">Student Count</th>
                                                                    <th class="sum center">Group (Only XI and XII)</th>
                                                                    
                                                                </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php if(!empty($school_class_details)){ $total1 = 0; foreach($school_class_details as $index=> $sd){ 
                                                                   $classid=$sd->class_id;
																  switch ($classid) {
