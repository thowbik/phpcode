    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="width:140%">
        <div class="modal-header">
          ...
          <h4 class="modal-title"> School Class And Sections</h4>
        </div>
		<style type="text/css">
											 ...
											 <div id ="classsection">
                                                  <div class="portlet box green">
                                                      <div class="portlet-title">
                                                         <div class="caption">
                                                            <i class="fa fa-globe"></i><?php echo $schoolname ?>- - Class And Sections
															
															 <input id="printBut" type="button" style="margin-left: 510px; background-color:#D0D0D0; color:black;" class="btn yellow" onclick="printclasssection('classsection')" value="Print" />
															</div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="width:8%;">Assigned Classes</th>
                                                                    
                                                                    
                                                                </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php if(!empty($school_class_section_timetable)){ $total1 = 0; foreach($school_class_section_timetable as $index=> $sd){ 
                                                                  															?>

                                                                <tr>
																   
                                                                    <td> <a href="<?php echo base_url().'Ceo_District/school_period_count_timetable?classsection='.$sd->class?>&schoolid=<?php echo $schoolid?>"><?=$sd->class;?></a></td>
   ...
   <script src="<?php echo base_url().'asset/js/district.js';?>" type="text/javascript"></script>
    ...
    <script src="<?php echo base_url().'asset/global/plugins/bootstrap-wysihtml5/wysihtml5-0.3.0.js';?>" type="text/javascript"></script>
        ...
        <script src="<?php echo base_url().'asset/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js';?>" type="text/javascript"></script>
              ...
              <script>
function printclasssection(divName) 
     {
