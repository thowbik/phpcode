...
<div class="container">
 ...
 <!--<?php $this->load->view('Ceo_District/emis_district_profile_header.php'); ?>-->
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-6">
                                                            <button type="button" class="btn green" id="emis_ceo_reset_pass">Submit</button>
   ...
   <script src="<?php echo base_url().'asset/js/ceo_district.js';?>" type="text/javascript"></script>
