                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     <div class="portlet light">
                                            <form action="<?php echo base_url()?>Ceo_District/get_districtwise_school" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                               ...
                                                               <tbody>
                                                            <?php if(!empty($school_info)){ $total1 = 0; foreach($school_info as $det){   ?>

                                                                <tr>
                                                                    <td> <a href="<?php echo base_url().'Ceo_District/get_schoolwise_teacherlist?school='.$det->school_id?>">
