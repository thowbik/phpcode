                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>NoonMeal Students Details(Grade1 to 8)<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th>Total Students</th>
																	 <th class="sum ">Opted Students</th>
																	                                                                                             </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php
														   ...
														   $studtot =0;										if(!empty($meal_school_details)){ $total1 = 0; foreach($meal_school_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																   ...
																   <td > <a href="<?php echo base_url().'Ceo_District/meal_school_eligible_stud_count?schoolid='.$sd->school_id?>">
