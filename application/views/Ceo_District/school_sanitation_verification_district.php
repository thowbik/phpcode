                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Ceo_District/school_sanitation_verification_district?dist_id='.$district_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <th>Block Name</th>
                                                                    ...
                                                                    <th>Drinking<br/>Water<br/>available</th>
                                                                     ...
                                                                     <th>Incinerator</th>
                                                                     <th>incinerator<br/>Auto<br/>Avail<br/>Count</th>
                                                                     <th>incinerator<br/>manu<br/>Avail<br/>Count</th>
                                                                      <th>incinerator<br/>Auto<br/>func<br/>Count</th>
                                                                     <th>incinerator<br/>manu<br/>func<br/>Count</th>
                                                                    <!--<th>Verified</th>-->
