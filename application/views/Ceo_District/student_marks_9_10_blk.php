...
<link href="<?php echo base_url().'asset/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css';?>" rel="stylesheet" type="text/css" />
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                       <h1><!--Past Class 12 Student Status-->SCHOLASTIC ACHIEVEMENT OF CHILDREN 
                                         <!--   <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Ceo_District/dge_2017_18_report'; ?>">
                                              <span class="text">Class 12 Status-(2017-2018)</span>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Ceo_District/dge_2018_19_report'; ?>">
                              ...
                              <form method="post" action="<?php  echo base_url().'Ceo_District/student_marks_9_10_blk/?district_id='.$dist;?>">
 ...
 <div class="col-md-4">  
                                           <select style="width: 85%;" class="form-control" data-placeholder="Choose a Category" tabindex="1" id="cls_id" name="cls_id"  style="width: 80%" required="" >
                                            <option value="">Select Class</option>
                                            <option value="9,10">ALL</option>
                      ...
                      <!--   <div class="col-md-12">
                         ...
                         <h5 style="color:red;"><strong>Distributed :</strong>Number of students for whom laptop has been distributed</h5>
                            ...
                            <div class="page-content">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>9th-10th Students Mark - Monitoring Report - &nbsp;&nbsp;EXAM  :&nbsp;&nbsp;<?php $termid=$this->input->post('termid');
                              if($termid==1){
                               echo 'I - Mid Term';
                              }
                              else if($termid==2 || $termid=='')
                              {
                                                            echo 'Quarterly';
                              }
                              else if($termid==3)
                              ...
                              ?>&nbsp;&nbsp;CLASS  :&nbsp;&nbsp;<?php $cls_id=$this->input->post('cls_id');
                              
                               if($cls_id=='' || $cls_id=='9,10'){
                               echo '9th-10th';
                              }
                              else
                              {
                                                            echo $this->input->post('cls_id');
                              }
                              ...
                              <tr>
                                ...
                                <th style="text-align: center;">Total Sections</th>  
                              ...
                              <tbody>
                              <?php $total1=[]; ?>
                              <?php if(!empty($student_migration_details)){ $Gov_tot= [];$FA_tot= [];$UA_tot= [];$PA_tot= []; $sum1= []; $assigned_sum1=[]; $not_marked1=[]; $i=1;foreach($student_migration_details as $key){ $j=0; $sum=0; $assigned_sum=0; $not_marked=0;//print_r($value); die();
                              
                                ?>
                                  <tr>
                                      <td style="text-align: center;"><?php echo($i++); ?></td>
                                      <td><a href="<?php echo base_url().'Ceo_District/student_marks_9_10_schl/?block_id='.$key->blk?>"><?php echo($key->blk); ?></td>
                                      <td style="text-align: center;"><?php echo number_format($key->sec_cnt); ?></td>
                                      <td style="text-align: center;"><?php echo number_format($key->markedcnt);?></td>
                                      <td style="text-align: center;"><?php echo number_format($not_marked=(($key->sec_cnt)-($key->markedcnt)));?></td>
                                       <td class="center">
                                           <?php 
                                              $marked_school = round(($key->markedcnt/$key->sec_cnt)*100);
  ...
  <div class="progress-bar progress-bar-success" role="progressbar" style="width:<?=$marked_school.'%'?>">
   <?=$marked_school.'%';?>
    ...
    <div class="progress-bar progress-bar-danger" role="progressbar" style="width:<?=(100-$marked_school).'%'?>">
                                    ...
                                    <?php  
                                      array_push($sum1,$key->sec_cnt);
                                      array_push($assigned_sum1,$key->markedcnt);
                            ...
                            <div class="row">
                                                            ...
                                                            <div class="color-box-green" style="background-color:#5cb85c;" data-hex="#CD5C5C" data-rgb="205, 92, 92" data-hsl="0, 53%, 58%"></div>Marked 
                                                        </div>
