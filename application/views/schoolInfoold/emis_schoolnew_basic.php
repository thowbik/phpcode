                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="number" class="form-control" id="logitude" name="logitude"  onfocus="textvalidate(this.id,'emis_longitude_alert');" onchange="textvalidate(this.id,'emis_longitude_alert');" autocomplete="off"  placeholder="LONGITUDE" value="<?php echo $basic[0]->longitude; ?>" readonly="readonly" required="required" />
                                                ...
                                                <div class="portlet light portlet-fit ">
                                                    ...
                                                    <div class="portlet-body">
                                                        <div class="form-row">
                                                            ...
                                                            <input type="hidden" id="chaingaddress" value="district_id,block_id,urbanrural,localbody_id,village_ward,vill_habitation_id,assembly_id,parliament_id,edu_district_id" />
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-3">
                                                                ...
                                                                <select id="parliament_id" name="parliament_id" class="form-control" onfocus="textvalidate(this.id,'emis_parliament_alert');" onchange="addressChainDetails(this,'edu_district_id',12,'district_id='+document.getElementById('district_id').value,'<?php echo base_url() ?>Basic/addressChainDetails/');document.getElementById('pincode').value='';textvalidate(this.id,'emis_parliament_alert');" required="required">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-3">
                                                                ...
                                                                <select id="edu_district_id" name="edu_district_id" class="form-control"  onfocus="textvalidate(this.id,'emis_edudistrict_alert');" onchange="textvalidate(this.id,'emis_edudistrict_alert');document.getElementById('pincode').value='';" required="required">
                                                    ...
                                                    <div class="portlet-body">
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select id="stdcode_id" name="stdcode_id" class="form-control"  required>
                                                                    <!--<option value="<?php echo $basic[0]->sid; ?>" selected="selected"><?php echo $basic[0]->std_code; ?></option>--->
                                                                    <?php
                                                                        foreach($stdcode as $dis){
                                                                    ?>
                                                                            <option value="<?php echo($dis->id)?>" <?php if($basic[0]->stdcode_id==$dis->id){echo('selected="selected"');}?> ><?php echo($dis->std_code)?></option>
                                                                    <?php
                                                                        }
                                                                    ?>
                                                                </select>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="tel" class="form-control" maxlength="0" onkeypress="return event.charCode >=48 && event.charCode <=57" id="landline" name="landline" placeholder="LandLine" value="<?php echo($basic[0]->landline) ?>" />
                                                                
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                                <label for="mobile">Office Mobile</label>
                                                                <input type="tel" class="form-control" id="mobile" maxlength="10" onfocus="mobilevalidate(this.id,'emis_mobile_alert');" onchange="mobilevalidate(this.id,'emis_mobile_alert');" autocomplete="off" onkeypress="return event.charCode >=48 && event.charCode <=57" name="mobile" placeholder="Mobile" value="<?php echo($basic[0]->mobile) ?>"/>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select id="stdcode_id2" name="office_code" class="form-control" >
                                                                    <!--<option value="<?php echo $basic[0]->sid; ?>" selected="selected"><?php echo $basic[0]->std_code; ?></option>-->
                                                                    <?php
                                                                        foreach($stdcode as $dis){
                                                                    ?>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="tel" class="form-control" maxlength="0"  onkeypress="return event.charCode >=48 && event.charCode <=57" id="landline2" name="landline2" placeholder="LandLine" value="<?php echo($basic[0]->landline2) ?>" />
                                                                <font style="color:#dd4b39;"><div id="emis_corresline_alert"></div></font>
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                                <label for="mobile">Correspondent/ Head Master Mobile</label>
                                                                <input type="tel" class="form-control" maxlength="10" onfocus="mobilevalidate1(this.id,'emis_corresmobile_alert');" onchange="mobilevalidate1(this.id,'emis_corresmobile_alert');" onkeypress="return event.charCode >=48 && event.charCode <=57" id="mobile2" name="mobile2" placeholder="Mobile"  value="<?php echo($basic[0]->mobile2) ?>"  />
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="email" class="form-control" id="schemail" name="sch_email" onfocus="emailvalidate(this.id,'emis_schoolemail_alert');" onchange="emailvalidate(this.id,'emis_schoolemail_alert');" autocomplete="off" placeholder="example@example.com" value="<?php echo($basic[0]->sch_email) ?>" required="required"/>
                                                ...
                                                <div class="portlet light portlet-fit ">
                                                    ...
                                                    <div class="portlet-body">
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-9" <?php if(!($this->session->userdata('school_manage')>1 && $this->session->userdata('school_manage')<5)) { echo('style="visibility:hidden;"'); } ?> >
                                                                <div class="form-group col-md-4">
                                                                    <label for="firstRecognition">Year of first recognition of School <font style="color:#dd4b39;">*</font></label>
                                                                    <input type="number" class="form-control" min="1900"  max="<?php echo date('Y'); ?>" maxlength="4" onfocus="textvalidate(this.id,'emis_recognition_alert');" onchange="textvalidate(this.id,'emis_recognition_alert');" onkeydown="return restlength(this)" onblur="if(!restlength(this)){setMinandMax(this,'lastrenewal');setMinandMax(this,'cwsn_lastrenewal');}" onkeypress="return event.charCode >=48 && event.charCode <=57" id="firstRecognition" name="offcat_id" placeholder="1947" autocomplete="off" value="<?php echo $basic[0]->offcat_id ?>" />
                                                                ...
                                                                <div class="form-group col-md-8">
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <input type="number" class="form-control" min="<?php echo date('Y',strtotime('now - 3Years')); ?>" max="<?php echo date('Y'); ?>" maxlength="4" onfocus="textvalidate(this.id,'emis_renewal_alert');" onchange="textvalidate(this.id,'emis_renewal_alert');" onkeydown="return restlength(this)" onblur="return restlength(this); " onkeypress="return event.charCode >=48 && event.charCode <=57" id="lastrenewal" name="office_email1" placeholder="1947" autocomplete="off" value="<?php echo $basic[0]->office_email1 ?>" />
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-12">
                                                                <label for="cwsn">Whether School for <strong>C</strong>hildren <strong>W</strong>ith <strong>S</strong>pecial <strong>N</strong>eeds <strong>(CWSN)</strong> <font style="color:#dd4b39;">*</font></label>&nbsp;&nbsp;
                                                                <label for="cwsn_1">YES &nbsp;</label>
                                                                <input type="radio"  id="cwsn_1" name="spl_school" value="1" />
                                                                <label for="cwsn_2">NO &nbsp;</label>
                                                                <input type="radio"  id="cwsn_2" name="spl_school" value="0"  checked="checked" />
                                                           ...
                                                           onchange="document.getElementById('cwsnvisible').style.visibility=(this.checked?'hidden':'');setRequiredField(this.value,'cwsn_lastrenewal,cwsn_refrenceno','1')"
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <label for="shiftschool" style="width: 387px;"><strong>Whether Shift School<font style="color:#dd4b39;">*</font></strong></label>
                                                                <label for="shift_1">YES &nbsp;</label>
                                                                <input type="radio"  id="shift_1" name="shftd_schl" value="1" />
                                                                <label for="shift_2">NO &nbsp;</label>
                                                                <input type="radio"  id="shift_2" name="shftd_schl" value="0" checked="checked" />
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="radio"  id="resi_1" name="resid_schl" value="1" onchange="document.getElementById('resivisible').style.visibility=(this.checked?'':'hidden');setRequiredField(this.value,'resitype','1')"/>
                                                                    <label for="resi_2">NO &nbsp;</label>
                                                                    <input type="radio"  id="resi_2" name="resid_schl" value="0" onchange="document.getElementById('resivisible').style.visibility=(this.checked?'hidden':'');setRequiredField(this.value,'resitype','1')" checked="checked"/>
                                                                    <font style="color:#dd4b39;"><div id="emis_resischool_alert"></div></font>
                                                              </div>
                                                                <div class="form-group col-md-6"  style="margin-top: -25px;" id="resivisible">
                                                                    <label for="resitype"><strong>Type of Residential</strong></label>
                                                                    <select style="width: 300px;" id="resitype" name="typ_resid_schl" class="form-control" onfocus="textvalidate(this.id,'emis_resitypeschool_alert');" onchange="textvalidate(this.id,'emis_resitypeschool_alert');">
                                                                        <option value="">Select Residential</option>
                                                                        <?php
                                                                        foreach($resitype as $dis){
                                                                        ?>
                                                            ...
                                                            <div class="form-group col-md-6" style="width: 390px;">
                                                                <label for="schoolarea">Is the School situated in Hill/Forest/Others Area? <font style="color:#dd4b39;">*</font></label>
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                <select style="width: 300px;" class="form-control" id="schoolarea" name="pri_stg_mothr_tngue"  onfocus="textvalidate(this.id,'emis_schoolarea_alert');" onchange="textvalidate(this.id,'emis_schoolarea_alert');">
                                                                    <option value="">Choose</option>
