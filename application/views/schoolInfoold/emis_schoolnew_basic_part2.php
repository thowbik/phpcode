                                            ...
                                            <form id="emis_schoolnew_basic_part2" method="post" action="<?php echo base_url().'Basic/schoolupdation/2';?>">
                                                ...
                                                <?php $this->load->view('schoolInfo/supportHeader'); ?>
                                                    ...
                                                    <div class="portlet-body">
                                                        <div class="form-group col-md-6">
                                                            <div class="col-md-5">
                                                                ...
                                                                <select id="schoolcategory" name="hostel_girls" onchange="document.getElementById('lowerclass').selectedIndex = 0;document.getElementById('higherclass').selectedIndex = 0;textvalidate(this.id,'emis_schoolcategory_alert');" onfocus="textvalidate(this.id,'emis_schoolcategory_alert');" class="form-control" required>
                                                                    <option value="">Choose.....</option>
                                                                    <?php foreach($schoolcategory as $dis){   ?>
                                                                    <option value="<?php echo($dis->id)?>"><?php echo($dis->category_name)?></option>
                                                                    <?php   }   ?>
                                                                </select>
                                                                <!--hostel_girls bigint(20) schoolnew_academicinfo-->
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select id="lowerclass" name="low_class" class="form-control" required>
                                                                        <option value="">Choose...</option>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select id="higherclass" name="high_class" class="form-control" required>
                                                                        <option value="">Choose...</option>
                                                                        <option value="15">Pre-KG</option>
                                                                        <option value="13">LKG</option>
                                                                        <option value="14">UKG</option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="radio" id="schooltype_1" name="schooltype" value="Boys" onchange="document.getElementById('schooltype').value=this.value" />
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="schooltype_1">Girls</label>&nbsp;&nbsp;
                                                                <input type="radio" id="schooltype_2" name="schooltype" value="Girls" onchange="document.getElementById('schooltype').value=this.value" />
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="schooltype_1">Co-Education</label>&nbsp;&nbsp;
                                                                <input type="radio" id="schooltype_3" name="schooltype" value="Co-Ed" onchange="document.getElementById('schooltype').value=this.value" />
                                                                <label style="display:none;">Boys/Girls/Co-Education</label>
                                                                <input type="hidden" id="schooltype" name="schooltype" required />
                                                                ...
                                                                <table class="table">
                                                                    <tr>
                                                                        <th style="width: 390px;">
                                                                            ...
                                                                            <input type="radio" id="minority_1" name="minority" required="required" class="custom-control-input" value="1" onchange="document.getElementById('minoritygroup_0').selectedIndex = 0;sbcshow1(this,'minorityvisible');selectshowminor(document.getElementById('minoritygroup_0'),'minoritygroupdetails');" />
                                                                            &nbsp;
                                                                            <label for="minority">No</label>
                                                                            <input type="radio" id="minority_2" name="minority" required="required" class="custom-control-input" value="0" onchange="document.getElementById('minoritygroup_0').selectedIndex = 0;sbcshow1(this,'minorityvisible');selectshowminor(document.getElementById('minoritygroup_0'),'minoritygroupdetails');" checked="checked" />
                                                                        </th>
                                                                        <th class="minorityvisible">Select <strong>Minority Group</strong> <font style="color:#dd4b39;">*</font></th>
                                                                        <th class="minorityvisible">
                                                                                <select class="form-control" id="minoritygroup_0" name="rel_minority" onchange="selectshowminor(this,'minoritygroupdetails');textvalidate(this.id,'emis_min_alert');" onfocus="textvalidate(this.id,'emis_min_alert');">
                                                                                ...
                                                                                <!--rel_minority tinyint(4) schoolnew_academicinfo-->
                                                                                <font style="color:#dd4b39;"><div id="emis_min_alert"></div></font>
                                                                            
                                                                        </th>
                                                                        <th class="minoritygroupdetails minorityvisible">
                                                                            <input type="text" maxlength="25" minlength="1" id="min_ord_no" name="min_ord_no" placeholder="Enter the language" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);" onkeypress="return  event.charCode >= 97 && event.charCode <= 122 || event.charCode >= 65 && event.charCode <= 90 || event.charCode == 32" class="form-control">
                                                                        ...
                                                                        <th class="minorityvisible">
                                                                             ...
                                                                             ?>
                                                                            <input type="number" maxlength="4" minlength="1" id="minoryear" name="start_yr" min="1990" max="<?php echo $EndDateTime->format('Y'); ?>" placeholder="Enter the year" onkeydown="return restlength(this)"  onblur="return restlength(this)" class="form-control">
                                                                            <!--start_yr varchar(10) schoolnew_academicinfo-->
                                                    ...
                                                    <div class="portlet-body">
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">  
                                                                ...
                                                                <input type="radio" id="prevocational_1" name="schl_ofr_prevoc_cours" required="required" class="custom-control-input" value="1" onchange="document.getElementById('prevocationalvisible').style.display=(this.checked?'':'none');" />
                                                                &nbsp; 
                                                                <label for="prevocational_2">No</label>
                                                                <input type="radio" id="prevocational_2" name="schl_ofr_prevoc_cours" required="required" class="custom-control-input" value="0" onchange="document.getElementById('prevocationalvisible').style.display=(this.checked?'none':'');" checked="checked" />
                                                            </div>
                                                    ...
                                                    <div class="portlet-body">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <label for="allweather">Whether School is approachable by <u><strong>All-Weather Roads? <font style="color:#dd4b39;">*</font></strong></u></ul>&nbsp; &nbsp; &nbsp; &nbsp;</label>
                                                                
                                                                <label for="allweather_1">Yes</label>
                                                                <input type="radio" id="allweather_1" name="schl_aprch_alwther" onchange="sbcshow2(this,'allweatherroads');setRequiredField(this.value,'weatherdetails,distancedetails','1');" required="required" class="custom-control-input" value="0" checked="checked" />
                                                                &nbsp;
                                                                <label for="allweather_2">No</label>
                                                                <input type="radio" id="allweather_2" name="schl_aprch_alwther" onchange="sbcshow2(this,'allweatherroads');setRequiredField(this.value,'weatherdetails,distancedetails','1');textvalidate(this.id,'emis_landa_alert');" required="required" class="custom-control-input" value="1" />
                                                            </div>
                                                            
                                                            <div class="form-group col-md-3 allweatherroads">
                                                                <label>if No, School is connected to All Weather road through</label>
                                                                <select id="weatherdetails" name="brdng_fac_avl_stg" onchange="textvalidate(this.id,'emis_weatherdetails_alert');"  onfocus="textvalidate(this.id,'emis_weatherdetails_alert');" class="form-control">
                                                                    <option value="">Choose</option>
                                                                    <option value="1">Kutcha Road</option>
                                                                    <option value="2">Partial Pucca Road</option>
                                                                    <option value="3">No Road</option>
                                                                </select>
                                                                <!--brdng_fac_avl_stg int(11) schoolnew_academicinfo2-->
                                                                <font style="color:#dd4b39;"><div id="emis_weatherdetails_alert"></div></font>
                                                            </div>
                                                            <div class="form-group col-md-3 allweatherroads">
                                                                <label>Distance to All Weather road in meters</label>
                                                                <input type="text" id="distancedetails" name="resid_pri_stud" maxlength="5" min="0" max="15000" onkeydown="return restlength(this)" onblur="return restlength(this)" onchange="textvalidate(this.id,'emis_distance_alert');" onfocus="textvalidate(this.id,'emis_distance_alert');" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57"/>
                                                                <!--resid_pri_stud int(11) schoolnew_academicinfo2-->
                                                                <font style="color:#dd4b39;"><div id="emis_distance_alert"></div></font>
                                                            </div>
                                                            
                                                            <div class="form-group col-md-6">
                                                                <label for="anganwadi">Whether <strong><u>Anganwadi</u></strong> is attached to the School? <font style="color:#dd4b39;">*</font></label>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label for="anganwadi_1">Yes</label>
                                                                <input type="radio" id="anganwadi_1" name="angwdi_cntr_schlcmps" required="required" class="custom-control-input" value="1" onchange="document.getElementById('anganvadivisible').style.display=(this.checked?'':'none');"  />
                                                                    &nbsp;
                                                                <label for="anganwadi_2">No</label>
                                                                <input type="radio" id="anganwadi_2" name="angwdi_cntr_schlcmps" required="required" class="custom-control-input" value="0" checked="checked" onchange="document.getElementById('anganvadivisible').style.display=(this.checked?'none':'');" />
                                                            </div>
                                                            <div class="form-group col-md-12" id="anganvadivisible">
                                                                <table class="table">
                                                                    <tr>
                                                                        <th colspan="4" style="font-weight: normal;">If Yes ! Total No. of Anganwadi Workers &amp; Children</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-weight: normal;">Total No. of Workers</th>
                                                                        <th>
                                                                            <input type="text" maxlength="2" minlength="1" onfocus="textvalidate(this.id,'emis_noteacher_alert');" onchange="textvalidate(this.id,'emis_noteacher_alert');" onkeypress="return event.charCode >= 48 && event.charCode <= 57" id="anganwadi_teachers" name="tot_tchrs_angwdi_wrks" class="form-control" />
                                                                            <font style="color:#dd4b39;"><div id="emis_noteacher_alert"></div></font>
                                                                        </th>
                                                                        <th style="font-weight: normal;">Total No. of Children</th>
                                                                        <th>
                                                                            <input type="text"  maxlength="3" minlength="1" onfocus="textvalidate(this.id,'emis_nostudent_alert');" onchange="textvalidate(this.id,'emis_nostudent_alert');"  onkeypress="return event.charCode >= 48 && event.charCode <= 57"  id="anganwadi_students" name="angwdi_cntr_tot_chldrs" class="form-control" />
                                                            ...
                                                            <!--<div class="form-group col-md-6">
                                                                <label>No. of Children actively reading Supplementary and Graded books in the Reading Corner (based on the Head Master/Teacher's observation)</label>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <input type="text" id="supplement" name="supplement" min="0" max="999" maxlength="3" minlength="1"  onfocus="textvalidate(this.id,'emis_supplement_alert');" onchange="textvalidate(this.id,'emis_supplement_alert');"  style="width:305px;" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                <font style="color:#dd4b39;"><div id="emis_supplement_alert"></div></font>
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                                <div class="form-group col-md-6">
                                                                    <label>Whether the School Report Card for the Previous Academic Year has been displayed on the Notice Board?</label>
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <input type="radio" id="srcpy_1" name="srcpy"/><label for="srcpy_1">YES</label>
                                                                    <input type="radio" id="srcpy_2" name="srcpy" checked="checked"/><label for="srcpy_2">NO</label></th>
                                                                </div>
                                                            </div>-->
                                                        </div>
