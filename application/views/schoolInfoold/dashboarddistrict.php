                                        ...
                                        <div class="form-actions">
                                            <div class="portlet box green">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <i class="fa fa-globe"></i>SCHOOL PROFILE COMPLETED - <?php if($this->uri->segment(3,0)=='dist'){ echo('DISTRICT'); } elseif($this->uri->segment(3,0)=='blk'){ echo('BLOCK'); }elseif($this->uri->segment(3,0)=='sch'){ echo('SCHOOL');}?></div>
                                                    <div class="tools"> </div>
                                                </div>
                                                <div class="portlet-body">    
