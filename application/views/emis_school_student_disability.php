...
<div class="col-lg-12">
                              ...
                              <!--      <div class="portlet light portlet-fit ">
                                        ...
                                        <!-- BEGIN CARDS -->
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>CWSN-Student Report | School</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                       ...
                                                       <?php $prekg_tot=0;$lkg_tot=0;$ukg_tot=0;$c1_tot=0;$c2_tot=0;$c3_tot=0;$c4_tot=0;$c5_tot=0;$c6_tot=0;$c7_tot=0;$c8_tot=0;$c9_tot=0;$c10_tot=0;$c11_tot=0;$c12_tot=0; ?>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <?php if(!empty($allstuds)){  $c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1; foreach($allstuds as $det){ $total = $det->cls_1 + $det->cls_2 + $det->cls_3 + $det->cls_4 + $det->cls_5 + $det->cls_6 + $det->cls_7 + $det->cls_8 + $det->cls_9 + $det->cls_10 + $det->cls_11 + $det->cls_12;
                                                             ?>

                        <tr>
                            <td style="text-align: center;"><?php echo $i;?></td>
                                                                  
                            <td> <a href="#"><?php echo $det->da_name; ?></a></td>
                                                                    
                             <td style="text-align: center;"><?php echo number_format($det->cls_1); ?></td>
                             <td style="text-align: center;"><?php echo number_format($det->cls_2); ?></td>
                             <td style="text-align: center;"><?php echo number_format($det->cls_3); ?></td>
                             <td style="text-align: center;"><?php echo number_format($det->cls_4); ?></td>
                             <td style="text-align: center;"><?php echo number_format($det->cls_5); ?></td>
                             <td style="text-align: center;"><?php echo number_format($det->cls_6); ?></td>
                             <td style="text-align: center;"><?php echo number_format($det->cls_7); ?></td>
                             <td style="text-align: center;"><?php echo number_format($det->cls_8); ?></td>
                             <td style="text-align: center;"><?php echo number_format($det->cls_9); ?></td>
                             <td style="text-align: center;"><?php echo number_format($det->cls_10); ?></td>
                             <td style="text-align: center;"><?php echo number_format($det->cls_11); ?></td>
                             <td style="text-align: center;"><?php echo number_format($det->cls_12); ?></td>
                             <td style="text-align: center;"><?php echo number_format($total); ?></td>
                                                            ...
                                                            array_push($c1_tot,$det->cls_1);
                                                            array_push($c2_tot,$det->cls_2);
                                                            array_push($c3_tot,$det->cls_3);
                                                            array_push($c4_tot,$det->cls_4);
                                                            array_push($c5_tot,$det->cls_5);
                                                            array_push($c6_tot,$det->cls_6);
                                                            array_push($c7_tot,$det->cls_7);
                                                            array_push($c8_tot,$det->cls_8);
                                                            array_push($c9_tot,$det->cls_9);
                                                            array_push($c10_tot,$det->cls_10);
                                                            array_push($c11_tot,$det->cls_11);

                                                            array_push($c12_tot,$det->cls_12);
	   ...
	   <div class="page-head">
                                ...
                                <div class="container">
                                                    ...
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globes"></i>CWSN-Student Report | School</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                          ...
                                                          <?php if(!empty($stud_detail)){ 
														  $i=1; foreach($stud_detail as $det){ 
                                                    ...
                                                    <tr>
														 ...
														 <td><?php 
                                                                  ...
                                                                  <td ><?= $det->class_studying_id ?>- <?= $det->class_section ?></td>
																  <td> 
                                                                    <?php echo $det->da_name; ?></td>
