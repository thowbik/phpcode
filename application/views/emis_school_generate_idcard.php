                                ...
                                <div class="container">
                                    <!-- BEGIN PAGE TITLE -->
                                     <div class="page-title">
                                        <h1>Print ID card
                                            <small> Class wise print student list</small>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                    <!-- BEGIN PAGE TOOLBAR -->
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <?php $this->load->view('emis_school_profile_header.php'); ?>
                                       ...
                                       <!---<?php $classes=array();
                                        ...
                                        <!-- BEGIN CARDS -->
                                        <span style="font-size: 22px;">Print Student List Class wise </span>
...
<!-- 
                                            ...
                                            <a href="<?php echo base_url().'Home/emis_school_studentsectionwise/'.$j; ?>" style="text-decoration: none;"> 
                                                ...
                                                <?php if(!empty($classlist)){ foreach ($classlist as $key){ ?>
                                                    ...
                                                    <div class="m-grid-col m-grid-col-middle m-grid-col-center">
                                            <a href="<?php echo base_url().'Home/emis_school_generate_idcard1/'.$key; ?>" style="text-decoration: none;"> 
                                              <?php 
                                                $classname =  $this->Homemodel->getstandaradnamesepe($key); ?>
                                                        <h2><?php echo $classname; ?></h2>
                                                <?php 
                                                $strength =  count($this->Homemodel->getallbrachesbyschoolinchildetail22($school_id,$key)); ?>
                                                <p style="color: red;">strength : <?php echo $strength; ?></p>
                                                    </a>
                                                    </div> 
                                                    <?php } } ?>
