                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> RTE Student Register<span> </span></div>
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                   <th> sno </th>                        
                                                                    ...
                                                                    <th> Name </th>           
                                                                    <th> Gender </th>                               <th>Community</th>                          
                                                                    <th> DOB </th>
                                                                    <th> Class</th>
                                                                    <th> Section </th>
																	 <?php if($class_id == 11 || $class_id == 12){?>
                                                                    <th> Group Code </th><?php }?>
                                                                    <th> RTE Status </th>
																	<th> RTE Type</th>
                                                                ...
                                                                <tr>
                                                                  <td><?php echo $i; ?></td>
                                                                   <!--  <td><a onclick="savestudentid1('<?php echo $all->unique_id_no; ?>')"><?php echo $all->unique_id_no; ?></a></td> -->
																	...
																	<td><?php echo $all->community_name; ?></td>
                                                                 ...
                                                                 <?php } 
                                                                   ...
                                                                   echo $group; }?></td>
                                                                     ...
                                                                     <td><?php 
                                                                     echo $all->child_admitted_under_reservation;
                                                                    
                                                                    
                                                                 ?></td>
																 													                               <td><?php echo $all->category; ?> -
														<?php echo $all->sub_category; ?>																						   </td>
