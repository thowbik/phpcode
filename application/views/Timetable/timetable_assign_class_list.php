...
<?php $this->load->view('state/header.php'); }else{ $this->load->view('header.php'); } ?>
                                        ...
                                        <div class="portlet light portlet-fit ">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-dark sbold uppercase">Timetable Assigning Status</span>
                                                </div>
                                            </div> 
                                                ...
                                                <center>
                                                  <form id="filter" method="post" action="<?php echo base_url().'TimetableController/timetable_assign_class_list';?>">
                                            ...
                                            <div class="portlet-body">
                                               ...
                                               <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Timetable Assigning Status Report&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;From &nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<?php echo $fromdate=date_format(date_create_from_format('Y-m-d', $this_week_fst), 'd-m-Y');?>
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<?php echo $todate=date_format(date_create_from_format('Y-m-d', $this_week_ed), 'd-m-Y');;?></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
															 ...
															 <tbody>
                              <?php  $i=1;?>
                              <?php if(!empty($classassignlist)){							  
                                foreach($classassignlist as $ca){ 
								
								$assigned=$ca->time_table;
          ...
          $class_roma = array
                                                    ...
                                                    $class_no= array
                                                            ...
                                                            $class_roman_name = array_search($ca->class_id,$class_roma);
                                                            $class_roman_no = array_search($ca->class_id,$class_no);
                                                            // echo $class_roman_no;
                             ...
                             <td style="text-align: center;"><?php echo $ca->class_id;?></td>
                              <td style="text-align: center;"><?php echo $ca->section; ?></td>
