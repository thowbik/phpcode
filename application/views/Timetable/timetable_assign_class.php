                                        ...
                                        <div class="portlet light portlet-fit ">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-dark sbold uppercase">Timetable Assign Classes Report</span>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="portlet-body">
                                               ...
                                               <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Timetable Assign Classes Report in the School </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Total Classes</th>
                                                                    <th style="width:15%;">Assigned Timetable</th>
                                                                    <th style="width:15%;" >Not Assigned Timetable</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                               ...
                                                               <tr>
															   <?php
															                                                                                                                          foreach($classassignDetails as $ca)
															   {
																 
																}
																		?>
																	<td><?php echo $ca->totalclasssection; ?>
                                                                    <td><?php echo $ca->marked; ?></td>
                                                                    <td><?php echo $notassigned=$ca->totalclasssection-$ca->marked; ?></td>
                                                               </tr>
                                                            </tbody>
