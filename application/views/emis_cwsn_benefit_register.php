                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>CWSN-Student Benefits Register<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th style="width:0%;" >CWSN</th>
																	<th style="width:0%;" >National Id</th>
																	<th style="width:0%;">Benefits</th>
																	<th style="width:0%;">Provided By</th>
																	<th style="width:0%;">Acad Year</th>
															...
															if(!empty($cwsn_benefit)){ $total1 = 0; foreach($cwsn_benefit as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   <td><?php echo $sd->unique_id_no;?></td> 
                                                                    ...
                                                                    <td><?php echo $sd->class_studying_id;?>-<?php echo $sd->class_section;?></td>
																	 <td><?php echo $sd->da_name;?></td>
																	 <td><?php echo $sd->national_id;?></td>
                                                                    <td><?php echo $sd->bf;?></td>
																	 <td><?php echo $sd->provided_by;?></td>
																	  <td><?php echo $sd->acad_year;?></td>
