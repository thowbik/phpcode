                    ...
                    <div class="page-container">
                                        ...
                                        <div class="row margin-bottom-20">
                                             <div class="portlet-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                           <center>
                                                  <!--<form id="filter" method="post" action="<?php echo base_url().'Home/get_student_scheme_list_trstse';?>">
                        ...
                        <!--   <div class="col-md-3">  
                          ...
                          <div class="col-md-offset-2 col-md-2">
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Scholarship and Sports Participation<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Gender</th>
                                                                    <th>Class-Sec</th>
                                                                    <th style="width:0%;">Game Participating</th>
                                                                    <th style="width:0%;" >Participating Date</th>
                                  <th style="width:0%;" >Played Level</th>
                                  <th style="width:0%;">Winner Level Details</th>
                              ...
                              if(!empty($student_tag1)){ $total1 = 0; foreach($student_tag1 as $index=> $sd){   ?>
                                  ...
                                  <td><?php echo $sd->game_participating;?></td>
                                                                    <td><?=
                                  date('d-m-Y', strtotime($sd->last_participating_date))?></td>
                                   <td><?php echo $sd->last_participating_level;?></td>
                                   <td><?php echo $sd->winner_level_details;?></td>                        
