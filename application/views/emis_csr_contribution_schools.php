...
<center>select
                                                  ...
                                                  <div class="portlet box green"> 
                                                    <div class="portlet-title">
                                                        ...
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> CSR Contributions<span> </span></div>
 ...
 -->                                                                    <!--<th class=" ">PAN</th>-->
                                                                   ...
                                                                   <!--  <th class=" ">Category Name</th> -->
                                                                    ...
                                                                    <th style="text-align: center" class=" ">Quantity</th>
                                                                    <th style="text-align: center" class=" ">Amount</th> 
                                                                  <!--   <th>Type</th> -->
                                                                    <th class=" ">Supporter Name</th>
                                                                    <th class=" ">Mobile</th>
 ...
 -->
                              ...
                              // "<?php echo base_url().'district/emis_staff_school_count_details?schoolid='.$sd->school_id
                               ...
                               if(!empty($csr)){ $total1 = 0; foreach($csr as $index=> $sd){ ?>
                                                                                          
                                                                <tr>
                                
                                                                    <td class="center"><?=$index+1;?></td>
                                          <td width="90"><span><?php echo date('d-m-Y',strtotime($sd->time)); ?></span></td>
                                                                        ...
                                                                        <td><?php echo $sd->material_name;?></td>
                                                                 <td style="text-align: center"><?php echo $sd->qty;?></td>
                                                                          <td style="text-align: right"><?php echo 'Rs.'. $sd->amount;?></td>
                                                                         <!--  <td><?php if($sd->cont_type ==1) {echo "FUNDS";}else {echo "MATERIAL";}?></td> -->
                                                                          <td><?php echo $sd->Supporter_name;?></td>
                                                                          <td><?php echo $sd->Mobile;?></td>
                                                                         <!--  <td><b><a href="<?php echo base_url()?>Home/pdf_question/<?php echo $sd->cont_id;?>"><i class="fa fa-file-pdf-o" style="color:red;font-size:26px"></i></a></b></td> -->
                                                             ...
                                                             <?php foreach($total_req as  $ts) { 
                                                                         // print_r($total_req);   ?>
                                                                       <tr><td><b></b></td><td></td><td></td><td></td><td><b>Total :  <?php $need = number_format($ts->received_amt)."<br>";?>
                                                                   <?php echo 'Rs.'.$need; ?></b></td><td></td><td><!-- </td><td> --></td></tr>
                                                                     <?php }?>
...
function sum_dataTable(dataId){
    var table = $(dataId).DataTable({
      dom: 'Bfrtip',
        ...
        { extend: 'pdf', className: 'btn default', orientation: 'landscape',
                  pageSize: 'LEGAL' }
            ],
    ...
    var  thead= '',tbody='';
       ...
       data:{'school_id':school_id},
           ...
           success: function (response) {
            console.log(response);
               ...
               // var data = JSON.parse(response.responseText);
                   ...
                   thead += '<td><b>District Name</b></td>';
                   thead += '<td><b>Block Name</b></td>';
                   thead += '<td><b>Education District Name</b></td>';
                   thead += '<td><b>School Name</b></td>';
                   thead += '<td><b>Udise Code</b></td>';
                   thead += '<td><b>Category</b></td>';
                   thead += '<td><b>Category Name</b></td>';
                   thead += '<td><b>Material Name</b></td>';
                   thead += '<td><b>Quantity</b></td>';
                   thead += '<td><b>Amount</b></td>';
                    thead += '<td><b>Supporter Name</b></td>';
                     thead += '<td><b>Mobile</b></td>';
                   thead += '<td><b>Status</b></td></thead>';
        ...
        console.log(d.school_name);
                tbody +='<tbody><tr>';
                tbody +='<td>'+i+'</td><td>'+d.district_name+'</td><td>'+d.block_name+'</td><td>'+d.edu_dist_name+'</td><td>'+d.school_name+'</td><td>'+d.udise_code+'</td><td>'+d.category+'</td><td>'+d.cat_name+'</td><td>'+d.material_name+'</td><td>'+d.qty+'</td><td>'+d.amount+'</td><td>'+d.Supporter_name+'</td><td>'+d.Mobile+'</td><td>'+d.status+'</td>';
                tbody +='</tr></tbody>';
