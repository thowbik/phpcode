                                ...
                                <div class="container">
                                    ...
                                    <?php $this->load->view('emis_school_profile_header.php'); ?>
                                        ...
                                        <!-- BEGIN CARDS -->
                                         ...
                                         <span style="font-size: 22px;">Approove id card Section wise </span>
      ...
      ?>
                                          ...
                                          <?php if($class!=""){ echo $class; } ?></span>
                                                 <hr>
                                                        ...
                                                        foreach($a as $v){?> 
                                                            <div class="col-md-4">
                                                            <a href="<?php echo base_url().'Home/emis_school_approove_idcard2/'.$class_id.'/'.$v;?>" style="text-decoration: none;">
