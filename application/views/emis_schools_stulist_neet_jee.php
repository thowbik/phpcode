...
<!-- 
                                            ...
                                            <a href="<?php echo base_url().'Home/emis_school_studentsectionwise/'.$j; ?>" style="text-decoration: none;"> 
                                                ...
                                                <?php  if(!empty($classlist)){ foreach ($classlist as $key){ if($key==11 || $key ==12) { ?>
                                                   
                                                    <div class="m-grid-col m-grid-col-middle m-grid-col-center">
                                            <a href="<?php echo base_url().'Home/emis_school_neet_jee_seclist/'.$key; ?>" style="text-decoration: none;"> 
                                              <?php 
                                                ...
                                                <p style="color: red;">strength : <?php echo $strength; ?></p>
                                                    ...
                                                    <?php if($highclass != 11 && $highclass !=12) {  ?>
                                                   <center>  <h2>Message :  Only applicable for Higher Secondary schools </h2> </center>
                                                     <?php } ?>
                                                </div> 
