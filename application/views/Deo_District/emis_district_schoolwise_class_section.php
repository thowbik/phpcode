                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Partially Aided School - Section Verification</div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="sum center">Un Aided Sections</th>
																	 <th class="sum center">Not Marked</th>
                                                                </tr>
                                                                </thead>
                                                               <tbody>
                                                            <?php if(!empty($school_details)){ $total1 = 0; foreach($school_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td> <a href="<?php echo base_url().'Deo_District/school_class_section?schoolid='.$sd->school_id?>&schoolname=<?php echo $sd->school_name ?>"><?=$sd->school_name;?></a></td>
