  ...
  <?php $this->load->view('Deo_District/header.php'); ?>
													...
													<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
														<div class="dashboard-stat2 ">
															<div class="display">
																<div class="number">
																	<h3 class="font-green-sharp">
																	<?php $nonteachercounts=0; ?>
																		<span data-counter="counterup" data-value="34"><?php if(!empty($special_schools)){  foreach($special_schools as $det){$nonteachercounts=$nonteachercounts+$det->nonteachercount;}} ?>
																		<?php echo number_format($nonteachercounts);?>
																		</span>
												...
												<div class="portlet box" >
													...
													<div class="portlet-body" >
														<div class="form-group">
															...
															<form action="<?php echo base_url(); ?>Deo_District/schoolcatemanagefil" method="POST">
															...
															<label class="control-label bold">Student Total count - less than - <?=$id1 !=''?$id1:'';?></label>
																...
																<div class="form-group" >
															<label class="control-label bold">Student Total count - Greater than - <?=$id2 !=''?$id2:'';?></label>
                                                    
																<div class="">
																<input type="number" class="form-control" id="emis_state_special_search1" name="emis_state_special_search1"  placeholder="Type the number" min="1" maxlength="4"  onKeyDown="if(this.value.length==4 && event.keyCode!=8) return false;"value="<?=$id2;?>"/>
																<!-- <input class="bar" type="range" id="student_count" value="0"/> -->
                                                  ...
                                                  <div class="portlet box green">
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <?php $total1 = 0; if(!empty($special_schools)){  $count = 0; foreach($special_schools as $det){ 
														
																   $count+=1; ?>

                                                                <tr>
																<td><?php echo number_format($count); ?></td>
                                                                <td><a href="#">        <?php echo $det->udise_code; ?></a></td>
        ...
        <script type="text/javascript">
			...
			function searchfilter(emis_state_report_schcate,emis_state_report_schmgtype,emis_state_special_search,emis_state_special_search1) {
				...
				var id1 = $("#emis_Ceo_District_special_search").val();
				var id2= $("#emis_Ceo_District_special_search1").val();
            ...
            $(document).on('change','#student_count',function()
             {
             	// alert($(this).val());
             	$("#emis_Ceo_District_special_search").val($(this).val());
             })
             $(document).on('change','#emis_Ceo_District_special_search',function()
             {
             ...
             {
             	// alert($(this).val());
             	$("#emis_Ceo_District_special_search1").val($(this).val());
             })
             $(document).on('change','#emis_Ceo_District_special_search1',function()
             {
             	$("#student_count").val($(this).val());
             })
