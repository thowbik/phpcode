                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Deo_District/school_committee_verification_district?dist_id='.$district_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
...
$total1 = [];
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>School Committee Details - Verification Report</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                           ...
                                                           <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>UDISE<br/>Code</th>
                                                                    <th>School Name</th>
                                                                    <th>SMC<br/>Constituted?</th>
                                                                    <th>SMDC<br/>Constituted?</th>
                                                                    <th>SBC <br/>constituted?</th>
                                                                    <th>AC <br/>Constituted?</th>
                                                                    <th>PTA<br/> Constituted?</th>
                                                                    <th>PTA <br/>Established<br/>Year</th>
                                                                    <th>PTA<br/> Registration<br/>Number</th>
                                                             ...
                                                             ?>
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td style="text-align: center;"><?=$det->block_name;?></td>
                                                                   ...
                                                                   <td style="text-align: center;"><?php if($det->smc_const==0)
                                                                    {
                                                                      echo "NO";
                                                                    }
                                                                    else
                                                                    ...
                                                                    ?></td>
                                                                     ...
                                                                     <td style="text-align: center;"><?php if($det->smdc_constitu==0)
                                                                    {
                                                                      echo "NO";
                                                                    }
                                                                    else
                                                                    ...
                                                                    ?></td>
                                                                     ...
                                                                     <td style="text-align: center;"><?php if($det->sbc_const==0)
                                                                    {
                                                                      echo "NO";
                                                                    }
                                                                    else
                                                                    ...
                                                                    ?></td>
                                                                     <td style="text-align: center;"><?php if($det->acadecomm_const==0)
                                                                    {
                                                                      echo "NO";
                                                                    }
                                                                    else
                                                                    ...
                                                                    ?></td>
                                                                     <td style="text-align: center;"><?php if($det->pta_const==0)
                                                                    {
                                                                      echo "NO";
                                                                    }
                                                                    else
                                                                   ...
                                                                   <td style="text-align: center;"> <?=$det->pta_est_yr;?></td>
                                                                   <td  style="text-align: center;"> <?php 
                                                                      echo $det->pta_reg_no;?></td>
