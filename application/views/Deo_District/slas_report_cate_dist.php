                                        ...
                                        <div class="row margin-bottom-20">
                                             <div class="portlet-body">
                                                <div class="row" style="margin-left: 6px;">
                                                    ...
                                                    <!--  <form  action="<?=base_url().'Deo_District/slas_report_dist'?>" method="POST" >
                                                        <div class="row">
                                                        <div class="col-md-4">
...
<div class="col-md-3">
        ...
        <br>
                              ...
                              <tr>
                                ...
                                <th style="text-align: center;">School Category</th>  
                               ...
                               $j=0; $sum=0; $assigned_sum=0; $not_marked=0;//print_r($value); die();
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="<?php echo base_url().'Deo_District/slas_report_schl_blk/?catty_id='.$key->catty_id?>"><?php echo($key->cate_type); ?></a></td>
