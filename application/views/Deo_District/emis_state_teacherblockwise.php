                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Deo_District/emis_teacher_classwise_district/?dist_id='.$dist_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td style="text-align: center;"><?php echo $i;?></td>
                                                             <td><a href="<?php echo base_url().'Deo_District/emis_teacher_classwise_block/?block_id='.$det->block_id?>">
