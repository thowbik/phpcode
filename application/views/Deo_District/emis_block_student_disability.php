                              ...
                              <!--      <div class="portlet light portlet-fit ">
                                        ...
                                        <!-- BEGIN CARDS -->
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i> CWSN-Student Report | Block-wise  </div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                             ...
                                                             ?>
                                                                ...
                                                                <tr>
                                                                  <td style="text-align: center;"><?php echo $i;?></td>
                                                                    ...
                                                                    <td> <a  href="<?php echo base_url().'Deo_District/emis_student_disability_schoolwise/?block_name='.$det->block_name?>">
                                                                 ...
                                                                 <td style="text-align: center; font-weight: bold;"><?php echo number_format($total); ?></td>
