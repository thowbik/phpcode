...
<link href="<?php echo base_url().'asset/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css';?>" rel="stylesheet" type="text/css" />
  ...
  <?php $this->load->view($header.'/header.php'); ?>
    ...
    <?php } }?>
                                                ...
                                                <div class="form-group">
    <label for="title" class="center">Title</label>
...
<input type="checkbox" id="block_checkbox" >Select All
    ...
    <select multiple id="block" style="width:300px" name="block[]">
        ...
        ?>
        <option value="<?=$blocks->block_code?>"><?=$blocks->block_name;?></option>
    <?php } }?>
    </select>
  </div>
                                               ...
                                               <div class="row">
                                                    <div class="col-md-offset-8 col-md-2">
                                                              ...
                                                              <div class="form-group" style="padding: 10px;margin-top: 15px">
                                                                ...
                                                                <button type="button" onclick="save();" class="btn green btn-lg" id="btn">Submit</button>
                                                              </div>
                                                              </div>
        ...
        <div class="col-md-4">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Messages &nbsp<span style="margin-top:-5px;background-color:yellow;"class="badge"><?=(!empty($old_flash_message)?sizeof($old_flash_message):'0');?></span></h3>
...
var link = '<?php echo $link?>';
                ...
                var block_details = <?php echo json_encode($block)?>;
              $(document).ready(function(){ 
                $("#block_group").hide();
                $("#manage_group").hide();
...
$('#district').on('select2:unselect', function(e) {
  ...
  $('#block').on('select2:unselect', function(e) {
    ...
    }else
    {
        ...
        if(to_msg =='-1' || title =='' || title == null || title == undefined || block_array.length ==0 ){
            // console.log('kif');
            $("#errmsg").html("<span style='color:red'>Please Enter The To Message,Title and Select atleast one Block</span>");
