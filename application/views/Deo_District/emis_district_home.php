                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Dashboard
                                            <small>State Dashboard</small> - <label style="color:red;"><?php echo $details[0]->district_name;?></label>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                    <!-- BEGIN PAGE TOOLBAR -->
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Deo_District/emis_Deo_District_home'?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                            ...
                                                            <?php if(!empty($details)){$prekg_tot= [];$lkg_tot= [];$ukg_tot= [];$c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1; foreach($details as $det){ $total=$det->PREKG+$det->LKG+$det->UKG+$det->class_1+$det->class_2+$det->class_3+$det->class_4+$det->class_5+$det->class_6+$det->class_7+$det->class_8+$det->class_9+$det->class_10+$det->class_11+$det->class_12 ?>
                                                                ...
                                                                <tr>
                                                                  <td style="text-align: center;"><?php echo $i;?></td>
                                                                    <td> <a href="<?php echo base_url().'Deo_District/get_dash_blockwise_school?block='.$det->block_name?>">
