                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Dashboard
                                            <small>school Details</small> - <label style="color:red;"><?php if($distname!="") { echo $distname; };?></label>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                    <!-- BEGIN PAGE TOOLBAR -->
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     <div class="portlet light">
                                            <form action="<?php echo base_url()?>Deo_District/get_districtwise_school" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-8" >
                                                              ...
                                                              <div class="form-group" style="padding: 10px;padding-left: 8%">
                                                                ...
                                                                School Management <input type="checkbox" id="emis_state_report_schmanage"  value="all" name="school_manage"> All</label><br/>
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> School List | <span>District : <?php if($distname!="") { echo $distname; } ?></span> </div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                               ...
                                                               <tbody>
                                                            <?php if(!empty($school_info)){ $total1 = 0; foreach($school_info as $index=> $det){   ?>

                                                                <tr>
                                                                <td><?=$index+1;?></td>
                                                                    <td> <a href="<?php echo base_url().'Deo_District/get_schoolwise_teacherlist?school='.$det->school_id?>">
