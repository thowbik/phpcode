...
<div class="container">
    ...
    <div class="page-title">
        <h1>Reset Password
            <small>user reset password-CEO</small>
        </h1>
    </div>
    <!-- END PAGE TITLE -->
    <!-- BEGIN PAGE TOOLBAR -->
...
<div class="container">
 ...
 <!--<?php $this->load->view('Ceo_District/emis_district_profile_header.php'); ?>-->
 </center>
                                                    ...
                                                    <label class="control-label col-md-4">Old password *</label>
                                                        <div class="col-md-4">
                                                            <input type="password" class="form-control" id="emis_dist_user_oldpass" name="emis_dist_user_oldpass"  placeholder="Old Password *" >
                                                             <font style="color:#dd4b39;"><div id="emis_ceo_user_oldpass_alert"></div></font>
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <label class="control-label col-md-4">Confirm New password *</label>
                                                        <div class="col-md-4">
                                                            <input type="password" class="form-control" id="emis_dist_user_cnfpass" name="emis_ceo_user_cnfpass"  placeholder="Confirm New password *">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-6">
                                                            <button type="button" class="btn green" id="emis_deo_reset_pass">Submit</button>
   ...
   <script src="<?php echo base_url().'asset/js/deo_district.js';?>" type="text/javascript"></script>
