                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="row">
                                       ...
                                       <form action="<?=base_url().'Deo_District/emis_dsesweater_indent'?>" method="post">
                        ...
                        <div class="panel panel-default panel-faq">
                                ...
                                <a data-toggle="collapse" data-parent="#accordion-cat-1" href="#" aria-expanded="true" class>
                                    <h4 class="panel-title">
                                        <i class="fa fa-globe"></i> Sweater Indent Summary 
															<?php  if($uf->scheme_category == 67){
															
															echo 'Cat-A Small Size 26-30'  ; } 
															else if($uf->scheme_category == 68)
															{ echo 'Cat-B Small Size 32-38';}
                            ...
                            <div id="faq-cat-1-sub-2" class="panel-collapse panel-collapse collapse in" aria-expanded="true" style>
							  ...
							  <?php if(!empty($uf->block_name)) {?>
							           ...
							           <td style="text-align:left;"><a href="<?php echo base_url().'Deo_District/emis_dsesweater_indent/?block_id='.$uf->scheme_category.$uf->scheme_id.$uf->block_id?>"><?php } else {?>
									   <td style="text-align:left;"><a href="<?php echo base_url().'Deo_District/emis_dsesweater_indent/?block_id='.'0'.$uf->scheme_id.$uf->block_id?>"><?php }?>
