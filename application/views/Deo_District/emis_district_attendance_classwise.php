                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Attendance By Class | School Name -   <?=$school_details->school_name;?><span></span> </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="sum center">Present</th>
                                                                    <th class="sum center">Absent</th>
                                                            ...
                                                            ('I'=>1,'II'=>'2','III'=>'3','IV'=>'4','V'=>'5','VI'=>'6','VII'=>'7','VIII'=>'8','IX'=>'9','X'=>'10','XI'=>'11','XII'=>'12','LKG'=>'13','UKG'=>'14','PreKG'=>'15');
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?=base_url().'Deo_District/get_attendance_sectionwise_details?school='.$school.'&class='.$det['class'].'&date='.$date?>"> 
                                                                    <?=$class_name;?></a>

                                                                </td>
                                                                   <td class="center">
                                                                    <b style="color:<?=($tot_stu >= $det['total_class'])?'green':'red'?>"><?=$tot_stu;?></b> / <b style="color: green;"><?=$det['total_class'];?></b></td>
                                                                   <td class="center"><?=$det['present'];?></td>
                                                                   <td class="center"><?=$det['absent'];?></td>
