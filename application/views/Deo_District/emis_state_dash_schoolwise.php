                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <form action="<?php echo base_url().'Deo_District/get_dash_blockwise_school?block='.$block_name?>"" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
        ...
        <?php echo number_format($over_total); ?></h4>
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i> Student School wise | <span>District :<?php echo $details[0]->district_name;?></span> | <span>Block : <?php echo $details[0]->block_name; ?></span>  </div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
