                                                            ...
                                                            <?php $total1 = []; if(!empty($allstuds)){ $pre_kg_tot= [];$ukg_tot= [];$lkg_tot= []; $c1_tot= [];$c2_tot= [];$c3_tot= [];$c4_tot= [];$c5_tot=[];$c6_tot= [];$c7_tot= [];$c8_tot= [];$c9_tot= [];$c10_tot= [];$c11_tot= [];$c12_tot= []; $i=1;$total1 = []; foreach($allstuds as $det){ 
                                                             ...
                                                             ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: center;"><?=$det->unique_id_no;?></td>
                                                                    <td><a href="#"><?=$det->name;?></a></td>
                                                                     <td style="text-align: center;"><?php if($det->class_studying_id==13)
                                                                            {
                                                                                echo 'LKG';
                                                                            }
                                                                            else if($det->class_studying_id==15)
                                                                            {
                                                                                echo 'PreKG';
                                                                            }
