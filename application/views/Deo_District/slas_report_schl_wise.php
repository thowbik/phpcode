                                       ...
                                       <!--  <div class="row margin-bottom-20">
                                             <div class="portlet-body">
                                               <div class="row" style="margin-left: 6px;">
                                                      ...
                                                      <form  action="<?php echo base_url().'Deo_District/slas_report_schl/?blk_id='.$blk_id?>" method="POST" >
                                                        <div class="row">
                                                        <div class="col-md-4">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>SLAS Marks Range -   <strong> BLOCK :</strong> <?php echo $student_migration_details[0]->block_name; ?> </div>
...
function sum_dataTable(dataId){
    var table = $(dataId).DataTable({
      dom: 'Blfrtip',
      order: [[0, "asc"]],
            lengthMenu: [[5, 10, 15, 20, -1], [5, 10, 15, 20]],
            pageLength: -1,
