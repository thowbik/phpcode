                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                                <div></div> 
                                <div class="container">
								<form id="filter" method="post" action="<?php echo base_url().'Deo_District/profile_status_blockwise';?>">
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Blockwise - Profile Completion Status<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
														...
														foreach($district_profile_completion_status as $index=> $comp_status){   ?>
                                                                ...
                                                                <tr>
                                                                    <td ><?=$index+1;?></td>
                                                                    <td style="text-align: left;"><a href="<?=base_url().'Deo_District/profile_status_schoolkwise?block='.$comp_status->block_id.'&school_type='.$school_type_c?>"><?=$comp_status->block_name?></a>
