                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Deo_District/school_land_verification_district?dist_id='.$district_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
...
$total1 = [];
                                           ...
                                           <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                             <i class="fa fa-globe"></i>School Land Details - Verification Report</div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>UDISE<br/>Code</th>
                                                                    <th>School Name</th>
                                                                    <th>Land Area<br/>in Acre</th>
                                                                    <th>Ground<br/>Available</th>
                                                                    <th>Ground<br/>Area<br/>in Acre</th>
                                                                    <th>Land<br/>Ownership</th>
                                                                    <th>Boundary<br/>Wall<br/>Type</th>
                                                                    <th>Perimenter of<br/>boundary<br/>in meters</th>
                                                                    <th>Length of<br/>boundarywall<br/>in m</th>
                                                                    <!--<th>Verified</th>-->
                                                             ...
                                                             ?>
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td style="text-align: center;">
                                                                    <?php 
                                                                    $num = $det->land_avail_sqft/43560;
                                                                    echo $num2=substr($num,0,6);
                                                                    ?></td>
                                                                   <td style="text-align: center;"> <?php 
                                                                   if($det->play_facility==0)
                                                                    {
                                                                        echo "NO";
                                                                    }
                                                                    else
                                                                  ...
                                                                  ?></td>
                                                                   <td style="text-align: center;"> <?php $num1=$det->play_area_sqft/43560;
                                                                     echo $num1=substr($num1,0,6)
                                                                   ?></td>
                                                                   <td> <?php 
                                                                   if($det->land_ownersip==1)
                                                                   {
                                                                    echo "Rental";
                                                                   }
                                                                   else if($det->land_ownersip==2)
                                                                   {
                                                                    echo "Leased";
                                                                   }
                                                                   else if($det->land_ownersip==3)
                                                                   {
                                                                    echo "Owned";
                                                                   }
                                                                   else if($det->land_ownersip==4)
                                                                   {
                                                                    echo "Rental Free";
                                                                   }
                                                                   ?></td>
                                                                   <td> <?php 
                                                                   if($det->cmpwall_type==1)
                                                                    {
                                                                    echo "Pucca";
                                                                    }
                                                                    else if($det->cmpwall_type==2)
                                                                    {
                                                                        echo "Pucca but broken";
                                                                    }
                                                                      else if($det->cmpwall_type==3)
                                                                    {
                                                                        echo "Barbed wire fencing";
                                                                    }
                                                                      else if($det->cmpwall_type==4)
                                                                    {
                                                                        echo "Hedges";
                                                                    }
                                                                      else if($det->cmpwall_type==5)
                                                                    {
                                                                        echo "Under Construction";
                                                                    }
                                                                      else if($det->cmpwall_type==6)
                                                                    {
                                                                        echo "No boundry wall";
                                                                    }


                                                                    ?></td>
                                                                   <td style="text-align: center;"> <?=$det->cmpwall_perimtr;?></td>
                                                                   <td style="text-align: center;"> <?=$det->cmpwall_length;?></td>
