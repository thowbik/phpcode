                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
														<?php 
														foreach($note_book_distribute_details as $sd)
														{
															
														}
														?>
                                                            <i class="fa fa-globe"></i>School Notebooks Distribution Register<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
															...
															if(!empty($note_book_distribute_details)){ $total1 = 0; foreach($note_book_distribute_details as $index=> $sd){   ?>
