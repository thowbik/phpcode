                                 ...
                                 <div class="page-content-inner">
                                    ...
                                    <div class="row">
                                       <div class="col-md-12">
                                             ...
                                             <?php } ?>
                                             <!-- error reporting End -->
                                                     <form method="post" action="<?php echo base_url().'Udise_schemes/emis_school_schemes2' ?>" id="schemestable2">
                                                         ...
                                                         <div class="table-scrollable">
                                                            <table class="table table-bordered table-striped">
                                                               ...
                                                               <tbody>
                                                                  <tr>
                                                                     <td>
                                                                        <select class="form-control" name="schem2fac" style="width: 150px;">
                                                                           ...
                                                                           <option value="12">Free Geometry Box</option>
                                                                           <option value="13">Free Atlas</option>
