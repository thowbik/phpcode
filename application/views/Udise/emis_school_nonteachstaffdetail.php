                                       ...
                                       <div class="col-md-9" style="margin-left: -6%">
                                          <div class="pull-left">
                                             <span class="testimonials-name">
												...
												<!--<h3 style="margin-top:0px;"> <a style="text-decoration: none; color:red;"><?php echo $teacher_name; ?></a></h3>
												<h3 style="margin-top:0px;"> <a style="text-decoration: none; color:red;"><?php echo $udise_code; ?></a></h3>-->
                                     ...
                                     <div class="col-md-12 thumbnail">                                        
                                      <span class="col-md-6">
											...
											<center>
											 ...
											 <span class="col-md-6">
											 <a href="<?php echo base_url().'Udise_staff/emis_school_staffdata2/'.$staff[0]->u_id?>" class="pull-right" style="margin-top: 2%; margin-right: 25px;" target="_blank">
