  ...
  <?php } ?>
            ...
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">Non-Teaching Staff profile</span>
                </div>
            </div> 
            <center> <h3 class="form-section">Non-teaching Staff Profile Registered Successfully</h3>
            <h4>Staff Name - <?php echo $teacher_name;  ?></h4>
             <h4>Staff ID - <?php echo  $teacher_code;  ?></h4>
             <br/>
             <br/>
