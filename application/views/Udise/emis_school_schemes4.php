                                    ...
                                    <div class="row">
                                       <div class="col-md-12">
                                                   ...
                                                   <div class="portlet-body">
                                                       ...
                                                       <?php if ($this->session->flashdata('schemes4')){ ?> 
                                                <!-- BEGIN PAGE CONTENT INNER -->
                                                   <div class="page-content-inner">
                                                      <div class="row">
                                                         <div class="col-md-12">
                                                            <div class="note note-danger note-bordered">
                                                               <?php echo $this->session->flashdata('schemes4'); ?>
                                                            </div>
                                                         </div>
                                                      </div>
                                                   </div>
                                             ...
                                             <!-- error reporting End -->
                                                      ...
                                                      <form method="post" action="<?php echo base_url().'Udise_schemes/emis_school_schemes4' ?>" id="schemestable4">
                                                         ...
                                                         <div class="table-scrollable">
                                                            <table class="table table-bordered table-striped">
                                                               ...
                                                               <tbody>
                                                                  <tr>
                                                                     <td>
                                                                        <select class="form-control" name="sch4fac" style="width: 150px;">
                                                                           ...
                                                                           <option value="15">Bi-Cycle</option>
                                       ...
                                       <div class="col-md-12">
                                                    <div class="portlet light ">
                                                        ...
                                                        <div class="portlet-body">
                                                         <!-- error reporting start -->
                                                       <?php if ($this->session->flashdata('schemestb2')){ ?> 
                                                <!-- BEGIN PAGE CONTENT INNER -->
                                                   <div class="page-content-inner">
                                                      <div class="row">
                                                         <div class="col-md-12">
                                                            <div class="note note-danger note-bordered">
                                                               <?php echo $this->session->flashdata('schemestb2'); ?>
                                                            </div>
                                                         </div>
                                                      </div>
                                                   </div>
                                             ...
                                             <?php } ?>
                                             <!-- error reporting End -->
                                                         <form method="post" action="<?php echo base_url().'Udise_schemes/emis_school_schemes4' ?>" id="schemestable5">
                                                            <!-- division for scrollable table -->
                                                            <div class="table-scrollable">
                                                               <table class="table table-bordered table-striped">
                                                                     <thead>
                                                                        <tr>
                                                                     ...
                                                                     <tbody>
                                                                        <tr>
                                                                           <td>
                                                                              <select class="form-control" name="sch4fac2">
                                                                                 <option value="">Select the option</option>
                                                                                 <option value="Brailbooks">Brailbooks</option>
                                                                                 <option value="Brailkit">Brailkit</option>
                                                                                 <option value="Low Vision Kit">Low Vision Kit</option>
                                                                           ...
                                                                           <td>
                                                                              <input type="text" class="form-control" name="tb1" maxlength="4">
                                                                           </td>
                                                                           <td>
                                                                              <input type="text" class="form-control" name="tb2" maxlength="4">
                                                                           </td>
                                                                           <td>
                                                                              <input type="text" class="form-control" name="tb3" maxlength="4">
                                                                           </td>
                                                                           <td>
                                                                              <input type="text" class="form-control" name="tb4" maxlength="4">
                                                                           </td>
                                                                           <td>
                                                                              <input type="text" class="form-control" name="tb5" maxlength="4">
                                                                           </td>
                                                                           <td>
                                                                              <input type="text" class="form-control" name="tb6" maxlength="4">
                                                                           </td>
                                                                        </tr>
                                                                     </tbody>
                                                               </table>   
                                                            </div>
                                                            <!-- division for scrollable table Ending -->
                                                            <div class="row">
                                                         ...
                                                         <table class="table table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                               <?php 
                                                               foreach ($schemes4frm2dta as $data1) { ?>
                                                                  
                                                               <tr>
                                                                  <td><?php echo $data1->facility; ?></td>
                                                                  <td><?php echo $data1->ele_b; ?></td>
                                                                  <td><?php echo $data1->ele_g; ?></td>
                                                                  <td><?php echo $data1->sec_b; ?></td>
                                                                  <td><?php echo $data1->sec_g; ?></td>
                                                                  <td><?php echo $data1->hsc_b; ?></td>
                                                                  <td><?php echo $data1->hsc_g; ?></td>
                                                               </tr>
                                                               <?php } ?>
