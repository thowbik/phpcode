                              ...
                              <div class="container">
                                 ...
                                 <div class="page-title">
                                    <h1>Staff Information
                                       <small>Teaching and Non-Teaching Staff</small>
                                    </h1>
                                 </div>
                                 <!-- END PAGE TITLE -->
                                 <!-- BEGIN PAGE TOOLBAR -->
                                             ...
                                             <div class="col-md-12">
                                                   <table class="table table-bordered" id="user">
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td style="width:50%">
                                                            <a href="javascript:;" id="schoolstaffteachingregularteacher" data-type="text" data-pk="1" data-value="<?php echo $tchingstff_reg; ?>" data-url="<?php echo base_url().'Udise_staff/updateschlstaffteachingregularteacher';?>" data-original-title="Enter total no of teaching regular staff">  </a> 
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td>Teaching Staff (Contract Teacher) :</td>
                                                         <td style="width:50%">
                                                            <a href="javascript:;" id="schoolstaffteachingcontractorteacher" data-type="text" data-pk="1" data-value="<?php echo $tchingstff_cntrct; ?>" data-url="<?php echo base_url().'Udise_staff/updateschlstaffteachingcontractorteacher';?>" data-original-title="Enter total no of teaching contractor staff">  </a> 
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td>Part-time instructors for Arts, Health and Physical Education positioned as per RTE norms for upper primary section</td>
                                                         <td style="width:50%">
                                                            <a href="javascript:;" id="schoolstaffparttimeinstructorsforartshealthandpysicaleducation" data-type="text" data-pk="1" data-value="<?php echo $prtme_instctr; ?>" data-url="<?php echo base_url().'Udise_staff/updateschlstaffparttimeinstructorsforartshealthandpysicaleducation';?>" data-original-title="Enter total no of part-time instructors for Arts, Health and Physical Education positioned as per RTE norms for upper primary section">  </a> 
                                                         </td>
                                                      </tr>
                                                ...
                                                <table id="user" class="table table-bordered">
                                                   ...
                                                   <tbody>
                                                      <tr>
                                                         <td> Accountant: </td>
                                                         <td style="width:50%">
                                                            <a href="javascript:;" id="schoolstaffaccountant" data-type="text" data-value="<?php echo $accntnt; ?>" data-pk="1" data-url="<?php echo base_url().'Udise_staff/updateschlstaffaccountant';?>" data-original-title="Enter No of accountant position">  </a> 
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td> Library Assistant: </td>
                                                         <td style="width:50%">
                                                            <a href="javascript:;" id="schoolstafflibraryassist" data-type="text" data-value="<?php echo $lib_asst; ?>" data-pk="1" data-url="<?php echo base_url().'Udise_staff/updateschlstafflibraryassist';?>" data-original-title="Enter No of library assistant position">  </a> 
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td> Laboratory Assistant: </td>
                                                         <td style="width:50%">
                                                            <a href="javascript:;" id="schoolstafflabassist" data-type="text" data-value="<?php echo $lab_asst; ?>"  data-pk="1" data-url="<?php echo base_url().'Udise_staff/updateschlstafflabassist';?>" data-original-title="Enter No of Laboratory assistant position">  </a> 
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td> UDC/ Head Clerk: </td>
                                                         <td style="width:50%">
                                                           <a href="javascript:;" id="schoolstaffudcorheadclerk" data-type="text" data-pk="1" data-url="<?php echo base_url().'Udise_staff/updateschlstaffudcorheadclerk';?>" data-value="<?php echo $udc_hedclrk; ?>" data-original-title="Enter No of UDC/Head Clerk position">  </a>  
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td> LDC: </td>
                                                         <td style="width:50%">
                                                            <a href="javascript:;" id="schoolstaffldc" data-type="text" data-pk="1" data-url="<?php echo base_url().'Udise_staff/updateschlstaffldc';?>" data-value="<?php echo $ldc; ?>" data-original-title="Enter No of LDC position">  </a>  
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td> Peon/MTS: </td>
                                                         <td style="width:50%">
                                                            <a href="javascript:;" id="schoolstaffpeonormts" data-type="text" data-pk="1" data-url="<?php echo base_url().'Udise_staff/updateschlstaffpeonormts';?>" data-value="<?php echo $peon_mts; ?>" data-original-title="Enter no of Peon/MTS position">  </a>  
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td> Night Watchman: </td>
                                                         <td style="width:50%">
                                                           <a href="javascript:;" id="schoolstaffnightwatchman" data-type="text" data-pk="1" data-url="<?php echo base_url().'Udise_staff/updateschlstaffnightwatchman';?>" data-value="<?php echo $night_wtchmn; ?>" data-original-title="Enter no of Nightwatchman position">  </a>  
                                                         </td>
                                                      </tr>
            ...
            <script>
              ...
              $('#schoolstaffaccountant').editable({
                   ...
                   success: function(response, newValue) {
                                    ...
                                    toastr.success("Accountant Updated Successfully", "Update Notifications"); 
                                    },
               ...
               $('#schoolstafflibraryassist').editable({
                   ...
                   success: function(response, newValue) {
                                    ...
                                    toastr.success("Library Assistant Updated Successfully", "Update Notifications"); 
                                    },
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
               ...
               $('#schoolstafflabassist').editable({
                   ...
                   success: function(response, newValue) {
                                    ...
                                    toastr.success("Laboratory Assistant Updated Successfully", "Update Notifications"); 
                                    },
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
               ...
               $('#schoolstaffudcorheadclerk').editable({
                   ...
                   success: function(response, newValue) {
                                    ...
                                    toastr.success("UDC/Head Clerk Updated Successfully", "Update Notifications"); 
                                    },
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
               ...
               $('#schoolstaffldc').editable({
                   ...
                   success: function(response, newValue) {
                                    ...
                                    toastr.success("LDC Updated Successfully", "Update Notifications"); 
                                    },
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
               ...
               $('#schoolstaffpeonormts').editable({
                   ...
                   success: function(response, newValue) {
                                    ...
                                    toastr.success("Peon/MTS Updated Successfully", "Update Notifications"); 
                                    },
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
               ...
               $('#schoolstaffnightwatchman').editable({
                   ...
                   success:  function(response, newValue) {
                                    ...
                                    toastr.success("Night Watchman Updated Successfully", "Update Notifications"); 
                                    },
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
               ...
               $('#schoolstaffteachingregularteacher').editable({
                   ...
                   success: function(response, newValue) {
                                    ...
                                    toastr.success("Teaching Staff (Regular Teacher) Updated Successfully", "Update Notifications"); 
                                    },
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
                ...
                $('#schoolstaffteachingcontractorteacher').editable({
                   ...
                   success: function(response, newValue) {
                                    ...
                                    toastr.success("Teaching Staff (Contract Teacher) Updated Successfully", "Update Notifications"); 
                                    },
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
                ...
                $('#schoolstaffparttimeinstructorsforartshealthandpysicaleducation').editable({
                   ...
                   success: function(response, newValue) {
                                    ...
                                    toastr.success("Part-time instructors for Arts, Health and Physical Education Updated Successfully", "Update Notifications"); 
                                    },
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
