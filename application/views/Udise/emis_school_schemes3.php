                                 ...
                                 <div class="page-content-inner">
                                    ...
                                    <div class="row">
                                       <div class="col-md-12">
                                             ...
                                             <?php } ?>
                                             <!-- error reporting End -->
                                                       <form method="post" action="<?php echo base_url().'Udise_schemes/emis_school_schemes3' ?>" id="schemestable3">
                                                         ...
                                                         <div class="table-scrollable">
                                                            <table class="table table-bordered table-striped">
                                                               ...
                                                               <tbody>
                                                                  <tr>
                                                                     <td>
                                                                        <select class="form-control" name="sch3fac" style="width: 150px;">
