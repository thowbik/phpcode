      ...
      <html lang="en">
         ...
         <body class="page-container-bg-solid page-md">
													...
													<table class="table table-striped" id="user">
														<tbody>
                                                         ...
                                                         <td ><!--<?php echo $staff[0]->teacher_name; ?>-->
                                                           <a href="javascript:;" id="teachername" data-type="text" data-pk="1" data-url="<?php echo (base_url().'Udise_staff/UpdateStaffData/'.$this->uri->segment(3,0)).'/teacher_name';?>" data-original-title="Enter the Teacher Name"><?php echo $staff[0]->teacher_name; ?>  </a>
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                      	 <td><b>Appointed for Subject:</b></td>
                                                         <td>
                                                            <a href="javascript:;" id="appointsubject" data-type="select2" data-pk="1"  data-value="<?php echo $staff[0]->appointed_subject; ?>" data-url="<?php echo (base_url().'Udise_staff/UpdateStaffData/'.$this->uri->segment(3,0)).'/appointed_subject';?>" data-original-title="Enter Appointed for Subject"><?php echo $staff[0]->appsub; ?></a>
                                                         </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                         <td><b>Gender:</b></td>
                                                         <td >
                                                            <a href="javascript:;" id="gender" data-type="select2" data-pk="1" data-value="<?php $staff[0]->gender; ?>" data-url="<?php echo (base_url().'Udise_staff/UpdateStaffData/'.$this->uri->segment(3,0)).'/gender';?>" data-original-title="Select Gender"><?php  
                                                                          if ($staff[0]->gender==1) {
                                                                           echo "Male";
                                                                          }
													  ...
													  <tr>
														...
														<!--<td><?php echo (date('d-m-Y', strtotime($staff[0]->staff_dob))); ?></td>-->
                                                ...
                                                <center>
													...
													<table class="table table-striped" id="user">
													  ...
													  <tr>
                                                         ...
                                                         <td><?php echo $staff[0]->aadhar_no;?>
                                                                    
															
																<!--	<a href="javascript:;" id="aadhar" data-type="text" data-pk="1" data-value="<?php 
                                                                          $aadhar = $staff[0]->aadhar_no;
                                                                            echo $aadhar; ?>" data-url="<?php echo (base_url().'Udise_staff/UpdateStaffData/'.$this->uri->segment(3,0)).'/aadhar_no';?>" data-original-title="Enter the adhaar number">  </a>--> 
                                                         </td>
                                                      </tr>
											...
											<div class="col-md-12 thumbnail">                                        
												<span class="col-md-6">
													...
													<table class="table table-striped" id="user">
														...
														<tr>
                                                      	 <td><b>Subject 1:</b></td>
                                                         <td>
                                                            <a href="javascript:;" id="subject1" data-type="select2" data-pk="1" data-value="<?php echo $staff[0]->subject1; ?>" data-url="<?php echo (base_url().'Udise_staff/UpdateStaffData/'.$this->uri->segment(3,0)).'/subject1';?>"  data-original-title="Select subject1"><?php echo $staff[0]->ts1; ?></a>
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                      	 <td><b>Subject 2:</b></td>
                                                         <td>
                                                            <a href="javascript:;" id="subject2" data-type="select2" data-pk="1" data-value="<?php echo $staff[0]->subject2; ?>" data-url="<?php echo (base_url().'Udise_staff/UpdateStaffData/'.$this->uri->segment(3,0)).'/subject2';?>"  data-original-title="Select subject2"><?php echo $staff[0]->ts2; ?></a>
                                                         </td>
                                                      </tr>
													  ...
													  <tr>
                                                      	 <td><b>Subject 3:</b></td>
                                                         <td>
                                                            <a href="javascript:;" id="subject3" data-type="select2" data-pk="1" data-value="<?php echo $staff[0]->subject3; ?>" data-url="<?php echo (base_url().'Udise_staff/UpdateStaffData/'.$this->uri->segment(3,0)).'/subject3';?>"  data-original-title="Select subject3"><?php echo $staff[0]->ts3; ?></a>
                                                         </td>
                                                      </tr>
                                                ...
                                                <!--<span class="col-md-6">
													...
													<tr>
                                                      	 <td><b>Office:</b></td>
                                                         <td>
                                                            <b>Place:</b><a href="javascript:;" id="depofficeplace" data-type="select2" data-pk="1" data-value="<?php echo $staff[0]->dep_off;?>" data-original-title="Select Office" data-url="<?php echo (base_url().'Udise_staff/UpdateStaffData/'.$this->uri->segment(3,0)).'/dep_off';?>"><?php echo $staff[0]->office_name;?></a>
            ...
            <script>
               ...
               $.each({
                   <?php 
                    foreach($subjects as $pro) { 
                        echo ('"'.$pro->id.'":"'.$pro->subjects.'",');
                    } 
                    ?> 
               }, function(k, v) {
                   subject1and2.push({
               ...
               $('#appointsubject').editable({
                   ...
                   success:function(response, newValue) {
                     ...
                     if(result.response_code != 1) return result.error_msg;
                        ...
                        toastr.success("Appointment subject updated sucessfully", "Update Notifications");
                     }, 
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
                    },
               ...
               $('#subject1').editable({
                   ...
                   success:function(response, newValue) {
                     ...
                     if(result.response_code != 1) return result.error_msg;
                        ...
                        toastr.success("Subject1 updated sucessfully", "Update Notifications");
                     }, 
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
                    },
               ...
               $('#subject2').editable({
                   ...
                   success:function(response, newValue) {
                     ...
                     if(result.response_code != 1) return result.error_msg;
                        ...
                        toastr.success("Subject2 updated sucessfully", "Update Notifications");
                     }, 
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
                    },
               ...
               $('#subject3').editable({
                   ...
                   success:function(response, newValue) {
                     ...
                     if(result.response_code != 1) return result.error_msg;
                        ...
                        toastr.success("Subject3 updated sucessfully", "Update Notifications");
                     }, 
                   error: function(response, newValue) {
                            return 'Service unavailable. Please try later.';
                    },
		...
		$('#dob').editable({
			...
			success: function(response, newValue) {
                     ...
                     if(result.response_code != 1) return result.error_msg; 
                        ...
                        toastr.success("Year Recruitment Updated Successfully", "Update Notifications");
            ...
            error: function(response, newValue) {
                     return 'Service unavailable. Please try later.';
                        ...
                        if(/[^0-9]/.test(value))
                       {
						   ...
						   return 'Please enter year properly';
                       }
                   }
			});*/
