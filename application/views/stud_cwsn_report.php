                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i>Facilities provided to CWSN<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="center">Types Of Facility</th>
															...
															if(!empty($school_community)){ $total1 = []; $tot=[]; $Prkg_b=[]; $Prkg_g=[]; $lkg_b=[]; $lkg_g=[]; $ukg_b=[]; $ukg_g=[]; $c1_b=[]; $c1_g=[]; $c2_b=[]; $c2_g=[]; $c3_b=[]; $c3_g=[]; $c4_b=[]; $c4_g=[]; $c5_b=[]; $c5_g=[]; $c6_b=[]; $c6_g=[]; $c7_b=[]; $c7_g=[]; $c8_b=[]; $c8_g=[]; $c9_b=[]; $c9_g=[]; $c10_b=[]; $c10_g=[]; $c11_b=[]; $c11_g=[]; $c12_b=[]; $c12_g=[]; $total_t=[]; $total_b=[]; $total_g=[]; $total=[]; foreach($school_community as $index=> $sd){   ?>

                             <tr>
                                  <td class="center"><?=$index+1;?></td>
																  <td style="text-align: left;"><?= $sd->benefit ?></td>		
                                   ...
                                   <td style="text-align: center;"><?= $sd->cnt ?></td>
