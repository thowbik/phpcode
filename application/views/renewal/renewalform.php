                            ...
                            <div class="container">
                                ...
                                <div class="page-content-inner">
                                    ...
                                    <div class="portlet light portlet-fit ">
                                        <?php 
                                            if((empty($renew) && (!empty($pc))) || $this->uri->segment(3,0)!='' ){
                                        ...
                                        <div class="form-actions">
                                            <form id="schoolRenewalform" method="post" action="<?php echo base_url().'Basic/schoolRenewalsubmit/';?>" enctype="multipart/form-data" onsubmit="return filesizelimit();">
                                                <div class="portlet light portlet-fit ">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <table class="table">
                                                            ...
                                                            <tr>
																...
																<td><input type="text" id="addressline_1" name="addressline_2" class="form-control" readonly="readonly" value="<?php echo($address[1]); ?>" /></td>
                                                            </tr>
                                                            <!--<tr>
                                                    ...
                                                    <div class="form-group col-md-12">
														<table class="table">
                                                            ...
                                                            <!--<tr>
                                                                ...
                                                                <td><input type="text" class="form-control" name="<?php if($basic[0]->yr_last_renwl!=''){echo('yr_last_renwl');}else{echo('offcat_id');} ?>" id="<?php if($basic[0]->yr_last_renwl!=''){echo('yr_last_renwl');}else{echo('yr_recgn_first');} ?>" readonly="readonly" value="<?php if($basic[0]->yr_last_renwl!=''){echo($basic[0]->yr_last_renwl);}else{echo($basic[0]->yr_recgn_first);} ?>" /></td>
														...
														<table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>  
                                                                    ...
                                                                    <td>
                                                                        <input type="text" id="ifsc_0" name="ifsc_0" class="form-control" maxlength="11" onkeyup="this.value=this.value.toUpperCase();" onblur="return ifscsearch(this,this.parentNode.nextElementSibling)" pattern="[SBINsbin0-9]{11}" autocomplete="off" required />
                                                                    </td>
                                        ...
                                        <?php 
                                            ...
                                            foreach($result as $key => $arrvalue){
                                                if($key!='' || $key==0){
                                                 ...
                                                 switch($arrvalue[0]['approvedby']){
                                                    case 1:$dis='CEO ';break;
                                                    case 2:$dis='DEO ';break;
                                                    case 3:$dis='BEO ';break;
                                                    case -1:$dis='CEO Queried';break;
                                                    case -2:$dis='DEO Queried';break;
                                                    case -3:$dis='';break;
                                                    default:$dis='WAITING : '.$arrvalue[0]['pending'].' DAYS';
                                                 }
                                        ?>
                                            ...
                                            <li class="<?php echo($class); ?>" data-html="true" data-toggle="tooltip" title="<?php echo($arrvalue[0]['approveremarks']); ?><br><?php echo(date("d/m/Y H:i:s",strtotime($arrvalue[0]['ts']))); ?>">
                                                ...
                                                <span><?php 
                                                    ...
                                                    if($arrvalue[0]['approvedby']==1 || ($temp==1 && $arrvalue[0]['approvedby']==2)){$dis='<a href="'.base_url().'Basic/pdf">RENEWAL</a>'.' / '.'<a href="'.$arrvalue[0]['contidion_file'].'">CONDITIONS</a>';}
                                                    if($arrvalue[0]['approvedby']==-3){$dis='<a href="'.base_url().'Home/renewalform/'.$renew[0]['renewal_id'].'">REAPPLICATION</a>';}
                                        ...
                                        <?php }} ?>
                                            <li style="float:none;display:block;visibility:hidden;"></li>
                                        </ol>
                                    </div>
                                </div>
