                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     <div class="portlet light">
                                            <form action="<?php echo base_url()?>DC/get_school_strick_report" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            ...
                                                            <?php if(!empty($teacher_strick)){ $total1 = 0; foreach($teacher_strick as $index=> $det){   ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="center"> <?php $not_entered = ($det->total_teacher-($det->teacher_participate+$det->teacher_not_participate));if($det->total_teacher !=$not_entered){?><a href="<?php echo base_url().'DC/get_teacher_strick_report?school='.$det->school_id?>"><?php }?>
