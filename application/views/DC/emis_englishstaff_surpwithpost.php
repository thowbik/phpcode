                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> English Teacher Surplus PersonFixation<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														    ...
														    $soctot =0;
														   $toteligible =0;									
														   if(!empty($englishstaff_surpwithpost)){ $total1 = 0; foreach($englishstaff_surpwithpost as $index=> $sd){   ?>
