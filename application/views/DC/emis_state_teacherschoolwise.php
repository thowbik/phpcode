                                         ...
                                         <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                           <li role="presentation">
                                             <a href="<?php echo base_url().'DC/emis_teacher_blockwise_district'; ?>">
                                              <span class="text">Teaching Staff</span>
                                            </a>
                                          </li>
                                          <li role="presentation">
                                            <a href="<?php echo base_url().'DC/emis_nonteaching_blockwise_district'; ?>">
                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'DC/emis_teacher_classwise_block/?block_id='.$block_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
