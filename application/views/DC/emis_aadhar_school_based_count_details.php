                                                                ...
                                                                <tr>
																   ...
																   <td ><?=$sd->aadharin?>
																    <?php $aadharincount=$aadharincount+$sd->aadharin;?></td>
                                                                     <td >
																   <a href="<?php echo base_url().'DC/aadhar_school_notin_count_details?schoolid='.$sd->school_id?>"><?=$aadharnotin=$sd->totalstudent-$sd->aadharin;?>
...
function openmodel(school)
{
    ...
    {
        type: "POST",
        url:baseurl+'Deo_DC/get_school_class_section_details',
