...
<link href="<?php echo base_url().'asset/global/plugins/simple-line-icons/simple-line-icons.min.css';?>" rel="stylesheet" type="text/css" />
    ...
    ?>
  <?php if($usertype== 3) { $this->load->view('DC/header.php'); } else if($usertype== 5) { $this->load->view('state/header.php');  } ?>
                            ...
                            <div class="page-content">
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     <center>   
                                   <?php /* ?><?php $this->load->view('DC/emis_district_profile_header.php'); ?> <?php */ ?>
                                        </center>
   ...
   <script type="text/javascript">
       function getdst(distid){
             $.post('<?php echo base_url(); ?>DC/get_dist/'+distid, function(data) {
              if(data!='')
              {
                 $('#blockdtl').html(data);
                 // $('#subblck').html(data);
       ...
       function get_school_key(udise){
        $.post('<?php echo base_url(); ?>DC/school_key/'+udise, function(data) {
              if(data!='')
              {
       ...
       function get_schl(blckid){
        // alert();
            ...
            $.post('<?php echo base_url(); ?>DC/get_schol/'+blckid, function(data) {
              if(data!='')
              {
                // alert(data);
                 $('#getschl').html(data);
       ...
       function get_tech_cat(myschl_id){
            ...
            $.post('<?php echo base_url(); ?>DC/tech_cat_only/'+myschl_id, function(data) {
              if(data!='')
              {
                // alert(data);
                 $('#type_tech').html(data);
       ...
       function get_tchr(schl_id){
        ...
        if(schl_id == "")
        {
            ...
            $.post('<?php echo base_url(); ?>DC/get_tchr/'+schl_id, function(data) {
              if(data!='')
              {
                // alert(data);
                 $('#gettchr').html(data);
       ...
       function getdst_anthr(dist_id){
                ...
                $.post('<?php echo base_url(); ?>DC/get_dist_nme/'+dist_id, function(data) {
              if(data!='')
              {
                 $('#showdist').html(data);
              }
       ...
       /*function get_tchr_type_only(tech_id){
        ...
        $.post('<?php echo base_url(); ?>DC/get_desig/'+tech_id, function(data) {
              if(data!='')
              {
                // alert(data);
       ...
       function tech_nme_only(tech_id){
        ...
        $.post('<?php echo base_url(); ?>DC/get_nme_only/'+tech_id, function(data) {
              if(data!='')
              {
                // alert(data);
                 $('#shownme').html(data);
       ...
       function get_another_block(blck_id){
        $.post('<?php echo base_url(); ?>DC/get_block_dtls/'+blck_id, function(data) {
              if(data!='')
              {
                // alert(data);
       ...
       function get_schl_key(schl_id){
        // alert(schl_id);
        $.post('<?php echo base_url(); ?>DC/get_schl_keyval/'+schl_id, function(data) {
              if(data!='')
              {
                //alert(data);
                 $('#schl_key').val(data);
            ...
            if(resp==true){
              swal({
                ...
                if (isConfirm) {
                  ...
                  window.open(baseurl+'DC/emis_teacher_transfer_form/'+tech_id, '_blank');
                } else {
