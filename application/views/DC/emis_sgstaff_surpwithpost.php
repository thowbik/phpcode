                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> SecondaryGrade Teacher Surplus PersonFixation<span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <thead>
                                                                <tr>
																	...
																	<th class=" ">Surplus SG Teachers</th>
																	<!-- <th class=" ">Science</th>
																	  <th class=" ">Maths</th>
																	 <th class=" ">English</th>
																	<th class=" ">Tamil</th>
															...
															// "<?php echo base_url().'DC/emis_staff_school_count_details?schoolid='.$sd->school_id
                                                            $sgtot=0;
														    $scitot =0;
															 $mattot=0;
														    $engtot =0;
														    ...
														    $soctot =0;
														   $toteligible =0;									
														   if(!empty($sgstaff_surpwithpost)){ $total1 = 0; foreach($sgstaff_surpwithpost as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
																 ...
																 <a href="<?php echo base_url().'Ceo_DC/emis_deegovsurplus_sgstaff_school?schoolid='.$sd->school_id; ?>">
																 
																 
																  
																   <?=$sd->school_name;?>
																    <input type="hidden" id="school_id<?=$index?>" value="<?=$sd->school_id;?>"></a>
																   </td>
													 
                                                                 <td><?php echo $sd->surp_w_sg;?><?php $sgtot=$sgtot+$sd->surp_w_sg;?></td>
																<!--	<td><?php echo $sd->surp_w_sci;?><?php $scitot=$scitot+$sd->surp_w_sci;?> </td>
																	<td><?php echo $sd->surp_w_mat;?> <?php $mattot=$mattot+$sd->surp_w_mat;?></td>
																	<td><?php echo $sd->surp_w_eng;?> <?php $engtot=$engtot+$sd->surp_w_eng;?></td>
																	<td><?php echo $sd->surp_w_tam;?><?php $tamtot=$tamtot+$sd->surp_w_tam;?> </td>
																	<td><?php echo $sd->surp_w_soc;?> <?php $soctot=$soctot+$sd->surp_w_soc;?></td>
																	  <td><?php echo $sd->surp_w_tot;?>
																	 <?php $toteligible=$toteligible+$sd->surp_w_tot;?>  </td> -->
...
function openmodel(school)
{
    ...
    {
        type: "POST",
        url:baseurl+'Ceo_DC/get_school_class_section_details',
...
$('#test').modal('show');
  ...
  $("#emis_state_report_schcate").change(function(){ 
    ...
    var emis_state_report_schcate = $("#emis_state_report_schcate").val();
      ...
      $.ajax({
        type: "POST",
        url:baseurl+'Ceo_DC/get_school_management_data',
...
function remove_catefilter(){
  ...
  $.ajax({
        type: "POST",
        url:baseurl+'Ceo_DC/deletereport_schoolcatemanage',
        data:"&test=1",
        success: function(resp){
        // alert(resp);  
