...
<link href="<?php echo base_url().'asset/global/plugins/simple-line-icons/simple-line-icons.min.css';?>" rel="stylesheet" type="text/css" />
                                    ...
                                    <div class="page-title">
                                        <h1>Dashboard
                                          ...
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                           ...
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'DC/emis_state_school_dee'?>">
                                              <span class="text">Directorate Of Elementary Education</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'DC/emis_state_school_dse'?>">
                                              <span class="text">Directorate Of School Education</span>
                                            </a>
                                          </li>
                                          <li role="presentation" class="next">
                                                <a href="<?php echo base_url().'DC/emis_state_school_dms'?>">
                                              <span class="text" >Directorate Of Matriculation School</a></span>
                                          </a>
                                          </li>
                                            <li role="presentation" class="next">
                                                <a href="<?php echo base_url().'DC/emis_state_school_others'?>">
 ...
 $s_cnt= []; $i=1; $total1=[];
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo base_url().'DC/get_state_school_wise_dee/?block_name='.$det->block_name."&mang=".$det->management?>"><?=$det->block_name;?></a></td>
...
<script src="<?php echo base_url().'asset/global/scripts/datatable.js';?>" type="text/javascript"></script>
        ...
        <script type="text/javascript">
            ...
            function saveclassid(value){
                ...
                $.ajax({
                type: "POST",
                url:baseurl+'DC/savedash_classidsession',
                data:"&class_id="+value,
                success: function(resp){ 
                if(resp==true){  
                window.location.href = baseurl+'DC/emis_dash_district_count'; 
                return true;  
                 }else{
                    return false;
                 }
...
if(manage == 0 ){
  ...
  $.ajax({
        type: "POST",
        url:baseurl+'DC/savereport_schoolcatemanage',
