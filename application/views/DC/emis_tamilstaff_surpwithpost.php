                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Tamil Teacher Surplus PersonFixation<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														    ...
														    $soctot =0;
														   $toteligible =0;									
														   if(!empty($tamilstaff_surpwithpost)){ $total1 = 0; foreach($tamilstaff_surpwithpost as $index=> $sd){   ?>
