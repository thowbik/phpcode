                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'DC/emis_nonteaching_blockwise_district'?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
...
$total1 = [];
 ...
 <?php $Government=0;$fullyaid=0;$unaidteachtot=0;$PartiallyAided=0;$CentralGovt=0; ?>                                                 
                              ...
                              <!--<th>Total</th>-->
                               ...
                               <td><a href="<?php echo base_url().'DC/emis_nonteaching_schoolwise_block/?block_id='.$teaching->block_id?>"><?php echo $teaching->block_name; ?></td></a>
