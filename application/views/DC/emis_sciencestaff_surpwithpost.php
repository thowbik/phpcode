                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <i class="fa fa-globe"></i> Science Teacher Surplus PersonFixation<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
														    ...
														    $soctot =0;
														   $toteligible =0;									
														   if(!empty($sciencestaff_surpwithpost)){ $total1 = 0; foreach($sciencestaff_surpwithpost as $index=> $sd){   ?>
                                                              ...
                                                              <!--    <td><?php echo $sd->surp_w_sg;?><?php $sgtot=$sgtot+$sd->surp_w_sg;?></td> -->
																	<td class="center"><?php echo $sd->surp_w_sci;?><?php $scitot=$scitot+$sd->surp_w_sci;?> </td>
