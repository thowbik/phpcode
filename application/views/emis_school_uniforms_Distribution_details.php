                                             ...
                                             <div class="portlet-body">
                                                <div class="row">
                                                    <div class="col-md-12">
													                                                  ...
													                                                  <form id="filter" method="post" action="<?php echo base_url().'Home/emis_school_uniforms_Distribution_details';?>">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
														<?php 
														if(!empty($uniform_distribute_details))
														{
														foreach($uniform_distribute_details as $sd)
														{
															
														}
														}
														?>
                                                            <i class="fa fa-globe"></i>School Uniforms Distribution Register<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
															...
															if(!empty($uniform_distribute_details)){ $total1 = 0; foreach($uniform_distribute_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <!--  <td ><?= $sd->community_name?></td>
																  ...
																  <td ><?= $sd->scheme_category ?></td>
																    <td ><?= 'Set' .' '.$sd->sets ?></td>
                                                                  <!-- <td ><?= $sd->distribution_date ?></td> -->
																      <td>
																	  <?= (empty ($sd->distribution_date))? " - ":date('d-m-Y',strtotime($sd->distribution_date ))?></td>
