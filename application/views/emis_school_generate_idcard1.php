                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Print ID card
                                            <small> Section wise print student list</small>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                    <!-- BEGIN PAGE TOOLBAR -->
                                ...
                                <div class="container">
                                    ...
                                    <?php $this->load->view('emis_school_profile_header.php'); ?>
                                        ...
                                        <!-- BEGIN CARDS -->
                                         ...
                                         <span style="font-size: 22px;">Print Student List Section wise </span>
      ...
      ?>
                                          ...
                                          <?php if($class!=""){ echo $class; } ?></span>
                                                 <hr>
                                                        ...
                                                        foreach($a as $v){?> 
                                                            <div class="col-md-4">
                                                            <a href="<?php echo base_url().'Home/emis_school_generate_idcard2/'.$class_id.'/'.$v;?>" style="text-decoration: none;">
