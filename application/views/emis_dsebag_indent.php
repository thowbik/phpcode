                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="row">
                                       ...
                                       <form action="<?=base_url().'Home/emis_bag_indent'?>" method="post">
                            ...
                            <div class="panel-heading active-faq">
                                <a data-toggle="collapse" data-parent="#accordion-cat-1" href="#" aria-expanded="true" class>
                                    <h4 class="panel-title">
                                        <i class="fa fa-globe"></i> Bags Indent Summary 
                                  ...
                                  <thead>
								    <tr>
									   ...
									   <th style="text-align: center;"  colspan = '3' >Small</th>
									    <th style="text-align: center;"  colspan = '4' >Medium</th>
									   
									   <th style="text-align: center;"  colspan = '5'>Large</th>
								  </tr>
							 ...
							 <?php if(!empty($uf->district_name)){?>
                              ...
                              <td style="text-align: center;"><?php echo $i;?></td>
							    ...
							    <?php if(!empty($uf->district_name)){?>
										...
										<td style="text-align: left;"> <a href="<?php echo base_url().'Home/emis_dsebag_indent/?district_id='.$uf->district_id?>"><?php } else {?>
										<td style="text-align: left;"> <a href="<?php echo base_url().'Home/emis_dsebag_indent/?district_id='.$uf->district_id?>"><?php }?>
							  ...
							  <?php } else if(!empty($uf->block_name)) {?>
							           <?php if(!empty($uf->scheme_category)){?>
							           <td style="text-align:left;"><a href="<?php echo base_url().'Home/emis_dsebag_indent/?block_id='.$uf->block_id?>"><?php } else {?>
									   <td style="text-align:left;"><a href="<?php echo base_url().'Home/emis_dsebag_indent/?block_id='.$uf->block_id?>"><?php }?>
							  ...
							  <td style="text-align: center;"><?php echo number_format($uf->c9); ?></td>
							  <td style="text-align: center;"><?php echo number_format($uf->c10); ?></td> 
							  <td style="text-align: center;"><?php echo number_format($uf->c11); ?></td>
							  <td style="text-align: center;"><?php echo number_format($uf->c12); ?></td>
