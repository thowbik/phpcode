                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Dashboard
                                              <small>Block Dashboard</small> - <label style="color:red;"><?=$block_dist_name[0]->block_name;?></label>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                    <!-- BEGIN PAGE TOOLBAR -->
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                         ...
                                         <form action="<?php echo base_url().'Beo_block/get_dash_blockwise_school'?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
