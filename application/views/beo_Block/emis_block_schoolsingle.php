...
<link href="<?php echo base_url().'asset/global/plugins/simple-line-icons/simple-line-icons.min.css';?>" rel="stylesheet" type="text/css" />
    ...
    <body class="page-container-bg-solid page-md">
        <div class="page-wrapper">
                         ...
                         <?php  $school_id =$this->session->userdata('emis_blockschool_id');
                          $classlist=array();
...
<!-- 
                                            ...
                                            <a href="<?php echo base_url().'Home/emis_school_studentsectionwise/'.$j; ?>" style="text-decoration: none;"> 
                                                ...
                                                <?php  if(!empty($classlist)){ foreach ($classlist as $key){ ?>
                                                    ...
                                                    <div class="m-grid-col m-grid-col-middle m-grid-col-center">
                                            <a href="<?php echo base_url().'Block/saveclassidsession/'.$key; ?>" style="text-decoration: none;"> 
                                              <?php 
        ...
        <script src="<?php echo base_url().'asset/js/block.js';?>" type="text/javascript"></script>
         ...
         <script type="text/javascript">
               function saveclassid(value){
                ...
                if(resp==true){    
                window.location.href = baseurl+'Block/emis_block_classwise_studentsall'; 
                 }
                 return true;  
