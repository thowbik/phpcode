                                         ...
                                         <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Beo_block/emis_teaching_schoolwise_block'; ?>">
                                              <span class="text">Teaching Staff</span>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Beo_block/emis_nonteaching_schoolwise_block'; ?>">
                                              <span class="text">Non-Teaching Staff</span>
                                            </a>
                                          </li>
                                          <li role="presentation" class="next">
                                             <a href="<?php echo base_url().'Beo_block/emis_teacher_blockwise'; ?>">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i>Teaching Staff Details By Grade -  District : <?php echo $block_dist_name[0]->district_name ?> | Block : <?php echo $block_dist_name[0]->block_name ?></div>
        ...
        <script src="<?php echo base_url().'asset/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js';?>" type="text/javascript"></script>
              ...
              <!--   <script type="text/javascript">
               function savedistrictid(value){
                ...
                if(resp==true){  
                window.location.href = baseurl+'District/emis_teacher_classwise_block'; 
                return true;  
                 }else{
                    return false;
                 }
