  ...
  <?php $this->load->view('block/header.php'); ?>
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-globe"></i> Student Community wise - <?php if($blockname!=""){ echo $blockname; } ?> </div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
       ...
       <script src="<?php echo base_url().'asset/js/block.js';?>" type="text/javascript"></script>
         <script type="text/javascript">
                ...
                $.ajax({
                type: "POST",
                url:baseurl+'Block/saveblockcommunity',
                data:"&block_id="+value,
                success: function(resp){ 
                if(resp==true){  
                window.location.href = baseurl+'Block/emis_block_community_schools'; 
                return true;  
                 }else{
                    return false;
                 }
       ...
       <script type="text/javascript">
               function savecommuntiyonly(value){
                ...
                $.ajax({
                type: "POST",
                url:baseurl+'Block/savecommunityonly',
                data:"&comm="+value,
                success: function(resp){ 
                if(resp==true){  
                window.location.href = baseurl+'Block/emis_block_community_schools'; 
