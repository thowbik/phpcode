                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'Beo_block/emis_teacher_classwise_block/?block_id='.$block_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                         ...
                                                         <?php echo $block_dist_name[0]->block_name; ?></span></div>
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                           ...
                                                           <td><a><!--savedistrictid('<?php echo $det->block_id; ?>')-->
