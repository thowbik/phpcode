...
<div class="page-content">
                                ...
                                <div class="container">
                                    ...
                                    <div class=" row page-content-inner">
                                      ...
                                      <!--<a href="<?php echo base_url().'State/getstudentsalltotal/1/0/'.$this->session->userdata('emis_block_id');?>"> -->
                                      <a href="<?php echo base_url().'Beo_block/get_dash_blockwise_school';?>">
                    <div class=" col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="bs-callout-lightsteelblue dashboard-stat2">
                            <div class="display">
                                ...
                                <h3><?php echo number_format($total_count_details->student_total);?></h3>
                                </div>
                                <br/>
                                <br/>
                                <br/>
                ...
                <!-- 1 Card End -->
                <a href="<?php echo base_url().'Beo_block/emis_teacher_classwise_block';?>">
                    <div class=" col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="bs-callout-lightblue dashboard-stat2">
                            <div class="display">
                                <div class="number">
                                    <h3 class="font-green-sharp">
                                                         <span class="bottom" data-counter="counterup" data-value="30">Total Staffs</span>
    ...
    <div class="col-lg-3">
            ...
            <div class="panel panel-success">
                <div class="panel-heading bs-callout-darkseagreen">
                    <h3 class="panel-title" style="color: #000;"><i class="fa fa-university"></i> Non-Teaching Staffs</h3>
                    <span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i> </span>
                </div>
                <div class="panel-body">
                    <div class="row">
                ...
                <div class="panel-body">
                   <div class="row">
                                                    ...
                                                    <div class="col-md-3 space-2px">
                                                            ...
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Beo_block/dash_renewal';?>"><?php echo ($renewal_details[0]['TOTAL']); ?></a></b></small>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Beo_block/dash_renewal_beo/';?>"><?php echo ($renewal_details[0]['BEO']); ?></a></b></small>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Beo_block/dash_renewal_deo/';?>"><?php echo ($renewal_details[0]['DE0']); ?></a></b></small>
                                                        </div>
                                                        <div class="col-md-9 space-2px">
                                                            <small>Pending CEO Approval</small>
                                                    </div>
                                                    <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Beo_block/dash_renewal_ceo/';?>"><?php echo ($renewal_details[0]['CE0']); ?></a></b></small>
                                                        </div>
                                                          <div class="col-md-9 space-2px">
