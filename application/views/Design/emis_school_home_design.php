                            ...
                            <div class="page-content">
                                ...
                                <?php $this->load->view('emis_school_profile_header.php'); ?>
                                        ...
                                        <div class="row margin-bottom-20">
                                            ...
                                            <a href="<?php echo base_url().'Udise_asset/emis_school_asset1';?>" target="_blank" class="">
                                            <div class="col-lg-3 col-md-3">
                                                <div class="portlet light">
                                                    <div class="card-icon" style="padding-top: 13%;padding-bottom: 13%;">
                                        ...
                                        <div class="row margin-bottom-20">
                                            ...
                                            <a href="<?php echo base_url().'Udise_staff/emis_school_staff1';?>" target="_blank" class="">
                                            ...
                                            <a href="<?php echo base_url().'Udise_schemes/emis_school_schemes1';?>" target="_blank" class="">
                                            <div class="col-lg-3 col-md-6">
                                                <div class="portlet light">
                                                    <div class="card-icon" style="padding-top: 13%;padding-bottom: 13%;">
                                            ...
                                            <a href="<?php echo base_url().'Udise_assesment/emis_school_examresult1';?>" target="_blank" class="">
                                            <div class="col-lg-3 col-md-6">
                                                <div class="portlet light">
                                                    <div class="card-icon" style="padding-top: 13%;padding-bottom: 13%;">
                                            ...
                                            <a href="<?php echo base_url().'Udise_finance/emis_school_finance';?>" target="_blank" class="">
                                            <div class="col-lg-3 col-md-6">
                                                <div class="portlet light">
                                                    <div class="card-icon" style="padding-top: 13%;padding-bottom: 13%;">
                                        ...
                                        <div class="row margin-bottom-20">
                                            ...
                                            <a href="<?php echo base_url().'Udise_sdvariable/emis_school_sdvariable1';?>" target="_blank" class="">
                                            <div class="col-lg-3 col-md-6">
                                                <div class="portlet light">
                                                    <div class="card-icon" style="padding-top: 13%;padding-bottom: 13%;">
                                                        <img src="<?php echo base_url().'asset/images/sdvar.png'?>" style="width: 60%;height: 60%;">
                                                    </div>
                                                    <div class="card-title">
                                                        <span> State Defined Variables </span>
                                                    </div>
                                                   <!--  <div class="card-desc">
                                                        <span> The best way to find yourself is
                                                            <br> to lose yourself in the service of others </span>
                                            ...
                                            <a href="<?php echo base_url().'Udise_enrolment/emis_school_enrolment1';?>" target="_blank" class="">
                                            <div class="col-lg-3 col-md-6">
                                                <div class="portlet light">
                                                    <div class="card-icon" style="padding-top: 13%;padding-bottom: 13%;">
                                                        <img src="<?php echo base_url().'asset/images/people.png'?>" style="width: 60%;height: 60%;">
                                                    </div>
                                                    <div class="card-title">
                                                        <span> Enrolment </span>
                                                    </div>
