...
<div class="page-content">
                                ...
                                <div class="container">
                                    ...
                                    <div class=" row page-content-inner">
                                      ...
                                      <a href="<?php echo base_url().'Block/get_dash_blockwise_school'?>">
   ...
   <h3> <?php echo number_format($total_count_details->teacher_total); ?></h3>
                ...
                <!-- 2 Card End -->
                <a href="<?php echo base_url().'Block/emis_state_school';?>">
                    <div class=" col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="bs-callout-mediumaquamarine dashboard-stat2">
                            <div class="display">
                                <div class="number">
                                    <h3 class="font-green-sharp">
                                                         <span class="bottom" data-counter="counterup" data-value="34">Total School</span>
                ...
                <div class="panel-body">
                   <div class="row">
                                                    ...
                                                    <div class="col-md-3 space-2px">
                                                            ...
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Block/dash_renewal';?>"><?php echo number_format($renewal_details[0]['TOTAL']); ?></a></b></small>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Block/dash_renewal_beo/';?>"><?php echo number_format($renewal_details[0]['BEO']); ?></a></b></small>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Block/dash_renewal_deo/';?>"><?php echo number_format($renewal_details[0]['DE0']); ?></a></b></small>
                                                        </div>
                                                        <div class="col-md-9 space-2px">
                                                            <small>Pending CEO Approval</small>
                                                    </div>
                                                    <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Block/dash_renewal_ceo/';?>"><?php echo number_format($renewal_details[0]['CE0']); ?></a></b></small>
                                                        </div>
                                                          <div class="col-md-9 space-2px">
                                                     ...
                                                     <div class="col-md-3 space-2px">
                                                            <small>: &nbsp;&nbsp;<b><a href="<?php echo base_url().'Block/get_renewal_rejected/';?>"></small><?php echo number_format($renewal_details[0]['REJECTED']); ?></a></b></small>
                                                    </div>
                                                        </div>
