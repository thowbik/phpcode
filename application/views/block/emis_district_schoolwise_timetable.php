                           ...
                           <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                          ...
                                          <div class="portlet light">
                                            <form action="<?php echo base_url().'block/schoolwise_class_timetable_report?dist_id='.$school_timetable_details[0]->district_id?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        ...
                                                        ?>
                                                            <i class="fa fa-globe"></i>Timetable  | Block - <?php echo $sd->block_name; ?> | date : <?php echo $this_week_fst;?> to <?php echo $this_week_ed;?><span> </span></div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                            ...
                                                            <?php if(!empty($school_timetable_details)){ $total1 = 0; foreach($school_timetable_details as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td> <a href="<?php echo base_url().'Block/school_class_section_timetable?schoolid='.$sd->school_key_id?>&schoolname=<?php echo $sd->school_name ?>"><?=$sd->school_name;?></a></td>
