                                ...
                                <div class="container">
                                    ...
                                    <div class="portlet-body">
                                     ...
                                     <div class="col-md-12">
                                        ...
                                        <center>
                                                   <form method="post" action="<?php echo base_url().'Block/emis_block_findschoolbyblock';?>">
                                                    <div class="form-group">
                                   ...
                                   <div class="portlet-body">
                                     ...
                                     <table id="user" class="table table-bordered table-striped">
                                        ...
                                        <center>
                            <a  href="<?php echo base_url().'Block/emis_block_schoolmainid/'.$schoolid.'/'.$udise_code;?>" class="btn green acedit" 
