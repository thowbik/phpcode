...
<link href="<?php echo base_url().'asset/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css';?>" rel="stylesheet" type="text/css" />
                                                  ...
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                         ...
                                                         <?php echo $details[0]->edu_dist_name; ?></span> </div>
 ...
 <?php $Government=0;$fullyaid=0;$unaidteachtot=0;$PartiallyAided=0;$CentralGovt=0; ?>                                                 
                              ...
                              <!--<th>Total</th>-->
                               ...
                               <td><a onclick="savedistrictid('<?php echo $teaching->block_id; ?>')"><?php echo $teaching->block_name; ?></td></a>
        ...
        <script src="<?php echo base_url().'asset/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js';?>" type="text/javascript"></script>
              <script src="<?php echo base_url().'asset/pages/scripts/table-datatables-colreorder.min.js';?>" type="text/javascript"></script>
               ...
               function savedistrictid(value){
                ...
                $.ajax({
                type: "POST",
                url:baseurl+'Deo_District/saveblockidsession',
                data:"&block_id="+value,
                success: function(resp){ 
                if(resp==true){  
                window.location.href = baseurl+'Deo_District/emis_teaching_schoolwise_block'; 
                return true;  
                 }else{
                    return false;
                 }
