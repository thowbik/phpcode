                                    ...
                                    <div class="page-title">
                                        <h1>Dashboard
                                          ...
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                            ...
                                            <a href="<?php echo base_url().'Block/getstudentsalltotal/1'; ?>">
                                              <span class="text">All Students</span><br>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="#"><!--<?php// echo base_url().'Block/getstudentsalltotal/2'; ?>-->
                                              <span class="text">Directorate Of Elementary Education</span><br>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="#"><!--<?php// echo base_url().'Block/getstudentsalltotal/3'; ?>-->
                                              <span class="text">Directorate Of School Education</span>
                                            </a>
                                          </li>
                                          <li role="presentation" class="next">
                                              <a href="#"><!--<?php //echo base_url().'Block/getstudentsalltotal/4'; ?>-->
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                     ...
                                     <div class="portlet-body">
                                         ...
                                         <form action="<?php echo base_url().'Block/get_dash_blockwise_school?block='.$block_name?>" method="POST">
                                                <div class="row">
                                                    <div class="col-md-12">
