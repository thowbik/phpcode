...
<link href="<?php echo base_url().'asset/global/plugins/simple-line-icons/simple-line-icons.min.css';?>" rel="stylesheet" type="text/css" />
                                ...
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Dashboard
                                            ...
                                            <a href="<?php echo base_url().'Block/get_state_school_district'?>">
                                              <span class="text">All Schools</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Block/get_state_school_district_dee'?>">
                                              <span class="text">Directorate Of Elementary Education</span><br/>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'Block/get_state_school_district_dse'?>">
                                              <span class="text">Directorate Of School Education</span>
                                            </a>
                                          </li>
                                          <li role="presentation" class="next">
                                                <a href="<?php echo base_url().'Block/get_state_school_district_dms'?>">
                                              <span class="text" >Directorate Of Matriculation School</a></span>
                                          </a>
                                          </li>
                                            <li role="presentation" class="next">
                                                <a href="<?php echo base_url().'Block/get_state_school_district_others'?>">
 ...
 $s_cnt= []; $i=1; $total1=[];
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo base_url().'Block/get_state_school_wise_others/?block_name='.$det->block_name."&mang=".$det->management?>"><?=$det->block_name;?></a></td>
