                                         ...
                                         <h1>SLAS Marks  
                                          ...
                                          <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'block/slas_report_schl_wise'; ?>">
                                              <span class="text">School-Wise</span>
                                            </a>
                                          </li>
                                           <li role="presentation">
                                            <a href="<?php echo base_url().'block/slas_report_cate_dist'; ?>">
                                              <span class="text">Category-Wise</span>
                                            </a>
                                          </li>
                                            <li role="presentation">
                                            <a href="<?php echo base_url().'block/slas_report_mana_dist'; ?>">
                                        ...
                                        <div class="row margin-bottom-20">
                                             <div class="portlet-body">
                                                <div class="row" style="margin-left: 6px;">
                                                    ...
                                                    <!--  <form  action="<?=base_url().'block/slas_report_dist'?>" method="POST" >
                                                        <div class="row">
                                                        <div class="col-md-4">
                               ...
                               $j=0; $sum=0; $assigned_sum=0; $not_marked=0;//print_r($value); die();
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="<?php echo base_url().'block/slas_report_schl_wise/?catty_id='.$key->catty_id?>"><?php echo($key->cate_type); ?></a></td>
