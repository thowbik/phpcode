							 ...
							 <?php if(!empty($uf->district_name)){?>
                              ...
                              <td style="text-align: center;"><?php echo $i;?></td>
							    ...
							    <?php if(!empty($uf->district_name)){?>
										...
										<td style="text-align: left;"> <a href="<?php echo base_url().'Home/emis_bag_indent/?district_id='.$uf->district_id?>"><?php } else {?>
										<td style="text-align: left;"> <a href="<?php echo base_url().'Home/emis_bag_indent/?district_id='.$uf->district_id?>"><?php }?>
							  ...
							  <?php } else if(!empty($uf->block_name)) {?>
							           <?php if(!empty($uf->scheme_category)){?>
							           <td style="text-align:left;"><a href="<?php echo base_url().'Home/emis_bag_indent/?block_id='.$uf->block_id?>"><?php } else {?>
									   <td style="text-align:left;"><a href="<?php echo base_url().'Home/emis_bag_indent/?block_id='.$uf->block_id?>"><?php }?>
