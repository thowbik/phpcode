...
<body class="page-container-bg-solid page-md">
                                    ...
                                    <div class="portlet light portlet-fit ">
                                        ...
                                        <div class="form-actions">
                                                    ...
                                                    <div class="portlet-body">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-12">
                                                                <table class="table" id="playareatab">
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                            <div class="col-md-6">
                                                                                <input type="text" id="landa" name="land_avail_sqft" onfocus="textvalidate(this.id,'emis_landa_alert');" onchange="textvalidate(this.id,'emis_landa_alert');sqfttoacre(this);"  required="required" maxlength="7" minlength="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57"  class="form-control" placeholder="Sq.Ft."/>
                                                                        ...
                                                                        <th>Whether the School has a Playground facility? <font style="color:#dd4b39;">*</font><br/>
                                                                            <input type="radio" id="spf_1" value="1" name="play_facility" onchange="sbcshow1(this,'spfdetails1');sbcshow1(document.getElementById('spf_2'),'spfdetails');setRequiredField(this.value,'areap,areap_1','1');document.getElementById('bgscdetails').style.display=(this.checked?'none':'');setRequiredField(this.value,'door,street,funcad,bp','1');" checked="checked"/><label for="spf_1">YES</label>
                                                                            <input type="radio" id="spf_2" value="0" name="play_facility" onchange="sbcshow1(document.getElementById('spf_1'),'spfdetails');sbcshow1(this,'spfdetails1');setRequiredField(this.value,'areap,areap_1','1');"  /><label for="spf_2">NO</label>
                                                                        ...
                                                                        <th class="spfdetails1">
                                                                           <div class="col-md-6">
                                                                                 <input type="text" id="areap" name="play_area_sqft" onfocus="textvalidate(this.id,'emis_areap_alert');" onchange="textvalidate(this.id,'emis_areap_alert');sqfttoacre(this);"  maxlength="7" minlength="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" placeholder="Sq.Ft."/>
                                                                    ...
                                                                    <tr class="spfdetails">
                                                                        ...
                                                                        <th>
                                                                            <input type="radio" value="1" id="aa_1" name="play_alt_arrang" onchange="document.getElementById('bgscdetails').style.display=(this.checked?'':'none');setRequiredField(this.value,'door,street,funcad,bp','1')"/><label for="aa_1">YES</label>
                                                                            <input type="radio" value="0" id="aa_2" name="play_alt_arrang" onchange="document.getElementById('bgscdetails').style.display=(this.checked?'none':'');setRequiredField(this.value,'door,street,funcad,bp','1')" checked="checked"/><label for="aa_2">NO</label>
                                                            ...
                                                            <div class="form-group col-md-12" id="bgscdetails">
                                                                <table class="table">
                                                                    <tr>
                                                                        <th>Address</th>
                                                                        <th>
                                                                            <textarea id="door" name="play_address"  onfocus="textvalidate(this.id,'emis_door_alert');" onchange="textvalidate(this.id,'emis_door_alert');"  class="form-control"></textarea>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                            <input type="text" id="bp" name="dist_build_playgr"  onfocus="textvalidate(this.id,'emis_bp_alert');" onchange="textvalidate(this.id,'emis_bp_alert');" maxlength="5" minlength="1" minlength="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57"  class="form-control">
                                                                ...
                                                                <table class="table">
                                                                    <tr>
                                                                       <th style="width: 500px;">Whether land is available for expansion of School facilities? <font style="color:#dd4b39;">*</font></th>
                                                                        <th>
                                                                            <input type="radio" value="1" id="schoolfaci_1" name="land_exp_scl" onchange="sbcshow1(this,'alanddetails');setRequiredField(this.value,'sf1','1')"/><label for="schoolfaci_1">YES</label>
                                                                            <input type="radio" value="0" id="schoolfaci_2" name="land_exp_scl" onchange="sbcshow1(this,'alanddetails');setRequiredField(this.value,'sf1','1')" checked="checked"/><label for="schoolfaci_2">NO</label>
                                                                        ...
                                                                        <th class="alanddetails">
                                                                                 <input type="text" id="sf1" name="play_land_area"  onfocus="textvalidate(this.id,'emis_sf_alert');"  maxlength="7" minlength="1" onchange="textvalidate(this.id,'emis_sf_alert');" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <table class="table">
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                            <select style="width: 140px;" class="form-control" id="lu" name="land_ownersip" onfocus="textvalidate(this.id,'emis_lu_alert');" onchange="textvalidate(this.id,'emis_lu_alert');landusage(this.value);" required>
                                                                        ...
                                                                        <th class="rentdetails">
                                                                                <input type="text"  maxlength="7" minlength="1" id="ifrent_0" name="land_rent_amt"  onfocus="textvalidate(this.id,'emis_rpy_alert');" onchange="textvalidate(this.id,'emis_rpy_alert');" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="Landdetails"  class="form-control">
                                                                        ...
                                                                        <th class="perioddetails">
                                                                            <input type="text" maxlength="2" minlength="1" id="ifperiod_0" name="land_lease_perid"  onfocus="textvalidate(this.id,'emis_ply_alert');" onchange="textvalidate(this.id,'emis_ply_alert');" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="Landdetails" class="form-control">
                                                                        ...
                                                                        <th class="perioddetails">
                                                                            <input type="date" id="periodyear" name="valid_upto" min="<?php echo (date('Y-m-d',strtotime('now'))); ?>" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);"  class="form-control"/>
                                                             ...
                                                             <div class="form-group col-md-12">
                                                                <table class="table">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                            <select class="form-control" id="bw" name="cmpwall_type" onfocus="textvalidate(this.id,'emis_bw_alert');" onchange="textvalidate(this.id,'emis_bw_alert');" required><option value="">Choose</option>
                                                                        ...
                                                                        <th>
                                                                            <input type="text" id="pbw" name="cmpwall_perimtr"  onfocus="textvalidate(this.id,'emis_pbw_alert');" onchange="textvalidate(this.id,'emis_pbw_alert');" maxlength="6" minlength="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required="required" class="form-control">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                            <input type="text" id="lbw" name="cmpwall_length" maxlength="6" minlength="1"  onfocus="textvalidate(this.id,'emis_lbw_alert');" onchange="textvalidate(this.id,'emis_lbw_alert');" onkeypress="return event.charCode >= 48 && event.charCode <= 57"  required="required" class="form-control">
                                                                        ...
                                                                        <th> 
                                                                            <input type="text" id="tnobb" name="build_block_no"  onfocus="textvalidate(this.id,'emis_tnobb_alert');" onchange="blockgenerate(this);textvalidate(this.id,'emis_tnobb_alert');" onblur="if(!restlength(this)){setMinandMax(this,'block_1');}blockgenerate(this);"  min="1" max="25" maxlength="2"  onkeypress="return event.charCode >= 48 && event.charCode <= 57" required="required" class="form-control">
                                                             ...
                                                             <div class="form-group col-md-12" id="block_1" style="display:none;">
                                                                <table class="table" id="blocktable_1">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <select class="form-control" id="noc" name="noc"  onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);makereadonly(this.parentNode);" required>
                                                                        <option value="">Choose</option> 
                                                                        <option value="1">Pucca</option>
                                                                        ...
                                                                        <th>
                                                                            <input type="text" id="totalarea" name="totalarea" minlength="1" maxlength="2"  min="0" max="10" required="required" onkeydown="return restlength(this)" onblur="return restlength(this)" id="totalarea" name="totalarea" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control">
                                                                            <div id="emistotalarea_0" style="color:#dd4b39;"></div>
                                                                            
                                                                        </th>
                                                                        
                                                                        <th >
                                                                            <input type="text" maxlength="2" minlength="1" id="classroominuse"  name="classroominuse" required="required" onkeyup="sum('noofrooms');" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control">
                                                                            <div id="emisclassroominuse_0" style="color:#dd4b39;"></div> 
                                                                        </th>
                                                                        <th>
                                                                           <input type="text" maxlength="2" minlength="1" id="classroomnotuse" name="classroomnotuse" required="required" onkeyup="sum('noofrooms');" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control">
                                                                           <div id="emisclassroomnotuse_0" style="color:#dd4b39;"></div>
                                                                        </th>
                                                                        
                                                                        <th >
                                                                            <input type="text" id="officeroom" maxlength="2" minlength="1" name="officeroom" required="required" onkeyup="sum('noofrooms');" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control">
                                                                            <div id="emisofficeroom_0" style="color:#dd4b39;"></div>
                                                                           
                                                                        </th>
                                                                        <th >
                                                                            <input type="text" id="labroom" name="labroom" maxlength="2" minlength="1" required="required" onkeyup="sum('noofrooms');" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);"  onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" >
                                                                           <div id="emislabroom_0" style="color:#dd4b39;"></div>
                                                                          
                                                                        </th>
                                                                        <th>
                                                                            <input type="text" id="libraryroom" maxlength="2" minlength="1" name="libraryroom" required="required" onkeyup="sum('noofrooms');" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);"  onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" >
                                                                            <div id="emislibraryroom_0" style="color:#dd4b39;"></div>
                                                                            
                                                                        </th>
                                                                        <th>
                                                                            <input type="text" id="com" name="com" maxlength="2" minlength="1" required="required" onkeyup="sum('noofrooms');" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" >
                                                                            <div id="emiscom_0" style="color:#dd4b39;"></div>
                                                                            
                                                                        </th>
                                                                        <th >
                                                                            <input type="text" id="gam" name="gam" maxlength="2" minlength="1" required="required" onkeyup="sum('noofrooms');" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);"onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" >
                                                                            <div id="emisgam_0" style="color:#dd4b39;"></div>
                                                                            
                                                                        </th>
                                                                        <th>
                                                                            <input type="text" id="staffroom" maxlength="2" name="staffroom" minlength="1" required="required" onkeyup="sum('noofrooms');" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control">
                                                                            <div id="staffroom_0" style="color:#dd4b39;"></div>
                                                                            
                                                                        </th>
                                                                        <th>
                                                                            <input type="text" id="sra" name="sra" onkeyup="sum('noofrooms');" required="required" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);" minlength="1" maxlength="2" onkeypress="return event.charCode >= 48 && event.charCode <= 57"  class="form-control"/>
                                                                            <div id="emissra_0" style="color:#dd4b39;"></div>
                                                                            
                                                                        </th>
                                                                        <th>
                                                                            <input type="text" id="scrg1" name="scrg1" onkeyup="sum('noofrooms');" required="required" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);" maxlength="2" minlength="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57"  class="form-control"/>
                                                                            <div id="emisscrg1_0" style="color:#dd4b39;"></div>
                                                                             
                                                                        </th>
                                                                        <th style="width: 80px !important;">
                                                                            <input type="text" maxlength="2" minlength="1" id="noofrooms" name="noofrooms" required="required" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" readonly>
                                                                        </th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th></th>
                                                                        ...
                                                                        <th>Needs minor repair</th>
                                                                        <th>Needs major repair</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th></th>
                                                                        <th></th>
                                                                        ...
                                                                        <th></th>
                                                                         <th >
                                                                            <input type="text" id="goodcondition" maxlength="2" minlength="1" name="goodcondition" onkeyup="sum('noofrooms');" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);checksumequal(this)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" required="required" />
                                                                            <div id="emisgoodcondition_0" style="color:#dd4b39;"></div>
                                                                           
                                                                        </th>
                                                                        <th >
                                                                            <input type="text" id="needminorrep" name="needminorrep" maxlength="2" minlength="1" onkeyup="sum('noofrooms');" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);checksumequal(this)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" required="required" />
                                                                           <div id="emisneedminrep_0" style="color:#dd4b39;"></div>
                                                                          
                                                                        </th>
                                                                        <th>
                                                                            <input type="text" id="needmajorrep" maxlength="2" minlength="1" name="needmajorrep" onkeyup="sum('noofrooms');" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);sumofall(this.parentNode.parentNode,2);checksumequal(this)"  onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" required="required" />
                                                                            <div id="emisneedmajrep_0" style="color:#dd4b39;"></div>
                                                                            
                                                                        </th>
                                                                        <th>
                                                                            <input type="text" id="totalrep" maxlength="2" minlength="1" name="totalrep" onkeyup="sum('noofrooms');" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);" readonly="readonly"  onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" required="required"/>
                                                                            <div id="alerttotalrep" style="color:#dd4b39;"></div>
                                                                        </th>
                                                                    </tr>
                                                                </table>
                                                             </div>
                                                             <div class="form-group col-md-12">
                                                                <table class="table">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                            <input type="text" id="cuc" name="classrm_undr_constr"  onfocus="textvalidate(this.id,'emis_cuc_alert');" onchange="textvalidate(this.id,'emis_cuc_alert');" maxlength="3" minlength="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required="required" class="form-control">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                            <input type="radio" id="dtst_1" value="1" name="classrm_desk_studs"><label for="dtst_1">YES</label>
                                                                            <input type="radio" id="dtst_2" value="0" name="classrm_desk_studs" checked="checked"/><label for="dtst">NO</label>
                                                                ...
                                                                <table class="table">
                                                                    <tr>
                                                                        <th >Whether there is a ramp for differently abled children to access classrooms? <font style="color:#dd4b39;">*</font></th><th>
                                                                            <input type="radio" id="dchac_1" name="ramp_disable_child" value="1" onchange="sbcshow2(this,'handrailsdetails');"/><label for="dchac">YES</label>
                                                                            <input type="radio" id="dchac_2" name="ramp_disable_child" value="0" onchange="sbcshow2(this,'handrailsdetails');" checked="checked"/><label for="dchac_2">NO</label>
                                                                        ...
                                                                        <th class="handrailsdetails">
                                                                            <input type="radio" value="1" id="rails_1" name="ramp_handrail" /><label for="rails_1">YES</label>
                                                                            <input type="radio" value="0" id="rails_2" name="ramp_handrail" checked="checked"/><label for="rails_2">NO</label>
                                                             ...
                                                             <div class="form-group col-md-12">
                                                                <table class="table">
                                                                    ...
                                                                    <tr>
                                                                        <th>Staff quarters (including Residential Quarters for Head Master/Principal and Others) <font style="color:#dd4b39;">*</font></th><th>
                                                                            <input type="radio" id="sq_1" value="1" name="staffquarter" onchange="sbcshow2(this,'sqdetails');setRequiredField(this.value,'sqhm','1');" /><label for="sq_1">YES</label>
                                                                            <input type="radio" id="sq_2" value="0" name="staffquarter" onchange="sbcshow2(this,'sqdetails');setRequiredField(this.value,'sqhm','1');" checked="checked"/><label for="sq_2">NO</label>
                                                                            <!--cwall_notcon_len bigint(20) schoolnew_infradet-->
                                                                        </th>
                                                                        <th class="sqdetails">
                                                                            <input type="text" id="sqhm" name="rooms_staffquartrs" onfocus="textvalidate(this.id,'emis_sqhm_alert');" onchange="textvalidate(this.id,'emis_sqhm_alert');" maxlength="2" onkeypress="return event.charCode >= 48 && event.charCode <= 57"  class="form-control"/>
                                                                ...
                                                                <table class="table">
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                             <input type="radio" id="fulltimelib_1" value="1" name="fulltime_lib"/><label for="fulltimelib_1">YES</label>
                                                                             <input type="radio" id="fulltimelib_2" value="0" name="fulltime_lib" checked="checked"/><label for="fulltimelib_2">NO</label>
                                                                        </th>
                                                                        <th>Does the school subscribe to newspapers/magazines?</th>
                                                                        <th>
                                                                            <input type="radio" id="newssubscribe_1" value="1" name="news_subscribe"/><label for="newssubscribe_1">YES</label>
                                                                            <input type="radio" id="newssubscribe_2" value="0" name="news_subscribe" checked="checked"/><label for="newssubscribe_2">NO</label>
                                                                        </th>
                                                                    </tr>
                                                                </table>
                                                             </div>
                                                             <div class="form-group col-md-12">
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                            <input type="text" id="lbr1" name="lbr1_0"  onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);" maxlength="6" minlength="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" required="required"/>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <input type="number" id="tnotam" name="toil_gents_tot"  onfocus="textvalidate(this.id,'emis_tnotam_alert');" onchange="textvalidate(this.id,'emis_tnotam_alert');" min="0" minlength="1" max="999"  maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" required/>
                                                                         <!--cwall_existbu_len bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="emis_tnotam_alert"></div></font>
                                                                    </th>
                                                                    <th>
                                                                        <input type="number" id="tnotaf" name="toil_ladies_tot" required onfocus="textvalidate(this.id,'emis_tnotaf_alert');" onchange="textvalidate(this.id,'emis_tnotaf_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <= 57" class="form-control"/>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <input type="number" id="tnouam" name="urinal_gents_tot" required onfocus="textvalidate(this.id,'emis_tnouam_alert');" onchange="textvalidate(this.id,'emis_tnouam_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control"/>
                                                                        <!--fans varchar(50) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="emis_tnouam_alert"></div></font>
                                                                    </th>
                                                                    <th>
                                                                        <input type="number" id="tnouaf" name="urinals_tot_ladies" required onfocus="textvalidate(this.id,'emis_tnouaf_alert');" onchange="textvalidate(this.id,'emis_tnouaf_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <= 57" class="form-control"/>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th style="width: 100px;">
                                                                        <input type="number" id="notsaisb" name="toil_bys_inuse" onfocus="textvalidate(this.id,'emis_notsaisb_alert');" onkeydown="return restlength(this)" onblur="return restlength(this)" onchange="textvalidate(this.id,'emis_notsaisb_alert');" min="0" max="999" minlength="1" maxlength="3" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" required/>
                                                                        <!--hostel_floor bigint(20) schoolnew_academicinfo-->
                                                                        <font style="color:#dd4b39;"><div id="emis_notsaisb_alert"></div></font>
                                                                    </th>
                                                                    <th style="width: 100px;">
                                                                        <input type="number" id="notsaisg" name="toil_notuse_bys" onfocus="textvalidate(this.id,'emis_notsaisg_alert');" onchange="textvalidate(this.id,'emis_notsaisg_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <= 57" class="form-control" required/>
                                                                    ...
                                                                    <th style="width: 150px; border-right: thin #ccc solid;">
                                                                        <select class="form-control" id="trnfb" name="toil_nonfunc_bys" onfocus="textvalidate(this.id,'emis_tnfb_alert');" onchange="textvalidate(this.id,'emis_tnfb_alert');" required>
                                                                            <option value="">Choose</option>
                                                                        ...
                                                                        <font style="color:#dd4b39;"><div id="emis_tnfb_alert"></div></font>
                                                                    </th>
                                                                    <th style="width: 100px;">
                                                                        <input type="number" id="totiuseg" name="toil_inuse_grls" onfocus="textvalidate(this.id,'emis_bu_usable_alert');" onchange="textvalidate(this.id,'emis_bu_usable_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <= 57" class="form-control" required/>
                                                                        <!--bu_usable bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="emis_bu_usable_alert"></div></font>
                                                                    </th>
                                                                    <th style="width: 100px;">
                                                                        <input type="number" id="totntuseg" name="toil_notuse_grls" onfocus="textvalidate(this.id,'emis_bu_minrep_alert');" onchange="textvalidate(this.id,'emis_bu_minrep_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <= 57" class="form-control" required/>
                                                                        <!--bu_minrep bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="emis_bu_minrep_alert"></div></font>
                                                                    </th>
                                                                    <th style="width: 150px;">
                                                                        <select class="form-control" id="trnfg" name="toil_reasn_grls" onfocus="textvalidate(this.id,'emis_tnfg_alert');" onchange="textvalidate(this.id,'emis_tnfg_alert');" required>
                                                                            <option value="">Choose</option>
                                                                            <option value="1">Water Supply</option>
                                                                            <option value="2">Drainage Problem</option>
                                                                            <option value="3">Toilet Damaged</option>
                                                                        ...
                                                                        <font style="color:#dd4b39;" ><div id="emis_tnfg_alert"></div></font>
                                                                    </th>
                                                                </tr>
                                                                <tr>
                                                                    <th>Number of CWSN friendly functional toilets <font style="color:#dd4b39;">*</font></th>
                                                                    <th>
                                                                        <input type="number" id="cwsnfftb" name="cwsntoil_inuse_bys" required onfocus="textvalidate(this.id,'emis_cwsninuseb_alert');" onchange="textvalidate(this.id,'emis_cwsninuseb_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                        <!--gu_no bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="emis_cwsninuseb_alert"></div></font>
                                                                    </th>
                                                                    <th>
                                                                        <input type="number" id="cwsnfftg" name="cwsntoil_notuse_bys" required onfocus="textvalidate(this.id,'emis_cwsnntg_alert');" onchange="textvalidate(this.id,'emis_cwsnntg_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                        <!--gu_usable bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="emis_cwsnntg_alert"></div></font>
                                                                    </th>
                                                                    <th style="border-right: thin #ccc solid;">
                                                                        <select class="form-control" id="cswntrfb" name="cwsntoil_reasn_bys" onfocus="textvalidate(this.id,'emis_gu_minrep_alert');" onchange="textvalidate(this.id,'emis_gu_minrep_alert');" required>
                                                                            <option value="">Choose</option>
                                                                            <option value="1">Water Supply</option>
                                                                            <option value="2">Drainage Problem</option>
                                                                            <option value="3">Toilet Damaged</option>
                                                                    ...
                                                                    <th>
                                                                        <input type="number" id="cwsntinuseg" name="cwsntoil_inuse_grls" required onfocus="textvalidate(this.id,'emis_cwsnfftg_alert');" onchange="textvalidate(this.id,'emis_cwsnfftg_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                         <!--gu_majrep bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="emis_cwsnfftg_alert"></div></font>
                                                                    </th>
                                                                    <th>
                                                                        <input type="number" id="cwsntntuseg" name="cwsntoil_notuse_grls" required onfocus="textvalidate(this.id,'emis_cwsnfftb_alert');" onchange="textvalidate(this.id,'emis_cwsnfftb_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                        <!--bl_no bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="emis_cwsnfftb_alert"></div></font>
                                                                    </th>
                                                                    <th>
                                                                        <select class="form-control" id="cswntrfg" name="cwsntoil_reasn_grls" onfocus="textvalidate(this.id,'emis_cwsnnftg_alert');" onchange="textvalidate(this.id,'emis_cwsnnftg_alert');" required>
                                                                            <option value="">Choose</option>
                                                                            <option value="1">Water Supply</option>
                                                                            <option value="2">Drainage Problem</option>
                                                                            <option value="3">Toilet Damaged</option>
                                                                        ...
                                                                        <font style="color:#dd4b39;"><div id="emis_cwsnnftg_alert"></div></font>
                                                                    </th>
                                                                </tr>
                                                                <tr>
                                                                    <th>Total number of Urinals available <font style="color:#dd4b39;">*</font></th>
                                                                    <th>
                                                                        <input type="number" id="tnoinuab" name="urinls_inuse_bys" required onfocus="textvalidate(this.id,'emis_tnouab_alert');" onchange="textvalidate(this.id,'emis_tnouab_alert');" onkeydown="return restlength(this)" onblur="return restlength(this)" min="0" max="999" minlength="1" maxlength="3" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                        <!--bl_minrep bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="emis_tnouab_alert"></div></font>
                                                                    </th>
                                                                    <th>
                                                                        <input type="number" id="tnontuab" name="urinls_notuse_bys" required onfocus="textvalidate(this.id,'emis_tnouag_alert');" onchange="textvalidate(this.id,'emis_tnouag_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                        <!--bl_majrep bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="emis_tnouag_alert"></div></font>
                                                                    </th>
                                                                    <th style="border-right: thin #ccc solid;">
                                                                        <select class="form-control" id="tnurbys" name="urinls_reasn_bys" onfocus="textvalidate(this.id,'emis_urnouab_alert');" onchange="textvalidate(this.id,'emis_urnouab_alert');" required>
                                                                            <option value="">Choose</option>
                                                                            <option value="1">Water Supply</option>
                                                                            <option value="2">Drainage Problem</option>
                                                                            <option value="3">Toilet Damaged</option>
                                                                        ...
                                                                        <font style="color:#dd4b39;" id="emis_urnouab_alert"></font>
                                                                    </th>
                                                                    <th>
                                                                        <input type="number" id="tnoinuag" name="urinls_inuse_grls" required onfocus="textvalidate(this.id,'emis_unuag_alert');" onchange="textvalidate(this.id,'emis_unuag_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                         <!--gl_usable bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;" id="emis_unuag_alert"></font>
                                                                    </th>
                                                                    <th>
                                                                        <input type="number" id="tnontuag" name="urinls_notuse_grls" required onfocus="textvalidate(this.id,'emis_unouag_alert');" onchange="textvalidate(this.id,'emis_unouag_alert');" onkeydown="return restlength(this)" onblur="return restlength(this)" min="0" max="999" minlength="1" maxlength="3" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                        <!--gl_minrep bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;" id="emis_unouag_alert"></font>
                                                                    </th>
                                                                    <th>
                                                                        <select class="form-control" id="tnurgirls" name="urinls_reasn_grls" onfocus="textvalidate(this.id,'emis_urngls_alert');" onchange="textvalidate(this.id,'emis_urngls_alert');" required>
                                                                            <option value="">Choose</option>
                                                                            <option value="1">Water Supply</option>
                                                                            <option value="2">Drainage Problem</option>
                                                                            <option value="3">Toilet Damaged</option>
                                                                        ...
                                                                        <font style="color:#dd4b39;" id="emis_urngls_alert"></font>
                                                                    </th>
                                                                </tr>
                                                                <!--<tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th colspan="3" style="border-right: thin #ccc solid;">
                                                                        <input type="number" id="hmatwfb" name="toil_waterfac_bys" required onfocus="textvalidate(this.id,'emis_hmatwfb_alert');" onchange="textvalidate(this.id,'emis_hmatwfb_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                        <!--gentsu_no bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="emis_hmatwfb_alert"></div></font>
                                                                    </th>
                                                                    <th colspan="3">
                                                                        <input type="number" id="hmatfwg" name="toil_waterfac_grls" required onfocus="textvalidate(this.id,'emis_hmatwfg_alert');" onchange="textvalidate(this.id,'emis_hmatwfg_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th colspan="3" style="border-right: thin #ccc solid;">
                                                                        <input type="number" id="oouwfb" name="urinls_waterfac_bys" required onfocus="textvalidate(this.id,'emis_oouwfb_alert');" onchange="textvalidate(this.id,'emis_oouwfb_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                        <!--gentsu_minrep bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="emis_oouwfb_alert"></div></font>
                                                                    </th>
                                                                    <th colspan="3">
                                                                        <input type="number" id="oouwfg" name="urinls_waterfac_grls" required onfocus="textvalidate(this.id,'emis_oouwfg_alert');" onchange="textvalidate(this.id,'emis_oouwfg_alert');" min="0" max="999" minlength="1" maxlength="3" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >=48 && event.charCode <=57" class="form-control"/>
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <th colspan="2">
                                                                            <input type="radio" id="clt_1" value="1" name="toil_sanit_wrks"/><label for="clt_1">YES</label>
                                                                            <input type="radio" id="clt_2" value="0" name="toil_sanit_wrks" checked="checked"/><label for="clt_2">NO</label>
                                                                    ...
                                                                    <th colspan="2">
                                                                        <input type="radio" id="atr_1" value="1" name="toil_land_avail" onchange="document.getElementById('adtoiletdetails').style.visibility=(this.checked?'':'hidden');setRequiredField(this.value,'adtoiletdetails1','1');"/><label for="atr_1">YES</label>
                                                                        <input type="radio" id="atr_1" value="0" name="toil_land_avail" onchange="document.getElementById('adtoiletdetails').style.visibility=(this.checked?'hidden':'');setRequiredField(this.value,'adtoiletdetails1','1');" checked="checked"/><label for="atr_2">NO</label>
                                                                        <!--ladiesu_usable bigint(20) schoolnew_infradet-->
                                                                    </th>
                                                                    <th id="adtoiletdetails" colspan="2">Sq.ft
                                                                        <input type="text" id="adtoiletdetails1" name="toil_land_avail_sqft" maxlength="7" minlength="1"  onfocus="textvalidate(this.id,'emis_adtoiletdetails1_alert');" onchange="textvalidate(this.id,'emis_adtoiletdetails1_alert');"  class="form-control" onkeypress="return event.charCode >=48 &amp;&amp; event.charCode <=57" placeholder="(in Sq.ft)">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th colspan="2">
                                                                        <input type="radio" id="nvm_1" value="1" name="napkin_incin" onchange="sbcshow2(this,'nvmdetails');setRequiredField(this.value,'napkin_avail,napkin_func','1');"/><label for="nvm_1">YES</label>
                                                                        <input type="radio" id="nvm_2" value="0" name="napkin_incin" onchange="sbcshow2(this,'nvmdetails');setRequiredField(this.value,'napkin_avail,napkin_func','1');" checked="checked"/><label for="nvm_2">NO</label>
                                                                        <!--napkin_inc bigint(20) schoolnew_infradet-->
                                                                    </th>
                                                                    <th class="nvmdetails">Avaliablity</th>
                                                                    <th class="nvmdetails">
                                                                        <input type="text" class="form-control" id="napkin_avail" name="napkin_avail_no" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" maxlength="1" min="0" max="9" onfocus="textvalidate(this.id,'emis_napauto_alert');" onchange="textvalidate(this.id,'emis_napauto_alert');" />
                                                                        <font style="color:#dd4b39;" id="emis_napauto_alert"></font>
                                                                    </th>
                                                                    <th class="nvmdetails">Functional</th>
                                                                    <th class="nvmdetails">
                                                                        <input type="text" class="form-control" id="napkin_func" name="napkin_func_no" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" maxlength="1" min="0" max="9" onfocus="textvalidate(this.id,'emis_napfun_alert');" onchange="textvalidate(this.id,'emis_napfun_alert');" />
                                                                        <font style="color:#dd4b39;" id="emis_napfun_alert"></font>
                                                                    </th>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <input type="radio" id="incin_1" value="1" name="incinerator" onchange="sbcshow2(this,'incindetails');setRequiredField(this.value,'inc_auto_avail,inc_auto_func,inc_man_avail,inc_man_func','1');"/><label for="incin_1">YES</label>
                                                                        <input type="radio" id="incin_2" value="0" name="incinerator" onchange="sbcshow2(this,'incindetails');setRequiredField(this.value,'inc_auto_avail,inc_auto_func,inc_man_avail,inc_man_func','1');" checked="checked"/><label for="incin_2">NO</label>
                                                                       
                                                                    </th>
                                                                    <th class="incindetails">
                                                                        <input type="text" class="form-control" id="inc_auto_avail" name="inci_auto_avail_no" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" maxlength="1" min="0" max="9"  onfocus="textvalidate(this.id,'emis_auto_alert');" onchange="textvalidate(this.id,'emis_auto_alert');" />
                                                                        <font style="color:#dd4b39;" id="emis_auto_alert"></font>
                                                                    </th>
                                                                    <th class="incindetails">
                                                                        <input type="text" class="form-control" id="inc_auto_func" name="inci_auto_func_no" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" maxlength="1" min="0" max="9"  onfocus="textvalidate(this.id,'emis_autofun_alert');" onchange="textvalidate(this.id,'emis_autofun_alert');" />
                                                                        <font style="color:#dd4b39;" id="emis_autofun_alert"></font>
                                                                    </th>
                                                                    <th class="incindetails">
                                                                        <input type="text" class="form-control" id="inc_man_avail" name="inci_man_avail_no" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" maxlength="1"  min="0" max="9"  onfocus="textvalidate(this.id,'emis_manav_alert');" onchange="textvalidate(this.id,'emis_manav_alert');" />
                                                                        <font style="color:#dd4b39;" id="emis_manav_alert"></font>
                                                                    </th>
                                                                    <th class="incindetails" colspan="2">
                                                                        <input type="text" class="form-control" id="inc_man_func" name="inci_man_func_no" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" maxlength="1" min="0" max="9"  onfocus="textvalidate(this.id,'emis_manfun_alert');" onchange="textvalidate(this.id,'emis_manfun_alert');" />
                                                                        <font style="color:#dd4b39;" id="emis_manfun_alert"></font>
                                                                    </th>
                                                                </tr>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th >
																		<input type="text" id="handwashboys" name="tot_handwash_bys" min="0" max="500" maxlength="3" minlength="1" onfocus="textvalidate(this.id,'totalhws_alert');" onchange="textvalidate(this.id,'totalhws_alert');" onkeydown="return restlength(this)"  onblur="return restlength(this);" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" required="required"/>
																		 <!--gentsl_no bigint(20) schoolnew_infradet-->
                                                                        <font style="color:#dd4b39;"><div id="totalhws_alert"></div></font>
																	</th>
                                                                    <th >
																		<input type="text" id="handwashgirls" name="tot_handwash_grls" min="0" max="500" maxlength="3" minlength="1" onfocus="textvalidate(this.id,'totalhwsg_alert');" onchange="textvalidate(this.id,'totalhwsg_alert');" onkeydown="return restlength(this)"  onblur="return restlength(this);"  onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" required="required"/>
                                                            ...
                                                            <table class="table">
                                                                <tr>
                                                                    ...
                                                                    <th style="width: 165px;">
                                                                        <input type="radio" id="dwa_1" name="drnkwater_avail" value="1" onchange="document.getElementById('wdwsp').selectedIndex=0;sbcshow1(this,'dwdetails'); selectshow(document.getElementById('wdwsp'),'topwell');  showOthersText(this.parentNode.parentNode,4,3); setRequiredField(this.value,'wdwsp','1');"/><label for="dwa_1">YES</label>
                                                                        <input type="radio" id="dwa_2" name="drnkwater_avail" value="0" onchange="document.getElementById('wdwsp').selectedIndex=0;sbcshow1(this,'dwdetails'); selectshow(document.getElementById('wdwsp'),'topwell'); showOthersText(this.parentNode.parentNode,4,3); setRequiredField(this.value,'wdwsp','1');" checked="checked"/><label for="dwa_2">NO</label>
                                                                        <!--well_close varchar(15) schoolnew_infradet-->
                                                                    </th>
                                                                    <th class="dwdetails">If Yes, source of drinking water</th>
                                                                    <th class="dwdetails">
                                                                        <select class="form-control" id="wdwsp" name="drnkwater_source" onfocus="textvalidate(this.id,'emis_wdwsp_alert');" onchange="selectshow(this,'topwell','2');showOthersText(this.parentNode.parentNode,4,3);textvalidate(this.id,'emis_wdwsp_alert');setRequiredField(this.value,'ifothersd_0','-1');if(this.value!=2){document.getElementById('well_top').value='';}">
                                                                            <option value="">Choose</option>
                                                                            ...
                                                                            <option value="5">Packaged / Bottled water</option>
                                                                    ...
                                                                    <th id="ifothersth_0">
                                                                                ...
                                                                                <input type="text" maxlength="100" minlength="1" id="ifothersd_0" name="drnkwater_othsource" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);" onkeypress="return  event.charCode >= 97 && event.charCode <= 122 || event.charCode >= 65 && event.charCode <= 90 || event.charCode == 32" class="form-control">
                                                                    ...
                                                                    <th class="topwell">
                                                                                ...
                                                                                Whether well is being maintained as top closed?<br />
                                                                                     <input type="radio" id="welltop_1" value="1" name="well_top1" onchange="document.getElementById('well_top').value=this.value;" /><label for="welltop_1">YES</label>
                                                                                     <input type="radio" id="welltop_2" value="0" name="well_top1" onchange="document.getElementById('well_top').value=this.value;" checked/><label for="welltop_2">NO</label>
                                                                                    <!--well_dia 'bigint(20)'-->
                                                                                    <input type="hidden" id="well_top" name="well_top" />
                                                                    ...
                                                                    <tr class="dwdetails">
                                                                    <th>Whether water quality is tested from water testing lab ?</th>
                                                                    <th>
                                                                        <input type="radio" id="watertest_1" value="1" name="water_test" /><label for="watertest_1">YES</label>
                                                                        <input type="radio" id="watertest_2" value="0" name="water_test" checked/><label for="watertest_2">NO</label>
                                                                    </th>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <input type="radio" id="spot_1" value="1" name="overheadtank_avail"/><label for="spot_1">YES</label>
                                                                        <input type="radio" id="spot_2" value="0" name="overheadtank_avail" checked="checked"/><label for="spot_1">NO</label></th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <input type="radio" id="wpac_1" value="1" name="waterpuri_avail"/><label for="wpac_1">YES</label>
                                                                        <input type="radio" id="wpac_2" value="0" name="waterpuri_avail" checked="checked"/><label for="wpac_2">NO</label>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <input type="radio" id="rwh_1" value="1" name="schl_rainwtr_hrv"/><label for="rwh_1">YES</label>
                                                                        <input type="radio" id="rwh_1" value="0" name="schl_rainwtr_hrv" checked="checked"/><label for="rwh_2">NO</label>
                                                                        <!--Fieldname: rainwater 'varchar(10)' schoolnew_infradet-->
                                                                    </th>
                                                                </tr>
                                                                <tr>
                                                                    <th>Whether solar panel is available in school ? <font style="color:#dd4b39;">*</font></th>
                                                                    <th>
                                                                        <input type="radio" id="solar_1" value="1" name="solar_panel"/><label for="solar_1">YES</label>
                                                                        <input type="radio" id="solar_1" value="0" name="solar_panel" checked="checked"/><label for="solar_2">NO</label>
                                                                    </th>
                                                                </tr>
                                                                <tr>
                                                                    <th>Whether Kitchen Garden is available in school? <font style="color:#dd4b39;">*</font></th>
                                                                    <th>
                                                                        <input type="radio" id="kitchengarden_1" value="1" name="kitchen_garden"/><label for="kitchengarden_1">YES</label>
                                                                        <input type="radio" id="kitchengarden_1" value="0" name="kitchen_garden" checked="checked"/><label for="kitchengarden_2">NO</label>
                                                                    </th>
                                                                </tr>
                                                             ...
                                                             <table class="table">
                                                                <tr>
                                                                    <th>Does the school have dustbins for collection of waste?</th>
                                                                    <th>Yes</th>
                                                                    <th>No</th>
                                                                    <th>Yes but some</th>
                                                                </tr>
                                                                <tr>
                                                                    <th>Each Class Room</th>
                                                                    <th><input type="radio" id="classdustbin_1" value="1" name="class_dustbin"/></th>
                                                                    <th><input type="radio" id="classdustbin_2" value="0" name="class_dustbin" checked="checked"/></th>
                                                                    <th><input type="radio" id="classdustbin_3" value="2" name="class_dustbin"/></th>
                                                                </tr>
                                                                <tr>
                                                                    <th>Toilets</th>
                                                                    <th><input type="radio" id="toilets_1" value="1" name="waste_toilets"/></th>
                                                                    <th><input type="radio" id="toilets_2" value="0" name="waste_toilets" checked="checked"/></th>
                                                                    <th><input type="radio" id="toilets_3" value="2" name="waste_toilets"/></th>
                                                                </tr>
                                                                <tr>
                                                                    <th>Kitchen</th>
                                                                    <th><input type="radio" id="kitchen_1" value="1" name="waste_kitchen"/></th>
                                                                    <th><input type="radio" id="kitchen_2" value="0" name="waste_kitchen" checked="checked"/></th>
                                                                    <th><input type="radio" id="kitchen_3" value="2" name="waste_kitchen"/></th>
                                                                </tr>
                                                              </table>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-row text-center">
                                                <?php if($this->uri->segment(4,0)=='-1' && $this->uri->segment(4,0)!=''){ ?>
    ...
    <script>
     ...
     function landusage(landvalue) {
        ...
        for(var i=0;i<ele.length;i++){
            for(var j=0;j<ele[i].length;j++){
               if(i==0){
                    ...
                    ele[i][j].innerHTML=ele[i][j].innerHTML;
               } 
               else{
      ...
      function checksumequal(node){
            var id=node.id.split('_');
            if(document.getElementById('totalrep_'+id[1]).value==document.getElementById('noofrooms_'+id[1]).value){
                return true;
            }
            else{
                if(document.getElementById('goodcondition_'+id[1]).value=='' || document.getElementById('needminorrep_'+id[1]).value=='' || document.getElementById('needmajorrep_'+id[1]).value==''){
                    return false;
                }
                else{
                    alert("Values Must Be Equal To The Above Total");   
                    document.getElementById('goodcondition_'+id[1]).value='';
                    document.getElementById('needminorrep_'+id[1]).value=''; 
                    document.getElementById('needmajorrep_'+id[1]).value='';
                    document.getElementById('totalrep_'+id[1]).value='';
                }
            }
            return false;
      }
