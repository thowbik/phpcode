...
<body class="page-container-bg-solid page-md">
                                                                    ...
                                                                    <tr>
                                                                        <th>
                                                                            <select class="form-control" id="sch_0" name="sch_0" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="selectionValidation(this,this.parentNode.parentNode);textvalidate(this.id,this.nextElementSibling.id);" required>
                                                                                ...
                                                                                <?php foreach($schooltype as $scltype) {?>
                                                                                <option value="<?php echo $scltype->id; ?>"><?php echo $scltype->category_name; ?></option>
                                                                                <?php }?>
                                                                        ...
                                                                        <th><input type="number" id="instructdays_0" name="instructdays_0" min="0" max="300" onkeydown="return restlength(this)" onblur="return restlength(this)" minlength="1" maxlength="3" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="textvalidate(this.id,this.nextElementSibling.id);" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" required/>
                                                                         ...
                                                                         <th>
                                                                            <div id="cceschcc_0">
                                                                                ...
                                                                                <input type="radio" class="custom-control-input" id="ccesch_0" name="ccesch_0" value="1" onchange="updateRadioCheck(this,this.parentNode.nextElementSibling);" />
                                                                                <label class="custom-control-label" for="cce_2">NO</label>
                                                                                <input type="radio" class="custom-control-input" id="ccesch_1" name="ccesch_0" value="0" onchange="updateRadioCheck(this,this.parentNode.nextElementSibling);this.parentNode.nextElementSibling.innerHTML=this.parentNode.nextElementSibling.innerHTML;" checked="checked" />
                                                                            </div>
                                                                ...
                                                                <table class="table">
                                                                    <tr>
                                                                       <th>When does the Academic Session start? Please indicate the month: <font style="color:#dd4b39;">*</font></th>
                                                                        <th><select class="form-control" id="sptass" name="acad_mnth_start" required>
                                                                        <!--<option value=""></option>-->
                                                                        <?php
                                                                        $i=6; $z=1;
                                                             ...
                                                             <div class="form-group col-md-12">
                                                                <table class="table">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <input type="radio"  id="spt_1" name="special_train" value="1" onchange="document.getElementById('specialtraining').style.display=(this.checked?'':'none');setRequiredField(this.value,'sptcyb,sptcyg,sptcby,sptstc,sptttbc','1')" /><label for="spt_1">YES</label>
                                                                        <input type="radio"  id="spt_2" name="special_train" value="0" onchange="document.getElementById('specialtraining').style.display=(this.checked?'none':'');setRequiredField(this.value,'sptcyb,sptcyg,sptcby,sptstc,sptttbc','1')" checked="checked" /><label for="spt_2">NO</label>
                                                                        </th>
                                                                    </tr>
                                                            ...
                                                            <div class="form-group col-md-12" id="specialtraining">
                                                                <table class="table">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th><input type="number" min="0" maxlength="4" max="9999" id="sptcyb" name="train_prov_boys" onfocus="textvalidate(this.id,'emis_stcyb_alert');" onchange="textvalidate(this.id,'emis_stcyb_alert');" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control">
                                                                        <font style="color:#dd4b39;"><div id="emis_stcyb_alert"></div></font>
                                                                        </th>
                                                                        <th><input type="number" min="0" maxlength="4" max="9999" minlength="1" id="sptcyg" name="train_prov_grls" onfocus="textvalidate(this.id,'emis_stcyg_alert');" onchange="textvalidate(this.id,'emis_stcyg_alert');" onkeydown="return restlength(this)" onblur="return restlength(this)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th><select class="form-control" id="sptcby" name="train_cond_by" onfocus="textvalidate(this.id,'emis_sptcby_alert');" onchange="textvalidate(this.id,'emis_sptcby_alert');">
                                                                        <option value="">Choose</option>
                                                                     ...
                                                                     <tr>
                                                                        ...
                                                                        <th><select class="form-control" id="sptstc" name="train_cond_in" onfocus="textvalidate(this.id,'emis_sptcin_alert');" onchange="textvalidate(this.id,'emis_sptcin_alert');">
                                                                        <option value="">Choose</option>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th><select class="form-control" id="sptttbc" name="train_type" onfocus="textvalidate(this.id,'emis_sptc_alert');" onchange="textvalidate(this.id,'emis_sptc_alert');">
                                                                        <option value="">Choose</option>
                                                             ...
                                                             <div class="form-group col-md-12">
                                                                <table class="table">
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                           <input type="radio"  id="counsel_1" name="stu_councel" value="1"  /><label for="counsel_1">YES</label>
                                                                           <input type="radio"  id="counsel_2" name="stu_councel" value="0" checked="checked" /><label for="counsel_2">NO</label>
                                                                    ...
                                                                    <tr>
                                                                        <th style="width: 281px;">
                                                                            <select id="club_1" name="club_1" onfocus="textvalidate(this.id,this.nextElementSibling.id);" onchange="showOthersText(this.parentNode.parentNode);selectionValidation(this,this.parentNode.parentNode);textvalidate(this.id,this.nextElementSibling.id);" class="form-control" required>
                                                                                ...
                                                                                <option value="">Choose</option>
                                                                                <?php foreach($clublist as $listclub ){?>
                                                                                <option value="<?php echo $listclub['id'];?>"><?php echo $listclub['clubs'];?></option>
                                                                                <?php }?>
                                                                            </select>
                                                                    ...
                                                                    <table class="table">
                                                                        <tr>
                                                                            <th colspan="3" class="bg-primary text-white">
                                                                                ...
                                                                                <span class="caption-subject text-white sbold uppercase" >School Safety</span>
                                                                            </th>
                                                                         </tr>
                                                                         <tr>
                                                                            <td>Whether the School Disaster Management Plan (SDMP) has been developed ?</td>
                                                                            <td>
                                                                                <input type="radio"  id="sdmp_1" name="sdmp_dev" value="1"  /><label for="sdmp_1">YES</label>
                                                                                <input type="radio"  id="sdmp_2" name="sdmp_dev" value="0" checked="checked" /><label for="sdmp_2">NO</label>
                                                                            </td>
                                                                         </tr>
                                                                          <tr>
                                                                            <td>Whether Structural Safety Audit has been conducted ?</td>
                                                                            <td>
                                                                                <input type="radio"  id="sturctsaf_1" name="sturct_saf" value="1"  /><label for="sturctsaf_1">YES</label>
                                                                                <input type="radio"  id="sturctsaf_2" name="sturct_saf" value="0" checked="checked" /><label for="sturctsaf_2">NO</label>
                                                                            </td>
                                                                         </tr>
                                                                          <tr>
                                                                            <td>Whether Non- structural Safety Audit has been conducted ?</td>
                                                                            <td>
                                                                                <input type="radio"  id="nonsturctsaf_1" name="nonsturct_saf" value="1"  /><label for="nonsturctsaf_1">YES</label>
                                                                                <input type="radio"  id="nonsturctsaf_2" name="nonsturct_saf" value="0" checked="checked" /><label for="nonsturctsaf_2">NO</label>
                                                                            </td>
                                                                         </tr>
                                                                         <tr>
                                                                            <td>Whether CCTV Cameras available in school ?</td>
                                                                            <td>
                                                                                <input type="radio"  id="cctvschool_1" name="cctv_school" value="1"  /><label for="cctvschool_1">YES</label>
                                                                                <input type="radio"  id="cctvschool_2" name="cctv_school" value="0" checked="checked" /><label for="cctvschool_2">NO</label>
                                                                            </td>
                                                                         </tr>
                                                                         <tr>
                                                                            <td>Whether Fire Extinguishers are installed ?</td>
                                                                            <td>
                                                                                <input type="radio"  id="firextschl_1" name="firext_schl" value="1"  /><label for="firextschl_1">YES</label>
                                                                                <input type="radio"  id="firextschl_2" name="firext_schl" value="0" checked="checked" /><label for="firextschl_2">NO</label>
                                                                            </td>
                                                                         </tr>
                                                                         <tr>
                                                                            <td>Does the school have a nodal teacher for school safety?</td>
                                                                            <td>
                                                                                <input type="radio"  id="nodtchrschl_1" name="nodtchr_schlsaf" value="1"  /><label for="nodtchrschl_1">YES</label>
                                                                                <input type="radio"  id="nodtchrschl_2" name="nodtchr_schlsaf" value="0" checked="checked" /><label for="nodtchrschl_2">NO</label>
                                                                            </td>
                                                                         </tr>
                                                                         <tr>
                                                                            <td>Whether students and teachers undergo regular training in school safety and disaster preparedness ?</td>
                                                                            <td>
                                                                                <input type="radio"  id="distertrng_1" name="dister_trng" value="1"  /><label for="distertrng_1">YES</label>
                                                                                <input type="radio"  id="distertrng_2" name="dister_trng" value="0" checked="checked" /><label for="distertrng_2">NO</label>
                                                                            </td>
                                                                         </tr>
                                                                         <tr>
                                                                            <td>Whether disaster management is being taught as part of the curriculum ?</td>
                                                                            <td>
                                                                                <input type="radio"  id="disterpart_1" name="dister_part" value="1"  /><label for="disterpart_1">YES</label>
                                                                                <input type="radio"  id="disterpart_2" name="dister_part" value="0" checked="checked" /><label for="disterpart_2">NO</label>
                                                                            </td>
                                                                         </tr>
                                                                        
                                                                         <tr>
                                                                            <td>Whether school has received grant for Self Defense Training for Girls ?</td>
                                                                            <td>
                                                                                <input type="radio"  id="slfdfsetrng_1" name="slfdfse_trng" value="1" onchange="document.getElementById('selfdefnsetraning').style.display=(this.checked?'':'none');setRequiredField(this.value,'noslfdfse_trng','1');" /><label for="slfdfsetrng_1">YES</label>
                                                                                <input type="radio"  id="slfdfsetrng_2" name="slfdfse_trng" value="0" onchange="document.getElementById('selfdefnsetraning').style.display=(this.checked?'none':'');setRequiredField(this.value,'noslfdfse_trng','1');document.getElementById('selfdefnsetraning').innerHTML=document.getElementById('selfdefnsetraning').innerHTML" checked="checked" /><label for="slfdfsetrng_2">NO</label>
                                                                            </td>
                                                                         </tr>
                                                                         <tr id="selfdefnsetraning">
                                                                            <td>If yes, No. of students provided training (provide actual number of student trained)</td>
                                                                            <td>
                                                                                <input type="text" id="noslfdfse_trng" name="noslfdfse_trng" class="form-control" style="width: 80px;" onfocus="textvalidate(this.id,'emis_noslfdfsetrng_alert');" onchange="textvalidate(this.id,'emis_noslfdfsetrng_alert');"/>
                                                                                <font style="color:#dd4b39;" id="emis_noslfdfsetrng_alert"></font>
                                                                            </td>
                                                                         </tr>
                                                                    </table>
                                                              </div>
    ...
    <script>
         ...
         document.getElementById('selfdefnsetraning').style.display='none';
