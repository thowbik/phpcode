                                              ...
                                              <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                  <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
														<?php 
														foreach($Laptops_distribute_pervious as $sd)
														{
															
														}
														?>
                                                            <i class="fa fa-globe"></i>School Laptops Distribution Register For Previous Year 12 Students<span> </span></div>
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
															...
															if(!empty($Laptops_distribute_pervious)){ $total1 = 0; foreach($Laptops_distribute_pervious as $index=> $sd){   ?>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <!--  <td ><?= $sd->community_name?></td>
																  ...
																  else
																  {
																   ...
																   <td ><?= $sd->
																   unique_supply ?></td>
                                                                    <td ><?php echo  date('d-m-Y', strtotime($sd->distribution_date ))?></td>
