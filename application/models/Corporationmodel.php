...
class Corporationmodel extends CI_Model
{
     ...
     public function get_district_Name($district_id)
      {
        ...
        $result = $this->db->get_where('emis_userlogin',array('emis_user_id'=>$district_id))->first_row();
        // print_r($result);die;
        return $result;
      }
...
public function get_districtid()
		...
		public function get_emis_blockwise_district($district_name,$school_type,$cate_type)
		        {
                  ...
                  ->where('management','Corporation School');
         ...
         public function get_district_school_student_teacher_total($district_name)
          {
            ...
            $this->db->select('sum(teach_mle+teach_fmle+nonteach_mle+nonteach_fmle) as teacher_total,sum(nonteach_mle+nonteach_fmle) as nonteaching_total,sum(total) as student_total,count(students_school_child_count.school_id) as school_total,')
            ...
            ->where('district_name',$district_name)
            ->where('students_school_child_count.management','Corporation School');
  ...
  public function get_ceo_school_info($district_name,$school_type)
  {
    ...
    $this->db->where('district_name',$district_name);
      $this->db->where('students_school_child_count.management','Corporation School'); 
    if(!empty($school_type))
    {
    $this->db->where_in('school_type',$school_type);
    ...
    public function get_teacherstrick_district_reports($dist_name,$school_type)
    {
     ...
     $this->db->select("sum(b.totstaff) as total_teacher,b.edu_dist_name,sum(a.part) as 'teacher_participate',sum(a.notpart) as 'teacher_not_participate'");
      ...
      $this->db->where_in('b.school_type',$school_type);
        $this->db->where('b.management','Corporation School'); 
...
,count(ssc.management) as mange,count(ac.yr_last_renwl) as last_year')
  ...
  ->where('ssc.management','Corporation School')
     ...
     /**
        ...
        **/
        ...
        public function get_attendance_teacherreport_blockwise($dist,$date,$table)
        {
         ...
         ->where('district_name',$dist)
        ->where('a.management','Corporation School')
         ->where_in('school_type',$school_type)
...
sum(distinct case when (attstatus!="") then 1 else 0 end) as absent from '.$table.' where date = "'.$date.'" group by teacher_code,school_code) as b','a.udise_code = b.school_code','left')
        ...
        **/
        ...
        public function get_attendance_teacher_classwise($date,$school_id,$table)
        {
          ...
          ->join('(SELECT distinct a.teacher_name, IF(a.attstatus="", "1", "0") as present, `a`.`attres`,a.teacher_code,a.school_id FROM '.$table.' as `a` WHERE `a`.`date` = "'.$date.'") as a','a.teacher_code =  b.u_id','left')
...
where students_child_detail.transfer_flag=0 AND students_school_child_count.district_id=".$dist_id." AND students_school_child_count.management='Corporation School'  group by block_name"; 
//print_r($SQL);
//die();
...
JOIN baseapp_differently_abled ON baseapp_differently_abled.id=students_child_detail.differently_abled
JOIN students_school_child_count ON students_school_child_count.school_id=students_child_detail.school_id
where students_child_detail.transfer_flag=0 AND students_school_child_count.block_name='".$block_name."' and students_school_child_count.management='Corporation School' group by school_name;"; 
//print_r($SQL);
//die();
       $query = $this->db->query($SQL);
       return $query->result();
...
join students_school_child_count sc on sc.school_id=st.school_id where sc.district_id=".$dist_id." and st.transfer_flag=0 and st.child_admitted_under_reservation='yes' and sc.school_type_id in (2,3,4) and sc.management='Corporation School' group by sc.block_name"; 
//print_r($SQL);
//die();
       $query = $this->db->query($SQL);
       return $query->result();
...
join students_school_child_count sc on sc.school_id=st.school_id where sc.block_name='".$block_id."' and st.transfer_flag=0 and st.child_admitted_under_reservation='yes' and sc.school_type_id in (2,3,4) and sc.management='Corporation School' group by sc.school_name;"; 
//print_r($SQL);
//die();
       $query = $this->db->query($SQL);
       return $query->result();
...
{
   $dist=$dist_id==$this->session->userdata('emis_corporation_id')?'students_school_child_count.district_id':'students_school_child_count.district_name';
  $SQL="select 
       ...
       block_name,district_id as dist_id,district_name
       from students_school_child_count 
       join students_transfer_history on students_transfer_history.school_id_transfer= students_school_child_count.school_id
       where students_transfer_history.school_id_admit IS NULL AND ".$dist."='".$dist_id."' AND students_transfer_history.class_studying_id!=12 and students_school_child_count.management='Corporation School'
...
left join students_school_child_count as sch1 ON sch1.school_id=school_id_transfer
left JOIN students_school_child_count as sch2 ON sch2.school_id=school_id_admit) as T1
WHERE district_id=".$dist_id." and sch1.management='Corporation School' or sch2.management='Corporation School'
GROUP BY block_name";
         $query = $this->db->query($SQL);
       return $query->result(); 
}
...
WHERE  sch2.management='Corporation School'  and sch2.district_id=".$dist_id." AND sch1.school_type='".$school_type_from."' AND sch2.school_type='".$school_type_to."' ) as T1
...
where schoolnew_schemeindent.scheme_id=15 and students_school_child_count.school_type_id in (1 ,2) and students_school_child_count.management='Corporation School' and students_child_detail.school_id =".$school_id." ";
	 $query =  $this->db->query($sql);
      return $query->result();  
   }
   ...
   {
	   $sql ="select district_id,district_name,school_id,school_name,block_name,udise_code,teach_tot as staff, nonteach_tot as nonstaff,totstaff as totstaff from students_school_child_count where district_id = ".$districtid." and students_school_child_count.management='Corporation School'  group by district_id,school_id";
	   $query =  $this->db->query($sql);
      return $query->result();   
   }
...
where school_id  = ".$school_id." and students_school_child_count.management='Corporation School'";
      ...
      return $query->result(); 
    	...
    	public function  emis_dist_school_prekg_student_joined($districtid){
              ...
              schoolnew_district.id,schoolnew_basicinfo.school_name,
              ...
              left JOIN students_school_child_count ON students_school_child_count.school_id=students_child_detail.school_id 
               ...
               schoolnew_basicinfo.manage_cate_id= 1 and schoolnew_basicinfo.district_id= ".$districtid." and students_school_child_count.management='Corporation School'  group by schoolnew_basicinfo.school_id ";
...
and students_school_child_count.school_type_id !=3 and students_school_child_count.management='Corporation School' and students_school_child_count.school_type_id != 5
...
where students_school_child_count.district_id= ".$districtid." and students_school_child_count.school_type_id !=3 and students_school_child_count.management='Corporation School' and  students_school_child_count.school_type_id != 5
group by students_school_child_count.school_id  ) bb 
on  aa.school_id = bb.school_id  ";
				  $query = $this->db->query($sql);
                 return $query->result();
...
and teacher_transfer_appli.desgnation=41 group by teacher_transfer_appli.teacher_id";
    ...
    {
     // print_r($sql);
        $sql="select district_id,management,count(*) as s_cnt from students_school_child_count where district_id=".$dist_id." and students_school_child_count.management='Corporation School' group by management;";
        $query = $this->db->query($sql);
        // print_r($this->db->last_query());
        return $query->result();
    ...
    {
     // print_r($sql);
        $sql="select management,block_name,school_name,udise_code,school_type from students_school_child_count where management='".$mang."' and block_name='".$block_name."' group by school_id;";
        $query = $this->db->query($sql);
        // print_r($this->db->last_query());
        return $query->result();
    ...
    {
     // print_r($sql);
        $sql="select block_name,school_name,udise_code,school_type from students_school_child_count where management='".$mang."' and block_name='".$block_name."' and sch_directorate_id in (2,3,16,18,27,29,32,34,42) group by school_id;";
        $query = $this->db->query($sql);
        // print_r($this->db->last_query());
        return $query->result();
    ...
    {
     // print_r($sql);
        $sql="select block_name,school_name,udise_code,school_type from students_school_child_count where management='".$mang."' and sch_directorate_id in (1,5,15,17,19,20,21,22,23,24,26,31,33) and block_name='".$block_name."' group by school_id;";
        $query = $this->db->query($sql);
        // print_r($this->db->last_query());
        return $query->result();
    ...
    {
     // print_r($sql);
        $sql="select block_name,school_name,udise_code,school_type from students_school_child_count where management='".$mang."' and sch_directorate_id in (28) and block_name='".$block_name."' group by school_id;";
        $query = $this->db->query($sql);
        // print_r($this->db->last_query());
        return $query->result();
    ...
    {
     // print_r($sql);
        $sql="select block_name,school_name,udise_code,school_type from students_school_child_count where management='".$mang."' and sch_directorate_id in (4,6,7,8,9,10,11,12,13,14,25,30,35,36,37,38,39,40,41,43,44,45,46,47,48) and block_name='".$block_name."' group by school_id";
        $query = $this->db->query($sql);
        // print_r($this->db->last_query());
        return $query->result();
