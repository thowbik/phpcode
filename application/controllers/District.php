...
class District extends CI_Controller {
  ...
  public function emis_district_dash()
  {
    ...
    if($emis_loggedin) {
      ...
      $district_details = $this->Districtmodel->get_districtName($dist_id);
      $data['total_count_details'] = $this->Districtmodel->get_district_school_student_teacher_total($district_details->district_name);
      // print_r($data);die;
      // echo Common::get_url();
       $data['Govt_detail']=$this->Districtmodel->govt_enrollment($dist_id);
      $school_details = $this->Districtmodel->get_district_scool_type_based_schoolinfo($district_details->district_name);
      $data['school_type'] = $school_details['result'];
      $data['renewal_details'] = $this->Districtmodel->get_state_renewal_details($dist_id);
      $user_type = $this->session->userdata('user_type');
      $data['reports_csv'] = $this->Districtmodel->get_districtwise_report($user_type);
      $data['school_based_count_details'] = $school_details['school_info'];
      $this->load->view('district/emis_district_home',$data);
  ...
  public function emis_district_home()
  {
    ...
    if($emis_loggedin) {
      ...
      $data['getmanagecate'] = $this->Districtmodel->getmanagecate();
      $data['getsctype'] = $this->Districtmodel->get_school_type();
...
if(!empty($manage)){
      ...
      if(!empty($manage)){
      $data['details'] = $this->Districtmodel->get_emis_blockwise_district($district_details->district_name,$manage,$school_cate);
     //print_r($data['details']);
    }else
    {
      $data['details'] = $this->Districtmodel->get_emis_blockwise_district($district_details->district_name,'','');
    }

      $data['distname'] = $district_details->district_name;
    $this->load->view('district/emis_district_student_home',$data);
    } else { redirect('/', 'refresh'); }
  }
  ...
  */
  ...
  public function get_classwise_district()
  {
		...
		if($emis_loggedin) {
			...
			// if($manage!=""){ 
			// $data['details'] = $this->Districtmodel->get_emis_blockwise_district($dist_id,$manage);

			// }else{
				$data['details'] = $this->Districtmodel->get_emis_blockwise_district($dist_id);
			// }
				// print_r($data);die;
			// $data['distname'] = $this->Districtmodel->getsingledistname($dist_id);
			$this->load->view('district/emis_district_dash_blockwise',$data);
  ...
  public function get_dash_schoolwise_class()
  {
  	$this->load->library('session');
		...
		if($emis_loggedin) {
			...
			echo $school_id;
			$data['details'] = $this->Districtmodel->get_schoolwise_class($school_id);
			// print_r($data);die;
			$this->load->view('district/emis_district_dash_schoolsingle',$data);
			// echo json_encode($data[' details']);
        } else { redirect('/', 'refresh'); }
  }
 /***************************End Filter Students*************** */
    ...
    **/
    ...
    if($emis_loggedin) {
     ...
     if($this->session->userdata('emis_state_special_search1')!=""){
        ...
        $data['special_schools'] = $this->Districtmodel->schoolcatemanagefilter($manage,$cate,$id1,$id2,$dist_id);
      ...
      $this->load->view('district/emis_district_special_reports',$data);
  ...
  **/
  ...
  public function get_districtwise_school()
  {
    ...
    if($emis_loggedin) {
      ...
      $data['school_info'] = $this->Districtmodel->get_ceo_school_info($district_details->district_name,$school_type);
      $data['getmanagecate'] = $this->Districtmodel->getmanagecate();

      $data['distname'] = $district_details->district_name;
      $this->load->view('district/emis_district_teacher_list',$data);
    }else { redirect('/', 'refresh'); }
  }
  ...
  public function get_schoolwise_teacherlist()
  {
    ...
    if($emis_loggedin) {
      $school_id = $this->input->get('school');
      $data['teacher_list'] = $this->Districtmodel->get_schoolwise_teacher_list($school_id);
      ...
      $this->load->view('district/emis_district_school_teacher_list',$data);
      }else { redirect('/', 'refresh'); }
  }
  ...
  */
  ...
  public function save_teacher_reports()
  {
    ...
    // print_r($records);die;
    $save_id = $this->Districtmodel->save_teacher_reports($records);
...
if($this->input->post())
      ...
      $data['teacher_strick'] = $this->Districtmodel->get_teacherstrick_district_reports($dist_name,$school_type);

      $this->load->view('district/emis_district_teacherstrick_district_reports',$data);
    }else { redirect('/', 'refresh'); }
...
if($this->input->post())
      ...
      $data['teacher_strick'] = $this->Districtmodel->get_teacherstrick_block_reports($edu_dist,$school_type);

      $this->load->view('district/emis_district_teacherstrick_block_reports',$data);
    }else { redirect('/', 'refresh'); }
...
if($this->input->post())
      ...
      $data['teacher_strick'] = $this->Districtmodel->get_teacherstrick_school_reports($block,$school_type);

      $this->load->view('district/emis_district_teacherstrick_school_reports',$data);
    }else { redirect('/', 'refresh'); }
...
if($this->input->post())
      ...
      $data['teacher_strick'] = $this->Districtmodel->get_teacherstrick_teacher_reports($school,$school_type);
      $data['school_details'] = $this->Districtmodel->get_school_name($school);

      $this->load->view('district/emis_district_teacherstrick_teacher_reports',$data);
    }else { redirect('/', 'refresh'); }
    ...
    ***/
    ...
    if($emis_loggedin) {
      ...
      }else
      {
        ...
        $data['school_renewal_status'] = $this->Districtmodel->get_renewal_district_block($school_type,$dist_id);
        $data['manage'] = '';
        $this->load->view('district/emis_district_renewal_block',$data);
    ...
    ***/
    ...
    if($emis_loggedin) {
      ...
      }else
      {
        ...
        $data['school_renewal_status'] = $this->Districtmodel->get_renewal_district_school($school_type,$block_id);
      
        $this->load->view('district/emis_district_renewal_school',$data);
  ...
  public function get_attendance_blockwise_details()
  {
      ...
      $date = $this->input->post('date');
          ...
          // echo $table;
				// print_r($data);
			// students
			$data['school_details_blockwise'] = $this->Districtmodel->get_attendance_schoolreport_blockwise($dist_id,$date,$table);
			$data['school_type'] = $this->Districtmodel->get_attendance_school_type_blockwise($dist_id,$date,$table);
			//teachers 
			$data['teacher_blockwise'] = $this->Districtmodel->get_attendance_teacherreport_blockwise($dist_id,$date,$teach_table);
			$data['teacher_school_type_blockwise'] =$this->Districtmodel->get_attendance_teacher_type_blockwise($dist_id,$date,$teach_table);
        ...
        // echo $date;
			...
			// print_r($data);
			// echo "</pre>";die;
			$this->load->view('district/emis_district_attendance_blockwise',$data);
		}else { redirect('/', 'refresh'); }
  }
  	...
  	$this->load->library('session');
		...
		if($emis_loggedin) {
          ...
          }else
          {
			...
			$this->load->view('district/emis_district_attendance_schoolwise',$data);
		}else { redirect('/', 'refresh'); }
   ...
   **/
	public function get_attendance_teacher_schoolwise()
	{
      ...
      $data['date'] = $date;
      // echo "funtion";
			$this->load->view('district/emis_district_teacher_attendance_schoolwise',$data);
	...
	**/
	...
	public function get_attendance_search()
	{
      ...
      $date = $this->input->get('date');
		  ...
		  $data['student_details_schoolwise'] = $this->Districtmodel->get_attendance_search_details($date,$school_cat,$blocks,$table);
  ...
  public function get_attendance_teacher_search()
  {
    ...
    if($emis_loggedin) 
    {
      ...
      // print_r($district);die;
      // echo $teach_table;
      $data['teacher_details_schoolwise'] = $this->Districtmodel->get_teacher_attendance_search($date,$school_type,$district,$blocks,$teach_table);
  ...
  /**
	...
	**/
	...
	public function get_attendance_classwise_details()
	{
      ...
      $data['school'] = $school_id;
      	$this->load->view('district/emis_district_attendance_classwise',$data);
	...
	**/
	...
	public function get_attendance_sectionwise_details()
	{
      ...
      $data['school'] = $school_id;
      $data['class'] = $class_id;
			$this->load->view('district/emis_district_attendance_sectionwise',$data);
	...
	**/
	...
	public function get_attendance_teacher_classwise()
	{
      ...
      // print_r($data['teacher_absent_list']);
			$this->load->view('district/emis_district_teacher_classwise',$data);
  ...
  */
  ...
  public function get_flash_news()
  {
    ...
    if($emis_loggedin) { 
      ...
      $dist_id = $district_details->district_name;
      // echo $dist_id;
      $data['old_flash_message'] = $this->Districtmodel->get_flash_news($dist_id);
      $data['block'] = $this->Districtmodel->get_all_block_name($dist_id);
      $data['authority'] = $this->Districtmodel->get_flash_news_authority();
      ...
      $this->load->view('district/emis_district_flash_news',$data);
    }else { redirect('/', 'refresh'); }
  }
  ...
  public function save_flash_news()
  {
    ...
    $result_id = $this->Districtmodel->save_flash_news_data($save_array);
...
$district_details = $this->Districtmodel->get_districtName($district_id);
      // print_r($dist_id);
      $dist_id = $district_details->district_name;
        switch ($data_id) {
          case 1:
  ...
  /************************ Students Requested Move To Common Pool ****************/
    ...
    if($emis_loggedin) { 
        ...
        $dist_id = $district_details->district_name;
         ...
         $data['dist_id1'] = $this->Districtmodel-> get_districtid();
         $dist_id=$this->input->post('emis_state_fix')==''?$this->session->userdata('emis_district_id'):$this->input->post('emis_state_fix');
        $data['details'] = $this->Districtmodel->get_stu_raise_request($dist_id);
  ...
  **/
      ...
      public function emis_district_communitywise()
  {
   ...
   if($this->session->userdata('emis_community')!=""){
     ...
     $data['communityname'] = $this->Districtmodel->getcommunityname($community);
 ...
 public function emis_district_findschoolbyblock(){
  ...
  public function emis_district_classwise_reports()
  {
    ...
    $data['lowclass']=$standardlist[0]->low_class;
     ...
     $data['allclass']  = $this->Districtmodel->getallbrachesbyschool($school_id);
     $data['overallstrength']  = count($this->Districtmodel->getallbrachesbyschoolinchildetail2_view($school_id));
     ...
     public function emis_student_aadhaar_dist()
  {
    ...
    $data['getmanagecate'] = $this->Districtmodel->getmanagecate();
     $manage =$this->session->userdata('emis_districtreport_schmanage');  
    if($manage!=""){ 
    $data['details'] = $this->Districtmodel->getalldistrictcountsbyclassblockaadhaar1($dist_id,$manage);
    }else{
    $data['details'] = $this->Districtmodel->getalldistrictcountsbyclassblockaadhaar($dist_id);
    }
       ...
       public function emis_student_aadhaar_block()
  {
    ...
    $data['getmanagecate'] = $this->Districtmodel->getmanagecate();
     $manage =$this->session->userdata('emis_districtreport_schmanage');  
    if($manage!=""){ 
    $data['details'] = $this->Districtmodel->getalldistrictcountsbyclassschoolaadhaar1($block_id,$manage);
    }else{
    $data['details'] = $this->Districtmodel->getalldistrictcountsbyclassschoolaadhaar($block_id);
    }
    // $data['schooldist'] = $this->Datamodel->getallachooldist();
    $data['blockname'] = $this->Districtmodel->getsingleblockname($block_id);
     ...
     public function emis_student_report_district()
  {
    ...
    $this->load->model('Districtmodel');
     ...
     $manage =$this->session->userdata('emis_districtreport_schmanage');  
    if($manage!=""){ 
     $data['details'] = $this->Districtmodel->getalldistrictcountsbyclassblockreport1($dist_id,$manage);
    }else{
    $data['details'] = $this->Districtmodel->getalldistrictcountsbyclassblockreport($dist_id);
    }
    // $data['schooldist'] = $this->Datamodel->getallachooldist();
       ...
       public function emis_student_report_block()
  {
    ...
    $this->load->model('Districtmodel');
     ...
     $manage =$this->session->userdata('emis_districtreport_schmanage');  
    if($manage!=""){ 
     $data['details'] = $this->Districtmodel->getalldistrictcountsbyclassschoolreport1($block_id,$manage);
    }else{
   $data['details'] = $this->Districtmodel->getalldistrictcountsbyclassschoolreport($block_id);
    }
    // $data['schooldist'] = $this->Datamodel->getallachooldist();
  ...
  public function get_office($distval){
    $get_office = $this->Districtmodel->get_office($distval);
    print_r($get_office);
    if ($get_office) {
      $mydata = '';
...
public function emis_teacher_transfer_form(){
 ...
 public function get_school_management_data(){
    ...
    $schoolmang = $this->Districtmodel->get_school_management_data($getschooltype);
 ...
 public function get_dash_blockwise_school()
  {
   $this->load->library('session');
    ...
    if($emis_loggedin) {
      ...
      $data['details'] = $this->Districtmodel->get_blockwise_school($block_name,$manage,$school_cate);
    ...
    }else
    {
      ...
      // print_r($data);
      $this->load->view('district/emis_state_dash_schoolwise',$data);
      } else { redirect('/', 'refresh'); }
  }
public function emis_teacher_classwise_district(){
    ...
    if($emis_loggedin) {
      ...
      if(!empty($school_cate)){
      $data['details'] = $this->Districtmodel->getalldistrictcountsbyteacherblock($dist_id,$school_cate);
           }
           else
           {
               $data['details'] = $this->Districtmodel->getalldistrictcountsbyteacherblock($dist_id,'');
           }

      $this->load->view('district/emis_state_teacherblockwise',$data);
    } else { redirect('/', 'refresh'); }
  }
  ...
  if($emis_loggedin) {
      ...
      $school_cate = $this->input->post('school_cate');
       if(!empty($school_cate)){
                ...
                //  print_r($result);
                 ...
                 $data['cate'] = $school_cate;
        if($school_cate!=""){ 
    $data['details'] = $this->Districtmodel->get_teaching_staff_block($dist_id,$school_cate);
         }else{
     $data['details'] = $this->Districtmodel->get_teaching_staff_block($dist_id,'');
      }
      //print_r($data['details']);
      $this->load->view('district/emis_state_teaching_blockwise',$data);
    } else { redirect('/', 'refresh'); }
  }
   public function emis_nonteaching_blockwise_district(){
    ...
    if($emis_loggedin) {
      ...
      $school_cate = $this->input->post('school_cate');
       if(!empty($school_cate)){
                ...
                //  print_r($result);
                 ...
                 $data['cate'] = $school_cate;
         if($school_cate!=""){ 
      $data['details'] = $this->Districtmodel->get_nonteaching_staff_block($dist_id,$school_cate);
        }
       else
       {
        $data['details'] = $this->Districtmodel->get_nonteaching_staff_block($dist_id,$school_cate);
      ...
      $this->load->view('district/emis_state_nonteaching_blockwise',$data);
...
public function emis_teaching_schoolwise_block(){
   $this->load->library('session');
     ...
     // print_r($block_id);
      ...
      $school_cate = $this->input->post('school_cate');
        if(!empty($school_cate)){
                 ...
                 $data['cate'] = $school_cate;
       if($school_cate!=""){ 
      $data['details'] = $this->Districtmodel->get_teaching_block_school($block_id,$school_cate); 
        }else{
     $data['details'] = $this->Districtmodel->get_teaching_block_school($block_id,'');
      }
      $this->load->view('district/emis_state_teaching_schoolwise',$data);
    ...
    if($emis_loggedin) { 
      ...
      $data['details'] = $this->Districtmodel->get_nonteaching_block_school($dist_id,$block_id,$school_cate); 
        }else{
     $data['details'] = $this->Districtmodel->get_nonteaching_block_school($dist_id,$block_id,$school_cate);
      }
   
      $this->load->view('district/emis_state_nonteaching_schoolwise',$data);
    ...
    if($emis_loggedin) { 
      ...
      $school_cate = $this->input->post('school_cate');
        ...
        if(!empty($school_cate)){
                 ...
                 if($school_cate!="")
                 {
                    $data['details'] = $this->Districtmodel->getalldistrictcountsbyclassteach($block_id,$school_cate); 
                 }
                 else
                 {
                  $data['details'] = $this->Districtmodel->getalldistrictcountsbyclassteach($block_id,$school_cate); 
      ...
      //print_r($data['details']);
      //echo json_encode($data['details']);
      $this->load->view('district/emis_state_teacherschoolwise',$data);
  ...
  public function emis_student_disability_blockwise()
{
  $emis_loggedin = $this->session->userdata('emis_loggedin');
    ...
    $dist_id =$this->session->userdata('emis_district_id');
      ...
      $data['allstuds'] = $this->Districtmodel->get_classwise_student_disability_block($dist_id);
     //  print_r($data['allstuds']);
       $this->load->view('district/emis_block_student_disability',$data);
      }else
      {
        redirect('/', 'refresh');
  ...
  $emis_loggedin = $this->session->userdata('emis_loggedin');
    if($emis_loggedin)
     ...
     $block_name =  $this->input->get('block_name');
      $data['allstuds'] = $this->Districtmodel->get_classwise_student_disability_school($block_name);
     //  print_r($data['allstuds']);
       $this->load->view('district/emis_student_disability_schoolwise',$data);
      }else
      {
        redirect('/', 'refresh');
...
public function get_RTE_district()
  {
   $this->load->library('session');
    ...
    if($emis_loggedin) {
      ...
      $dist_id =$this->session->userdata('emis_district_id');
    $data['allstuds'] = $this->Districtmodel->get_blockwise_RTE_student($dist_id);
    //print_r($data['allstuds']);
      $this->load->view('district/emis_state_RTE_blockwise',$data);
  ...
  public function get_RTE_school()
  {
   $this->load->library('session');
    ...
    $data['allstuds'] = $this->Districtmodel->get_schoolwise_RTE_student($block_id);
    //print_r($data['allstuds']);
      $this->load->view('district/emis_state_RTE_schoolwise',$data);
   ...
   public function dash_renewal(){
    ...
    $data['renewal']=$this->Districtmodel->get_state_renewal_details($dist_id);
   
      $this->load->view('district/emis_dash_renewal',$data);
  ...
  public function dash_renewal_beo(){
    ...
    if($emis_loggedin)
     ...
     $data['renewal_pending_detail'] = $this->Districtmodel->get_state_renewal_pending_details($dist_id);
     // print_r( $data['renewal_pending_detail']);die;
     $this->load->view('district/emis_state_beo_pending',$data);
 } else { redirect('/', 'refresh'); }
  }
  public function dash_renewal_deo(){
    ...
    $data['renewal_pending_detail_deo'] = $this->Districtmodel->get_state_deo_pending_details($dist_id);
    //print_r( $data['renewal_pending_detail_deo']);
    $this->load->view('district/emis_state_deo_pending',$data);
 } else { redirect('/', 'refresh'); }
  }
  public function dash_renewal_ceo(){
    ...
    $data['renewal_pending_detail_ceo'] = $this->Districtmodel->get_state_ceo_pending_details($dist_id);
   // print_r( $data['renewal_pending_detail']);die;
    $this->load->view('district/emis_dash_ceo_pending',$data);
  } else { redirect('/', 'refresh'); }
  }
    public function emis_district_student_report_2018()
  {
    ...
    if($emis_loggedin) {
      ...
      $data['cate'] = $school_cate;
      if(!empty($manage)){
      $data['details'] = $this->Districtmodel->get_emis_blockwise_district_2018($district_details->district_name,$manage,$school_cate);
    
    }else
    {
      $data['details'] = $this->Districtmodel->get_emis_blockwise_district_2018($district_details->district_name,'','');
    }

      $data['distname'] = $district_details->district_name;
    $this->load->view('district/emis_district_student_report_2018',$data);
    } else { redirect('/', 'refresh'); }
  }
 public function get_dash_blockwise_school_2018()
  {
   $this->load->library('session');
    ...
    if($emis_loggedin) {
      ...
      $data['details'] = $this->Districtmodel->get_blockwise_school_2018($block_name,$manage,$school_cate);
    ...
    }else
    {
      ...
      // print_r($data);
      $this->load->view('district/emis_state_dash_schoolwise_2018',$data);
      } else { redirect('/', 'refresh'); }
  }
  public function get_renewal_rejected(){
    ...
    if($emis_loggedin) {
     $dist_id = $this->session->userdata('emis_district_id');
    $data['renewal_rejected'] = $this->Districtmodel->get_renewal_rejected($dist_id);
   // print_r( $data['renewal_pending_detail']);die;
    $this->load->view('district/emis_district_renew_rejected',$data);
 } else { redirect('/', 'refresh'); }
}
...
$this->load->library('session');
  ...
  $data['dist_id1'] = $this->Districtmodel-> get_districtid();
     $dist_id=$this->input->post('emis_state_fix')==''?$this->session->userdata('emis_district_id'):$this->input->post('emis_state_fix');
      $data['student_migration_details'] = json_decode(json_encode($this->Districtmodel->get_blk_student_migration($dist_id)),true);
  ...
  // print_r($dist_id);
    ...
    $this->load->view('district/emis_student_migration_block',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
    ...
    $this->load->model('Statemodel');
      ...
      $data['student_migration_details'] = $this->Districtmodel->get_school_student_migration($block_name);
          // print_r($data['student_migration_details']);die();
    $this->load->view('district/emis_student_migration_school',$data);
  } else { redirect('/', 'refresh'); }
  ...
  if($emis_loggedin) {
    $data['dist_id'] = $this->session->userdata('emis_district_id');
     $dist_id=$data['dist_id'];
      ...
      $data['student_migration_details'] = $this->Districtmodel->get_dist_student_migration_details($dist_id);
     // print_r($data['student_migration_details']);
    $this->load->view('district/emis_student_migration_details',$data);
  } else { redirect('/', 'refresh'); }
  ...
  if($emis_loggedin) {
   $data['dist_id'] = $this->session->userdata('emis_district_id');
     $dist_id=$data['dist_id'];
      ...
      $data['student_migration_details'] = $this->Districtmodel->get_migration_detail_student($dist_id,$school_type_from,$school_type_to);

              

    $this->load->view('district/emis_migration_detail_student',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
     $district_id =$this->session->userdata('emis_district_id');
      //$data['get_teacherdetails'] = $this->Statemodel->get_dist_teacherdetails();
      $data['student_unrecognized_details'] = $this->Districtmodel->get_school_unrecognized_block($district_id);
      // print_r($data['student_migration_details']);die();
    $this->load->view('district/emis_school_unrecognized_block',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
     $block_name=$this->input->get('block_name');
      ...
      //$data['get_teacherdetails'] = $this->Statemodel->get_dist_teacherdetails();
      $data['student_unrecognized_details'] = $this->Districtmodel->get_school_unrecognized_school($block_name);
          // print_r($data['student_migration_details']);die();
    $this->load->view('district/emis_school_unrecognized_school',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  //  $mng_cat=$this->input->get('magt_type');
      ...
      //$data['get_teacherdetails'] = $this->Statemodel->get_dist_teacherdetails();
      $data['school_profile_verification'] = $this->Districtmodel->get_school_profile_verification_district($district_id,$manage,$school_cate);
    }
    else
    {
       $data['school_profile_verification'] = $this->Districtmodel->get_school_profile_verification_district($district_id,$manage,$school_cate);
    ...
    $this->load->view('district/school_profile_verification_district',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  //  $mng_cat=$this->input->get('magt_type');
      ...
      if($manage!="" && $school_cate){ 
      $data['school_land_verification'] = $this->Districtmodel->get_school_land_verification_district($district_id,$manage,$school_cate);
    }
    else
    {
        $data['school_land_verification'] = $this->Districtmodel->get_school_land_verification_district($district_id,$manage,$school_cate);
    ...
    $this->load->view('district/school_land_verification_district',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  //  $mng_cat=$this->input->get('magt_type');
      ...
      if($manage!="" && $school_cate){ 
      $data['school_land_verification'] = $this->Districtmodel->get_school_sanitation_verification_district($district_id,$manage,$school_cate);
    ...
    $this->load->view('district/school_sanitation_verification_district',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  //  $mng_cat=$this->input->get('magt_type');
      ...
      if($manage!="" && $school_cate){ 
      $data['school_land_verification'] = $this->Districtmodel->get_school_committee_verification_district($district_id,$manage,$school_cate);
    }
    else
    {
       $data['school_land_verification'] = $this->Districtmodel->get_school_committee_verification_district($district_id,$manage,$school_cate);
    ...
    $this->load->view('district/school_committee_verification_district',$data);
  } else { redirect('/', 'refresh'); }
...
// Aadhaar distic wise school count details
  ...
  public function aadhar_school_distic_based_count_details()
  {
      ...
      if($emis_loggedin) {
      $districtid =$this->session->userdata('emis_district_id');
      $data['aadhar_school_details'] = $this->Districtmodel->aadhar_school_distic_based_count_details($districtid);
      $this->load->view('district/emis_aadhar_school_based_count_details',$data);
      }else { redirect('/', 'refresh'); }
  ...
  public function aadhar_school_base_count_details()
  {
   ...
   $data['aadhar_schoolbase_details'] = $this->Districtmodel->aadhar_school_base_count_details($school_id);
  
      $this->load->view('district/emis_aadhar_school_count_details',$data);
      }else { redirect('/', 'refresh'); }
  ...
  public function aadhar_school_notin_count_details()
  {
      ...
      if($emis_loggedin) 
	  {
	      ...
	      // echo $school_id;
		   // $data['schoolname']=$_GET['schoolname'];
		   $data['notinaadhar_schoolbase_details'] = $this->Districtmodel->
		   notin_aadhar_school_base_count_details($school_id);
            $this->load->view('district/emis_notin_aadhar_school_count_details',$data);
      }else { redirect('/', 'refresh'); }
   ...
   public function meal_school_distic_based_count_details()
  {
      ...
      if($emis_loggedin) 
	  {
		  $districtid =$this->session->userdata('emis_district_id');
			// echo $districtid ;
		   $data['meal_school_details'] = $this->Districtmodel->meal_school_distic_based_count_details($districtid);
		  $this->load->view('district/meal_school_distic_based_count_details',$data);
      }else { redirect('/', 'refresh'); }
  ...
  public function meal_school_eligible_stud_count()
   {
      ...
      if($emis_loggedin) 
	  {
	       ...
	       //echo $school_id;
		    //$data['schoolname']=$_GET['schoolname'];
		   $data['meal_school_eligible_stud_count'] = $this->Districtmodel->
		   meal_school_eligible_stud_count_details($school_id);
            $this->load->view('district/emis_meal_school_eligible_stud_count_details',$data);
      }else { redirect('/', 'refresh'); }
  ...
  // public function emis_prekg_student_joined()
	// {
		...
		// $data['state_student']= $this->Districtmodel->govt_enrollment();
		// // $studtotal=$state_student[0]->total;
		// // print_r($studtotal);
		// $data['stud_admission_count']=$this->Districtmodel->stud_admission_count();
				// $this->load->view('district/emis_state_district_prekg_student_joined',$data);
	...
	public function emis_staff_district_count_details()
	{
		  ...
		  if($emis_loggedin) 
		  {
				$data['staff_district_details'] = $this->Districtmodel->emis_staff_district_count_details();
			   $this->load->view('district/emis_staff_district_count_details',$data);
		  }else { redirect('/', 'refresh'); }
	}
	...
	public function emis_staff_district_school_count_details()
	{
		  ...
		  {      
	            $districtid =$this->session->userdata('emis_district_id');
				$data['staff_district_school_details'] = $this->Districtmodel->emis_staff_district_school_count_details($districtid);
			    $this->load->view('district/emis_staff_district_school_count_details',$data);
		  }else { redirect('/', 'refresh'); }
	}
	...
	// {
		  ...
		  // {       
				...
				// $data['staff_school_details'] = $this->Districtmodel->emis_staff_school_count_details($school_id);
			    // $this->load->view('district/emis_staff_school_count_details',$data);
		  // }else { redirect('/', 'refresh'); }
	// }
	...
	public function emis_district_staff_data()
	{
		$school_id=$this->input->post('school_id');
				...
				$staff_school_details = $this->Districtmodel->emis_staff_school_count_details($school_id);
     ...
     public function emis_dist_school_prekg_student_joined()
	{
		...
		$data['stud_school_admission_count']=$this->Districtmodel->emis_dist_school_prekg_student_joined($districtid);
				$this->load->view('district/emis_dist_school_prekg_student_joined',$data);
      ...
      if($emis_loggedin) 
      {
      	$data['school_details'] = $this->Districtmodel->get_districtwise_school_building_details();
      	// print_r($data);
      	$head_details = $this->get_common_control_link();
      	$data['header'] = $head_details['header'];
      	$data['link'] = $head_details['link'];
        $this->load->view('district/emis_state_bd_district',$data);
...
// echo $dist_id;
      		$data['school_details'] = $this->Districtmodel->get_schoolwise_building_details($dist_id,$block_filter);
      	...
      	$this->load->view('district/emis_state_bd_schoolwise',$data);
		...
		public function emis_staff_stud_dist_school_details()
	{
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			if($emis_loggedin) 
			{
				...
				$districtid  =$this->session->userdata('emis_district_id');
				$data['staff_stud_dist_school_details'] = $this->Districtmodel->emis_staff_stud_dist_school_details($districtid);
				$head_details = $this->get_common_control_link();
				$data['header'] = $head_details['header'];
				$data['link'] = $head_details['link'];
				$this->load->view('district/emis_staff_stud_dist_school_details',$data); 
			}
	}
		...
		public function emis_staff_fixa_tot_school_details()
	{
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				  $dist_id  =$this->session->userdata('emis_district_id');
				$data['staff_fixa'] = $this->Districtmodel->emis_staff_fixa_tot_school_details(  $dist_id);
				$data['staff_eli'] = $this->Districtmodel->staff_eligible( $dist_id);
				$data['staff_sanct'] = $this->Districtmodel->staff_sanct( $dist_id);
				$data['staff_avail'] = $this->Districtmodel->staff_avail( $dist_id);
				$data['staff_need'] = $this->Districtmodel->staff_need( $dist_id);
				$data['staff_surpwith'] = $this->Districtmodel->staff_surpwith( $dist_id); 
			    $data['staff_surpwithout'] = $this->Districtmodel->staff_surpwithout( $dist_id);
				// print_r($data['staff_fixa']);
				$head_details = $this->get_common_control_link();
				$data['header'] = $head_details['header'];
				$data['link'] = $head_details['link'];
				$this->load->view('district/emis_staff_fixa_tot_school_details',$data); 
			}
	}
	public function emis_staff_eligiblepost()
	{
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				 $dist_id  =$this->session->userdata('emis_district_id');
				$data['staff_eligiblepost'] = $this->Districtmodel->emis_staff_eligiblepost( $dist_id);
				// print_r($data['staff_fixa']);
				$head_details = $this->get_common_control_link();
				$data['header'] = $head_details['header'];
				$data['link'] = $head_details['link'];
				$this->load->view('district/emis_staff_eligiblepost',$data); 
			}
	}
	...
	public function emis_staff_sanctionpost()
	{
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				 $dist_id  =$this->session->userdata('emis_district_id');
				$data['staff_sanctpost'] = $this->Districtmodel->emis_staff_sanctionpost( $dist_id);
				// print_r($data['staff_fixa']);
				$head_details = $this->get_common_control_link();
				$data['header'] = $head_details['header'];
				$data['link'] = $head_details['link'];
				$this->load->view('district/emis_staff_sanctionpost',$data); 
			}
	}
	public function emis_staff_availpost()
	{
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				 $dist_id  =$this->session->userdata('emis_district_id');
				$data['staff_availpost'] = $this->Districtmodel->emis_staff_availpost( $dist_id);
				// print_r($data['staff_fixa']);
				$head_details = $this->get_common_control_link();
				$data['header'] = $head_details['header'];
				$data['link'] = $head_details['link'];
				$this->load->view('district/emis_staff_availpost',$data); 
			}
	}
	public function emis_staff_needpost()
	{
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				 $dist_id  =$this->session->userdata('emis_district_id');
				$data['staff_needpost'] = $this->Districtmodel->emis_staff_needpost( $dist_id);
				// print_r($data['staff_fixa']);
				$head_details = $this->get_common_control_link();
				$data['header'] = $head_details['header'];
				$data['link'] = $head_details['link'];
				$this->load->view('district/emis_staff_needpost',$data); 
			}
	}
	public function emis_staff_surpwithpost()
	{
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				 $dist_id  =$this->session->userdata('emis_district_id');
				$data['staff_surpwithpost'] = $this->Districtmodel->emis_staff_surpwithpost( $dist_id);
				// print_r($data['staff_fixa']);
				$head_details = $this->get_common_control_link();
				$data['header'] = $head_details['header'];
				$data['link'] = $head_details['link'];
				$this->load->view('district/emis_staff_surpwithpost',$data); 
			}
	}
	public function emis_staff_surpwithoutpost()
	{
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				 $dist_id  =$this->session->userdata('emis_district_id');
				$data['staff_surpwithoutpost'] = $this->Districtmodel->emis_staff_surpwithoutpost($dist_id);
				// print_r($data['staff_fixa']);
				$head_details = $this->get_common_control_link();
				$data['header'] = $head_details['header'];
				$data['link'] = $head_details['link'];
				$this->load->view('district/emis_staff_surpwithoutpost',$data); 
			}
	}
    public function emis_staff_fixa_report_block()
  {
     $this->load->library('session');
      ...
      if($emis_loggedin) 
      {
       ...
       $district_id  =$this->session->userdata('emis_district_id');
      // print_r($district_id);
        $data['staff_fixa_report'] = $this->Districtmodel->staff_fixa_report_block($district_id); 
       // print_r($data['staff_fixa_report']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_staff_fixa_school_report_block',$data); 
      }
  }
     ...
     $this->load->library('session');
      ...
      if($emis_loggedin) 
      {
       ...
       $block_id=$this->input->get('block_id');
        ...
        $data['staff_fixa_report'] = $this->Districtmodel->staff_fixa_report_school($block_id); 
       // print_r($data['staff_fixa_report']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_staff_fixa_school_report_school',$data); 
      }
  }
  public function staff_fixtation_sub_wise()
  {
     $this->load->library('session');
      ...
      {
        $dist_id  =$this->session->userdata('emis_district_id');
        $data['staff_fixtation_sub_wise'] = $this->Districtmodel->staff_fixtation_sub_wise($dist_id);
       //print_r( $data['staff_fixtation_sub_wise']);
       
        $this->load->view('district/emis_staff_fixtation_sub_wise',$data); 
      }
  }
    public function emis_staff_transfer_req_block()
  {
     $this->load->library('session');
      ...
      if($emis_loggedin) 
      {
        ...
        $data['staff_transfer_req'] = $this->Districtmodel->staff_transfer_req_block($district_id); 
     // print_r($data['staff_transfer_req']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_staff_req_report_block',$data); 
      }
  }
   public function emis_staff_transfer_req_teacher()
  {
     $this->load->library('session');
      ...
      if($emis_loggedin) 
      {
        ...
        $block_id=$this->input->get('block_id');
        $data['staff_transfer_req'] = $this->Districtmodel->staff_transfer_req_teacher($block_id); 
       //print_r($data['staff_transfer_req']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_staff_req_report_teacher',$data); 
      }
  }
    public function get_staff_fix_district()
  {
    ...
    {
        $district_id=$this->session->userdata('emis_district_id');
        $data['dist_details'] = $this->Districtmodel->get_staff_fix_district($district_id);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_state_staff_fix_districtwise',$data);
    }
  }
  public function get_staff_fix_schoolwise()
  {
      ...
      $data['school_details'] = $this->Districtmodel->get_staff_fix_schoolwise($block_id);
      $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
      $this->load->view('district/emis_state_staff_fix_schoolwise',$data);   
  }
   public function emis_staff_surplus_tot_subject()
    {
     $this->load->library('session');
      ...
      {
        $dist_id  =$this->session->userdata('emis_district_id');
        $data['schoolsurp'] = $this->Districtmodel->emis_staff_surplus_tot_subject($dist_id);
        $data['surptot'] = $this->Districtmodel->surplus_tot($dist_id);
        $data['surplus_sub'] = $this->Districtmodel ->surplus_sub($dist_id);
        $this->load->view('district/emis_staff_surplus_tot_subject',$data);
      ...
      public function emis_sgstaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['sgstaff_surpwithpost'] = $this->Districtmodel->emis_sgstaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_sgstaff_surpwithpost',$data); 
      }
  }
    public function emis_sciencestaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['sciencestaff_surpwithpost'] = $this->Districtmodel->emis_sciencestaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_sciencestaff_surpwithpost',$data); 
      }
  }
   ...
   public function emis_mathstaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['mathstaff_surpwithpost'] = $this->Districtmodel->emis_mathstaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_mathstaff_surpwithpost',$data); 
      }
  }
   public function emis_englishstaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['englishstaff_surpwithpost'] = $this->Districtmodel->emis_englishstaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_englishstaff_surpwithpost',$data); 
      }
  }
   public function emis_tamilstaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['tamilstaff_surpwithpost'] = $this->Districtmodel->emis_tamilstaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_tamilstaff_surpwithpost',$data); 
      }
  }
   public function emis_socialsciencestaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['socialsciencestaff_surpwithpost'] = $this->Districtmodel->emis_socialsciencestaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_socialsciencestaff_surpwithpost',$data); 
      }
  }
   public function emis_primaryhmstaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['primarystaff_surpwithpost'] = $this->Districtmodel->emis_primaryhmstaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_primaryhmstaff_surpwithpost',$data); 
      }
  }
   public function emis_middlehmstaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['middlestaff_surpwithpost'] = $this->Districtmodel->emis_middlehmstaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_middlehmstaff_surpwithpost',$data); 
      }
  }
   public function emis_highhmstaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['highstaff_surpwithpost'] = $this->Districtmodel->emis_highhmstaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_highhmstaff_surpwithpost',$data); 
      }
  }
  public function emis_telgustaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['telgustaff_surpwithpost'] = $this->Districtmodel->emis_telgustaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_telgustaff_surpwithpost',$data); 
      }
  }
  public function emis_kannadastaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['kannadamstaff_surpwithpost'] = $this->Districtmodel->emis_kannadastaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_kannadastaff_surpwithpost',$data); 
      }
  }
  public function emis_urdustaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['urdustaff_surpwithpost'] = $this->Districtmodel->emis_urdustaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_urdustaff_surpwithpost',$data); 
      }
  }
  public function emis_malayalamstaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['malastaff_surpwithpost'] = $this->Districtmodel->emis_malayalamstaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_malayalamstaff_surpwithpost',$data); 
      }
  }
   public function emis_staff_fixa_report_PG_block()
  {
     $this->load->library('session');
      ...
      {
       $district_id  =$this->session->userdata('emis_district_id');
        $data['staff_fixa_report'] = $this->Districtmodel->staff_fixa_report_PG_block($district_id); 
       // print_r($data['staff_fixa_report']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_staff_fixa_report_PG_block1',$data); 
      }
  }
   public function emis_staff_fixa_report_PG_school()
  {
     $this->load->library('session');
      ...
      {
        $block_id=$this->input->get('block_id');
        $data['staff_fixa_report'] = $this->Districtmodel->staff_fixa_report_PG_school($block_id); 
       // print_r($data['staff_fixa_report']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_staff_fixa_report_PG_school_dse',$data); 
      }
  }
   public function emis_staff_transfer_dse_req_block()
  {
     $this->load->library('session');
      ...
      if($emis_loggedin) 
      {
        ...
        $district_id=$this->session->userdata('emis_district_id');
        $data['staff_transfer_req'] = $this->Districtmodel->staff_transfer_dse_req_block($district_id); 
     //  print_r($data['staff_transfer_req']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_staff_dse_req_report_block',$data); 
      }
  }
    public function emis_staff_transfer_dse_req_teacher()
  {
     $this->load->library('session');
      ...
      {      
        $block_id=$this->input->get('block_id');
        $data['staff_transfer_req'] = $this->Districtmodel->staff_transfer_dse_req_teacher($block_id); 
     //  print_r($data['staff_transfer_req']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_staff_dse_req_report_teacher',$data); 
      }
  }
    public function get_staff_fix_district_dse()
  {
    ...
    {
      $district_id=$this->session->userdata('emis_district_id');
        $data['dist_details'] = $this->Districtmodel->get_staff_fix_district_dse($district_id);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_state_staff_fix_districtwise_dse',$data);
    }
  }
   public function get_staff_fix_schoolwise_dse()
  {
      ...
      $data['school_details'] = $this->Districtmodel->get_staff_fix_schoolwise_dse($block_id);
      $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
      $this->load->view('district/emis_state_staff_fix_schoolwise_dse',$data);   
  }
   public function emis_dsestaff_surplus_tot_subject()
    {
     $this->load->library('session');
      ...
      {
        $dist_id  =$this->session->userdata('emis_district_id');
        $data['dseschoolsurp'] = $this->Districtmodel->emis_dsestaff_surplus_tot_subject($dist_id);
        $data['dsesurptot'] = $this->Districtmodel->dsesurplus_tot($dist_id);
        $data['dsesurplus_sub'] = $this->Districtmodel ->DSEsurplus_sub($dist_id);
        $this->load->view('district/emis_dsestaff_surplus_tot_subject',$data);
    ...
    public function emis_dsesgstaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['dsesgstaff_surpwithpost'] = $this->Districtmodel->emis_dsesgstaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_dsesgstaff_surpwithpost',$data); 
      }
  }
    public function emis_dsesciencestaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['dsesciencestaff_surpwithpost'] = $this->Districtmodel->emis_dsesciencestaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_dsesciencestaff_surpwithpost',$data); 
      }
  }
   ...
   public function emis_dsemathstaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['dsemathstaff_surpwithpost'] = $this->Districtmodel->emis_dsemathstaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_dsemathstaff_surpwithpost',$data); 
      }
  }
   public function emis_dseenglishstaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['dseenglishstaff_surpwithpost'] = $this->Districtmodel->emis_dseenglishstaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_dseenglishstaff_surpwithpost',$data); 
      }
  }
   public function emis_dsetamilstaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['dsetamilstaff_surpwithpost'] = $this->Districtmodel->emis_dsetamilstaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_dsetamilstaff_surpwithpost',$data); 
      }
  }
   public function emis_dsesocialsciencestaff_surpwithpost()
  {
     $this->load->library('session');
      ...
      {
         $dist_id  =$this->session->userdata('emis_district_id');
        $data['dsesocialsciencestaff_surpwithpost'] = $this->Districtmodel->emis_dsesocialsciencestaff_surpwithpost( $dist_id);
        // print_r($data['staff_fixa']);
        $head_details = $this->get_common_control_link();
        $data['header'] = $head_details['header'];
        $data['link'] = $head_details['link'];
        $this->load->view('district/emis_dsesocialsciencestaff_surpwithpost',$data); 
      }
  }
     ...
     $this->load->library('session');
      ...
      {   
          $school_id=$this->input->get('schoolid');
            ...
            $data['dsegovsurplus_sgstaff'] = $this->Districtmodel->emis_dsegovsurplus_sgstaff_school($school_id);
      ...
      $this->load->view('district/emis_dsegovsurplus_sgstaff_school',$data);
      }else { redirect('/', 'refresh'); }
  }
   /* DEE school surplus staff count Created by Bala*/
	 public function emis_total_surplus_teacher_dee()
	  {
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				$dist_id  =$this->session->userdata('emis_district_id');
				$data['totalsurplus'] = $this->Districtmodel->emis_total_surplus_teacher_dee($dist_id);
				$data['teachertype_total'] = $this->Districtmodel->emis_total_surplus_teacher_type_dee($dist_id);
				$this->load->view('district/emis_district_surplus_tot_count_dee',$data);
			}
	   ...
	   public function emis_teacher_surplus_sg_dee()
	  {
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				$dist_id  =$this->session->userdata('emis_district_id');
				$data['sgteachers'] = $this->Districtmodel->emis_total_surplus_teacher_sg_dee($dist_id);
				$this->load->view('district/emis_staff_sg_teachers_dee',$data);
			}
	  ...
	  public function emis_teacher_surplus_phm_dee()
	  {
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				$dist_id  =$this->session->userdata('emis_district_id');
				$data['sgteachers'] = $this->Districtmodel->emis_total_surplus_teacher_phm_dee($dist_id);
				$this->load->view('district/emis_staff_phm_teachers_dee',$data);
			}
	  ...
	  public function emis_teacher_surplus_mhm_dee()
	  {
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				$dist_id  =$this->session->userdata('emis_district_id');
				$data['sgteachers'] = $this->Districtmodel->emis_total_surplus_teacher_mhm_dee($dist_id);
				$this->load->view('district/emis_staff_mhm_teachers_dee',$data);
			}
	  ...
	  { 
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				$dist_id  =$this->session->userdata('emis_district_id');
				$data['sgteachers'] = $this->Districtmodel->emis_total_surplus_teacher_pg_dee($dist_id);
				$this->load->view('district/emis_staff_pg_teachers_dee',$data);
			}
	  ...
	  { 
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				$dist_id  =$this->session->userdata('emis_district_id');
				$data['sgteachers'] = $this->Districtmodel->emis_total_surplus_teacher_bt_dee($dist_id);
				$this->load->view('district/emis_staff_bt_teachers_dee',$data);
			}
	  }
	 ...
	 public function emis_total_surplus_teacher()
	  {
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				$dist_id  =$this->session->userdata('emis_district_id');
				$data['totalsurplus'] = $this->Districtmodel->emis_total_surplus_teacher($dist_id);
				 $data['teachertype_total'] = $this->Districtmodel->emis_total_surplus_teacher_type($dist_id);
				// $data['dsesurplus_sub'] = $this->Ceo_District_model ->DSEsurplus_sub($dist_id);
				$this->load->view('district/emis_district_surplus_tot_count_dse',$data);
	  ...
	  public function emis_teacher_surplus_sg()
	  {
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				$dist_id  =$this->session->userdata('emis_district_id');
				$data['sgteachers'] = $this->Districtmodel->emis_total_surplus_teacher_sg($dist_id);
				$this->load->view('district/emis_staff_sg_teachers_dse',$data);
			}
	  ...
	  public function emis_teacher_surplus_highhm()
	  {
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				$dist_id  =$this->session->userdata('emis_district_id');
				$data['sgteachers'] = $this->Districtmodel->emis_total_surplus_teacher_highhm($dist_id);
				$this->load->view('district/emis_staff_highhm_teachers_dse',$data);
			}
	  ...
	  public function emis_teacher_surplus_hrshm()
	  {
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				$dist_id  =$this->session->userdata('emis_district_id');
				$data['sgteachers'] = $this->Districtmodel->emis_total_surplus_teacher_hrshm($dist_id);
				$this->load->view('district/emis_staff_hrhm_teachers_dse',$data);
			}
	  ...
	  { 
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				$dist_id  =$this->session->userdata('emis_district_id');
				$data['sgteachers'] = $this->Districtmodel->emis_total_surplus_teacher_pg($dist_id);
				$this->load->view('district/emis_staff_pg_teachers_dse',$data);
			}
	  ...
	  { 
         ...
         $emis_loggedin = $this->session->userdata('emis_loggedin');
			...
			{
				$dist_id  =$this->session->userdata('emis_district_id');
				$data['btteachers'] = $this->Districtmodel->emis_total_surplus_teacher_bt($dist_id);
				$this->load->view('district/emis_staff_bt_teachers_dse',$data);
			}
	  }
    public function emis_PG_fixation()
    {
        ...
        // print_r($pst);
         ...
         $data['DT']=$this->Districtmodel->emis_PG_fixation($ssql,$district_id);
     // print_r($DT['pg_fix']);
        $this->load->view('district/emis_PG_fixation',$data);
      }
    }
      ...
      public function emis_state_school()
    {
      ...
      $data['total_count_details'] = $this->Districtmodel->get_state_school($dist_id);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school',$data);
      ...
      public function get_state_school_district()
    {
      ...
      $dist_id  =$this->session->userdata('emis_district_id');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_district($mang,$dist_id);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school_district',$data);
        ...
        public function get_state_school_wise()
    {
      ...
      $block_name=$this->input->get('block_name');
      $mang=$this->input->get('mang');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_wise($block_name,$mang);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school_wise',$data);
      ...
      public function emis_state_school_dee()
    {
      ...
      $this->load->model('Ceo_District_model');
      $dist_id  =$this->session->userdata('emis_district_id');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_dee($dist_id);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school_dee',$data);
      ...
      public function get_state_school_district_dee()
    {
      ...
      $block_name=$this->input->get('block_name');
      $mang=$this->input->get('mang');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_district_dee($mang,$dist_id);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school_district_dee',$data);
        ...
        public function get_state_school_wise_dee()
    {
      ...
      $block_name=$this->input->get('block_name');
      $mang=$this->input->get('mang');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_wise_dee($block_name,$mang);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school_wise_dee',$data);
      ...
      public function emis_state_school_dse()
    {
      ...
      $this->load->model('Ceo_District_model');
      $dist_id  =$this->session->userdata('emis_district_id');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_dse($dist_id);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school_dse',$data);
      ...
      public function get_state_school_district_dse()
    {
      ...
      $mang=$this->input->get('mang');
      $dist_id  =$this->session->userdata('emis_district_id');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_district_dse($mang,$dist_id);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school_district_dse',$data);
        ...
        public function get_state_school_wise_dse()
    {
      ...
      $block_name=$this->input->get('block_name');
      $mang=$this->input->get('mang');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_wise_dse($block_name,$mang);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school_wise_dse',$data);
      ...
      public function emis_state_school_dms()
    {
      ...
      $this->load->model('Ceo_District_model');
      $dist_id  =$this->session->userdata('emis_district_id');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_dms($dist_id);
     // print_r($data['total_count_details']);
      $this->load->view('district/emis_state_school_dms',$data);
      ...
      public function get_state_school_district_dms()
    {
      ...
      $this->load->model('Ceo_District_model');
        $dist_id  =$this->session->userdata('emis_district_id');
      $mang=$this->input->get('mang');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_district_dms($mang,$dist_id);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school_district_dms',$data);
        ...
        public function get_state_school_wise_dms()
    {
      ...
      $block_name=$this->input->get('block_name');
      $mang=$this->input->get('mang');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_wise_dms($block_name,$mang);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school_wise_dms',$data);
       ...
       public function emis_state_school_others()
    {
      ...
      $this->load->model('Ceo_District_model');
         $dist_id  =$this->session->userdata('emis_district_id');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_others($dist_id);
     // print_r($data['total_count_details']);
      $this->load->view('district/emis_state_school_others',$data);
      ...
      public function get_state_school_district_others()
    {
      ...
      $mang=$this->input->get('mang');
       $dist_id  =$this->session->userdata('emis_district_id');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_district_others($mang,$dist_id);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school_district_others',$data);
        ...
        public function get_state_school_wise_others()
    {
      ...
      $block_name=$this->input->get('block_name');
      $mang=$this->input->get('mang');
      $data['total_count_details'] = $this->Districtmodel->get_state_school_wise_others($block_name,$mang);
      //print_r( $data['total_count_details']);
      $this->load->view('district/emis_state_school_wise_others',$data);
      ...
      public function schoolwise_class_timetable_report_blk()
  {
    ...
    $monday = strtotime("last monday");
      ...
      if(!empty($school_cate))
        ...
        if($school_cate!=""){ 
       $data['school_timetable_details'] = $this->Districtmodel->get_dist_school_timetable_details_blk($district_id,$school_cate,$this_week_fst,$this_week_ed);
      }
      else
      {
        $data['school_timetable_details'] = $this->Districtmodel->get_dist_school_timetable_details_blk($district_id,$school_cate,$this_week_fst,$this_week_ed);
   ...
   // print_r($data['school_timetable_details']);
      $this->load->view('district/emis_district_schoolwise_timetable_blk',$data);
      }else { redirect('/', 'refresh'); }
   ...
   public function schoolwise_class_timetable_report()
  {
    ...
    $monday = strtotime("last monday");
      ...
      if(!empty($school_cate)){
        $data['school_timetable_details'] = $this->Districtmodel->get_dist_school_timetable_details($school_cate,$block_name,$this_week_fst,$this_week_ed);
    ...
    else
    {
      $data['school_timetable_details'] = $this->Districtmodel->get_dist_school_timetable_details($school_cate,$block_name,$this_week_fst,$this_week_ed);
       ...
       $data['this_week_fst']= $this_week_fst; 
         $data['this_week_ed']= $this_week_ed;
   // print_r($data['school_timetable_details']);
      $this->load->view('district/emis_district_schoolwise_timetable',$data);
      }else { redirect('/', 'refresh'); }
   ...
   $data['schoolid']=$_GET['schoolid'];
    ...
    $monday = strtotime("last monday");
        $monday = date('w', $monday)==date('w') ? $monday+7*86400 : $monday;
         ...
         $this_week_fst = date("Y-m-d",$monday);
         $this_week_ed = date("Y-m-d",$sunday);
      $data['school_class_section_timetable'] = $this->Districtmodel->get_school_class_section_timetable($school_id,$this_week_fst,$this_week_ed);
      $data['this_week_fst']= $this_week_fst; 
         $data['this_week_ed']= $this_week_ed;
      $this->load->view('district/emis_district_school_section_timetable',$data);
    }else { redirect('/', 'refresh');}
...
$this->load->library('session');
  ...
  $data['student_migration_details'] = json_decode(json_encode($this->Districtmodel->dge_2017_18_report_blk($dist_id)),true);
    ...
    $this->load->view('district/dge_2017_18_report_blk',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
   $block_id=$this->input->get('block_id');
      $data['student_migration_details'] =$this->Districtmodel->dge_2017_18_report_schl($block_id);
  

    $this->load->view('district/dge_2017_18_report_schl',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
   $dist_id=$this->session->userdata('emis_district_id');
  $data['student_migration_details'] = json_decode(json_encode($this->Districtmodel->dge_2018_19_report_blk($dist_id)),true);
    ...
    $this->load->view('district/dge_2018_19_report_blk',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
   $block_id=$this->input->get('block_id');
      $data['student_migration_details'] =$this->Districtmodel->dge_2018_19_report_schl($block_id);
  

    $this->load->view('district/dge_2018_19_report_schl',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
    ...
    //print_r($district_id);die();
     $data['child_studying_status'] = json_decode(json_encode($this->Districtmodel->teacher_child_studyingstatus_district($district_id)),true);
...
$this->load->view('district/emis_state_teacher_child_report_district',$data);
} 
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
    $block_id=$this->input->get('block_id');
    //print_r($block_id);die();
     $data['child_studying_status'] = json_decode(json_encode($this->Districtmodel->teacher_child_studyingstatus_block($block_id)),true);
       ...
       $data['child_studying_status']=$result;
$this->load->view('district/emis_state_teacher_child_report_block',$data);
} 
...
$this->load->library('session');
 ...
 //print_r($catty_id);
    ...
    $this->load->model('Districtmodel');
      ...
      //$data['get_teacherdetails'] = $this->Statemodel->get_dist_teacherdetails();
      $data['student_migration_details'] = $this->Districtmodel->slas_report_schl_blk($dist_id,$catty_id,$manage_id);
          // print_r($data['student_migration_details']);die();
      $data['dist_id']=$dist_id;
      $data['catty_id']=$catty_id;
      $data['manage_id']=$manage_id;

    $this->load->view('district/slas_report_schl_blk',$data);
  } else { redirect('/', 'refresh'); }
  ...
  //  $pst=$this->input->post('emis_state_fix')==''?'tamil':$this->input->post('emis_state_fix');
   ...
   // print_r($gender);
    ...
    $this->load->model('Districtmodel');
      ...
      //$data['get_teacherdetails'] = $this->Statemodel->get_dist_teacherdetails();
      $data['student_migration_details'] = $this->Districtmodel->slas_report_schl_wise($blk_id, $catty_id,$manage_id);
          // print_r($data['student_migration_details']);die();
      $data['blk_id']=$blk_id;
      $data['manage_id']=$manage_id;
    $this->load->view('district/slas_report_schl_wise',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
    ...
    $dist_id=$this->session->userdata('emis_district_id');
      //$data['get_teacherdetails'] = $this->Statemodel->get_dist_teacherdetails();
      $data['student_migration_details'] = $this->Districtmodel->slas_report_cate_dist($dist_id);
          // print_r($data['student_migration_details']);de();
    $this->load->view('district/slas_report_cate_dist',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
    ...
    $dist_id=$this->session->userdata('emis_district_id');
      ...
      //$data['get_teacherdetails'] = $this->Statemodel->get_dist_teacherdetails();
      $data['student_migration_details'] = $this->Districtmodel->slas_report_mana_dist($dist_id);
          // print_r($data['student_migration_details']);die();
    $this->load->view('district/slas_report_mana_dist',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  // print_r($gender);
    ...
    $this->load->model('Districtmodel');
      ...
      //$data['get_teacherdetails'] = $this->Statemodel->get_dist_teacherdetails();
      $data['student_migration_details'] = $this->Districtmodel->slas_report_blk($dist_id,$pst,$gender);
          //print_r($data['student_migration_details']);die();
      $data['dist_id']=$dist_id;
    $this->load->view('district/slas_report_blk',$data);
  } else { redirect('/', 'refresh'); }
  ...
  if($emis_loggedin) {
   ...
   // print_r($gender);
    ...
    $this->load->model('Districtmodel');
      ...
      //$data['get_teacherdetails'] = $this->Statemodel->get_dist_teacherdetails();
      $data['student_migration_details'] = $this->Districtmodel->slas_report_schl($blk_id,$pst,$gender);
          // print_r($data['student_migration_details']);die();
      $data['blk_id']=$blk_id;
    $this->load->view('district/slas_report_schl',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
    $data['dist_id'] = $this->session->userdata('emis_district_id');
     $dist_id=$data['dist_id'] ;
      ...
      $data['student_migration_details'] = json_decode(json_encode($this->Districtmodel->get_OSC_List($dist_id)),true);
   //print_r($data['student_migration_details']);
       $result = array();$key='block_name';
  ...
  // print_r($dist_id);
     // $data['student_migration_details'] = $this->Ceo_District_model->get_blk_student_migration($dist_id);
          // print_r($data['student_migration_details']);die();
    $this->load->view('district/get_OSC_List',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
  $block_id=$this->input->get('block_id');
  $data['student_migration_details'] = json_decode(json_encode($this->Districtmodel->get_OSC_List_school($block_id)),true);
   //print_r($data['student_migration_details']);
       $result = array();$key='school_name';
  ...
  // print_r($dist_id);
     // $data['student_migration_details'] = $this->Ceo_District_model->get_blk_student_migration($dist_id);
          // print_r($data['student_migration_details']);die();
    $this->load->view('district/get_OSC_List_school',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  $data['student_osc'] = $this->Districtmodel->students_osc_reg($school_id);
   
    $this->load->view('district/students_osc_reg',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
    ...
    $this->load->database();
     $this->load->model('Statemodel');
  $dist_id=$this->session->userdata('emis_district_id');
  $data['student_osc'] = $this->Districtmodel->students_Dropped_out_block($dist_id);
   
    $this->load->view('district/students_Dropped_out_block',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
    ...
    $this->load->model('Statemodel');
  $block_id=$this->input->get('block_id');
  $data['student_osc'] = $this->Districtmodel->students_Dropped_out_school($block_id);
   
    $this->load->view('district/students_Dropped_out_school',$data);
  } else { redirect('/', 'refresh'); }
...
$this->load->library('session');
  ...
  if($emis_loggedin) {
    ...
    $this->load->model('Statemodel');
  $school_id=$this->input->get('school_id');
  $data['student_osc'] = $this->Districtmodel->students_Dropped_out_student_list($school_id);
   
    $this->load->view('district/students_Dropped_out_student_list',$data);
  } else { redirect('/', 'refresh'); }
 ...
 public function emis_gis_video()
    {
     $this->load->library('session');
      ...
      if($emis_loggedin) 
      {
        ...
        $data['surptot'] = $this->Districtmodel->surplus_tot($dist_id);
        $data['surplus_sub'] = $this->Districtmodel ->surplus_sub($dist_id);
        $this->load->view('District/emis_gis_video',$data);
        
      }
     
    }

    /** Screen : PINDICS Monitoring -> Teacher's Status reset 
     *  LastMod : 18/12/2019 - Functionality Done By Wesley John
     */
          /** 1 ) For Listing */
          public function pindics_teacher_status_reset()
          {
            $this->load->library('session');
              ...
              {
                $districtid  =$this->session->userdata('emis_district_id');        
                $data['staff_stud_dist_school_details'] = $this->Districtmodel->pindics_teachr_status_reset_rep($districtid);        
          ...
          public function teacher_status_reset(){
            ...
            $status_reset=$this->Districtmodel->teacher_status_reset($data);
            echo $status_reset;
            }
          }
		   ...
		   public function profile_status_blockwise()
{
	$this->load->library('session');
      ...
      if($emis_loggedin) {
	     ...
	     $data['district_profile_completion_status'] = $this->Districtmodel->district_profile_completion_status($district_id,$school_type);
	    $data['school_type'] = $this->Statemodel->school_type();
	   $this->load->view('district/emis_district_profile_completed',$data);
  }
  else { redirect('/', 'refresh'); }
}
public function profile_status_schoolkwise()
{
	$this->load->library('session');
	  ...
	  $data['block_profile_completion_status'] = $this->Districtmodel->block_profile_completion_status($block_id,$school_type);
	  
	   $this->load->view('district/emis_block_profile_completed',$data);
  }
  else { redirect('/', 'refresh'); }
}
  
   /** Functionality Ends Here */
public function get_emis_resend_password(){
  $this->load->library('session');
    $district_id = $this->session->userdata('emis_district_id');
		$emis_loggedin = $this->session->userdata('emis_loggedin');
		if($emis_loggedin) {

			$data['dist'] = $this->Datamodel->getallschoolblock($district_id);
		...
		//	$data['details'] = $this->Statemodel->getalldistrictcountsbyclass();
			...
			// // echo json_encode($data);
			$this->load->view('district/emis_dc_resend_pswd',$data);
