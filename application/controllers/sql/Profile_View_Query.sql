...
) as landesc ON landesc.school_key_id=meddesc.school_key_id) AS langandmed ON langandmed.school_key_id=students_school_child_count.school_id 
...
LEFT JOIN (SELECT clubs,school_key_id FROM schoolnew_extracc_entry
