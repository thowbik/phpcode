SELECT 
	...
	) AS hill_frst,(CASE WHEN RESITYPE_DESC IS NULL THEN 'NOT APPLICAPLE' ELSE RESITYPE_DESC END) as typ_resid_schl,
    ...
    (CASE WHEN (SELECT minority FROM schoolnew_minority WHERE schoolnew_minority.id=schoolnew_academic_detail.minority_grp) IS NULL THEN 'N/A'
	...
	(CASE WHEN schoolnew_academic_detail.minority_sch=1 THEN schoolnew_academic_detail.minority_yr ELSE 'N/A' END) AS minority_yr,
    ...
    mediumentry.MEDINSTR_DESC as mediumetr,
    langentry.MEDINSTR_DESC as langetr,
    (SELECT category_name FROM schoolnew_type WHERE id=schoolnew_dayswork_entry.school_type) AS daywork_school_type,
    ...
    (CASE WHEN schoolnew_training_detail.special_train=1 THEN 'YES' ELSE 'NO' END) AS special_train,
    (CASE WHEN schoolnew_training_detail.stu_councel=1 THEN 'YES' ELSE 'NO' END) AS stu_councel,
    IF(schoolnew_training_detail.special_train=1,schoolnew_training_detail.train_prov_boys,NULL) AS train_prov_boys,
    IF(schoolnew_training_detail.special_train=1,schoolnew_training_detail.train_prov_grls,NULL) AS train_prov_grls,
    ...
    CASE WHEN schoolnew_training_detail.train_cond_by=4 THEN 'NGO' END END END END),'N/A') AS train_cond_by,
    ...
    (CASE WHEN schoolnew_safety_details.slfdfse_trng=1 THEN 'YES' ELSE 'NO' END) AS slfdfse_trng,
    (CASE WHEN schoolnew_safety_details.noslfdfse_trng=1 THEN 'YES' ELSE 'NO' END) AS noslfdfse_trng,
    ...
    IF(smc_const=1,schoolnew_committee_detail.smc_acc_no,'N/A') as smc_acc_no,
    IF(smc_const=1,schoolnew_committee_detail.smc_acc_name,'N/A') as smc_acc_name,
    ...
    (CASE WHEN schoolnew_academic_detail.prevoc_course=0 THEN 'N/A' ELSE 'YES' END) AS prevoc_course,
    (CASE WHEN voctrade.trade IS NULL THEN 'N/A' ELSE voctrade.trade END) AS trade,
    
    (CASE WHEN schoolnew_textbook_detail.txtbk_curyr_prepri=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.txtbk_curyr_prepri=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.txtbk_curyr_prepri=3 THEN 'N/A' END END END) AS txtbk_curyr_prepri,
    (CASE WHEN schoolnew_textbook_detail.txtbk_curyr_pri=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.txtbk_curyr_pri=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.txtbk_curyr_pri=3 THEN 'N/A' END END END) AS txtbk_curyr_pri,
	(CASE WHEN schoolnew_textbook_detail.txtbk_curyr_upp=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.txtbk_curyr_upp=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.txtbk_curyr_upp=3 THEN 'N/A' END END END) AS txtbk_curyr_upp,
	(CASE WHEN schoolnew_textbook_detail.txtbk_curyr_sec=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.txtbk_curyr_sec=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.txtbk_curyr_sec=3 THEN 'N/A' END END END) AS txtbk_curyr_sec,
	(CASE WHEN schoolnew_textbook_detail.txtbk_curyr_hsec=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.txtbk_curyr_hsec=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.txtbk_curyr_hsec=3 THEN 'N/A' END END END) AS txtbk_curyr_hsec,
	(CASE WHEN schoolnew_textbook_detail.tle_grade_preprim=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.tle_grade_preprim=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.tle_grade_preprim=3 THEN 'N/A' END END END) AS tle_grade_preprim,
    (CASE WHEN schoolnew_textbook_detail.tle_grade_prim=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.tle_grade_prim=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.tle_grade_prim=3 THEN 'N/A' END END END) AS tle_grade_prim,
	(CASE WHEN schoolnew_textbook_detail.tle_grde_upp=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.tle_grde_upp=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.tle_grde_upp=3 THEN 'N/A' END END END) AS tle_grde_upp,
	(CASE WHEN schoolnew_textbook_detail.tle_grde_sec=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.tle_grde_sec=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.tle_grde_sec=3 THEN 'N/A' END END END) AS tle_grde_sec,
	(CASE WHEN schoolnew_textbook_detail.tle_grde_hsec=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.tle_grde_hsec=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.tle_grde_hsec=3 THEN 'N/A' END END END) AS tle_grde_hsec,
	(CASE WHEN schoolnew_textbook_detail.sports_prepri=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.sports_prepri=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.sports_prepri=3 THEN 'N/A' END END END) AS sports_prepri,
    (CASE WHEN schoolnew_textbook_detail.sports_pri=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.sports_pri=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.sports_pri=3 THEN 'N/A' END END END) AS sports_pri,
	(CASE WHEN schoolnew_textbook_detail.sports_upp=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.sports_upp=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.sports_upp=3 THEN 'N/A' END END END) AS sports_upp,
	(CASE WHEN schoolnew_textbook_detail.sports_sec=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.sports_sec=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.sports_sec=3 THEN 'N/A' END END END) AS sports_sec,
	(CASE WHEN schoolnew_textbook_detail.sports_hsec=1 THEN 'YES' ELSE
		CASE WHEN schoolnew_textbook_detail.sports_hsec=2 THEN 'NO' ELSE
			CASE WHEN schoolnew_textbook_detail.sports_hsec=3 THEN 'N/A' END END END) AS sports_hsec,
    ...
    IF(schoolnew_committee_detail.smdc_constitu=1,schoolnew_committee_detail.smdc_acc_name,'N/A') as smdc_acc_name,
    IF(schoolnew_committee_detail.smdc_constitu=1,schoolnew_committee_detail.smdc_acc_no,'N/A') as smdc_acc_no,
    IF(schoolnew_committee_detail.smdc_constitu=1,(SELECT CONCAT(bank_name,'<br>',branch,'<br>',branch_add,'<br>',city,'<br>IFSC CODE:',ifsc_code) FROM schoolnew_branch where id=schoolnew_committee_detail.smdc_bnk_brnch),'N/A') as smdc_bank,
    ...
    IF(schoolnew_committee_detail.sbc_const=1,schoolnew_committee_detail.sbc_const_year,'N/A') as sbc_const,
    IF(schoolnew_committee_detail.acadecomm_const=1,schoolnew_committee_detail.acadecomm_year,'N/A') as acadecomm_const,
    ...
    (CASE WHEN schoolnew_natureofconst_entry.construct_type=1 THEN 'PUCCA' ELSE
        ...
        schoolnew_natureofconst_entry.art_room,
        schoolnew_natureofconst_entry.staff_room,
        schoolnew_natureofconst_entry.hm_room,
        schoolnew_natureofconst_entry.girl_room,
        schoolnew_natureofconst_entry.good_condition,
        schoolnew_natureofconst_entry.need_minorrep,
        schoolnew_natureofconst_entry.need_majorrep,
        ...
        IF(schoolnew_academic_detail.internet=1,interetr.internetid,'0') AS internet,
        IF(schoolnew_academic_detail.internet=1,interetr.subscriber,'N/A') AS subscriber,
        IF(schoolnew_academic_detail.internet=1,interetr.data_speed,'N/A') AS data_speed,
        IF(schoolnew_academic_detail.internet=1,interetr.provided_by,'N/A') AS provided_by,
...
JOIN schoolnew_mediumentry ON schoolnew_mediumentry.school_key_id=students_school_child_count.school_id
JOIN schoolnew_mediumofinstruction as mediumentry ON mediumentry.MEDINSTR_ID=schoolnew_mediumentry.medium_instrut
JOIN schoolnew_langtaught_entry ON schoolnew_langtaught_entry.school_key_id=students_school_child_count.school_id
JOIN schoolnew_mediumofinstruction as langentry ON langentry.MEDINSTR_ID=schoolnew_langtaught_entry.lang_taught
JOIN schoolnew_dayswork_entry ON schoolnew_dayswork_entry.school_key_id=students_school_child_count.school_id
JOIN schoolnew_training_detail ON schoolnew_training_detail.school_key_id=students_school_child_count.school_id
JOIN schoolnew_committee_detail ON schoolnew_committee_detail.school_key_id=students_school_child_count.school_id
JOIN schoolnew_textbook_detail ON schoolnew_textbook_detail.school_key_id=students_school_child_count.school_id
JOIN schoolnew_inspection_entry ON schoolnew_inspection_entry.school_key_id=students_school_child_count.school_id
JOIN schoolnew_infra_detail ON schoolnew_infra_detail.school_key_id=students_school_child_count.school_id
JOIN schoolnew_natureofconst_entry ON schoolnew_natureofconst_entry.school_key_id=students_school_child_count.school_id
JOIN schoolnew_library_entry ON schoolnew_library_entry.school_key_id=students_school_child_count.school_id
JOIN (SELECT manage_name,management,department,schoolnew_school_department.id as directid FROM schoolnew_manage_cate
		...
		JOIN schoolnew_school_department ON schoolnew_school_department.school_mana_id=schoolnew_management.id) AS schooldirectrate ON schooldirectrate.directid=schoolnew_basicinfo.sch_directorate_id 
JOIN (SELECT  
...
JOIN schoolnew_type ON schoolnew_type.id=schoolnew_classroomlevel_entry.school_type) AS clsentry  ON clsentry.school_key_id=students_school_child_count.school_id
JOIN (SELECT clubs,school_key_id FROM schoolnew_extracc_entry
			JOIN schoolnew_club ON schoolnew_club.id=schoolnew_extracc_entry.extra_cc) AS clubsetr ON clubsetr.school_key_id=students_school_child_count.school_id
...
JOIN schoolnew_ict_suppliers ON schoolnew_ict_suppliers.id=schoolnew_internet.provided_by) AS interetr ON interetr.school_key_id=students_school_child_count.school_id
LEFT JOIN schoolnew_safety_details ON schoolnew_safety_details.school_key_id=students_school_child_count.school_id
...
LEFT JOIN (SELECT trade,schoolnew_voctrade_entry.school_key_id FROM schoolnew_voctrade_entry
			...
			JOIN schoolnew_trade on schoolnew_trade.id=schoolnew_voctrade_entry.voc_trade) as voctrade ON voctrade.school_key_id=students_school_child_count.school_id
WHERE students_school_child_count.school_id=3531;
